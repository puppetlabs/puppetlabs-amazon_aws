...
Puppet::Type.type(:aws_db_cluster_parameter_group).provide(:arm) do
  ...
  def self.instance_to_hash(instance)
    ...
    db_cluster_parameter_group[:name] = instance.to_hash[namevar]
  ...
  def build_hash
    ...
    db_cluster_parameter_group[namevar] = resource[:name]
  ...
  def create
    ...
    client.create_db_cluster_parameter_group(build_hash)
