...
# AwsDbParameterGroup class
class Puppet::Provider::AwsDbParameterGroup::AwsDbParameterGroup
  ...
  def create(context, name, should)
    context.creating(name) do
      ...
      client   = Aws::RDS::Client.new(region: region)
      client.create_db_parameter_group(new_hash)
    end
  ...
  def update(context, name, should)
    context.updating(name) do
      ...
      client = Aws::RDS::Client.new(region: region)
      client.modify_db_parameter_group(new_hash)
    end
  rescue StandardError => ex
  ...
  def delete(should)
    new_hash = symbolize(build_hash(should))
    client = Aws::RDS::Client.new(region: region)
    client.delete_db_parameter_group(new_hash)
  rescue StandardError => ex
