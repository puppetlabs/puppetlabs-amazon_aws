...
def DescribeStackInstance(*args)
  puts "Calling task operation DescribeStackInstance" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_stack_instance(call_hash)
  end
...
begin
  result = DescribeStackInstance(params)
