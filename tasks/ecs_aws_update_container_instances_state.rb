...
def UpdateContainerInstancesState(*args)
  puts "Calling task operation UpdateContainerInstancesState" 
  ...
  client = Aws::ECS::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.update_container_instances_state(call_hash)
  end
...
begin
  result = UpdateContainerInstancesState(params)
