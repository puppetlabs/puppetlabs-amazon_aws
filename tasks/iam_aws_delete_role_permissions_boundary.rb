...
def DeleteRolePermissionsBoundary(*args)
  puts "Calling task operation DeleteRolePermissionsBoundary" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_role_permissions_boundary(call_hash)
  end
...
begin
  result = DeleteRolePermissionsBoundary(params)
