...
def GetChangeTokenStatus(*args)
  puts "Calling task operation GetChangeTokenStatus" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_change_token_status(call_hash)
  end
...
begin
  result = GetChangeTokenStatus(params)
