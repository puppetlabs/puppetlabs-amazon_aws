...
def CreateInstancesFromSnapshot(*args)
  puts "Calling task operation CreateInstancesFromSnapshot" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_instances_from_snapshot(call_hash)
  end
...
begin
  result = CreateInstancesFromSnapshot(params)
