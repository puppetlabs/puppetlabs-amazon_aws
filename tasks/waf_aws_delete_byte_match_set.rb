...
def DeleteByteMatchSet(*args)
  puts "Calling task operation DeleteByteMatchSet" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_byte_match_set(call_hash)
  end
...
begin
  result = DeleteByteMatchSet(params)
