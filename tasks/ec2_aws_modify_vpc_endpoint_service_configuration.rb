...
def ModifyVpcEndpointServiceConfiguration(*args)
  puts "Calling task operation ModifyVpcEndpointServiceConfiguration" 
  ...
  if arg_hash.empty?
    ...
    response = client.modify_vpc_endpoint_service_configuration(call_hash)
  end
...
begin
  result = ModifyVpcEndpointServiceConfiguration(params)
