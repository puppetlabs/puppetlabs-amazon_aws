...
def operation_with_hash(arg_hash)
  ...
  client.list_instance_profiles_for_role(call_hash)
end
...
def list_instance_profiles_for_role(*args)
  ...
  client = Aws::IAM::Client.new(region: region)
  response = client.list_instance_profiles_for_role if arg_hash.empty?
...
def task
  ...
  params = STDIN.read
  result = list_instance_profiles_for_role(params)
