...
def ListInstanceProfilesForRole(*args)
  puts "Calling task operation ListInstanceProfilesForRole" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_instance_profiles_for_role(call_hash)
  end
...
begin
  result = ListInstanceProfilesForRole(params)
