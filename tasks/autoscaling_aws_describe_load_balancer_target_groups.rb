...
def DescribeLoadBalancerTargetGroups(*args)
  puts "Calling task operation DescribeLoadBalancerTargetGroups" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_load_balancer_target_groups(call_hash)
  end
...
begin
  result = DescribeLoadBalancerTargetGroups(params)
