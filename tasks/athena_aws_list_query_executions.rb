...
def ListQueryExecutions(*args)
  puts "Calling task operation ListQueryExecutions" 
  ...
  client = Aws::Athena::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.list_query_executions(call_hash)
  end
...
begin
  result = ListQueryExecutions(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::Athena::Errors::ServiceError => e
