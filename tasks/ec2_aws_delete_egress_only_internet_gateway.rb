...
def DeleteEgressOnlyInternetGateway(*args)
  puts "Calling task operation DeleteEgressOnlyInternetGateway" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_egress_only_internet_gateway(call_hash)
  end
...
begin
  result = DeleteEgressOnlyInternetGateway(params)
