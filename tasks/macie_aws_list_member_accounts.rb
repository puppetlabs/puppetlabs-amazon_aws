...
def ListMemberAccounts(*args)
  puts "Calling task operation ListMemberAccounts" 
  ...
  client = Aws::Macie::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.list_member_accounts(call_hash)
  end
...
begin
  result = ListMemberAccounts(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::Macie::Errors::ServiceError => e
