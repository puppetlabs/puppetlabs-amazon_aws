...
def DeregisterElasticIp(*args)
  puts "Calling task operation DeregisterElasticIp" 
  ...
  if arg_hash.empty?
    ...
    response = client.deregister_elastic_ip(call_hash)
  end
...
begin
  result = DeregisterElasticIp(params)
