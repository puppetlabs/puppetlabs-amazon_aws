...
def ListThingPrincipals(*args)
  puts "Calling task operation ListThingPrincipals" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_thing_principals(call_hash)
  end
...
begin
  result = ListThingPrincipals(params)
