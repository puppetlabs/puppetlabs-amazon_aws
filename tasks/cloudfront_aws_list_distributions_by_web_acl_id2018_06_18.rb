...
def ListDistributionsByWebACLId2018_06_18(*args)
  puts "Calling task operation ListDistributionsByWebACLId2018_06_18" 
  ...
  if arg_hash.empty?
    response = client.list_distributions_by_web_acl_id2018_06_18()
  else 
    call_hash={}
    ...
    response = client.list_distributions_by_web_acl_id2018_06_18(call_hash)
  end
...
begin
  result = ListDistributionsByWebACLId2018_06_18(params)
