...
def operation_with_hash(arg_hash)
  ...
  client.delete_user_defined_function(call_hash)
end

def delete_user_defined_function(*args)
  argstring = args[0]
  argstring.delete('\\')
  ...
  client = Aws::Glue::Client.new(region: region)
  response = client.delete_user_defined_function if arg_hash.empty?
...
def task
  ...
  params = STDIN.read
  result = delete_user_defined_function(params)
