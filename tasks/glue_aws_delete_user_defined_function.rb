...
def DeleteUserDefinedFunction(*args)
  puts "Calling task operation DeleteUserDefinedFunction" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_user_defined_function(call_hash)
  end
...
begin
  result = DeleteUserDefinedFunction(params)
