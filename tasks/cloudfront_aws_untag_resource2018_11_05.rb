...
def operation_with_hash(arg_hash)
  ...
  client.untag_resource2018_11_05(call_hash)
end

def untag_resource2018_11_05(*args)
  argstring = args[0]
  argstring.delete('\\')
  ...
  client = Aws::CloudFront::Client.new(region: region)
  response = client.untag_resource2018_11_05 if arg_hash.empty?
...
def task
  ...
  params = STDIN.read
  result = untag_resource2018_11_05(params)
