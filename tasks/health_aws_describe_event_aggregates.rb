...
def DescribeEventAggregates(*args)
  puts "Calling task operation DescribeEventAggregates" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_event_aggregates(call_hash)
  end
...
begin
  result = DescribeEventAggregates(params)
