...
def DescribeCacheClusters(*args)
  puts "Calling task operation DescribeCacheClusters" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_cache_clusters(call_hash)
  end
...
begin
  result = DescribeCacheClusters(params)
