...
def DeregisterEcsCluster(*args)
  puts "Calling task operation DeregisterEcsCluster" 
  ...
  if arg_hash.empty?
    ...
    response = client.deregister_ecs_cluster(call_hash)
  end
...
begin
  result = DeregisterEcsCluster(params)
