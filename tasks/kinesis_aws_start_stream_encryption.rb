...
def StartStreamEncryption(*args)
  puts "Calling task operation StartStreamEncryption" 
  ...
  if arg_hash.empty?
    ...
    response = client.start_stream_encryption(call_hash)
  end
...
begin
  result = StartStreamEncryption(params)
