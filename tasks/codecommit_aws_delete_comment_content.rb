...
def DeleteCommentContent(*args)
  puts "Calling task operation DeleteCommentContent" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_comment_content(call_hash)
  end
...
begin
  result = DeleteCommentContent(params)
