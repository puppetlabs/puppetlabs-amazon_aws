...
def ModifyCacheParameterGroup(*args)
  puts "Calling task operation ModifyCacheParameterGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.modify_cache_parameter_group(call_hash)
  end
...
begin
  result = ModifyCacheParameterGroup(params)
