...
def AddSourceIdentifierToSubscription(*args)
  puts "Calling task operation AddSourceIdentifierToSubscription" 
  ...
  if arg_hash.empty?
    ...
    response = client.add_source_identifier_to_subscription(call_hash)
  end
...
begin
  result = AddSourceIdentifierToSubscription(params)
