...
def DeleteHsmConfiguration(*args)
  puts "Calling task operation DeleteHsmConfiguration" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_hsm_configuration(call_hash)
  end
...
begin
  result = DeleteHsmConfiguration(params)
