...
def DeregisterStreamConsumer(*args)
  puts "Calling task operation DeregisterStreamConsumer" 
  ...
  if arg_hash.empty?
    ...
    response = client.deregister_stream_consumer(call_hash)
  end
...
begin
  result = DeregisterStreamConsumer(params)
