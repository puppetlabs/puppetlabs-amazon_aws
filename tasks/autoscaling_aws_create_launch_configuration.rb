...
def CreateLaunchConfiguration(*args)
  puts "Calling task operation CreateLaunchConfiguration" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_launch_configuration(call_hash)
  end
...
begin
  result = CreateLaunchConfiguration(params)
