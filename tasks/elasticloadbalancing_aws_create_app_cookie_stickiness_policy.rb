...
def CreateAppCookieStickinessPolicy(*args)
  puts "Calling task operation CreateAppCookieStickinessPolicy" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_app_cookie_stickiness_policy(call_hash)
  end
...
begin
  result = CreateAppCookieStickinessPolicy(params)
