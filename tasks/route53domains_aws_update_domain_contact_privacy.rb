...
def UpdateDomainContactPrivacy(*args)
  puts "Calling task operation UpdateDomainContactPrivacy" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_domain_contact_privacy(call_hash)
  end
...
begin
  result = UpdateDomainContactPrivacy(params)
