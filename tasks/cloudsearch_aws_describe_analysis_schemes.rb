...
def DescribeAnalysisSchemes(*args)
  puts "Calling task operation DescribeAnalysisSchemes" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_analysis_schemes(call_hash)
  end
...
begin
  result = DescribeAnalysisSchemes(params)
