...
def CreateRateBasedRule(*args)
  puts "Calling task operation CreateRateBasedRule" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_rate_based_rule(call_hash)
  end
...
begin
  result = CreateRateBasedRule(params)
