...
def DescribeChapCredentials(*args)
  puts "Calling task operation DescribeChapCredentials" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_chap_credentials(call_hash)
  end
...
begin
  result = DescribeChapCredentials(params)
