...
def ListDevelopmentSchemaArns(*args)
  puts "Calling task operation ListDevelopmentSchemaArns" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_development_schema_arns(call_hash)
  end
...
begin
  result = ListDevelopmentSchemaArns(params)
