...
def DescribeConfigRuleEvaluationStatus(*args)
  puts "Calling task operation DescribeConfigRuleEvaluationStatus" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_config_rule_evaluation_status(call_hash)
  end
...
begin
  result = DescribeConfigRuleEvaluationStatus(params)
