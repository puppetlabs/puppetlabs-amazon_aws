...
def DescribeSentimentDetectionJob(*args)
  puts "Calling task operation DescribeSentimentDetectionJob" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_sentiment_detection_job(call_hash)
  end
...
begin
  result = DescribeSentimentDetectionJob(params)
