...
def DeleteNotificationSubscription(*args)
  puts "Calling task operation DeleteNotificationSubscription" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_notification_subscription(call_hash)
  end
...
begin
  result = DeleteNotificationSubscription(params)
