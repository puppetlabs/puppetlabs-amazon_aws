...
def ListCompatibleImages(*args)
  puts "Calling task operation ListCompatibleImages" 
  ...
  client = Aws::Snowball::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.list_compatible_images(call_hash)
  end
...
begin
  result = ListCompatibleImages(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::Snowball::Errors::ServiceError => e
