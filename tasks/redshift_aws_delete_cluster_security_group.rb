...
def DeleteClusterSecurityGroup(*args)
  puts "Calling task operation DeleteClusterSecurityGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_cluster_security_group(call_hash)
  end
...
begin
  result = DeleteClusterSecurityGroup(params)
