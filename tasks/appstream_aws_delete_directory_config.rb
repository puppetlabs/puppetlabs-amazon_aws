...
def DeleteDirectoryConfig(*args)
  puts "Calling task operation DeleteDirectoryConfig" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_directory_config(call_hash)
  end
...
begin
  result = DeleteDirectoryConfig(params)
