...
def CreateLaunchTemplateVersion(*args)
  puts "Calling task operation CreateLaunchTemplateVersion" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_launch_template_version(call_hash)
  end
...
begin
  result = CreateLaunchTemplateVersion(params)
