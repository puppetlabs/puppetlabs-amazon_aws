...
def GetCelebrityRecognition(*args)
  puts "Calling task operation GetCelebrityRecognition" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_celebrity_recognition(call_hash)
  end
...
begin
  result = GetCelebrityRecognition(params)
