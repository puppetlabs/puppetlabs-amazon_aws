...
def ListConfigurationRevisions(*args)
  puts "Calling task operation ListConfigurationRevisions" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_configuration_revisions(call_hash)
  end
...
begin
  result = ListConfigurationRevisions(params)
