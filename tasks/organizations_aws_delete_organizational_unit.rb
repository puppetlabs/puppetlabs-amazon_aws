...
def DeleteOrganizationalUnit(*args)
  puts "Calling task operation DeleteOrganizationalUnit" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_organizational_unit(call_hash)
  end
...
begin
  result = DeleteOrganizationalUnit(params)
