...
def DescribeInstancesHealth(*args)
  puts "Calling task operation DescribeInstancesHealth" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_instances_health(call_hash)
  end
...
begin
  result = DescribeInstancesHealth(params)
