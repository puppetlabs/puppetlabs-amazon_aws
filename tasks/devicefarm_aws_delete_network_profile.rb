...
def DeleteNetworkProfile(*args)
  puts "Calling task operation DeleteNetworkProfile" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_network_profile(call_hash)
  end
...
begin
  result = DeleteNetworkProfile(params)
