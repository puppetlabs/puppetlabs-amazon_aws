...
def ListResourceDelegates(*args)
  puts "Calling task operation ListResourceDelegates" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_resource_delegates(call_hash)
  end
...
begin
  result = ListResourceDelegates(params)
