...
def StartOnDemandReplicationRun(*args)
  puts "Calling task operation StartOnDemandReplicationRun" 
  ...
  client = Aws::SMS::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.start_on_demand_replication_run(call_hash)
  end
...
begin
  result = StartOnDemandReplicationRun(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::SMS::Errors::ServiceError => e
