...
def GetWorkflowExecutionHistory(*args)
  puts "Calling task operation GetWorkflowExecutionHistory" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_workflow_execution_history(call_hash)
  end
...
begin
  result = GetWorkflowExecutionHistory(params)
