...
def DeleteSecurityProfile(*args)
  puts "Calling task operation DeleteSecurityProfile" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_security_profile(call_hash)
  end
...
begin
  result = DeleteSecurityProfile(params)
