...
def operation_with_hash(arg_hash)
  ...
  client.delete_security_profile(call_hash)
end

def delete_security_profile(*args)
  argstring = args[0]
  argstring.delete('\\')
  ...
  client = Aws::IoT1ClickDevicesService::Client.new(region: region)
  response = client.delete_security_profile if arg_hash.empty?
...
def task
  ...
  params = STDIN.read
  result = delete_security_profile(params)
