...
def DescribeTargetGroupAttributes(*args)
  puts "Calling task operation DescribeTargetGroupAttributes" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_target_group_attributes(call_hash)
  end
...
begin
  result = DescribeTargetGroupAttributes(params)
