...
def GetApplicationRevision(*args)
  puts "Calling task operation GetApplicationRevision" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_application_revision(call_hash)
  end
...
begin
  result = GetApplicationRevision(params)
