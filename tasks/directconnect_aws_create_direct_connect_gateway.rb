...
def CreateDirectConnectGateway(*args)
  puts "Calling task operation CreateDirectConnectGateway" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_direct_connect_gateway(call_hash)
  end
...
begin
  result = CreateDirectConnectGateway(params)
