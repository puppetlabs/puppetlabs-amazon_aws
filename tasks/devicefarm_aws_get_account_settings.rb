...
def GetAccountSettings(*args)
  puts "Calling task operation GetAccountSettings" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_account_settings(call_hash)
  end
...
begin
  result = GetAccountSettings(params)
