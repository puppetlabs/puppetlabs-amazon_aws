...
def DeleteLifecycleHook(*args)
  puts "Calling task operation DeleteLifecycleHook" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_lifecycle_hook(call_hash)
  end
...
begin
  result = DeleteLifecycleHook(params)
