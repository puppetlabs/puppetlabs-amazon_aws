...
def DeletePatchBaseline(*args)
  puts "Calling task operation DeletePatchBaseline" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_patch_baseline(call_hash)
  end
...
begin
  result = DeletePatchBaseline(params)
