...
def UpdateRuntimeConfiguration(*args)
  puts "Calling task operation UpdateRuntimeConfiguration" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_runtime_configuration(call_hash)
  end
...
begin
  result = UpdateRuntimeConfiguration(params)
