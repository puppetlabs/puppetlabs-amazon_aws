...
def ListFieldLevelEncryptionProfiles2018_06_18(*args)
  puts "Calling task operation ListFieldLevelEncryptionProfiles2018_06_18" 
  ...
  if arg_hash.empty?
    response = client.list_field_level_encryption_profiles2018_06_18()
  else 
    call_hash={}
    ...
    response = client.list_field_level_encryption_profiles2018_06_18(call_hash)
  end
...
begin
  result = ListFieldLevelEncryptionProfiles2018_06_18(params)
