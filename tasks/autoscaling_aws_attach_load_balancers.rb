...
def AttachLoadBalancers(*args)
  puts "Calling task operation AttachLoadBalancers" 
  ...
  if arg_hash.empty?
    ...
    response = client.attach_load_balancers(call_hash)
  end
...
begin
  result = AttachLoadBalancers(params)
