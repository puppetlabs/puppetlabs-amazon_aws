...
def DescribeFleetCapacity(*args)
  puts "Calling task operation DescribeFleetCapacity" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_fleet_capacity(call_hash)
  end
...
begin
  result = DescribeFleetCapacity(params)
