...
def ListAttachedGroupPolicies(*args)
  puts "Calling task operation ListAttachedGroupPolicies" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_attached_group_policies(call_hash)
  end
...
begin
  result = ListAttachedGroupPolicies(params)
