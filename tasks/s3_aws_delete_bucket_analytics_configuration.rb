...
def DeleteBucketAnalyticsConfiguration(*args)
  puts "Calling task operation DeleteBucketAnalyticsConfiguration" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_bucket_analytics_configuration(call_hash)
  end
...
begin
  result = DeleteBucketAnalyticsConfiguration(params)
