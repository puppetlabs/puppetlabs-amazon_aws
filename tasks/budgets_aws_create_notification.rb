...
def CreateNotification(*args)
  puts "Calling task operation CreateNotification" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_notification(call_hash)
  end
...
begin
  result = CreateNotification(params)
