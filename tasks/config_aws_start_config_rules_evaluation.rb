...
def StartConfigRulesEvaluation(*args)
  puts "Calling task operation StartConfigRulesEvaluation" 
  ...
  if arg_hash.empty?
    ...
    response = client.start_config_rules_evaluation(call_hash)
  end
...
begin
  result = StartConfigRulesEvaluation(params)
