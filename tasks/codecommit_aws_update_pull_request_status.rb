...
def UpdatePullRequestStatus(*args)
  puts "Calling task operation UpdatePullRequestStatus" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_pull_request_status(call_hash)
  end
...
begin
  result = UpdatePullRequestStatus(params)
