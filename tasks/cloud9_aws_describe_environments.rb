...
def DescribeEnvironments(*args)
  puts "Calling task operation DescribeEnvironments" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_environments(call_hash)
  end
...
begin
  result = DescribeEnvironments(params)
