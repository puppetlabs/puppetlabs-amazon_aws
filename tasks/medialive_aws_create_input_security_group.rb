...
def CreateInputSecurityGroup(*args)
  puts "Calling task operation CreateInputSecurityGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_input_security_group(call_hash)
  end
...
begin
  result = CreateInputSecurityGroup(params)
