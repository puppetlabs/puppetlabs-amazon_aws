...
def CreateDiskSnapshot(*args)
  puts "Calling task operation CreateDiskSnapshot" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_disk_snapshot(call_hash)
  end
...
begin
  result = CreateDiskSnapshot(params)
