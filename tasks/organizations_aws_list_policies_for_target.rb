...
def ListPoliciesForTarget(*args)
  puts "Calling task operation ListPoliciesForTarget" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_policies_for_target(call_hash)
  end
...
begin
  result = ListPoliciesForTarget(params)
