...
def StartNotebookInstance(*args)
  puts "Calling task operation StartNotebookInstance" 
  ...
  if arg_hash.empty?
    ...
    response = client.start_notebook_instance(call_hash)
  end
...
begin
  result = StartNotebookInstance(params)
