...
def UpdateProvisionedProduct(*args)
  puts "Calling task operation UpdateProvisionedProduct" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_provisioned_product(call_hash)
  end
...
begin
  result = UpdateProvisionedProduct(params)
