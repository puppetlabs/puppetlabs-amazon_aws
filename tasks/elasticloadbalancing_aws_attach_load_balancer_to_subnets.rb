...
def AttachLoadBalancerToSubnets(*args)
  puts "Calling task operation AttachLoadBalancerToSubnets" 
  ...
  if arg_hash.empty?
    ...
    response = client.attach_load_balancer_to_subnets(call_hash)
  end
...
begin
  result = AttachLoadBalancerToSubnets(params)
