...
def DeleteVPCEConfiguration(*args)
  puts "Calling task operation DeleteVPCEConfiguration" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_vpce_configuration(call_hash)
  end
...
begin
  result = DeleteVPCEConfiguration(params)
