...
def DescribeTopicsDetectionJob(*args)
  puts "Calling task operation DescribeTopicsDetectionJob" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_topics_detection_job(call_hash)
  end
...
begin
  result = DescribeTopicsDetectionJob(params)
