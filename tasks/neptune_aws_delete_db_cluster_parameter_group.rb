...
def DeleteDBClusterParameterGroup(*args)
  puts "Calling task operation DeleteDBClusterParameterGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_db_cluster_parameter_group(call_hash)
  end
...
begin
  result = DeleteDBClusterParameterGroup(params)
