...
def CreateDeliveryStream(*args)
  puts "Calling task operation CreateDeliveryStream" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_delivery_stream(call_hash)
  end
...
begin
  result = CreateDeliveryStream(params)
