...
def DeregisterContainerInstance(*args)
  puts "Calling task operation DeregisterContainerInstance" 
  ...
  if arg_hash.empty?
    ...
    response = client.deregister_container_instance(call_hash)
  end
...
begin
  result = DeregisterContainerInstance(params)
