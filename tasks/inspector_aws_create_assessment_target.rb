...
def CreateAssessmentTarget(*args)
  puts "Calling task operation CreateAssessmentTarget" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_assessment_target(call_hash)
  end
...
begin
  result = CreateAssessmentTarget(params)
