...
def DescribeDirectConnectGatewayAssociations(*args)
  puts "Calling task operation DescribeDirectConnectGatewayAssociations" 
  ...
  client = Aws::DirectConnect::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.describe_direct_connect_gateway_associations(call_hash)
  end
...
begin
  result = DescribeDirectConnectGatewayAssociations(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::DirectConnect::Errors::ServiceError => e
