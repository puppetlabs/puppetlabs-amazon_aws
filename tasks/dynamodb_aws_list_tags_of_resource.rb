...
def ListTagsOfResource(*args)
  puts "Calling task operation ListTagsOfResource" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_tags_of_resource(call_hash)
  end
...
begin
  result = ListTagsOfResource(params)
