...
def GetRegexPatternSet(*args)
  puts "Calling task operation GetRegexPatternSet" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_regex_pattern_set(call_hash)
  end
...
begin
  result = GetRegexPatternSet(params)
