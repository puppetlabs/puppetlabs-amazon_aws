...
def UpdateServerEngineAttributes(*args)
  puts "Calling task operation UpdateServerEngineAttributes" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_server_engine_attributes(call_hash)
  end
...
begin
  result = UpdateServerEngineAttributes(params)
