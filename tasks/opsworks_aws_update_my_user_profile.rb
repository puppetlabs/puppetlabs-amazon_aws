...
def UpdateMyUserProfile(*args)
  puts "Calling task operation UpdateMyUserProfile" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_my_user_profile(call_hash)
  end
...
begin
  result = UpdateMyUserProfile(params)
