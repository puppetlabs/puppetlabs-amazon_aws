...
def ListRetirableGrants(*args)
  puts "Calling task operation ListRetirableGrants" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_retirable_grants(call_hash)
  end
...
begin
  result = ListRetirableGrants(params)
