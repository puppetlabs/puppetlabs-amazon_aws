...
def TagResource2018_06_18(*args)
  puts "Calling task operation TagResource2018_06_18" 
  ...
  if arg_hash.empty?
    response = client.tag_resource2018_06_18()
  else 
    call_hash={}
    ...
    response = client.tag_resource2018_06_18(call_hash)
  end
...
begin
  result = TagResource2018_06_18(params)
