...
def ListAccountAliases(*args)
  puts "Calling task operation ListAccountAliases" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_account_aliases(call_hash)
  end
...
begin
  result = ListAccountAliases(params)
