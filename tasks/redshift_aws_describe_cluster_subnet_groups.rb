...
def DescribeClusterSubnetGroups(*args)
  puts "Calling task operation DescribeClusterSubnetGroups" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_cluster_subnet_groups(call_hash)
  end
...
begin
  result = DescribeClusterSubnetGroups(params)
