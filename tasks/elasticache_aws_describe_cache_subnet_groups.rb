...
def DescribeCacheSubnetGroups(*args)
  puts "Calling task operation DescribeCacheSubnetGroups" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_cache_subnet_groups(call_hash)
  end
...
begin
  result = DescribeCacheSubnetGroups(params)
