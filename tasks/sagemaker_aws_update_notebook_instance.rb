...
def UpdateNotebookInstance(*args)
  puts "Calling task operation UpdateNotebookInstance" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_notebook_instance(call_hash)
  end
...
begin
  result = UpdateNotebookInstance(params)
