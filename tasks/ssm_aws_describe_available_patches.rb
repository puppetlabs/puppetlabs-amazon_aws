...
def DescribeAvailablePatches(*args)
  puts "Calling task operation DescribeAvailablePatches" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_available_patches(call_hash)
  end
...
begin
  result = DescribeAvailablePatches(params)
