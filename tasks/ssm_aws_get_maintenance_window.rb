...
def GetMaintenanceWindow(*args)
  puts "Calling task operation GetMaintenanceWindow" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_maintenance_window(call_hash)
  end
...
begin
  result = GetMaintenanceWindow(params)
