...
def GetCatalogImportStatus(*args)
  puts "Calling task operation GetCatalogImportStatus" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_catalog_import_status(call_hash)
  end
...
begin
  result = GetCatalogImportStatus(params)
