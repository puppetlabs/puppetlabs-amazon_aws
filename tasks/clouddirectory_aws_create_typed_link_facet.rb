...
def CreateTypedLinkFacet(*args)
  puts "Calling task operation CreateTypedLinkFacet" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_typed_link_facet(call_hash)
  end
...
begin
  result = CreateTypedLinkFacet(params)
