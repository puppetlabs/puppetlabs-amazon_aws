...
def DescribeActivations(*args)
  puts "Calling task operation DescribeActivations" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_activations(call_hash)
  end
...
begin
  result = DescribeActivations(params)
