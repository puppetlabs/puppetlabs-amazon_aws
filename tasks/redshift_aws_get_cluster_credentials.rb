...
def GetClusterCredentials(*args)
  puts "Calling task operation GetClusterCredentials" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_cluster_credentials(call_hash)
  end
...
begin
  result = GetClusterCredentials(params)
