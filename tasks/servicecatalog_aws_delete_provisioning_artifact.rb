...
def DeleteProvisioningArtifact(*args)
  puts "Calling task operation DeleteProvisioningArtifact" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_provisioning_artifact(call_hash)
  end
...
begin
  result = DeleteProvisioningArtifact(params)
