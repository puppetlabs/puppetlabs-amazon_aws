...
def DeleteClusterParameterGroup(*args)
  puts "Calling task operation DeleteClusterParameterGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_cluster_parameter_group(call_hash)
  end
...
begin
  result = DeleteClusterParameterGroup(params)
