...
def DeleteReusableDelegationSet(*args)
  puts "Calling task operation DeleteReusableDelegationSet" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_reusable_delegation_set(call_hash)
  end
...
begin
  result = DeleteReusableDelegationSet(params)
