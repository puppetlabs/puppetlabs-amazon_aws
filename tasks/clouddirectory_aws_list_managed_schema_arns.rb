...
def ListManagedSchemaArns(*args)
  puts "Calling task operation ListManagedSchemaArns" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_managed_schema_arns(call_hash)
  end
...
begin
  result = ListManagedSchemaArns(params)
