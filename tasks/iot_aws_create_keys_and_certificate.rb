...
def CreateKeysAndCertificate(*args)
  puts "Calling task operation CreateKeysAndCertificate" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_keys_and_certificate(call_hash)
  end
...
begin
  result = CreateKeysAndCertificate(params)
