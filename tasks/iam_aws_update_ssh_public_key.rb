...
def UpdateSSHPublicKey(*args)
  puts "Calling task operation UpdateSSHPublicKey" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_ssh_public_key(call_hash)
  end
...
begin
  result = UpdateSSHPublicKey(params)
