...
def DescribeClusterSecurityGroups(*args)
  puts "Calling task operation DescribeClusterSecurityGroups" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_cluster_security_groups(call_hash)
  end
...
begin
  result = DescribeClusterSecurityGroups(params)
