...
def ListTrafficPolicyInstancesByHostedZone(*args)
  puts "Calling task operation ListTrafficPolicyInstancesByHostedZone" 
  ...
  client = Aws::Route53::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.list_traffic_policy_instances_by_hosted_zone(call_hash)
  end
...
begin
  result = ListTrafficPolicyInstancesByHostedZone(params)
