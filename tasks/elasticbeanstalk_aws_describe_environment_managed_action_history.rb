...
def DescribeEnvironmentManagedActionHistory(*args)
  puts "Calling task operation DescribeEnvironmentManagedActionHistory" 
  ...
  client = Aws::ElasticBeanstalk::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.describe_environment_managed_action_history(call_hash)
  end
...
begin
  result = DescribeEnvironmentManagedActionHistory(params)
