...
def ListPrincipalThings(*args)
  puts "Calling task operation ListPrincipalThings" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_principal_things(call_hash)
  end
...
begin
  result = ListPrincipalThings(params)
