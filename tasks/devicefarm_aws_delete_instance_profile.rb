...
def DeleteInstanceProfile(*args)
  puts "Calling task operation DeleteInstanceProfile" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_instance_profile(call_hash)
  end
...
begin
  result = DeleteInstanceProfile(params)
