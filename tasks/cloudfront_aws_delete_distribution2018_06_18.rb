...
def DeleteDistribution2018_06_18(*args)
  puts "Calling task operation DeleteDistribution2018_06_18" 
  ...
  if arg_hash.empty?
    response = client.delete_distribution2018_06_18()
  else 
    call_hash={}
    ...
    response = client.delete_distribution2018_06_18(call_hash)
  end
...
begin
  result = DeleteDistribution2018_06_18(params)
