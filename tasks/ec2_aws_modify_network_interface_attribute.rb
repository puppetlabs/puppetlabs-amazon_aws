...
def ModifyNetworkInterfaceAttribute(*args)
  puts "Calling task operation ModifyNetworkInterfaceAttribute" 
  ...
  if arg_hash.empty?
    ...
    response = client.modify_network_interface_attribute(call_hash)
  end
...
begin
  result = ModifyNetworkInterfaceAttribute(params)
