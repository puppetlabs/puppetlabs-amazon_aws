...
def StartPipelineExecution(*args)
  puts "Calling task operation StartPipelineExecution" 
  ...
  if arg_hash.empty?
    ...
    response = client.start_pipeline_execution(call_hash)
  end
...
begin
  result = StartPipelineExecution(params)
