...
def DescribeAvailabilityOptions(*args)
  puts "Calling task operation DescribeAvailabilityOptions" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_availability_options(call_hash)
  end
...
begin
  result = DescribeAvailabilityOptions(params)
