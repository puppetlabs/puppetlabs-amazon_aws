...
def ListStreamingDistributions2018_06_18(*args)
  puts "Calling task operation ListStreamingDistributions2018_06_18" 
  ...
  if arg_hash.empty?
    response = client.list_streaming_distributions2018_06_18()
  else 
    call_hash={}
    ...
    response = client.list_streaming_distributions2018_06_18(call_hash)
  end
...
begin
  result = ListStreamingDistributions2018_06_18(params)
