...
def GetLifecyclePolicies(*args)
  puts "Calling task operation GetLifecyclePolicies" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_lifecycle_policies(call_hash)
  end
...
begin
  result = GetLifecyclePolicies(params)
