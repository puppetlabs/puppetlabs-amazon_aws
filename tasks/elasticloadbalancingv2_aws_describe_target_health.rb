...
def DescribeTargetHealth(*args)
  puts "Calling task operation DescribeTargetHealth" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_target_health(call_hash)
  end
...
begin
  result = DescribeTargetHealth(params)
