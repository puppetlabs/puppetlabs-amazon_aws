...
def GetFunctionDefinitionVersion(*args)
  puts "Calling task operation GetFunctionDefinitionVersion" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_function_definition_version(call_hash)
  end
...
begin
  result = GetFunctionDefinitionVersion(params)
