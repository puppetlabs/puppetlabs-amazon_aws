...
def DeleteDBParameterGroup(*args)
  puts "Calling task operation DeleteDBParameterGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_db_parameter_group(call_hash)
  end
...
begin
  result = DeleteDBParameterGroup(params)
