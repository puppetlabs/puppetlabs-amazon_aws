...
def ListTagsForProject(*args)
  puts "Calling task operation ListTagsForProject" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_tags_for_project(call_hash)
  end
...
begin
  result = ListTagsForProject(params)
