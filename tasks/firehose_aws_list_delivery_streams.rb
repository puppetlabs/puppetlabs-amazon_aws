...
def ListDeliveryStreams(*args)
  puts "Calling task operation ListDeliveryStreams" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_delivery_streams(call_hash)
  end
...
begin
  result = ListDeliveryStreams(params)
