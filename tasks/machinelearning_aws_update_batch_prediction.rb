...
def UpdateBatchPrediction(*args)
  puts "Calling task operation UpdateBatchPrediction" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_batch_prediction(call_hash)
  end
...
begin
  result = UpdateBatchPrediction(params)
