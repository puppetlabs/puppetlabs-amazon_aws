...
def CreateOpenIDConnectProvider(*args)
  puts "Calling task operation CreateOpenIDConnectProvider" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_open_id_connect_provider(call_hash)
  end
...
begin
  result = CreateOpenIDConnectProvider(params)
