...
def UpdateDomainContact(*args)
  puts "Calling task operation UpdateDomainContact" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_domain_contact(call_hash)
  end
...
begin
  result = UpdateDomainContact(params)
