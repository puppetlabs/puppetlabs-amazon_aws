...
def ListDeviceDefinitions(*args)
  puts "Calling task operation ListDeviceDefinitions" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_device_definitions(call_hash)
  end
...
begin
  result = ListDeviceDefinitions(params)
