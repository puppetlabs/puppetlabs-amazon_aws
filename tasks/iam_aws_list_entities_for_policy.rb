...
def ListEntitiesForPolicy(*args)
  puts "Calling task operation ListEntitiesForPolicy" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_entities_for_policy(call_hash)
  end
...
begin
  result = ListEntitiesForPolicy(params)
