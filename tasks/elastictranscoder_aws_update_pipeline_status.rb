...
def UpdatePipelineStatus(*args)
  puts "Calling task operation UpdatePipelineStatus" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_pipeline_status(call_hash)
  end
...
begin
  result = UpdatePipelineStatus(params)
