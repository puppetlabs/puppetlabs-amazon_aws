...
def CreateStreamingURL(*args)
  puts "Calling task operation CreateStreamingURL" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_streaming_url(call_hash)
  end
...
begin
  result = CreateStreamingURL(params)
