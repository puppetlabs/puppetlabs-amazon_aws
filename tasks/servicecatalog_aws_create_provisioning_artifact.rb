...
def CreateProvisioningArtifact(*args)
  puts "Calling task operation CreateProvisioningArtifact" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_provisioning_artifact(call_hash)
  end
...
begin
  result = CreateProvisioningArtifact(params)
