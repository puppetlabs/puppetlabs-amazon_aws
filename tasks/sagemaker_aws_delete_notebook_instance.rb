...
def DeleteNotebookInstance(*args)
  puts "Calling task operation DeleteNotebookInstance" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_notebook_instance(call_hash)
  end
...
begin
  result = DeleteNotebookInstance(params)
