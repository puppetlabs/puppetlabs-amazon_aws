...
def UpdateDocumentDefaultVersion(*args)
  puts "Calling task operation UpdateDocumentDefaultVersion" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_document_default_version(call_hash)
  end
...
begin
  result = UpdateDocumentDefaultVersion(params)
