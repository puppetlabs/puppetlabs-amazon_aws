...
def ListVirtualMFADevices(*args)
  puts "Calling task operation ListVirtualMFADevices" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_virtual_mfa_devices(call_hash)
  end
...
begin
  result = ListVirtualMFADevices(params)
