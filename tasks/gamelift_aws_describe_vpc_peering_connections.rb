...
def DescribeVpcPeeringConnections(*args)
  puts "Calling task operation DescribeVpcPeeringConnections" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_vpc_peering_connections(call_hash)
  end
...
begin
  result = DescribeVpcPeeringConnections(params)
