...
def DeleteImportedKeyMaterial(*args)
  puts "Calling task operation DeleteImportedKeyMaterial" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_imported_key_material(call_hash)
  end
...
begin
  result = DeleteImportedKeyMaterial(params)
