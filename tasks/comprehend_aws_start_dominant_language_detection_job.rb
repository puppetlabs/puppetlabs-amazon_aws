...
def StartDominantLanguageDetectionJob(*args)
  puts "Calling task operation StartDominantLanguageDetectionJob" 
  ...
  if arg_hash.empty?
    ...
    response = client.start_dominant_language_detection_job(call_hash)
  end
...
begin
  result = StartDominantLanguageDetectionJob(params)
