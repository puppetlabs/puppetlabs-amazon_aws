...
def DescribeClusterDbRevisions(*args)
  puts "Calling task operation DescribeClusterDbRevisions" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_cluster_db_revisions(call_hash)
  end
...
begin
  result = DescribeClusterDbRevisions(params)
