...
def DescribeRdsDbInstances(*args)
  puts "Calling task operation DescribeRdsDbInstances" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_rds_db_instances(call_hash)
  end
...
begin
  result = DescribeRdsDbInstances(params)
