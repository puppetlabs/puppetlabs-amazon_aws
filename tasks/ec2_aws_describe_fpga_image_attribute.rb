...
def DescribeFpgaImageAttribute(*args)
  puts "Calling task operation DescribeFpgaImageAttribute" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_fpga_image_attribute(call_hash)
  end
...
begin
  result = DescribeFpgaImageAttribute(params)
