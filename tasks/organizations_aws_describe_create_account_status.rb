...
def DescribeCreateAccountStatus(*args)
  puts "Calling task operation DescribeCreateAccountStatus" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_create_account_status(call_hash)
  end
...
begin
  result = DescribeCreateAccountStatus(params)
