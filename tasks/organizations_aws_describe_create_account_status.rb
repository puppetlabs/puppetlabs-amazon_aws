...
def operation_with_hash(arg_hash)
  ...
  client.describe_create_account_status(call_hash)
end

def describe_create_account_status(*args)
  argstring = args[0]
  argstring.delete('\\')
  ...
  client = Aws::Organizations::Client.new(region: region)
  response = client.describe_create_account_status if arg_hash.empty?
...
def task
  ...
  params = STDIN.read
  result = describe_create_account_status(params)
