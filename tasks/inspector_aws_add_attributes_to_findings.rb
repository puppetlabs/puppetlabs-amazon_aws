...
def AddAttributesToFindings(*args)
  puts "Calling task operation AddAttributesToFindings" 
  ...
  if arg_hash.empty?
    ...
    response = client.add_attributes_to_findings(call_hash)
  end
...
begin
  result = AddAttributesToFindings(params)
