...
def DescribeSubnetGroups(*args)
  puts "Calling task operation DescribeSubnetGroups" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_subnet_groups(call_hash)
  end
...
begin
  result = DescribeSubnetGroups(params)
