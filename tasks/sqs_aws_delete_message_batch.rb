...
def DeleteMessageBatch(*args)
  puts "Calling task operation DeleteMessageBatch" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_message_batch(call_hash)
  end
...
begin
  result = DeleteMessageBatch(params)
