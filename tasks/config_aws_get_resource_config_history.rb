...
def GetResourceConfigHistory(*args)
  puts "Calling task operation GetResourceConfigHistory" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_resource_config_history(call_hash)
  end
...
begin
  result = GetResourceConfigHistory(params)
