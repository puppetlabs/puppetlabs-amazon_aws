...
def CreateHsmClientCertificate(*args)
  puts "Calling task operation CreateHsmClientCertificate" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_hsm_client_certificate(call_hash)
  end
...
begin
  result = CreateHsmClientCertificate(params)
