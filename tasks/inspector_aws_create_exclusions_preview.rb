...
def CreateExclusionsPreview(*args)
  puts "Calling task operation CreateExclusionsPreview" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_exclusions_preview(call_hash)
  end
...
begin
  result = CreateExclusionsPreview(params)
