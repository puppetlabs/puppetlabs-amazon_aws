...
def DeleteStackInstances(*args)
  puts "Calling task operation DeleteStackInstances" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_stack_instances(call_hash)
  end
...
begin
  result = DeleteStackInstances(params)
