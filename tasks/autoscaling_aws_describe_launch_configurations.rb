...
def DescribeLaunchConfigurations(*args)
  puts "Calling task operation DescribeLaunchConfigurations" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_launch_configurations(call_hash)
  end
...
begin
  result = DescribeLaunchConfigurations(params)
