...
def CreateServiceLinkedRole(*args)
  puts "Calling task operation CreateServiceLinkedRole" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_service_linked_role(call_hash)
  end
...
begin
  result = CreateServiceLinkedRole(params)
