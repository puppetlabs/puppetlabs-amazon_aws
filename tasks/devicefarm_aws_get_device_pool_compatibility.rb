...
def GetDevicePoolCompatibility(*args)
  puts "Calling task operation GetDevicePoolCompatibility" 
  ...
  client = Aws::DeviceFarm::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.get_device_pool_compatibility(call_hash)
  end
...
begin
  result = GetDevicePoolCompatibility(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::DeviceFarm::Errors::ServiceError => e
