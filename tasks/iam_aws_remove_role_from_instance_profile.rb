...
def operation_with_hash(arg_hash)
  ...
  client.remove_role_from_instance_profile(call_hash)
end
...
def remove_role_from_instance_profile(*args)
  ...
  client = Aws::IAM::Client.new(region: region)
  response = client.remove_role_from_instance_profile if arg_hash.empty?
...
def task
  ...
  params = STDIN.read
  result = remove_role_from_instance_profile(params)
