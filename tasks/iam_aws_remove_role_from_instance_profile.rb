...
def RemoveRoleFromInstanceProfile(*args)
  puts "Calling task operation RemoveRoleFromInstanceProfile" 
  ...
  if arg_hash.empty?
    ...
    response = client.remove_role_from_instance_profile(call_hash)
  end
...
begin
  result = RemoveRoleFromInstanceProfile(params)
