...
def DeleteResourceDefinition(*args)
  puts "Calling task operation DeleteResourceDefinition" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_resource_definition(call_hash)
  end
...
begin
  result = DeleteResourceDefinition(params)
