...
def UpdateDeviceInstance(*args)
  puts "Calling task operation UpdateDeviceInstance" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_device_instance(call_hash)
  end
...
begin
  result = UpdateDeviceInstance(params)
