...
def ListOrganizationalUnitsForParent(*args)
  puts "Calling task operation ListOrganizationalUnitsForParent" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_organizational_units_for_parent(call_hash)
  end
...
begin
  result = ListOrganizationalUnitsForParent(params)
