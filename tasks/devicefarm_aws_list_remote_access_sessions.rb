...
def ListRemoteAccessSessions(*args)
  puts "Calling task operation ListRemoteAccessSessions" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_remote_access_sessions(call_hash)
  end
...
begin
  result = ListRemoteAccessSessions(params)
