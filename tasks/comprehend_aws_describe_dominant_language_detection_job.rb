...
def DescribeDominantLanguageDetectionJob(*args)
  puts "Calling task operation DescribeDominantLanguageDetectionJob" 
  ...
  client = Aws::Comprehend::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.describe_dominant_language_detection_job(call_hash)
  end
...
begin
  result = DescribeDominantLanguageDetectionJob(params)
