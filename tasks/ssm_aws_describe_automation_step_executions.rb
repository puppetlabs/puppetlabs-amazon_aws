...
def DescribeAutomationStepExecutions(*args)
  puts "Calling task operation DescribeAutomationStepExecutions" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_automation_step_executions(call_hash)
  end
...
begin
  result = DescribeAutomationStepExecutions(params)
