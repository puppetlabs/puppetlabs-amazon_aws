...
def UpdateAccountPasswordPolicy(*args)
  puts "Calling task operation UpdateAccountPasswordPolicy" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_account_password_policy(call_hash)
  end
...
begin
  result = UpdateAccountPasswordPolicy(params)
