...
def DeleteDiskSnapshot(*args)
  puts "Calling task operation DeleteDiskSnapshot" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_disk_snapshot(call_hash)
  end
...
begin
  result = DeleteDiskSnapshot(params)
