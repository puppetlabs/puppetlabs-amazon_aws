...
def CreateCacheSubnetGroup(*args)
  puts "Calling task operation CreateCacheSubnetGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_cache_subnet_group(call_hash)
  end
...
begin
  result = CreateCacheSubnetGroup(params)
