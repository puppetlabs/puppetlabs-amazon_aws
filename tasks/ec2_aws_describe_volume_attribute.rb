...
def DescribeVolumeAttribute(*args)
  puts "Calling task operation DescribeVolumeAttribute" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_volume_attribute(call_hash)
  end
...
begin
  result = DescribeVolumeAttribute(params)
