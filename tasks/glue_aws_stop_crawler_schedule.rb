...
def StopCrawlerSchedule(*args)
  puts "Calling task operation StopCrawlerSchedule" 
  ...
  if arg_hash.empty?
    ...
    response = client.stop_crawler_schedule(call_hash)
  end
...
begin
  result = StopCrawlerSchedule(params)
