...
def CreateNotificationSubscription(*args)
  puts "Calling task operation CreateNotificationSubscription" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_notification_subscription(call_hash)
  end
...
begin
  result = CreateNotificationSubscription(params)
