...
def ListAvailableZones(*args)
  puts "Calling task operation ListAvailableZones" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_available_zones(call_hash)
  end
...
begin
  result = ListAvailableZones(params)
