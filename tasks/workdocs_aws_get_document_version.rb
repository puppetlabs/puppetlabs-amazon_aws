...
def GetDocumentVersion(*args)
  puts "Calling task operation GetDocumentVersion" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_document_version(call_hash)
  end
...
begin
  result = GetDocumentVersion(params)
