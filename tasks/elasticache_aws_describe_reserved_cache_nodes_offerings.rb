...
def DescribeReservedCacheNodesOfferings(*args)
  puts "Calling task operation DescribeReservedCacheNodesOfferings" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_reserved_cache_nodes_offerings(call_hash)
  end
...
begin
  result = DescribeReservedCacheNodesOfferings(params)
