...
def DescribeVpcClassicLink(*args)
  puts "Calling task operation DescribeVpcClassicLink" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_vpc_classic_link(call_hash)
  end
...
begin
  result = DescribeVpcClassicLink(params)
