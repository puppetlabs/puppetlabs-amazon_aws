...
def UpdateContainerAgent(*args)
  puts "Calling task operation UpdateContainerAgent" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_container_agent(call_hash)
  end
...
begin
  result = UpdateContainerAgent(params)
