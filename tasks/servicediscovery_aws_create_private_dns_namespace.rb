...
def CreatePrivateDnsNamespace(*args)
  puts "Calling task operation CreatePrivateDnsNamespace" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_private_dns_namespace(call_hash)
  end
...
begin
  result = CreatePrivateDnsNamespace(params)
