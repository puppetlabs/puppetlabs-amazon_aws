...
def RequestUploadCredentials(*args)
  puts "Calling task operation RequestUploadCredentials" 
  ...
  if arg_hash.empty?
    ...
    response = client.request_upload_credentials(call_hash)
  end
...
begin
  result = RequestUploadCredentials(params)
