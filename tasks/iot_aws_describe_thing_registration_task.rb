...
def DescribeThingRegistrationTask(*args)
  puts "Calling task operation DescribeThingRegistrationTask" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_thing_registration_task(call_hash)
  end
...
begin
  result = DescribeThingRegistrationTask(params)
