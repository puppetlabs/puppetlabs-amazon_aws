...
def UpdateUserDefinedFunction(*args)
  puts "Calling task operation UpdateUserDefinedFunction" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_user_defined_function(call_hash)
  end
...
begin
  result = UpdateUserDefinedFunction(params)
