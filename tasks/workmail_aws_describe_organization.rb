...
def DescribeOrganization(*args)
  puts "Calling task operation DescribeOrganization" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_organization(call_hash)
  end
...
begin
  result = DescribeOrganization(params)
