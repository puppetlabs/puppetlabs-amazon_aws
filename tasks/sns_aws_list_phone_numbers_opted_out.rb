...
def ListPhoneNumbersOptedOut(*args)
  puts "Calling task operation ListPhoneNumbersOptedOut" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_phone_numbers_opted_out(call_hash)
  end
...
begin
  result = ListPhoneNumbersOptedOut(params)
