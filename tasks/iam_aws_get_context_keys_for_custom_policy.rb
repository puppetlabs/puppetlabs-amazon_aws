...
def GetContextKeysForCustomPolicy(*args)
  puts "Calling task operation GetContextKeysForCustomPolicy" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_context_keys_for_custom_policy(call_hash)
  end
...
begin
  result = GetContextKeysForCustomPolicy(params)
