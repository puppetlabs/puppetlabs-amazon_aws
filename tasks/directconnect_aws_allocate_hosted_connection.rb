...
def AllocateHostedConnection(*args)
  puts "Calling task operation AllocateHostedConnection" 
  ...
  if arg_hash.empty?
    ...
    response = client.allocate_hosted_connection(call_hash)
  end
...
begin
  result = AllocateHostedConnection(params)
