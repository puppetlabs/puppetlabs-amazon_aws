...
def GenerateCredentialReport(*args)
  puts "Calling task operation GenerateCredentialReport" 
  ...
  if arg_hash.empty?
    ...
    response = client.generate_credential_report(call_hash)
  end
...
begin
  result = GenerateCredentialReport(params)
