...
def DeleteCacheParameterGroup(*args)
  puts "Calling task operation DeleteCacheParameterGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_cache_parameter_group(call_hash)
  end
...
begin
  result = DeleteCacheParameterGroup(params)
