...
def GetResourceDefinition(*args)
  puts "Calling task operation GetResourceDefinition" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_resource_definition(call_hash)
  end
...
begin
  result = GetResourceDefinition(params)
