...
def DescribeScheduledAudit(*args)
  puts "Calling task operation DescribeScheduledAudit" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_scheduled_audit(call_hash)
  end
...
begin
  result = DescribeScheduledAudit(params)
