...
def ListPortfolioAccess(*args)
  puts "Calling task operation ListPortfolioAccess" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_portfolio_access(call_hash)
  end
...
begin
  result = ListPortfolioAccess(params)
