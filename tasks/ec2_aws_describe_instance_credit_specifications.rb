...
def DescribeInstanceCreditSpecifications(*args)
  puts "Calling task operation DescribeInstanceCreditSpecifications" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_instance_credit_specifications(call_hash)
  end
...
begin
  result = DescribeInstanceCreditSpecifications(params)
