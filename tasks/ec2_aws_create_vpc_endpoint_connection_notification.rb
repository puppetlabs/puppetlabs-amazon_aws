...
def CreateVpcEndpointConnectionNotification(*args)
  puts "Calling task operation CreateVpcEndpointConnectionNotification" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_vpc_endpoint_connection_notification(call_hash)
  end
...
begin
  result = CreateVpcEndpointConnectionNotification(params)
