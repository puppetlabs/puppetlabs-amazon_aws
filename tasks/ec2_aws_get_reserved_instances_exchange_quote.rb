...
def GetReservedInstancesExchangeQuote(*args)
  puts "Calling task operation GetReservedInstancesExchangeQuote" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_reserved_instances_exchange_quote(call_hash)
  end
...
begin
  result = GetReservedInstancesExchangeQuote(params)
