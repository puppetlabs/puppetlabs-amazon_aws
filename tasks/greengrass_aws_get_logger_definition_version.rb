...
def GetLoggerDefinitionVersion(*args)
  puts "Calling task operation GetLoggerDefinitionVersion" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_logger_definition_version(call_hash)
  end
...
begin
  result = GetLoggerDefinitionVersion(params)
