...
def DescribeSnapshotAttribute(*args)
  puts "Calling task operation DescribeSnapshotAttribute" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_snapshot_attribute(call_hash)
  end
...
begin
  result = DescribeSnapshotAttribute(params)
