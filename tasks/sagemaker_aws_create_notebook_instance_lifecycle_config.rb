...
def CreateNotebookInstanceLifecycleConfig(*args)
  puts "Calling task operation CreateNotebookInstanceLifecycleConfig" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_notebook_instance_lifecycle_config(call_hash)
  end
...
begin
  result = CreateNotebookInstanceLifecycleConfig(params)
