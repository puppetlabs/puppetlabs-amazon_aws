...
def CreateCoreDefinition(*args)
  puts "Calling task operation CreateCoreDefinition" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_core_definition(call_hash)
  end
...
begin
  result = CreateCoreDefinition(params)
