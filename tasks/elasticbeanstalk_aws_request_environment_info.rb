...
def RequestEnvironmentInfo(*args)
  puts "Calling task operation RequestEnvironmentInfo" 
  ...
  if arg_hash.empty?
    ...
    response = client.request_environment_info(call_hash)
  end
...
begin
  result = RequestEnvironmentInfo(params)
