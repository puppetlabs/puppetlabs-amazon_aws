...
def CreateVpcEndpointServiceConfiguration(*args)
  puts "Calling task operation CreateVpcEndpointServiceConfiguration" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_vpc_endpoint_service_configuration(call_hash)
  end
...
begin
  result = CreateVpcEndpointServiceConfiguration(params)
