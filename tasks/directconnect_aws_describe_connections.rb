...
def DescribeConnections(*args)
  puts "Calling task operation DescribeConnections" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_connections(call_hash)
  end
...
begin
  result = DescribeConnections(params)
