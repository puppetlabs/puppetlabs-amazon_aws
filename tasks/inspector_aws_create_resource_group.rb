...
def CreateResourceGroup(*args)
  puts "Calling task operation CreateResourceGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_resource_group(call_hash)
  end
...
begin
  result = CreateResourceGroup(params)
