...
def DescribeSMBSettings(*args)
  puts "Calling task operation DescribeSMBSettings" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_smb_settings(call_hash)
  end
...
begin
  result = DescribeSMBSettings(params)
