...
def GetLoggerDefinition(*args)
  puts "Calling task operation GetLoggerDefinition" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_logger_definition(call_hash)
  end
...
begin
  result = GetLoggerDefinition(params)
