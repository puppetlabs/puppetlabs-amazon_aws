...
def DeleteVpcEndpointServiceConfigurations(*args)
  puts "Calling task operation DeleteVpcEndpointServiceConfigurations" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_vpc_endpoint_service_configurations(call_hash)
  end
...
begin
  result = DeleteVpcEndpointServiceConfigurations(params)
