...
def CreateLifecyclePolicy(*args)
  puts "Calling task operation CreateLifecyclePolicy" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_lifecycle_policy(call_hash)
  end
...
begin
  result = CreateLifecyclePolicy(params)
