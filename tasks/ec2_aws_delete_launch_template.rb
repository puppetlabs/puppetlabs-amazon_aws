...
def DeleteLaunchTemplate(*args)
  puts "Calling task operation DeleteLaunchTemplate" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_launch_template(call_hash)
  end
...
begin
  result = DeleteLaunchTemplate(params)
