...
def ListVolumeInitiators(*args)
  puts "Calling task operation ListVolumeInitiators" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_volume_initiators(call_hash)
  end
...
begin
  result = ListVolumeInitiators(params)
