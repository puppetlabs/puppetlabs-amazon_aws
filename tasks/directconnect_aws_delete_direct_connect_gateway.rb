...
def DeleteDirectConnectGateway(*args)
  puts "Calling task operation DeleteDirectConnectGateway" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_direct_connect_gateway(call_hash)
  end
...
begin
  result = DeleteDirectConnectGateway(params)
