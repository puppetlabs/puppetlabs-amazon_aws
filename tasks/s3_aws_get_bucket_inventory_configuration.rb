...
def GetBucketInventoryConfiguration(*args)
  puts "Calling task operation GetBucketInventoryConfiguration" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_bucket_inventory_configuration(call_hash)
  end
...
begin
  result = GetBucketInventoryConfiguration(params)
