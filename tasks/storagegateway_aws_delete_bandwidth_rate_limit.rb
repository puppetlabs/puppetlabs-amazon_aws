...
def DeleteBandwidthRateLimit(*args)
  puts "Calling task operation DeleteBandwidthRateLimit" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_bandwidth_rate_limit(call_hash)
  end
...
begin
  result = DeleteBandwidthRateLimit(params)
