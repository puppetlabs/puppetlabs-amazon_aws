...
def UpdateServerCertificate(*args)
  puts "Calling task operation UpdateServerCertificate" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_server_certificate(call_hash)
  end
...
begin
  result = UpdateServerCertificate(params)
