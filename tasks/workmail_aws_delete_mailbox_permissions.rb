...
def DeleteMailboxPermissions(*args)
  puts "Calling task operation DeleteMailboxPermissions" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_mailbox_permissions(call_hash)
  end
...
begin
  result = DeleteMailboxPermissions(params)
