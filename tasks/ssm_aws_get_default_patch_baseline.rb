...
def GetDefaultPatchBaseline(*args)
  puts "Calling task operation GetDefaultPatchBaseline" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_default_patch_baseline(call_hash)
  end
...
begin
  result = GetDefaultPatchBaseline(params)
