...
def DescribeTrainingJob(*args)
  puts "Calling task operation DescribeTrainingJob" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_training_job(call_hash)
  end
...
begin
  result = DescribeTrainingJob(params)
