...
def ListPrincipalsForPortfolio(*args)
  puts "Calling task operation ListPrincipalsForPortfolio" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_principals_for_portfolio(call_hash)
  end
...
begin
  result = ListPrincipalsForPortfolio(params)
