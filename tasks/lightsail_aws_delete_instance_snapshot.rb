...
def DeleteInstanceSnapshot(*args)
  puts "Calling task operation DeleteInstanceSnapshot" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_instance_snapshot(call_hash)
  end
...
begin
  result = DeleteInstanceSnapshot(params)
