...
def CreateVirtualMFADevice(*args)
  puts "Calling task operation CreateVirtualMFADevice" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_virtual_mfa_device(call_hash)
  end
...
begin
  result = CreateVirtualMFADevice(params)
