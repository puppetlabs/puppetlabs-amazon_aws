...
def ListLoggingConfigurations(*args)
  puts "Calling task operation ListLoggingConfigurations" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_logging_configurations(call_hash)
  end
...
begin
  result = ListLoggingConfigurations(params)
