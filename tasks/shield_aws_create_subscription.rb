...
def CreateSubscription(*args)
  puts "Calling task operation CreateSubscription" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_subscription(call_hash)
  end
...
begin
  result = CreateSubscription(params)
