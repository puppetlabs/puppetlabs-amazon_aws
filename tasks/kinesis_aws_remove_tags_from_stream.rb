...
def RemoveTagsFromStream(*args)
  puts "Calling task operation RemoveTagsFromStream" 
  ...
  if arg_hash.empty?
    ...
    response = client.remove_tags_from_stream(call_hash)
  end
...
begin
  result = RemoveTagsFromStream(params)
