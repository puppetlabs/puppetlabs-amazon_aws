...
def CreatePlayerSession(*args)
  puts "Calling task operation CreatePlayerSession" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_player_session(call_hash)
  end
...
begin
  result = CreatePlayerSession(params)
