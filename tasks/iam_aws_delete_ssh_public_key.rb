...
def DeleteSSHPublicKey(*args)
  puts "Calling task operation DeleteSSHPublicKey" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_ssh_public_key(call_hash)
  end
...
begin
  result = DeleteSSHPublicKey(params)
