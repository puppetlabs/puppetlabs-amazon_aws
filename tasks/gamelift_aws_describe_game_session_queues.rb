...
def DescribeGameSessionQueues(*args)
  puts "Calling task operation DescribeGameSessionQueues" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_game_session_queues(call_hash)
  end
...
begin
  result = DescribeGameSessionQueues(params)
