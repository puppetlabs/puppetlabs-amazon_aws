...
def CreateNetworkInterface(*args)
  puts "Calling task operation CreateNetworkInterface" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_network_interface(call_hash)
  end
...
begin
  result = CreateNetworkInterface(params)
