...
def DescribeEffectivePatchesForPatchBaseline(*args)
  puts "Calling task operation DescribeEffectivePatchesForPatchBaseline" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_effective_patches_for_patch_baseline(call_hash)
  end
...
begin
  result = DescribeEffectivePatchesForPatchBaseline(params)
