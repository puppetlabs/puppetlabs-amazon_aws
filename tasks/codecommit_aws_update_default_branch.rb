...
def UpdateDefaultBranch(*args)
  puts "Calling task operation UpdateDefaultBranch" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_default_branch(call_hash)
  end
...
begin
  result = UpdateDefaultBranch(params)
