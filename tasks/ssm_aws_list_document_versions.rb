...
def ListDocumentVersions(*args)
  puts "Calling task operation ListDocumentVersions" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_document_versions(call_hash)
  end
...
begin
  result = ListDocumentVersions(params)
