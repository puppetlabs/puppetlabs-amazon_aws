...
def UpdatePipelineNotifications(*args)
  puts "Calling task operation UpdatePipelineNotifications" 
  ...
  client = Aws::ElasticTranscoder::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.update_pipeline_notifications(call_hash)
  end
...
begin
  result = UpdatePipelineNotifications(params)
