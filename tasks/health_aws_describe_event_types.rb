...
def DescribeEventTypes(*args)
  puts "Calling task operation DescribeEventTypes" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_event_types(call_hash)
  end
...
begin
  result = DescribeEventTypes(params)
