...
def DescribeImportImageTasks(*args)
  puts "Calling task operation DescribeImportImageTasks" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_import_image_tasks(call_hash)
  end
...
begin
  result = DescribeImportImageTasks(params)
