...
def ListBuildsForProject(*args)
  puts "Calling task operation ListBuildsForProject" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_builds_for_project(call_hash)
  end
...
begin
  result = ListBuildsForProject(params)
