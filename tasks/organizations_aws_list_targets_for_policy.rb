...
def ListTargetsForPolicy(*args)
  puts "Calling task operation ListTargetsForPolicy" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_targets_for_policy(call_hash)
  end
...
begin
  result = ListTargetsForPolicy(params)
