...
def ListHostedZonesByName(*args)
  puts "Calling task operation ListHostedZonesByName" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_hosted_zones_by_name(call_hash)
  end
...
begin
  result = ListHostedZonesByName(params)
