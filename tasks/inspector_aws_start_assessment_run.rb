...
def StartAssessmentRun(*args)
  puts "Calling task operation StartAssessmentRun" 
  ...
  if arg_hash.empty?
    ...
    response = client.start_assessment_run(call_hash)
  end
...
begin
  result = StartAssessmentRun(params)
