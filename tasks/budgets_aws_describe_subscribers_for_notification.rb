...
def DescribeSubscribersForNotification(*args)
  puts "Calling task operation DescribeSubscribersForNotification" 
  ...
  client = Aws::Budgets::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.describe_subscribers_for_notification(call_hash)
  end
...
begin
  result = DescribeSubscribersForNotification(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::Budgets::Errors::ServiceError => e
