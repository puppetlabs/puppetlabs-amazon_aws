...
def DeleteAggregationAuthorization(*args)
  puts "Calling task operation DeleteAggregationAuthorization" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_aggregation_authorization(call_hash)
  end
...
begin
  result = DeleteAggregationAuthorization(params)
