...
def UpdateClientCertificate(*args)
  puts "Calling task operation UpdateClientCertificate" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_client_certificate(call_hash)
  end
...
begin
  result = UpdateClientCertificate(params)
