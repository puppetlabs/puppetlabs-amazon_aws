...
def CreateCustomMetadata(*args)
  puts "Calling task operation CreateCustomMetadata" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_custom_metadata(call_hash)
  end
...
begin
  result = CreateCustomMetadata(params)
