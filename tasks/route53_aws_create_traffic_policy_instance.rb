...
def CreateTrafficPolicyInstance(*args)
  puts "Calling task operation CreateTrafficPolicyInstance" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_traffic_policy_instance(call_hash)
  end
...
begin
  result = CreateTrafficPolicyInstance(params)
