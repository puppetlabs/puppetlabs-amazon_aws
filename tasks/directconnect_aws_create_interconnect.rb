...
def CreateInterconnect(*args)
  puts "Calling task operation CreateInterconnect" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_interconnect(call_hash)
  end
...
begin
  result = CreateInterconnect(params)
