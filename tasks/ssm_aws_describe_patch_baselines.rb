...
def DescribePatchBaselines(*args)
  puts "Calling task operation DescribePatchBaselines" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_patch_baselines(call_hash)
  end
...
begin
  result = DescribePatchBaselines(params)
