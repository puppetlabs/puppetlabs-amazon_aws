...
def DescribeVpcAttribute(*args)
  puts "Calling task operation DescribeVpcAttribute" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_vpc_attribute(call_hash)
  end
...
begin
  result = DescribeVpcAttribute(params)
