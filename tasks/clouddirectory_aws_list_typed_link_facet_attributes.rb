...
def ListTypedLinkFacetAttributes(*args)
  puts "Calling task operation ListTypedLinkFacetAttributes" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_typed_link_facet_attributes(call_hash)
  end
...
begin
  result = ListTypedLinkFacetAttributes(params)
