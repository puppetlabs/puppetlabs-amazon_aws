...
def DescribeLaunchTemplateVersions(*args)
  puts "Calling task operation DescribeLaunchTemplateVersions" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_launch_template_versions(call_hash)
  end
...
begin
  result = DescribeLaunchTemplateVersions(params)
