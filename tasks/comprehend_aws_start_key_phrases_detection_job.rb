...
def StartKeyPhrasesDetectionJob(*args)
  puts "Calling task operation StartKeyPhrasesDetectionJob" 
  ...
  if arg_hash.empty?
    ...
    response = client.start_key_phrases_detection_job(call_hash)
  end
...
begin
  result = StartKeyPhrasesDetectionJob(params)
