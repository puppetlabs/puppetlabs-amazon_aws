...
def CreateSMBFileShare(*args)
  puts "Calling task operation CreateSMBFileShare" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_smb_file_share(call_hash)
  end
...
begin
  result = CreateSMBFileShare(params)
