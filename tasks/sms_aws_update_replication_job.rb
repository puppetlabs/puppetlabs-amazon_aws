...
def UpdateReplicationJob(*args)
  puts "Calling task operation UpdateReplicationJob" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_replication_job(call_hash)
  end
...
begin
  result = UpdateReplicationJob(params)
