...
def DeletePlatformApplication(*args)
  puts "Calling task operation DeletePlatformApplication" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_platform_application(call_hash)
  end
...
begin
  result = DeletePlatformApplication(params)
