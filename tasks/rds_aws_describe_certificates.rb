...
def DescribeCertificates(*args)
  puts "Calling task operation DescribeCertificates" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_certificates(call_hash)
  end
...
begin
  result = DescribeCertificates(params)
