...
def GetReusableDelegationSet(*args)
  puts "Calling task operation GetReusableDelegationSet" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_reusable_delegation_set(call_hash)
  end
...
begin
  result = GetReusableDelegationSet(params)
