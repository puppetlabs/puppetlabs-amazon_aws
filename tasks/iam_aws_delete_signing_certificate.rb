...
def DeleteSigningCertificate(*args)
  puts "Calling task operation DeleteSigningCertificate" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_signing_certificate(call_hash)
  end
...
begin
  result = DeleteSigningCertificate(params)
