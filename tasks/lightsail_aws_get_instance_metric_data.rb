...
def GetInstanceMetricData(*args)
  puts "Calling task operation GetInstanceMetricData" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_instance_metric_data(call_hash)
  end
...
begin
  result = GetInstanceMetricData(params)
