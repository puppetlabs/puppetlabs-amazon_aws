...
def DeleteDeliveryStream(*args)
  puts "Calling task operation DeleteDeliveryStream" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_delivery_stream(call_hash)
  end
...
begin
  result = DeleteDeliveryStream(params)
