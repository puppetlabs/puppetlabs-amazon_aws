...
def CreatePlayerSessions(*args)
  puts "Calling task operation CreatePlayerSessions" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_player_sessions(call_hash)
  end
...
begin
  result = CreatePlayerSessions(params)
