...
def GetSqlInjectionMatchSet(*args)
  puts "Calling task operation GetSqlInjectionMatchSet" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_sql_injection_match_set(call_hash)
  end
...
begin
  result = GetSqlInjectionMatchSet(params)
