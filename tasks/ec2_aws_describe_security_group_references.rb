...
def DescribeSecurityGroupReferences(*args)
  puts "Calling task operation DescribeSecurityGroupReferences" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_security_group_references(call_hash)
  end
...
begin
  result = DescribeSecurityGroupReferences(params)
