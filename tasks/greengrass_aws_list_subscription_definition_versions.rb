...
def ListSubscriptionDefinitionVersions(*args)
  puts "Calling task operation ListSubscriptionDefinitionVersions" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_subscription_definition_versions(call_hash)
  end
...
begin
  result = ListSubscriptionDefinitionVersions(params)
