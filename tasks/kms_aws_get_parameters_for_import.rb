...
def GetParametersForImport(*args)
  puts "Calling task operation GetParametersForImport" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_parameters_for_import(call_hash)
  end
...
begin
  result = GetParametersForImport(params)
