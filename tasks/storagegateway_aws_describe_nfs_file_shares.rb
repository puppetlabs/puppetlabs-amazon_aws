...
def DescribeNFSFileShares(*args)
  puts "Calling task operation DescribeNFSFileShares" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_nfs_file_shares(call_hash)
  end
...
begin
  result = DescribeNFSFileShares(params)
