...
def CreateEnvironmentEC2(*args)
  puts "Calling task operation CreateEnvironmentEC2" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_environment_ec2(call_hash)
  end
...
begin
  result = CreateEnvironmentEC2(params)
