...
def CreatePlatformVersion(*args)
  puts "Calling task operation CreatePlatformVersion" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_platform_version(call_hash)
  end
...
begin
  result = CreatePlatformVersion(params)
