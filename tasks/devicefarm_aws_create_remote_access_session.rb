...
def CreateRemoteAccessSession(*args)
  puts "Calling task operation CreateRemoteAccessSession" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_remote_access_session(call_hash)
  end
...
begin
  result = CreateRemoteAccessSession(params)
