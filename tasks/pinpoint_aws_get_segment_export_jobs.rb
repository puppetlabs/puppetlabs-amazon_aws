...
def GetSegmentExportJobs(*args)
  puts "Calling task operation GetSegmentExportJobs" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_segment_export_jobs(call_hash)
  end
...
begin
  result = GetSegmentExportJobs(params)
