...
def DescribeAdjustmentTypes(*args)
  puts "Calling task operation DescribeAdjustmentTypes" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_adjustment_types(call_hash)
  end
...
begin
  result = DescribeAdjustmentTypes(params)
