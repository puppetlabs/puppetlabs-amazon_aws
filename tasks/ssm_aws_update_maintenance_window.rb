...
def UpdateMaintenanceWindow(*args)
  puts "Calling task operation UpdateMaintenanceWindow" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_maintenance_window(call_hash)
  end
...
begin
  result = UpdateMaintenanceWindow(params)
