...
def DeleteClusterSnapshot(*args)
  puts "Calling task operation DeleteClusterSnapshot" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_cluster_snapshot(call_hash)
  end
...
begin
  result = DeleteClusterSnapshot(params)
