...
def DescribeElasticGpus(*args)
  puts "Calling task operation DescribeElasticGpus" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_elastic_gpus(call_hash)
  end
...
begin
  result = DescribeElasticGpus(params)
