...
def DescribeTargetGroups(*args)
  puts "Calling task operation DescribeTargetGroups" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_target_groups(call_hash)
  end
...
begin
  result = DescribeTargetGroups(params)
