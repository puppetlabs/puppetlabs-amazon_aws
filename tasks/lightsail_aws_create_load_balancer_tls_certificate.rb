...
def CreateLoadBalancerTlsCertificate(*args)
  puts "Calling task operation CreateLoadBalancerTlsCertificate" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_load_balancer_tls_certificate(call_hash)
  end
...
begin
  result = CreateLoadBalancerTlsCertificate(params)
