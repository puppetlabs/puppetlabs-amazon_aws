...
def DescribeAssociationExecutionTargets(*args)
  puts "Calling task operation DescribeAssociationExecutionTargets" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_association_execution_targets(call_hash)
  end
...
begin
  result = DescribeAssociationExecutionTargets(params)
