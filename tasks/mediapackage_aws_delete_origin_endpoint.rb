...
def DeleteOriginEndpoint(*args)
  puts "Calling task operation DeleteOriginEndpoint" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_origin_endpoint(call_hash)
  end
...
begin
  result = DeleteOriginEndpoint(params)
