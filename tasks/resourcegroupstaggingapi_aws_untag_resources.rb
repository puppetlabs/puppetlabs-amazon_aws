...
def UntagResources(*args)
  puts "Calling task operation UntagResources" 
  ...
  client = Aws::ResourceGroupsTaggingAPI::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.untag_resources(call_hash)
  end
...
begin
  result = UntagResources(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::ResourceGroupsTaggingAPI::Errors::ServiceError => e
