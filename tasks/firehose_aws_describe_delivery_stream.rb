...
def DescribeDeliveryStream(*args)
  puts "Calling task operation DescribeDeliveryStream" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_delivery_stream(call_hash)
  end
...
begin
  result = DescribeDeliveryStream(params)
