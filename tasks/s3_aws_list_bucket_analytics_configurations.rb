...
def ListBucketAnalyticsConfigurations(*args)
  puts "Calling task operation ListBucketAnalyticsConfigurations" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_bucket_analytics_configurations(call_hash)
  end
...
begin
  result = ListBucketAnalyticsConfigurations(params)
