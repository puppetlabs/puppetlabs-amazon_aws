...
def CreateMultipartUpload(*args)
  puts "Calling task operation CreateMultipartUpload" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_multipart_upload(call_hash)
  end
...
begin
  result = CreateMultipartUpload(params)
