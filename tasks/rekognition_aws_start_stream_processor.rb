...
def StartStreamProcessor(*args)
  puts "Calling task operation StartStreamProcessor" 
  ...
  if arg_hash.empty?
    ...
    response = client.start_stream_processor(call_hash)
  end
...
begin
  result = StartStreamProcessor(params)
