...
def UpdateSnapshotSchedule(*args)
  puts "Calling task operation UpdateSnapshotSchedule" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_snapshot_schedule(call_hash)
  end
...
begin
  result = UpdateSnapshotSchedule(params)
