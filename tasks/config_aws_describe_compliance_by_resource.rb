...
def DescribeComplianceByResource(*args)
  puts "Calling task operation DescribeComplianceByResource" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_compliance_by_resource(call_hash)
  end
...
begin
  result = DescribeComplianceByResource(params)
