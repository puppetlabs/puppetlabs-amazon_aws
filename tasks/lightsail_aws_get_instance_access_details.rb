...
def GetInstanceAccessDetails(*args)
  puts "Calling task operation GetInstanceAccessDetails" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_instance_access_details(call_hash)
  end
...
begin
  result = GetInstanceAccessDetails(params)
