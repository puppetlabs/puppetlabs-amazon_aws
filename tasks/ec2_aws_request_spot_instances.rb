...
def RequestSpotInstances(*args)
  puts "Calling task operation RequestSpotInstances" 
  ...
  if arg_hash.empty?
    ...
    response = client.request_spot_instances(call_hash)
  end
...
begin
  result = RequestSpotInstances(params)
