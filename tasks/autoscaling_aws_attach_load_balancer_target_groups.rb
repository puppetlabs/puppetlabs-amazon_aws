...
def AttachLoadBalancerTargetGroups(*args)
  puts "Calling task operation AttachLoadBalancerTargetGroups" 
  ...
  if arg_hash.empty?
    ...
    response = client.attach_load_balancer_target_groups(call_hash)
  end
...
begin
  result = AttachLoadBalancerTargetGroups(params)
