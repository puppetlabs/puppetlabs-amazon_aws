...
def DescribeResourceGroups(*args)
  puts "Calling task operation DescribeResourceGroups" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_resource_groups(call_hash)
  end
...
begin
  result = DescribeResourceGroups(params)
