...
def DescribeBatchPredictions(*args)
  puts "Calling task operation DescribeBatchPredictions" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_batch_predictions(call_hash)
  end
...
begin
  result = DescribeBatchPredictions(params)
