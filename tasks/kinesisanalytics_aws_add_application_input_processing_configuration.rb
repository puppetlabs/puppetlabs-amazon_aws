...
def AddApplicationInputProcessingConfiguration(*args)
  puts "Calling task operation AddApplicationInputProcessingConfiguration" 
  ...
  if arg_hash.empty?
    ...
    response = client.add_application_input_processing_configuration(call_hash)
  end
...
begin
  result = AddApplicationInputProcessingConfiguration(params)
