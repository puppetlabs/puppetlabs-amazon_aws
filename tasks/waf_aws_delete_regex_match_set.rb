...
def DeleteRegexMatchSet(*args)
  puts "Calling task operation DeleteRegexMatchSet" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_regex_match_set(call_hash)
  end
...
begin
  result = DeleteRegexMatchSet(params)
