...
def CreateTrafficPolicy(*args)
  puts "Calling task operation CreateTrafficPolicy" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_traffic_policy(call_hash)
  end
...
begin
  result = CreateTrafficPolicy(params)
