...
def GetSubscriptionAttributes(*args)
  puts "Calling task operation GetSubscriptionAttributes" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_subscription_attributes(call_hash)
  end
...
begin
  result = GetSubscriptionAttributes(params)
