...
def UpdateSecurityProfile(*args)
  puts "Calling task operation UpdateSecurityProfile" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_security_profile(call_hash)
  end
...
begin
  result = UpdateSecurityProfile(params)
