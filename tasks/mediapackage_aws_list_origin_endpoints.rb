...
def ListOriginEndpoints(*args)
  puts "Calling task operation ListOriginEndpoints" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_origin_endpoints(call_hash)
  end
...
begin
  result = ListOriginEndpoints(params)
