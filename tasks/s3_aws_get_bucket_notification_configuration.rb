...
def GetBucketNotificationConfiguration(*args)
  puts "Calling task operation GetBucketNotificationConfiguration" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_bucket_notification_configuration(call_hash)
  end
...
begin
  result = GetBucketNotificationConfiguration(params)
