...
def DescribeServiceAccessPolicies(*args)
  puts "Calling task operation DescribeServiceAccessPolicies" 
  ...
  client = Aws::CloudSearch::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.describe_service_access_policies(call_hash)
  end
...
begin
  result = DescribeServiceAccessPolicies(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::CloudSearch::Errors::ServiceError => e
