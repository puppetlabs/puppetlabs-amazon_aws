...
def ModifyTargetGroupAttributes(*args)
  puts "Calling task operation ModifyTargetGroupAttributes" 
  ...
  if arg_hash.empty?
    ...
    response = client.modify_target_group_attributes(call_hash)
  end
...
begin
  result = ModifyTargetGroupAttributes(params)
