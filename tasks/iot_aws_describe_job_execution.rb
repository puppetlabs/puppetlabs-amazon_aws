...
def DescribeJobExecution(*args)
  puts "Calling task operation DescribeJobExecution" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_job_execution(call_hash)
  end
...
begin
  result = DescribeJobExecution(params)
