...
def CreateTransformJob(*args)
  puts "Calling task operation CreateTransformJob" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_transform_job(call_hash)
  end
...
begin
  result = CreateTransformJob(params)
