...
def ListStackSetOperationResults(*args)
  puts "Calling task operation ListStackSetOperationResults" 
  ...
  client = Aws::CloudFormation::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.list_stack_set_operation_results(call_hash)
  end
...
begin
  result = ListStackSetOperationResults(params)
