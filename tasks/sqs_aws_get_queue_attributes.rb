...
def GetQueueAttributes(*args)
  puts "Calling task operation GetQueueAttributes" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_queue_attributes(call_hash)
  end
...
begin
  result = GetQueueAttributes(params)
