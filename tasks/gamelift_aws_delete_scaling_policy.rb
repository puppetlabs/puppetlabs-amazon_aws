...
def DeleteScalingPolicy(*args)
  puts "Calling task operation DeleteScalingPolicy" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_scaling_policy(call_hash)
  end
...
begin
  result = DeleteScalingPolicy(params)
