...
def GetOnPremisesInstance(*args)
  puts "Calling task operation GetOnPremisesInstance" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_on_premises_instance(call_hash)
  end
...
begin
  result = GetOnPremisesInstance(params)
