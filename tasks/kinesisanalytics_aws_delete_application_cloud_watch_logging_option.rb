...
def DeleteApplicationCloudWatchLoggingOption(*args)
  puts "Calling task operation DeleteApplicationCloudWatchLoggingOption" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_application_cloud_watch_logging_option(call_hash)
  end
...
begin
  result = DeleteApplicationCloudWatchLoggingOption(params)
