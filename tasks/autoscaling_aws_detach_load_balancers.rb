...
def DetachLoadBalancers(*args)
  puts "Calling task operation DetachLoadBalancers" 
  ...
  if arg_hash.empty?
    ...
    response = client.detach_load_balancers(call_hash)
  end
...
begin
  result = DetachLoadBalancers(params)
