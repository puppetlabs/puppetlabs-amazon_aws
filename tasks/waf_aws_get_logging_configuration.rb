...
def GetLoggingConfiguration(*args)
  puts "Calling task operation GetLoggingConfiguration" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_logging_configuration(call_hash)
  end
...
begin
  result = GetLoggingConfiguration(params)
