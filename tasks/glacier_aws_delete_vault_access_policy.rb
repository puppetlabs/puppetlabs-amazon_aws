...
def DeleteVaultAccessPolicy(*args)
  puts "Calling task operation DeleteVaultAccessPolicy" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_vault_access_policy(call_hash)
  end
...
begin
  result = DeleteVaultAccessPolicy(params)
