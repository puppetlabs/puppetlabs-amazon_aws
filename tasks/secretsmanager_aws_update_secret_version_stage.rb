...
def UpdateSecretVersionStage(*args)
  puts "Calling task operation UpdateSecretVersionStage" 
  ...
  client = Aws::SecretsManager::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.update_secret_version_stage(call_hash)
  end
...
begin
  result = UpdateSecretVersionStage(params)
