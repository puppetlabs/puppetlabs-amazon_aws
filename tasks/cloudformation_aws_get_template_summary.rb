...
def GetTemplateSummary(*args)
  puts "Calling task operation GetTemplateSummary" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_template_summary(call_hash)
  end
...
begin
  result = GetTemplateSummary(params)
