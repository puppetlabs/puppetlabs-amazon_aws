...
def DeleteApnsVoipSandboxChannel(*args)
  puts "Calling task operation DeleteApnsVoipSandboxChannel" 
  ...
  client = Aws::Pinpoint::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.delete_apns_voip_sandbox_channel(call_hash)
  end
...
begin
  result = DeleteApnsVoipSandboxChannel(params)
