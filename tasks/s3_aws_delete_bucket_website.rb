...
def DeleteBucketWebsite(*args)
  puts "Calling task operation DeleteBucketWebsite" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_bucket_website(call_hash)
  end
...
begin
  result = DeleteBucketWebsite(params)
