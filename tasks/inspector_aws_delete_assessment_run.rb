...
def DeleteAssessmentRun(*args)
  puts "Calling task operation DeleteAssessmentRun" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_assessment_run(call_hash)
  end
...
begin
  result = DeleteAssessmentRun(params)
