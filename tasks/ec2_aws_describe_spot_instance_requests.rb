...
def DescribeSpotInstanceRequests(*args)
  puts "Calling task operation DescribeSpotInstanceRequests" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_spot_instance_requests(call_hash)
  end
...
begin
  result = DescribeSpotInstanceRequests(params)
