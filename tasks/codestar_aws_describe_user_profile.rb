...
def DescribeUserProfile(*args)
  puts "Calling task operation DescribeUserProfile" 
  ...
  client = Aws::CodeStar::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.describe_user_profile(call_hash)
  end
...
begin
  result = DescribeUserProfile(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::CodeStar::Errors::ServiceError => e
