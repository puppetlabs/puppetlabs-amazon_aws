...
def GetThirdPartyJobDetails(*args)
  puts "Calling task operation GetThirdPartyJobDetails" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_third_party_job_details(call_hash)
  end
...
begin
  result = GetThirdPartyJobDetails(params)
