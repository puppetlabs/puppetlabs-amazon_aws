...
def CreateCertificateFromCsr(*args)
  puts "Calling task operation CreateCertificateFromCsr" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_certificate_from_csr(call_hash)
  end
...
begin
  result = CreateCertificateFromCsr(params)
