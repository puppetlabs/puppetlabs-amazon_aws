...
def DescribeMatchmaking(*args)
  puts "Calling task operation DescribeMatchmaking" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_matchmaking(call_hash)
  end
...
begin
  result = DescribeMatchmaking(params)
