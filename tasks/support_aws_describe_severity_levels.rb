...
def DescribeSeverityLevels(*args)
  puts "Calling task operation DescribeSeverityLevels" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_severity_levels(call_hash)
  end
...
begin
  result = DescribeSeverityLevels(params)
