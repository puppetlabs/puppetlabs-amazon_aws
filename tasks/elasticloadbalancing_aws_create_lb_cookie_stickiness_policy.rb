...
def CreateLBCookieStickinessPolicy(*args)
  puts "Calling task operation CreateLBCookieStickinessPolicy" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_lb_cookie_stickiness_policy(call_hash)
  end
...
begin
  result = CreateLBCookieStickinessPolicy(params)
