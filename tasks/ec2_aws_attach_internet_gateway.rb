...
def AttachInternetGateway(*args)
  puts "Calling task operation AttachInternetGateway" 
  ...
  if arg_hash.empty?
    ...
    response = client.attach_internet_gateway(call_hash)
  end
...
begin
  result = AttachInternetGateway(params)
