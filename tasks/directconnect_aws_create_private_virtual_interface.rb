...
def CreatePrivateVirtualInterface(*args)
  puts "Calling task operation CreatePrivateVirtualInterface" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_private_virtual_interface(call_hash)
  end
...
begin
  result = CreatePrivateVirtualInterface(params)
