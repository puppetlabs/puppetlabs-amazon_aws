...
def DescribeStackResources(*args)
  puts "Calling task operation DescribeStackResources" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_stack_resources(call_hash)
  end
...
begin
  result = DescribeStackResources(params)
