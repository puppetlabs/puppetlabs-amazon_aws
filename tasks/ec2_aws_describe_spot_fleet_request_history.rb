...
def DescribeSpotFleetRequestHistory(*args)
  puts "Calling task operation DescribeSpotFleetRequestHistory" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_spot_fleet_request_history(call_hash)
  end
...
begin
  result = DescribeSpotFleetRequestHistory(params)
