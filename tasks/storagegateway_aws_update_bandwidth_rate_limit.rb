...
def UpdateBandwidthRateLimit(*args)
  puts "Calling task operation UpdateBandwidthRateLimit" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_bandwidth_rate_limit(call_hash)
  end
...
begin
  result = UpdateBandwidthRateLimit(params)
