...
def GetCampaignActivities(*args)
  puts "Calling task operation GetCampaignActivities" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_campaign_activities(call_hash)
  end
...
begin
  result = GetCampaignActivities(params)
