...
def DescribeTransformJob(*args)
  puts "Calling task operation DescribeTransformJob" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_transform_job(call_hash)
  end
...
begin
  result = DescribeTransformJob(params)
