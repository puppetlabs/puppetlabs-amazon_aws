...
def CreateDirectoryConfig(*args)
  puts "Calling task operation CreateDirectoryConfig" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_directory_config(call_hash)
  end
...
begin
  result = CreateDirectoryConfig(params)
