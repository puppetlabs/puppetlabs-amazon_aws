...
def GetLifecyclePolicy(*args)
  puts "Calling task operation GetLifecyclePolicy" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_lifecycle_policy(call_hash)
  end
...
begin
  result = GetLifecyclePolicy(params)
