...
def GetRateBasedRuleManagedKeys(*args)
  puts "Calling task operation GetRateBasedRuleManagedKeys" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_rate_based_rule_managed_keys(call_hash)
  end
...
begin
  result = GetRateBasedRuleManagedKeys(params)
