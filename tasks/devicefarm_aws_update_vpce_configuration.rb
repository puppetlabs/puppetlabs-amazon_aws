...
def UpdateVPCEConfiguration(*args)
  puts "Calling task operation UpdateVPCEConfiguration" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_vpce_configuration(call_hash)
  end
...
begin
  result = UpdateVPCEConfiguration(params)
