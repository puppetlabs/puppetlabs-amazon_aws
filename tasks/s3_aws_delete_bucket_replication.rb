...
def DeleteBucketReplication(*args)
  puts "Calling task operation DeleteBucketReplication" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_bucket_replication(call_hash)
  end
...
begin
  result = DeleteBucketReplication(params)
