...
def DescribeScalingProcessTypes(*args)
  puts "Calling task operation DescribeScalingProcessTypes" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_scaling_process_types(call_hash)
  end
...
begin
  result = DescribeScalingProcessTypes(params)
