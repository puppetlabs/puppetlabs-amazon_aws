...
def DescribeWorkspaces(*args)
  puts "Calling task operation DescribeWorkspaces" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_workspaces(call_hash)
  end
...
begin
  result = DescribeWorkspaces(params)
