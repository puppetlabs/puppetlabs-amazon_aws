...
def GetDeploymentGroup(*args)
  puts "Calling task operation GetDeploymentGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_deployment_group(call_hash)
  end
...
begin
  result = GetDeploymentGroup(params)
