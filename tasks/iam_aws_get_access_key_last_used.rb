...
def GetAccessKeyLastUsed(*args)
  puts "Calling task operation GetAccessKeyLastUsed" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_access_key_last_used(call_hash)
  end
...
begin
  result = GetAccessKeyLastUsed(params)
