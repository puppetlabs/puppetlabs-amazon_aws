...
def UpdateFindingsFeedback(*args)
  puts "Calling task operation UpdateFindingsFeedback" 
  ...
  client = Aws::GuardDuty::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.update_findings_feedback(call_hash)
  end
...
begin
  result = UpdateFindingsFeedback(params)
