...
def CreateApplicationVersion(*args)
  puts "Calling task operation CreateApplicationVersion" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_application_version(call_hash)
  end
...
begin
  result = CreateApplicationVersion(params)
