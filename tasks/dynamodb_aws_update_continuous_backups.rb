...
def UpdateContinuousBackups(*args)
  puts "Calling task operation UpdateContinuousBackups" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_continuous_backups(call_hash)
  end
...
begin
  result = UpdateContinuousBackups(params)
