...
def GetTypedLinkFacetInformation(*args)
  puts "Calling task operation GetTypedLinkFacetInformation" 
  ...
  client = Aws::CloudDirectory::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.get_typed_link_facet_information(call_hash)
  end
...
begin
  result = GetTypedLinkFacetInformation(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::CloudDirectory::Errors::ServiceError => e
