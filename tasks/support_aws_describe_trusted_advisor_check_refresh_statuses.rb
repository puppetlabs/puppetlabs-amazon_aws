...
def DescribeTrustedAdvisorCheckRefreshStatuses(*args)
  puts "Calling task operation DescribeTrustedAdvisorCheckRefreshStatuses" 
  ...
  client = Aws::Support::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.describe_trusted_advisor_check_refresh_statuses(call_hash)
  end
...
begin
  result = DescribeTrustedAdvisorCheckRefreshStatuses(params)
