...
def DescribeThingGroup(*args)
  puts "Calling task operation DescribeThingGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_thing_group(call_hash)
  end
...
begin
  result = DescribeThingGroup(params)
