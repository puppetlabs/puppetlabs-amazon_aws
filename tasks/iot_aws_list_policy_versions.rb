...
def ListPolicyVersions(*args)
  puts "Calling task operation ListPolicyVersions" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_policy_versions(call_hash)
  end
...
begin
  result = ListPolicyVersions(params)
