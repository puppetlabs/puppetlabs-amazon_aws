...
def DeleteEnvironmentMembership(*args)
  puts "Calling task operation DeleteEnvironmentMembership" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_environment_membership(call_hash)
  end
...
begin
  result = DeleteEnvironmentMembership(params)
