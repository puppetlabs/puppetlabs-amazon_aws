...
def UpdateRegexPatternSet(*args)
  puts "Calling task operation UpdateRegexPatternSet" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_regex_pattern_set(call_hash)
  end
...
begin
  result = UpdateRegexPatternSet(params)
