...
def DeleteDeliveryChannel(*args)
  puts "Calling task operation DeleteDeliveryChannel" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_delivery_channel(call_hash)
  end
...
begin
  result = DeleteDeliveryChannel(params)
