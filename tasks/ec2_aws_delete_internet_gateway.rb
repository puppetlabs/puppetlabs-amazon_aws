...
def DeleteInternetGateway(*args)
  puts "Calling task operation DeleteInternetGateway" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_internet_gateway(call_hash)
  end
...
begin
  result = DeleteInternetGateway(params)
