...
def DescribeDBSubnetGroups(*args)
  puts "Calling task operation DescribeDBSubnetGroups" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_db_subnet_groups(call_hash)
  end
...
begin
  result = DescribeDBSubnetGroups(params)
