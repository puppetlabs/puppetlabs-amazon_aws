...
def DescribeMyUserProfile(*args)
  puts "Calling task operation DescribeMyUserProfile" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_my_user_profile(call_hash)
  end
...
begin
  result = DescribeMyUserProfile(params)
