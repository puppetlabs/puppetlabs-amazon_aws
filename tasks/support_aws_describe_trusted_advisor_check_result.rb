...
def DescribeTrustedAdvisorCheckResult(*args)
  puts "Calling task operation DescribeTrustedAdvisorCheckResult" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_trusted_advisor_check_result(call_hash)
  end
...
begin
  result = DescribeTrustedAdvisorCheckResult(params)
