...
def GetDeviceDefinition(*args)
  puts "Calling task operation GetDeviceDefinition" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_device_definition(call_hash)
  end
...
begin
  result = GetDeviceDefinition(params)
