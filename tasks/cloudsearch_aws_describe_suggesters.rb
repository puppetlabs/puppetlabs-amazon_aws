...
def DescribeSuggesters(*args)
  puts "Calling task operation DescribeSuggesters" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_suggesters(call_hash)
  end
...
begin
  result = DescribeSuggesters(params)
