...
def DescribeAuthorizer(*args)
  puts "Calling task operation DescribeAuthorizer" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_authorizer(call_hash)
  end
...
begin
  result = DescribeAuthorizer(params)
