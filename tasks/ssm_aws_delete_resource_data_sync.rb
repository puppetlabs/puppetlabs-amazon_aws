...
def DeleteResourceDataSync(*args)
  puts "Calling task operation DeleteResourceDataSync" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_resource_data_sync(call_hash)
  end
...
begin
  result = DeleteResourceDataSync(params)
