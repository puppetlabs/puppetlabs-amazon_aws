...
def DeleteStreamProcessor(*args)
  puts "Calling task operation DeleteStreamProcessor" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_stream_processor(call_hash)
  end
...
begin
  result = DeleteStreamProcessor(params)
