...
def DeleteSecurityConfiguration(*args)
  puts "Calling task operation DeleteSecurityConfiguration" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_security_configuration(call_hash)
  end
...
begin
  result = DeleteSecurityConfiguration(params)
