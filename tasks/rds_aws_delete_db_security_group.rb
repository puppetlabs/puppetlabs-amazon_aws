...
def DeleteDBSecurityGroup(*args)
  puts "Calling task operation DeleteDBSecurityGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_db_security_group(call_hash)
  end
...
begin
  result = DeleteDBSecurityGroup(params)
