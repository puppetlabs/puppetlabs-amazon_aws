...
def GetNotificationChannel(*args)
  puts "Calling task operation GetNotificationChannel" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_notification_channel(call_hash)
  end
...
begin
  result = GetNotificationChannel(params)
