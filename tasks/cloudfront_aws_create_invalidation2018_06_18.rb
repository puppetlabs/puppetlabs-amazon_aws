...
def CreateInvalidation2018_06_18(*args)
  puts "Calling task operation CreateInvalidation2018_06_18" 
  ...
  if arg_hash.empty?
    response = client.create_invalidation2018_06_18()
  else 
    call_hash={}
    ...
    response = client.create_invalidation2018_06_18(call_hash)
  end
...
begin
  result = CreateInvalidation2018_06_18(params)
