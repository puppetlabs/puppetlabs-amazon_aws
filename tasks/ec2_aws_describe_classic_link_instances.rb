...
def DescribeClassicLinkInstances(*args)
  puts "Calling task operation DescribeClassicLinkInstances" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_classic_link_instances(call_hash)
  end
...
begin
  result = DescribeClassicLinkInstances(params)
