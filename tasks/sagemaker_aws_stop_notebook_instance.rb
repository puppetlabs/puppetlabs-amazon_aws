...
def StopNotebookInstance(*args)
  puts "Calling task operation StopNotebookInstance" 
  ...
  if arg_hash.empty?
    ...
    response = client.stop_notebook_instance(call_hash)
  end
...
begin
  result = StopNotebookInstance(params)
