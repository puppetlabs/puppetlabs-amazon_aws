...
def ModifySnapshotAttribute(*args)
  puts "Calling task operation ModifySnapshotAttribute" 
  ...
  if arg_hash.empty?
    ...
    response = client.modify_snapshot_attribute(call_hash)
  end
...
begin
  result = ModifySnapshotAttribute(params)
