...
def AllocatePrivateVirtualInterface(*args)
  puts "Calling task operation AllocatePrivateVirtualInterface" 
  ...
  if arg_hash.empty?
    ...
    response = client.allocate_private_virtual_interface(call_hash)
  end
...
begin
  result = AllocatePrivateVirtualInterface(params)
