...
def DescribeVirtualInterfaces(*args)
  puts "Calling task operation DescribeVirtualInterfaces" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_virtual_interfaces(call_hash)
  end
...
begin
  result = DescribeVirtualInterfaces(params)
