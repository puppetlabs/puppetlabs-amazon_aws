...
def ListThingsInThingGroup(*args)
  puts "Calling task operation ListThingsInThingGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_things_in_thing_group(call_hash)
  end
...
begin
  result = ListThingsInThingGroup(params)
