...
def UpdateRoleDescription(*args)
  puts "Calling task operation UpdateRoleDescription" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_role_description(call_hash)
  end
...
begin
  result = UpdateRoleDescription(params)
