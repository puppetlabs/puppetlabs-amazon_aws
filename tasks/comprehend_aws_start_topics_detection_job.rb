...
def StartTopicsDetectionJob(*args)
  puts "Calling task operation StartTopicsDetectionJob" 
  ...
  if arg_hash.empty?
    ...
    response = client.start_topics_detection_job(call_hash)
  end
...
begin
  result = StartTopicsDetectionJob(params)
