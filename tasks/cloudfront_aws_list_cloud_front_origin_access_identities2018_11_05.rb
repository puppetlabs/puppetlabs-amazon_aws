...
def operation_with_hash(arg_hash)
  ...
  client.list_cloud_front_origin_access_identities2018_11_05(call_hash)
end

def list_cloud_front_origin_access_identities2018_11_05(*args)
  argstring = args[0]
  argstring.delete('\\')
  ...
  client = Aws::CloudFront::Client.new(region: region)
  response = client.list_cloud_front_origin_access_identities2018_11_05 if arg_hash.empty?
...
def task
  ...
  params = STDIN.read
  result = list_cloud_front_origin_access_identities2018_11_05(params)
