...
def ListCloudFrontOriginAccessIdentities2018_06_18(*args)
  puts "Calling task operation ListCloudFrontOriginAccessIdentities2018_06_18" 
  ...
  if arg_hash.empty?
    response = client.list_cloud_front_origin_access_identities2018_06_18()
  else 
    call_hash={}
    ...
    response = client.list_cloud_front_origin_access_identities2018_06_18(call_hash)
  end
...
begin
  result = ListCloudFrontOriginAccessIdentities2018_06_18(params)
