...
def DescribeComplianceByConfigRule(*args)
  puts "Calling task operation DescribeComplianceByConfigRule" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_compliance_by_config_rule(call_hash)
  end
...
begin
  result = DescribeComplianceByConfigRule(params)
