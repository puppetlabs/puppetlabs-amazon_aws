...
def ListThingRegistrationTaskReports(*args)
  puts "Calling task operation ListThingRegistrationTaskReports" 
  ...
  client = Aws::IoT1ClickDevicesService::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.list_thing_registration_task_reports(call_hash)
  end
...
begin
  result = ListThingRegistrationTaskReports(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::IoT1ClickDevicesService::Errors::ServiceError => e
