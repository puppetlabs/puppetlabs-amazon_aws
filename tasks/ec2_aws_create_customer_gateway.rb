...
def CreateCustomerGateway(*args)
  puts "Calling task operation CreateCustomerGateway" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_customer_gateway(call_hash)
  end
...
begin
  result = CreateCustomerGateway(params)
