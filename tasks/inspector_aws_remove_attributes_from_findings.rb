...
def RemoveAttributesFromFindings(*args)
  puts "Calling task operation RemoveAttributesFromFindings" 
  ...
  if arg_hash.empty?
    ...
    response = client.remove_attributes_from_findings(call_hash)
  end
...
begin
  result = RemoveAttributesFromFindings(params)
