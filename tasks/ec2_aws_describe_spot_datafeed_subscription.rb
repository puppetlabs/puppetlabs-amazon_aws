...
def DescribeSpotDatafeedSubscription(*args)
  puts "Calling task operation DescribeSpotDatafeedSubscription" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_spot_datafeed_subscription(call_hash)
  end
...
begin
  result = DescribeSpotDatafeedSubscription(params)
