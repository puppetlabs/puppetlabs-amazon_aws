...
def ListReusableDelegationSets(*args)
  puts "Calling task operation ListReusableDelegationSets" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_reusable_delegation_sets(call_hash)
  end
...
begin
  result = ListReusableDelegationSets(params)
