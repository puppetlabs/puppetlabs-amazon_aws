...
def DescribeInventoryDeletions(*args)
  puts "Calling task operation DescribeInventoryDeletions" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_inventory_deletions(call_hash)
  end
...
begin
  result = DescribeInventoryDeletions(params)
