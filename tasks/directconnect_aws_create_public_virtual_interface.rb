...
def CreatePublicVirtualInterface(*args)
  puts "Calling task operation CreatePublicVirtualInterface" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_public_virtual_interface(call_hash)
  end
...
begin
  result = CreatePublicVirtualInterface(params)
