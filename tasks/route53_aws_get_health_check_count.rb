...
def GetHealthCheckCount(*args)
  puts "Calling task operation GetHealthCheckCount" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_health_check_count(call_hash)
  end
...
begin
  result = GetHealthCheckCount(params)
