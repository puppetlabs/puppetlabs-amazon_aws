...
def DeleteApnsVoipChannel(*args)
  puts "Calling task operation DeleteApnsVoipChannel" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_apns_voip_channel(call_hash)
  end
...
begin
  result = DeleteApnsVoipChannel(params)
