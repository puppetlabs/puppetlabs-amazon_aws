...
def DeregisterFromWorkMail(*args)
  puts "Calling task operation DeregisterFromWorkMail" 
  ...
  if arg_hash.empty?
    ...
    response = client.deregister_from_work_mail(call_hash)
  end
...
begin
  result = DeregisterFromWorkMail(params)
