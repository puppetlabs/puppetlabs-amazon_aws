...
def DescribeVpnGateways(*args)
  puts "Calling task operation DescribeVpnGateways" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_vpn_gateways(call_hash)
  end
...
begin
  result = DescribeVpnGateways(params)
