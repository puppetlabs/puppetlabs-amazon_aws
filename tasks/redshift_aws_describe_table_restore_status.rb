...
def DescribeTableRestoreStatus(*args)
  puts "Calling task operation DescribeTableRestoreStatus" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_table_restore_status(call_hash)
  end
...
begin
  result = DescribeTableRestoreStatus(params)
