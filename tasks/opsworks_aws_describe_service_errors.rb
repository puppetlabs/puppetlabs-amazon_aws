...
def DescribeServiceErrors(*args)
  puts "Calling task operation DescribeServiceErrors" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_service_errors(call_hash)
  end
...
begin
  result = DescribeServiceErrors(params)
