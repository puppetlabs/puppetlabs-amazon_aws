...
def ListServiceSpecificCredentials(*args)
  puts "Calling task operation ListServiceSpecificCredentials" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_service_specific_credentials(call_hash)
  end
...
begin
  result = ListServiceSpecificCredentials(params)
