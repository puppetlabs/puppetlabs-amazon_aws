...
def GetDeploymentConfig(*args)
  puts "Calling task operation GetDeploymentConfig" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_deployment_config(call_hash)
  end
...
begin
  result = GetDeploymentConfig(params)
