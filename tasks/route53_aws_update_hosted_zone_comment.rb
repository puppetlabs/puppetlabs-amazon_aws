...
def UpdateHostedZoneComment(*args)
  puts "Calling task operation UpdateHostedZoneComment" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_hosted_zone_comment(call_hash)
  end
...
begin
  result = UpdateHostedZoneComment(params)
