...
def ListQueryLoggingConfigs(*args)
  puts "Calling task operation ListQueryLoggingConfigs" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_query_logging_configs(call_hash)
  end
...
begin
  result = ListQueryLoggingConfigs(params)
