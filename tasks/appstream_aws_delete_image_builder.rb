...
def DeleteImageBuilder(*args)
  puts "Calling task operation DeleteImageBuilder" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_image_builder(call_hash)
  end
...
begin
  result = DeleteImageBuilder(params)
