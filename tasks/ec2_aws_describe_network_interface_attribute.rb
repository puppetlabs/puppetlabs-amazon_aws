...
def DescribeNetworkInterfaceAttribute(*args)
  puts "Calling task operation DescribeNetworkInterfaceAttribute" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_network_interface_attribute(call_hash)
  end
...
begin
  result = DescribeNetworkInterfaceAttribute(params)
