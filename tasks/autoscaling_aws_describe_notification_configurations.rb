...
def DescribeNotificationConfigurations(*args)
  puts "Calling task operation DescribeNotificationConfigurations" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_notification_configurations(call_hash)
  end
...
begin
  result = DescribeNotificationConfigurations(params)
