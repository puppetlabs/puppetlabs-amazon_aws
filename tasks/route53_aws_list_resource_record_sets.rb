...
def ListResourceRecordSets(*args)
  puts "Calling task operation ListResourceRecordSets" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_resource_record_sets(call_hash)
  end
...
begin
  result = ListResourceRecordSets(params)
