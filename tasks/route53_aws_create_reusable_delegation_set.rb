...
def CreateReusableDelegationSet(*args)
  puts "Calling task operation CreateReusableDelegationSet" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_reusable_delegation_set(call_hash)
  end
...
begin
  result = CreateReusableDelegationSet(params)
