...
def DescribeRepositories(*args)
  puts "Calling task operation DescribeRepositories" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_repositories(call_hash)
  end
...
begin
  result = DescribeRepositories(params)
