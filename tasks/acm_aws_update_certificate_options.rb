...
def UpdateCertificateOptions(*args)
  puts "Calling task operation UpdateCertificateOptions" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_certificate_options(call_hash)
  end
...
begin
  result = UpdateCertificateOptions(params)
