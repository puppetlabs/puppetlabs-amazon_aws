...
def ModifyClusterIamRoles(*args)
  puts "Calling task operation ModifyClusterIamRoles" 
  ...
  if arg_hash.empty?
    ...
    response = client.modify_cluster_iam_roles(call_hash)
  end
...
begin
  result = ModifyClusterIamRoles(params)
