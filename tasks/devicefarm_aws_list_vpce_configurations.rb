...
def ListVPCEConfigurations(*args)
  puts "Calling task operation ListVPCEConfigurations" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_vpce_configurations(call_hash)
  end
...
begin
  result = ListVPCEConfigurations(params)
