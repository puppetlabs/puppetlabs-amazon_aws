...
def ListInvalidations2018_06_18(*args)
  puts "Calling task operation ListInvalidations2018_06_18" 
  ...
  if arg_hash.empty?
    response = client.list_invalidations2018_06_18()
  else 
    call_hash={}
    ...
    response = client.list_invalidations2018_06_18(call_hash)
  end
...
begin
  result = ListInvalidations2018_06_18(params)
