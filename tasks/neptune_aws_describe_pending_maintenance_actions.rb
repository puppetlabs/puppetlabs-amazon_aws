...
def DescribePendingMaintenanceActions(*args)
  puts "Calling task operation DescribePendingMaintenanceActions" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_pending_maintenance_actions(call_hash)
  end
...
begin
  result = DescribePendingMaintenanceActions(params)
