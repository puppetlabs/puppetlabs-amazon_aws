...
def UpdateSqlInjectionMatchSet(*args)
  puts "Calling task operation UpdateSqlInjectionMatchSet" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_sql_injection_match_set(call_hash)
  end
...
begin
  result = UpdateSqlInjectionMatchSet(params)
