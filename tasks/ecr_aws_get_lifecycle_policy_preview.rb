...
def GetLifecyclePolicyPreview(*args)
  puts "Calling task operation GetLifecyclePolicyPreview" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_lifecycle_policy_preview(call_hash)
  end
...
begin
  result = GetLifecyclePolicyPreview(params)
