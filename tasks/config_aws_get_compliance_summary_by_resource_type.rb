...
def GetComplianceSummaryByResourceType(*args)
  puts "Calling task operation GetComplianceSummaryByResourceType" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_compliance_summary_by_resource_type(call_hash)
  end
...
begin
  result = GetComplianceSummaryByResourceType(params)
