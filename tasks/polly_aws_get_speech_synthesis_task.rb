...
def GetSpeechSynthesisTask(*args)
  puts "Calling task operation GetSpeechSynthesisTask" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_speech_synthesis_task(call_hash)
  end
...
begin
  result = GetSpeechSynthesisTask(params)
