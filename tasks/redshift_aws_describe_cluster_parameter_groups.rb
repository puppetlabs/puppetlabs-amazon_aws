...
def DescribeClusterParameterGroups(*args)
  puts "Calling task operation DescribeClusterParameterGroups" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_cluster_parameter_groups(call_hash)
  end
...
begin
  result = DescribeClusterParameterGroups(params)
