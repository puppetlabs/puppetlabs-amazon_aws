...
def GetLoadBalancerMetricData(*args)
  puts "Calling task operation GetLoadBalancerMetricData" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_load_balancer_metric_data(call_hash)
  end
...
begin
  result = GetLoadBalancerMetricData(params)
