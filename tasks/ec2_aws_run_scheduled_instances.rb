...
def RunScheduledInstances(*args)
  puts "Calling task operation RunScheduledInstances" 
  ...
  if arg_hash.empty?
    ...
    response = client.run_scheduled_instances(call_hash)
  end
...
begin
  result = RunScheduledInstances(params)
