...
def DescribeCacheSecurityGroups(*args)
  puts "Calling task operation DescribeCacheSecurityGroups" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_cache_security_groups(call_hash)
  end
...
begin
  result = DescribeCacheSecurityGroups(params)
