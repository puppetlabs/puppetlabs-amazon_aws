...
def DescribeTapeArchives(*args)
  puts "Calling task operation DescribeTapeArchives" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_tape_archives(call_hash)
  end
...
begin
  result = DescribeTapeArchives(params)
