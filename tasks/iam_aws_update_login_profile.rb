...
def UpdateLoginProfile(*args)
  puts "Calling task operation UpdateLoginProfile" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_login_profile(call_hash)
  end
...
begin
  result = UpdateLoginProfile(params)
