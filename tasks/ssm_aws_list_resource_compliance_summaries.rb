...
def ListResourceComplianceSummaries(*args)
  puts "Calling task operation ListResourceComplianceSummaries" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_resource_compliance_summaries(call_hash)
  end
...
begin
  result = ListResourceComplianceSummaries(params)
