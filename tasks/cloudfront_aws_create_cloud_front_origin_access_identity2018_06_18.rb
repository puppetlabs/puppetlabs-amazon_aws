...
def CreateCloudFrontOriginAccessIdentity2018_06_18(*args)
  puts "Calling task operation CreateCloudFrontOriginAccessIdentity2018_06_18" 
  ...
  if arg_hash.empty?
    response = client.create_cloud_front_origin_access_identity2018_06_18()
  else 
    call_hash={}
    ...
    response = client.create_cloud_front_origin_access_identity2018_06_18(call_hash)
  end
...
begin
  result = CreateCloudFrontOriginAccessIdentity2018_06_18(params)
