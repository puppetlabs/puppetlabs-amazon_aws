...
def AttachNetworkInterface(*args)
  puts "Calling task operation AttachNetworkInterface" 
  ...
  if arg_hash.empty?
    ...
    response = client.attach_network_interface(call_hash)
  end
...
begin
  result = AttachNetworkInterface(params)
