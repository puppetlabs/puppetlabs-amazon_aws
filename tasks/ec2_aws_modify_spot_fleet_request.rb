...
def ModifySpotFleetRequest(*args)
  puts "Calling task operation ModifySpotFleetRequest" 
  ...
  if arg_hash.empty?
    ...
    response = client.modify_spot_fleet_request(call_hash)
  end
...
begin
  result = ModifySpotFleetRequest(params)
