...
def DescribeImageAttribute(*args)
  puts "Calling task operation DescribeImageAttribute" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_image_attribute(call_hash)
  end
...
begin
  result = DescribeImageAttribute(params)
