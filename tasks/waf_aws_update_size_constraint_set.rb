...
def UpdateSizeConstraintSet(*args)
  puts "Calling task operation UpdateSizeConstraintSet" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_size_constraint_set(call_hash)
  end
...
begin
  result = UpdateSizeConstraintSet(params)
