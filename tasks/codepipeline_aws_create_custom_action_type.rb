...
def CreateCustomActionType(*args)
  puts "Calling task operation CreateCustomActionType" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_custom_action_type(call_hash)
  end
...
begin
  result = CreateCustomActionType(params)
