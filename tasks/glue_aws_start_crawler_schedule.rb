...
def StartCrawlerSchedule(*args)
  puts "Calling task operation StartCrawlerSchedule" 
  ...
  if arg_hash.empty?
    ...
    response = client.start_crawler_schedule(call_hash)
  end
...
begin
  result = StartCrawlerSchedule(params)
