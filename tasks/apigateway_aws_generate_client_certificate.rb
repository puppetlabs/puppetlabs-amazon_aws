...
def GenerateClientCertificate(*args)
  puts "Calling task operation GenerateClientCertificate" 
  ...
  if arg_hash.empty?
    ...
    response = client.generate_client_certificate(call_hash)
  end
...
begin
  result = GenerateClientCertificate(params)
