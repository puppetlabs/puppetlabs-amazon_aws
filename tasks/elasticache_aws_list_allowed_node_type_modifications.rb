...
def ListAllowedNodeTypeModifications(*args)
  puts "Calling task operation ListAllowedNodeTypeModifications" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_allowed_node_type_modifications(call_hash)
  end
...
begin
  result = ListAllowedNodeTypeModifications(params)
