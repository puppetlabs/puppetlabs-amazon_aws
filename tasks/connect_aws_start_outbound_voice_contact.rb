...
def StartOutboundVoiceContact(*args)
  puts "Calling task operation StartOutboundVoiceContact" 
  ...
  if arg_hash.empty?
    ...
    response = client.start_outbound_voice_contact(call_hash)
  end
...
begin
  result = StartOutboundVoiceContact(params)
