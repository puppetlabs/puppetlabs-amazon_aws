...
def DescribeAffectedEntities(*args)
  puts "Calling task operation DescribeAffectedEntities" 
  ...
  client = Aws::Health::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.describe_affected_entities(call_hash)
  end
...
begin
  result = DescribeAffectedEntities(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::Health::Errors::ServiceError => e
