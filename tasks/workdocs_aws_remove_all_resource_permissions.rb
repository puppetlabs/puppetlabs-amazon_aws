...
def RemoveAllResourcePermissions(*args)
  puts "Calling task operation RemoveAllResourcePermissions" 
  ...
  if arg_hash.empty?
    ...
    response = client.remove_all_resource_permissions(call_hash)
  end
...
begin
  result = RemoveAllResourcePermissions(params)
