...
def GetMaintenanceWindowExecutionTask(*args)
  puts "Calling task operation GetMaintenanceWindowExecutionTask" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_maintenance_window_execution_task(call_hash)
  end
...
begin
  result = GetMaintenanceWindowExecutionTask(params)
