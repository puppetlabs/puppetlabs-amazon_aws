...
def CreateDocumentationPart(*args)
  puts "Calling task operation CreateDocumentationPart" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_documentation_part(call_hash)
  end
...
begin
  result = CreateDocumentationPart(params)
