...
def GetServerCertificate(*args)
  puts "Calling task operation GetServerCertificate" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_server_certificate(call_hash)
  end
...
begin
  result = GetServerCertificate(params)
