...
def CreateByteMatchSet(*args)
  puts "Calling task operation CreateByteMatchSet" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_byte_match_set(call_hash)
  end
...
begin
  result = CreateByteMatchSet(params)
