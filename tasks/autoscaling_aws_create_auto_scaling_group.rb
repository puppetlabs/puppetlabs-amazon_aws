...
def CreateAutoScalingGroup(*args)
  puts "Calling task operation CreateAutoScalingGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_auto_scaling_group(call_hash)
  end
...
begin
  result = CreateAutoScalingGroup(params)
