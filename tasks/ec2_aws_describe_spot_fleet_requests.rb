...
def DescribeSpotFleetRequests(*args)
  puts "Calling task operation DescribeSpotFleetRequests" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_spot_fleet_requests(call_hash)
  end
...
begin
  result = DescribeSpotFleetRequests(params)
