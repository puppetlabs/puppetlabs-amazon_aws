...
def ListEntitiesDetectionJobs(*args)
  puts "Calling task operation ListEntitiesDetectionJobs" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_entities_detection_jobs(call_hash)
  end
...
begin
  result = ListEntitiesDetectionJobs(params)
