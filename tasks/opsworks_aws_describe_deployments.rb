...
def DescribeDeployments(*args)
  puts "Calling task operation DescribeDeployments" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_deployments(call_hash)
  end
...
begin
  result = DescribeDeployments(params)
