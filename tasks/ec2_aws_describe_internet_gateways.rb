...
def DescribeInternetGateways(*args)
  puts "Calling task operation DescribeInternetGateways" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_internet_gateways(call_hash)
  end
...
begin
  result = DescribeInternetGateways(params)
