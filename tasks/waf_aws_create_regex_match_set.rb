...
def CreateRegexMatchSet(*args)
  puts "Calling task operation CreateRegexMatchSet" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_regex_match_set(call_hash)
  end
...
begin
  result = CreateRegexMatchSet(params)
