...
def GetAccountAuthorizationDetails(*args)
  puts "Calling task operation GetAccountAuthorizationDetails" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_account_authorization_details(call_hash)
  end
...
begin
  result = GetAccountAuthorizationDetails(params)
