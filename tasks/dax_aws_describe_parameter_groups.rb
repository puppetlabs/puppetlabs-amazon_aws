...
def DescribeParameterGroups(*args)
  puts "Calling task operation DescribeParameterGroups" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_parameter_groups(call_hash)
  end
...
begin
  result = DescribeParameterGroups(params)
