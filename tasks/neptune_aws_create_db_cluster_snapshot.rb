...
def CreateDBClusterSnapshot(*args)
  puts "Calling task operation CreateDBClusterSnapshot" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_db_cluster_snapshot(call_hash)
  end
...
begin
  result = CreateDBClusterSnapshot(params)
