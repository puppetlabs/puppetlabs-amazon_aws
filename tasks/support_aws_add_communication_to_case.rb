...
def AddCommunicationToCase(*args)
  puts "Calling task operation AddCommunicationToCase" 
  ...
  if arg_hash.empty?
    ...
    response = client.add_communication_to_case(call_hash)
  end
...
begin
  result = AddCommunicationToCase(params)
