...
def ListSecretVersionIds(*args)
  puts "Calling task operation ListSecretVersionIds" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_secret_version_ids(call_hash)
  end
...
begin
  result = ListSecretVersionIds(params)
