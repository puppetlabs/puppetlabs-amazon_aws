...
def operation_with_hash(arg_hash)
  ...
  client.delete_portfolio_share(call_hash)
end

def delete_portfolio_share(*args)
  argstring = args[0]
  argstring.delete('\\')
  ...
  client = Aws::ServiceCatalog::Client.new(region: region)
  response = client.delete_portfolio_share if arg_hash.empty?
...
def task
  ...
  params = STDIN.read
  result = delete_portfolio_share(params)
