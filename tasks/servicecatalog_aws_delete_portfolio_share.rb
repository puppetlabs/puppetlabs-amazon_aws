...
def DeletePortfolioShare(*args)
  puts "Calling task operation DeletePortfolioShare" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_portfolio_share(call_hash)
  end
...
begin
  result = DeletePortfolioShare(params)
