...
def UpdateEndpointWeightsAndCapacities(*args)
  puts "Calling task operation UpdateEndpointWeightsAndCapacities" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_endpoint_weights_and_capacities(call_hash)
  end
...
begin
  result = UpdateEndpointWeightsAndCapacities(params)
