...
def DeleteBucketEncryption(*args)
  puts "Calling task operation DeleteBucketEncryption" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_bucket_encryption(call_hash)
  end
...
begin
  result = DeleteBucketEncryption(params)
