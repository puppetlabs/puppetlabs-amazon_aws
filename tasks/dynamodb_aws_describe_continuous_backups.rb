...
def DescribeContinuousBackups(*args)
  puts "Calling task operation DescribeContinuousBackups" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_continuous_backups(call_hash)
  end
...
begin
  result = DescribeContinuousBackups(params)
