...
def DescribeVpcEndpoints(*args)
  puts "Calling task operation DescribeVpcEndpoints" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_vpc_endpoints(call_hash)
  end
...
begin
  result = DescribeVpcEndpoints(params)
