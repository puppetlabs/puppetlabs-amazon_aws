...
def DescribeFleetEvents(*args)
  puts "Calling task operation DescribeFleetEvents" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_fleet_events(call_hash)
  end
...
begin
  result = DescribeFleetEvents(params)
