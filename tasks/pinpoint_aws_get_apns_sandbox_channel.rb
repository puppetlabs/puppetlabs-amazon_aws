...
def GetApnsSandboxChannel(*args)
  puts "Calling task operation GetApnsSandboxChannel" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_apns_sandbox_channel(call_hash)
  end
...
begin
  result = GetApnsSandboxChannel(params)
