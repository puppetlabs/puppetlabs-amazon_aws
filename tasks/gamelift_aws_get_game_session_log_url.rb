...
def GetGameSessionLogUrl(*args)
  puts "Calling task operation GetGameSessionLogUrl" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_game_session_log_url(call_hash)
  end
...
begin
  result = GetGameSessionLogUrl(params)
