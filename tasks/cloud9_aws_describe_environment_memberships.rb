...
def DescribeEnvironmentMemberships(*args)
  puts "Calling task operation DescribeEnvironmentMemberships" 
  ...
  client = Aws::Cloud9::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.describe_environment_memberships(call_hash)
  end
...
begin
  result = DescribeEnvironmentMemberships(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::Cloud9::Errors::ServiceError => e
