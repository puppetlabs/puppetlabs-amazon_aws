...
def operation_with_hash(arg_hash)
  ...
  client.get_distribution_config2018_11_05(call_hash)
end

def get_distribution_config2018_11_05(*args)
  argstring = args[0]
  argstring.delete('\\')
  ...
  client = Aws::CloudFront::Client.new(region: region)
  response = client.get_distribution_config2018_11_05 if arg_hash.empty?
...
def task
  ...
  params = STDIN.read
  result = get_distribution_config2018_11_05(params)
