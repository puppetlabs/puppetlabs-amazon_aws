...
def CreateInstanceProfile(*args)
  puts "Calling task operation CreateInstanceProfile" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_instance_profile(call_hash)
  end
...
begin
  result = CreateInstanceProfile(params)
