...
def CreateDataSourceFromRDS(*args)
  puts "Calling task operation CreateDataSourceFromRDS" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_data_source_from_rds(call_hash)
  end
...
begin
  result = CreateDataSourceFromRDS(params)
