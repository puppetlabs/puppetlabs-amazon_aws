...
def ListStreamProcessors(*args)
  puts "Calling task operation ListStreamProcessors" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_stream_processors(call_hash)
  end
...
begin
  result = ListStreamProcessors(params)
