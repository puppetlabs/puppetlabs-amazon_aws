...
def StopStackSetOperation(*args)
  puts "Calling task operation StopStackSetOperation" 
  ...
  if arg_hash.empty?
    ...
    response = client.stop_stack_set_operation(call_hash)
  end
...
begin
  result = StopStackSetOperation(params)
