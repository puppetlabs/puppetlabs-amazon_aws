...
def DeleteScheduledAudit(*args)
  puts "Calling task operation DeleteScheduledAudit" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_scheduled_audit(call_hash)
  end
...
begin
  result = DeleteScheduledAudit(params)
