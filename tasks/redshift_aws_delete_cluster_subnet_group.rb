...
def DeleteClusterSubnetGroup(*args)
  puts "Calling task operation DeleteClusterSubnetGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_cluster_subnet_group(call_hash)
  end
...
begin
  result = DeleteClusterSubnetGroup(params)
