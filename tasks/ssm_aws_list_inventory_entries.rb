...
def ListInventoryEntries(*args)
  puts "Calling task operation ListInventoryEntries" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_inventory_entries(call_hash)
  end
...
begin
  result = ListInventoryEntries(params)
