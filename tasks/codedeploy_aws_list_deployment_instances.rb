...
def ListDeploymentInstances(*args)
  puts "Calling task operation ListDeploymentInstances" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_deployment_instances(call_hash)
  end
...
begin
  result = ListDeploymentInstances(params)
