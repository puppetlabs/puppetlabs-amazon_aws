...
def DetachInternetGateway(*args)
  puts "Calling task operation DetachInternetGateway" 
  ...
  if arg_hash.empty?
    ...
    response = client.detach_internet_gateway(call_hash)
  end
...
begin
  result = DetachInternetGateway(params)
