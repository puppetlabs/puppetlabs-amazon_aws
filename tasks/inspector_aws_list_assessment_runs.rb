...
def ListAssessmentRuns(*args)
  puts "Calling task operation ListAssessmentRuns" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_assessment_runs(call_hash)
  end
...
begin
  result = ListAssessmentRuns(params)
