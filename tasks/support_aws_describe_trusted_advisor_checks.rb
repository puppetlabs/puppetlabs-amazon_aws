...
def DescribeTrustedAdvisorChecks(*args)
  puts "Calling task operation DescribeTrustedAdvisorChecks" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_trusted_advisor_checks(call_hash)
  end
...
begin
  result = DescribeTrustedAdvisorChecks(params)
