...
def GetObjectAttributes(*args)
  puts "Calling task operation GetObjectAttributes" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_object_attributes(call_hash)
  end
...
begin
  result = GetObjectAttributes(params)
