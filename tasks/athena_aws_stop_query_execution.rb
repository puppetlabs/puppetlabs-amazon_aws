...
def StopQueryExecution(*args)
  puts "Calling task operation StopQueryExecution" 
  ...
  if arg_hash.empty?
    ...
    response = client.stop_query_execution(call_hash)
  end
...
begin
  result = StopQueryExecution(params)
