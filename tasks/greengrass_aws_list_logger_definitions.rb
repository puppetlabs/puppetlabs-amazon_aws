...
def ListLoggerDefinitions(*args)
  puts "Calling task operation ListLoggerDefinitions" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_logger_definitions(call_hash)
  end
...
begin
  result = ListLoggerDefinitions(params)
