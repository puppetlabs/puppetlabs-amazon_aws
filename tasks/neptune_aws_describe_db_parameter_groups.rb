...
def DescribeDBParameterGroups(*args)
  puts "Calling task operation DescribeDBParameterGroups" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_db_parameter_groups(call_hash)
  end
...
begin
  result = DescribeDBParameterGroups(params)
