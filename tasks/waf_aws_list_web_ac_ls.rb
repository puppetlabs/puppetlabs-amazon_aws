...
def ListWebACLs(*args)
  puts "Calling task operation ListWebACLs" 
  ...
  if arg_hash.empty?
    response = client.list_web_ac_ls()
  else 
    call_hash={}
    ...
    response = client.list_web_ac_ls(call_hash)
  end
