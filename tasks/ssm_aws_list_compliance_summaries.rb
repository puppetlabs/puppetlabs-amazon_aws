...
def ListComplianceSummaries(*args)
  puts "Calling task operation ListComplianceSummaries" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_compliance_summaries(call_hash)
  end
...
begin
  result = ListComplianceSummaries(params)
