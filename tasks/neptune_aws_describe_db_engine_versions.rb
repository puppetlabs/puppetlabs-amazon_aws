...
def DescribeDBEngineVersions(*args)
  puts "Calling task operation DescribeDBEngineVersions" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_db_engine_versions(call_hash)
  end
...
begin
  result = DescribeDBEngineVersions(params)
