...
def UpdateUserSecurityProfiles(*args)
  puts "Calling task operation UpdateUserSecurityProfiles" 
  ...
  client = Aws::Connect::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.update_user_security_profiles(call_hash)
  end
...
begin
  result = UpdateUserSecurityProfiles(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::Connect::Errors::ServiceError => e
