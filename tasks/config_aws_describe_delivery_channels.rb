...
def DescribeDeliveryChannels(*args)
  puts "Calling task operation DescribeDeliveryChannels" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_delivery_channels(call_hash)
  end
...
begin
  result = DescribeDeliveryChannels(params)
