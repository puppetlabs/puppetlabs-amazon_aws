...
def GetCampaignVersions(*args)
  puts "Calling task operation GetCampaignVersions" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_campaign_versions(call_hash)
  end
...
begin
  result = GetCampaignVersions(params)
