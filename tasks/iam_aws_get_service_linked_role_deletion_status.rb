...
def GetServiceLinkedRoleDeletionStatus(*args)
  puts "Calling task operation GetServiceLinkedRoleDeletionStatus" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_service_linked_role_deletion_status(call_hash)
  end
...
begin
  result = GetServiceLinkedRoleDeletionStatus(params)
