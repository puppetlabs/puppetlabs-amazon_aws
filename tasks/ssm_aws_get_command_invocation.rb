...
def GetCommandInvocation(*args)
  puts "Calling task operation GetCommandInvocation" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_command_invocation(call_hash)
  end
...
begin
  result = GetCommandInvocation(params)
