...
def GetSecurityConfigurations(*args)
  puts "Calling task operation GetSecurityConfigurations" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_security_configurations(call_hash)
  end
...
begin
  result = GetSecurityConfigurations(params)
