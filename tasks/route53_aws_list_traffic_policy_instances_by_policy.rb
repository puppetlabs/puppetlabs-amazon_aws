...
def ListTrafficPolicyInstancesByPolicy(*args)
  puts "Calling task operation ListTrafficPolicyInstancesByPolicy" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_traffic_policy_instances_by_policy(call_hash)
  end
...
begin
  result = ListTrafficPolicyInstancesByPolicy(params)
