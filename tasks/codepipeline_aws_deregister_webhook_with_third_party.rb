...
def DeregisterWebhookWithThirdParty(*args)
  puts "Calling task operation DeregisterWebhookWithThirdParty" 
  ...
  client = Aws::CodePipeline::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.deregister_webhook_with_third_party(call_hash)
  end
...
begin
  result = DeregisterWebhookWithThirdParty(params)
