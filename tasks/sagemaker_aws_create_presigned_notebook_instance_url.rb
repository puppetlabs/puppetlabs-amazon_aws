...
def CreatePresignedNotebookInstanceUrl(*args)
  puts "Calling task operation CreatePresignedNotebookInstanceUrl" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_presigned_notebook_instance_url(call_hash)
  end
...
begin
  result = CreatePresignedNotebookInstanceUrl(params)
