...
def DeleteClientCertificate(*args)
  puts "Calling task operation DeleteClientCertificate" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_client_certificate(call_hash)
  end
...
begin
  result = DeleteClientCertificate(params)
