...
def UpdateGlobalTableSettings(*args)
  puts "Calling task operation UpdateGlobalTableSettings" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_global_table_settings(call_hash)
  end
...
begin
  result = UpdateGlobalTableSettings(params)
