...
def CreateSoftwareUpdateJob(*args)
  puts "Calling task operation CreateSoftwareUpdateJob" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_software_update_job(call_hash)
  end
...
begin
  result = CreateSoftwareUpdateJob(params)
