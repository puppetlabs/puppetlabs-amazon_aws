...
def DeleteTrafficPolicyInstance(*args)
  puts "Calling task operation DeleteTrafficPolicyInstance" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_traffic_policy_instance(call_hash)
  end
...
begin
  result = DeleteTrafficPolicyInstance(params)
