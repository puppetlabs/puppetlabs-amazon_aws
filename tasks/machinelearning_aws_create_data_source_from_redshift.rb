...
def CreateDataSourceFromRedshift(*args)
  puts "Calling task operation CreateDataSourceFromRedshift" 
  ...
  client = Aws::MachineLearning::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.create_data_source_from_redshift(call_hash)
  end
...
begin
  result = CreateDataSourceFromRedshift(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::MachineLearning::Errors::ServiceError => e
