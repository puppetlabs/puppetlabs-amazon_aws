...
def DescribeStackResource(*args)
  puts "Calling task operation DescribeStackResource" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_stack_resource(call_hash)
  end
...
begin
  result = DescribeStackResource(params)
