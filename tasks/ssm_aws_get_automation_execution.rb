...
def GetAutomationExecution(*args)
  puts "Calling task operation GetAutomationExecution" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_automation_execution(call_hash)
  end
...
begin
  result = GetAutomationExecution(params)
