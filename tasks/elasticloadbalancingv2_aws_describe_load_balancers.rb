...
def DescribeLoadBalancers(*args)
  puts "Calling task operation DescribeLoadBalancers" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_load_balancers(call_hash)
  end
...
begin
  result = DescribeLoadBalancers(params)
