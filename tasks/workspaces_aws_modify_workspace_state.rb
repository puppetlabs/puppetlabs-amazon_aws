...
def ModifyWorkspaceState(*args)
  puts "Calling task operation ModifyWorkspaceState" 
  ...
  if arg_hash.empty?
    ...
    response = client.modify_workspace_state(call_hash)
  end
...
begin
  result = ModifyWorkspaceState(params)
