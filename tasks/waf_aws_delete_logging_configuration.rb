...
def DeleteLoggingConfiguration(*args)
  puts "Calling task operation DeleteLoggingConfiguration" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_logging_configuration(call_hash)
  end
...
begin
  result = DeleteLoggingConfiguration(params)
