...
def UpdateAutoScalingGroup(*args)
  puts "Calling task operation UpdateAutoScalingGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_auto_scaling_group(call_hash)
  end
...
begin
  result = UpdateAutoScalingGroup(params)
