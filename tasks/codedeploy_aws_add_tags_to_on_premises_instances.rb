...
def AddTagsToOnPremisesInstances(*args)
  puts "Calling task operation AddTagsToOnPremisesInstances" 
  ...
  if arg_hash.empty?
    ...
    response = client.add_tags_to_on_premises_instances(call_hash)
  end
...
begin
  result = AddTagsToOnPremisesInstances(params)
