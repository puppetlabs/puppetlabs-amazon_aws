...
def CreateStorediSCSIVolume(*args)
  puts "Calling task operation CreateStorediSCSIVolume" 
  ...
  if arg_hash.empty?
    response = client.create_storedi_scsi_volume()
  else 
    call_hash={}
    ...
    response = client.create_storedi_scsi_volume(call_hash)
  end
...
begin
  result = CreateStorediSCSIVolume(params)
