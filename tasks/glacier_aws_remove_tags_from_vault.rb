...
def RemoveTagsFromVault(*args)
  puts "Calling task operation RemoveTagsFromVault" 
  ...
  if arg_hash.empty?
    ...
    response = client.remove_tags_from_vault(call_hash)
  end
...
begin
  result = RemoveTagsFromVault(params)
