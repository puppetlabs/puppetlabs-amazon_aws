...
def CreatePortfolioShare(*args)
  puts "Calling task operation CreatePortfolioShare" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_portfolio_share(call_hash)
  end
...
begin
  result = CreatePortfolioShare(params)
