...
def DeleteVpcPeeringConnection(*args)
  puts "Calling task operation DeleteVpcPeeringConnection" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_vpc_peering_connection(call_hash)
  end
...
begin
  result = DeleteVpcPeeringConnection(params)
