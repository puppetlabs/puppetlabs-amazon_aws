...
def DeleteBatchPrediction(*args)
  puts "Calling task operation DeleteBatchPrediction" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_batch_prediction(call_hash)
  end
...
begin
  result = DeleteBatchPrediction(params)
