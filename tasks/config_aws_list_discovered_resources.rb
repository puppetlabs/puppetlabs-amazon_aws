...
def ListDiscoveredResources(*args)
  puts "Calling task operation ListDiscoveredResources" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_discovered_resources(call_hash)
  end
...
begin
  result = ListDiscoveredResources(params)
