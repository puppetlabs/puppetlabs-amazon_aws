...
def ListObjectVersions(*args)
  puts "Calling task operation ListObjectVersions" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_object_versions(call_hash)
  end
...
begin
  result = ListObjectVersions(params)
