...
def DeleteAccountPasswordPolicy(*args)
  puts "Calling task operation DeleteAccountPasswordPolicy" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_account_password_policy(call_hash)
  end
...
begin
  result = DeleteAccountPasswordPolicy(params)
