...
def DescribeCacheEngineVersions(*args)
  puts "Calling task operation DescribeCacheEngineVersions" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_cache_engine_versions(call_hash)
  end
...
begin
  result = DescribeCacheEngineVersions(params)
