...
def UpdateTrafficPolicyInstance(*args)
  puts "Calling task operation UpdateTrafficPolicyInstance" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_traffic_policy_instance(call_hash)
  end
...
begin
  result = UpdateTrafficPolicyInstance(params)
