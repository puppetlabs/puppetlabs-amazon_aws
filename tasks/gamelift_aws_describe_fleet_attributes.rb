...
def DescribeFleetAttributes(*args)
  puts "Calling task operation DescribeFleetAttributes" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_fleet_attributes(call_hash)
  end
...
begin
  result = DescribeFleetAttributes(params)
