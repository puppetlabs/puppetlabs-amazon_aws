...
def AddApplicationCloudWatchLoggingOption(*args)
  puts "Calling task operation AddApplicationCloudWatchLoggingOption" 
  ...
  if arg_hash.empty?
    ...
    response = client.add_application_cloud_watch_logging_option(call_hash)
  end
...
begin
  result = AddApplicationCloudWatchLoggingOption(params)
