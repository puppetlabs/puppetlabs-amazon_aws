...
def DescribeEventSubscriptions(*args)
  puts "Calling task operation DescribeEventSubscriptions" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_event_subscriptions(call_hash)
  end
...
begin
  result = DescribeEventSubscriptions(params)
