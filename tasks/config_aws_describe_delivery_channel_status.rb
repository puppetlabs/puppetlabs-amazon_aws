...
def DescribeDeliveryChannelStatus(*args)
  puts "Calling task operation DescribeDeliveryChannelStatus" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_delivery_channel_status(call_hash)
  end
...
begin
  result = DescribeDeliveryChannelStatus(params)
