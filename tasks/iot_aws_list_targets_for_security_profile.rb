...
def ListTargetsForSecurityProfile(*args)
  puts "Calling task operation ListTargetsForSecurityProfile" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_targets_for_security_profile(call_hash)
  end
...
begin
  result = ListTargetsForSecurityProfile(params)
