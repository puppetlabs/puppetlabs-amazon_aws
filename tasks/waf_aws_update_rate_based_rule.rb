...
def UpdateRateBasedRule(*args)
  puts "Calling task operation UpdateRateBasedRule" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_rate_based_rule(call_hash)
  end
...
begin
  result = UpdateRateBasedRule(params)
