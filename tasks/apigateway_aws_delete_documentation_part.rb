...
def DeleteDocumentationPart(*args)
  puts "Calling task operation DeleteDocumentationPart" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_documentation_part(call_hash)
  end
...
begin
  result = DeleteDocumentationPart(params)
