...
def DescribeEntityAggregates(*args)
  puts "Calling task operation DescribeEntityAggregates" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_entity_aggregates(call_hash)
  end
...
begin
  result = DescribeEntityAggregates(params)
