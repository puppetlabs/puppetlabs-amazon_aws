...
def DeleteConfigurationRecorder(*args)
  puts "Calling task operation DeleteConfigurationRecorder" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_configuration_recorder(call_hash)
  end
...
begin
  result = DeleteConfigurationRecorder(params)
