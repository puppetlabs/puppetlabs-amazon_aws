...
def DeleteLoadBalancer(*args)
  puts "Calling task operation DeleteLoadBalancer" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_load_balancer(call_hash)
  end
...
begin
  result = DeleteLoadBalancer(params)
