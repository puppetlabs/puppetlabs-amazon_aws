...
def DeleteSAMLProvider(*args)
  puts "Calling task operation DeleteSAMLProvider" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_saml_provider(call_hash)
  end
...
begin
  result = DeleteSAMLProvider(params)
