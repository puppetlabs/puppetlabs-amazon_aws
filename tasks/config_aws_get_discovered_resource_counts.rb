...
def GetDiscoveredResourceCounts(*args)
  puts "Calling task operation GetDiscoveredResourceCounts" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_discovered_resource_counts(call_hash)
  end
...
begin
  result = GetDiscoveredResourceCounts(params)
