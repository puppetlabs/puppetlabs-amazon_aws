...
def CreatePlatformApplication(*args)
  puts "Calling task operation CreatePlatformApplication" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_platform_application(call_hash)
  end
...
begin
  result = CreatePlatformApplication(params)
