...
def ListOfferingTransactions(*args)
  puts "Calling task operation ListOfferingTransactions" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_offering_transactions(call_hash)
  end
...
begin
  result = ListOfferingTransactions(params)
