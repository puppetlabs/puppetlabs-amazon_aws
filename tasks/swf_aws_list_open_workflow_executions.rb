...
def ListOpenWorkflowExecutions(*args)
  puts "Calling task operation ListOpenWorkflowExecutions" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_open_workflow_executions(call_hash)
  end
...
begin
  result = ListOpenWorkflowExecutions(params)
