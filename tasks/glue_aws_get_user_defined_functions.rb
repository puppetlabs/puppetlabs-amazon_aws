...
def GetUserDefinedFunctions(*args)
  puts "Calling task operation GetUserDefinedFunctions" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_user_defined_functions(call_hash)
  end
...
begin
  result = GetUserDefinedFunctions(params)
