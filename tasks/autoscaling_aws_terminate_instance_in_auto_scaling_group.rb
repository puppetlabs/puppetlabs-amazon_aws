...
def TerminateInstanceInAutoScalingGroup(*args)
  puts "Calling task operation TerminateInstanceInAutoScalingGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.terminate_instance_in_auto_scaling_group(call_hash)
  end
...
begin
  result = TerminateInstanceInAutoScalingGroup(params)
