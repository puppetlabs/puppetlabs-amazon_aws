...
def ListSubscribedRuleGroups(*args)
  puts "Calling task operation ListSubscribedRuleGroups" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_subscribed_rule_groups(call_hash)
  end
...
begin
  result = ListSubscribedRuleGroups(params)
