...
def DescribeSourceRegions(*args)
  puts "Calling task operation DescribeSourceRegions" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_source_regions(call_hash)
  end
...
begin
  result = DescribeSourceRegions(params)
