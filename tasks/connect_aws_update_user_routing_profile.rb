...
def UpdateUserRoutingProfile(*args)
  puts "Calling task operation UpdateUserRoutingProfile" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_user_routing_profile(call_hash)
  end
...
begin
  result = UpdateUserRoutingProfile(params)
