...
def GetBucketLifecycle(*args)
  puts "Calling task operation GetBucketLifecycle" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_bucket_lifecycle(call_hash)
  end
...
begin
  result = GetBucketLifecycle(params)
