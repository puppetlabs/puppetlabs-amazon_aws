...
def AddRoleToDBCluster(*args)
  puts "Calling task operation AddRoleToDBCluster" 
  ...
  if arg_hash.empty?
    ...
    response = client.add_role_to_db_cluster(call_hash)
  end
...
begin
  result = AddRoleToDBCluster(params)
