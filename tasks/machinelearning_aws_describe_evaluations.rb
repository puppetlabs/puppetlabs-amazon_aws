...
def DescribeEvaluations(*args)
  puts "Calling task operation DescribeEvaluations" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_evaluations(call_hash)
  end
...
begin
  result = DescribeEvaluations(params)
