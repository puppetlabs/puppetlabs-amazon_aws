...
def GetInstanceSnapshot(*args)
  puts "Calling task operation GetInstanceSnapshot" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_instance_snapshot(call_hash)
  end
...
begin
  result = GetInstanceSnapshot(params)
