...
def CreatePlatformEndpoint(*args)
  puts "Calling task operation CreatePlatformEndpoint" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_platform_endpoint(call_hash)
  end
...
begin
  result = CreatePlatformEndpoint(params)
