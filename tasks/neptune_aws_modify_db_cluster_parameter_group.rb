...
def ModifyDBClusterParameterGroup(*args)
  puts "Calling task operation ModifyDBClusterParameterGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.modify_db_cluster_parameter_group(call_hash)
  end
...
begin
  result = ModifyDBClusterParameterGroup(params)
