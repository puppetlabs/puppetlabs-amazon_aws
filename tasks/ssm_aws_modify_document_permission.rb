...
def ModifyDocumentPermission(*args)
  puts "Calling task operation ModifyDocumentPermission" 
  ...
  if arg_hash.empty?
    ...
    response = client.modify_document_permission(call_hash)
  end
...
begin
  result = ModifyDocumentPermission(params)
