...
def DeleteConfigurationAggregator(*args)
  puts "Calling task operation DeleteConfigurationAggregator" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_configuration_aggregator(call_hash)
  end
...
begin
  result = DeleteConfigurationAggregator(params)
