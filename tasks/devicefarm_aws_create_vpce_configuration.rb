...
def CreateVPCEConfiguration(*args)
  puts "Calling task operation CreateVPCEConfiguration" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_vpce_configuration(call_hash)
  end
...
begin
  result = CreateVPCEConfiguration(params)
