...
def DescribeAggregateIdFormat(*args)
  puts "Calling task operation DescribeAggregateIdFormat" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_aggregate_id_format(call_hash)
  end
...
begin
  result = DescribeAggregateIdFormat(params)
