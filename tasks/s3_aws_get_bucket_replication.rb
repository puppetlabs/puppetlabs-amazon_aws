...
def GetBucketReplication(*args)
  puts "Calling task operation GetBucketReplication" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_bucket_replication(call_hash)
  end
...
begin
  result = GetBucketReplication(params)
