...
def StartThingRegistrationTask(*args)
  puts "Calling task operation StartThingRegistrationTask" 
  ...
  if arg_hash.empty?
    ...
    response = client.start_thing_registration_task(call_hash)
  end
...
begin
  result = StartThingRegistrationTask(params)
