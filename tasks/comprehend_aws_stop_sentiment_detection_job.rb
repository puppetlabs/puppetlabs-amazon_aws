...
def StopSentimentDetectionJob(*args)
  puts "Calling task operation StopSentimentDetectionJob" 
  ...
  if arg_hash.empty?
    ...
    response = client.stop_sentiment_detection_job(call_hash)
  end
...
begin
  result = StopSentimentDetectionJob(params)
