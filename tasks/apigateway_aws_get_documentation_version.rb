...
def GetDocumentationVersion(*args)
  puts "Calling task operation GetDocumentationVersion" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_documentation_version(call_hash)
  end
...
begin
  result = GetDocumentationVersion(params)
