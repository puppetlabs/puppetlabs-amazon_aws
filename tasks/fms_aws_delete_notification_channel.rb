...
def DeleteNotificationChannel(*args)
  puts "Calling task operation DeleteNotificationChannel" 
  ...
  client = Aws::FMS::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.delete_notification_channel(call_hash)
  end
...
begin
  result = DeleteNotificationChannel(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::FMS::Errors::ServiceError => e
