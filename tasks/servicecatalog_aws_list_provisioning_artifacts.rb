...
def ListProvisioningArtifacts(*args)
  puts "Calling task operation ListProvisioningArtifacts" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_provisioning_artifacts(call_hash)
  end
...
begin
  result = ListProvisioningArtifacts(params)
