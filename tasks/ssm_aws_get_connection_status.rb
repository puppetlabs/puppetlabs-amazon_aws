...
def GetConnectionStatus(*args)
  puts "Calling task operation GetConnectionStatus" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_connection_status(call_hash)
  end
...
begin
  result = GetConnectionStatus(params)
