...
def UpdateDocumentationVersion(*args)
  puts "Calling task operation UpdateDocumentationVersion" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_documentation_version(call_hash)
  end
...
begin
  result = UpdateDocumentationVersion(params)
