...
def ListAccountsForParent(*args)
  puts "Calling task operation ListAccountsForParent" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_accounts_for_parent(call_hash)
  end
...
begin
  result = ListAccountsForParent(params)
