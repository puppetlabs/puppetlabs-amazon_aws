...
def CreateServiceSpecificCredential(*args)
  puts "Calling task operation CreateServiceSpecificCredential" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_service_specific_credential(call_hash)
  end
...
begin
  result = CreateServiceSpecificCredential(params)
