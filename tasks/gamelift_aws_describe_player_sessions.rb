...
def DescribePlayerSessions(*args)
  puts "Calling task operation DescribePlayerSessions" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_player_sessions(call_hash)
  end
...
begin
  result = DescribePlayerSessions(params)
