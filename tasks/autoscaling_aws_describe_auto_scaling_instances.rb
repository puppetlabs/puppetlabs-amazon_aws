...
def DescribeAutoScalingInstances(*args)
  puts "Calling task operation DescribeAutoScalingInstances" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_auto_scaling_instances(call_hash)
  end
...
begin
  result = DescribeAutoScalingInstances(params)
