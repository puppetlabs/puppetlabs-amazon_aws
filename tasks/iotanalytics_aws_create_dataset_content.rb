...
def CreateDatasetContent(*args)
  puts "Calling task operation CreateDatasetContent" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_dataset_content(call_hash)
  end
...
begin
  result = CreateDatasetContent(params)
