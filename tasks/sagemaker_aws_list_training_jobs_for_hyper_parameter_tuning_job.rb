...
def ListTrainingJobsForHyperParameterTuningJob(*args)
  puts "Calling task operation ListTrainingJobsForHyperParameterTuningJob" 
  ...
  client = Aws::SageMaker::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.list_training_jobs_for_hyper_parameter_tuning_job(call_hash)
  end
...
begin
  result = ListTrainingJobsForHyperParameterTuningJob(params)
