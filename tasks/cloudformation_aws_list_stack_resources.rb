...
def ListStackResources(*args)
  puts "Calling task operation ListStackResources" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_stack_resources(call_hash)
  end
...
begin
  result = ListStackResources(params)
