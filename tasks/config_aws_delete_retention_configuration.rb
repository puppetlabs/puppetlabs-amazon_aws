...
def DeleteRetentionConfiguration(*args)
  puts "Calling task operation DeleteRetentionConfiguration" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_retention_configuration(call_hash)
  end
...
begin
  result = DeleteRetentionConfiguration(params)
