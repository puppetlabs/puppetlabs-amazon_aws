...
def DeregisterTaskFromMaintenanceWindow(*args)
  puts "Calling task operation DeregisterTaskFromMaintenanceWindow" 
  ...
  if arg_hash.empty?
    ...
    response = client.deregister_task_from_maintenance_window(call_hash)
  end
...
begin
  result = DeregisterTaskFromMaintenanceWindow(params)
