...
def ModifyCurrentDBClusterCapacity(*args)
  puts "Calling task operation ModifyCurrentDBClusterCapacity" 
  ...
  if arg_hash.empty?
    ...
    response = client.modify_current_db_cluster_capacity(call_hash)
  end
...
begin
  result = ModifyCurrentDBClusterCapacity(params)
