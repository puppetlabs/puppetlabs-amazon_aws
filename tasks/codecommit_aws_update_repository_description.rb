...
def UpdateRepositoryDescription(*args)
  puts "Calling task operation UpdateRepositoryDescription" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_repository_description(call_hash)
  end
...
begin
  result = UpdateRepositoryDescription(params)
