...
def DescribeInstancePatches(*args)
  puts "Calling task operation DescribeInstancePatches" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_instance_patches(call_hash)
  end
...
begin
  result = DescribeInstancePatches(params)
