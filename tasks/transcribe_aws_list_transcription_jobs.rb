...
def ListTranscriptionJobs(*args)
  puts "Calling task operation ListTranscriptionJobs" 
  ...
  client = Aws::TranscribeService::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.list_transcription_jobs(call_hash)
  end
...
begin
  result = ListTranscriptionJobs(params)
