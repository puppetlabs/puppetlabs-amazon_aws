...
def UpdateInstanceProfile(*args)
  puts "Calling task operation UpdateInstanceProfile" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_instance_profile(call_hash)
  end
...
begin
  result = UpdateInstanceProfile(params)
