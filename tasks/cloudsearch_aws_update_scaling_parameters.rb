...
def UpdateScalingParameters(*args)
  puts "Calling task operation UpdateScalingParameters" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_scaling_parameters(call_hash)
  end
...
begin
  result = UpdateScalingParameters(params)
