...
def CreateDBClusterParameterGroup(*args)
  puts "Calling task operation CreateDBClusterParameterGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_db_cluster_parameter_group(call_hash)
  end
...
begin
  result = CreateDBClusterParameterGroup(params)
