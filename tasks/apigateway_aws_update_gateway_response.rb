...
def UpdateGatewayResponse(*args)
  puts "Calling task operation UpdateGatewayResponse" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_gateway_response(call_hash)
  end
...
begin
  result = UpdateGatewayResponse(params)
