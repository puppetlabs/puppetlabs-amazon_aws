...
def DescribeNetworkInterfacePermissions(*args)
  puts "Calling task operation DescribeNetworkInterfacePermissions" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_network_interface_permissions(call_hash)
  end
...
begin
  result = DescribeNetworkInterfacePermissions(params)
