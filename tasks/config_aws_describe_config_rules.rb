...
def DescribeConfigRules(*args)
  puts "Calling task operation DescribeConfigRules" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_config_rules(call_hash)
  end
...
begin
  result = DescribeConfigRules(params)
