...
def CreateReplicationJob(*args)
  puts "Calling task operation CreateReplicationJob" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_replication_job(call_hash)
  end
...
begin
  result = CreateReplicationJob(params)
