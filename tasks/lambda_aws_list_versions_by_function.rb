...
def ListVersionsByFunction(*args)
  puts "Calling task operation ListVersionsByFunction" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_versions_by_function(call_hash)
  end
...
begin
  result = ListVersionsByFunction(params)
