...
def RemoveTagsFromCertificate(*args)
  puts "Calling task operation RemoveTagsFromCertificate" 
  ...
  client = Aws::ACM::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.remove_tags_from_certificate(call_hash)
  end
...
begin
  result = RemoveTagsFromCertificate(params)
