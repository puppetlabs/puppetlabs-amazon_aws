...
def StartFaceDetection(*args)
  puts "Calling task operation StartFaceDetection" 
  ...
  if arg_hash.empty?
    ...
    response = client.start_face_detection(call_hash)
  end
...
begin
  result = StartFaceDetection(params)
