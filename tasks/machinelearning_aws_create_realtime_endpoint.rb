...
def CreateRealtimeEndpoint(*args)
  puts "Calling task operation CreateRealtimeEndpoint" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_realtime_endpoint(call_hash)
  end
...
begin
  result = CreateRealtimeEndpoint(params)
