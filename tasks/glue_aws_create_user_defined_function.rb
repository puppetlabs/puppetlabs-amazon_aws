...
def CreateUserDefinedFunction(*args)
  puts "Calling task operation CreateUserDefinedFunction" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_user_defined_function(call_hash)
  end
...
begin
  result = CreateUserDefinedFunction(params)
