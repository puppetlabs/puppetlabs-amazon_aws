...
def GetCampaignVersion(*args)
  puts "Calling task operation GetCampaignVersion" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_campaign_version(call_hash)
  end
...
begin
  result = GetCampaignVersion(params)
