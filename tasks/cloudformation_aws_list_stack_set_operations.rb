...
def ListStackSetOperations(*args)
  puts "Calling task operation ListStackSetOperations" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_stack_set_operations(call_hash)
  end
...
begin
  result = ListStackSetOperations(params)
