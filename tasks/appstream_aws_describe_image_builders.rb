...
def DescribeImageBuilders(*args)
  puts "Calling task operation DescribeImageBuilders" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_image_builders(call_hash)
  end
...
begin
  result = DescribeImageBuilders(params)
