...
def DescribeOriginEndpoint(*args)
  puts "Calling task operation DescribeOriginEndpoint" 
  ...
  client = Aws::MediaPackage::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.describe_origin_endpoint(call_hash)
  end
...
begin
  result = DescribeOriginEndpoint(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::MediaPackage::Errors::ServiceError => e
