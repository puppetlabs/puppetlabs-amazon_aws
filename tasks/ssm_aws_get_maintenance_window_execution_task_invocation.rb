...
def GetMaintenanceWindowExecutionTaskInvocation(*args)
  puts "Calling task operation GetMaintenanceWindowExecutionTaskInvocation" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_maintenance_window_execution_task_invocation(call_hash)
  end
...
begin
  result = GetMaintenanceWindowExecutionTaskInvocation(params)
