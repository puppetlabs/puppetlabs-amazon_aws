...
def DescribeConfigurationRecorderStatus(*args)
  puts "Calling task operation DescribeConfigurationRecorderStatus" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_configuration_recorder_status(call_hash)
  end
...
begin
  result = DescribeConfigurationRecorderStatus(params)
