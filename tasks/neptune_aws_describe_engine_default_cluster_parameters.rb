...
def DescribeEngineDefaultClusterParameters(*args)
  puts "Calling task operation DescribeEngineDefaultClusterParameters" 
  ...
  client = Aws::Neptune::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.describe_engine_default_cluster_parameters(call_hash)
  end
...
begin
  result = DescribeEngineDefaultClusterParameters(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::Neptune::Errors::ServiceError => e
