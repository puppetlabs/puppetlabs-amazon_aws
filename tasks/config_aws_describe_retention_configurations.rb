...
def DescribeRetentionConfigurations(*args)
  puts "Calling task operation DescribeRetentionConfigurations" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_retention_configurations(call_hash)
  end
...
begin
  result = DescribeRetentionConfigurations(params)
