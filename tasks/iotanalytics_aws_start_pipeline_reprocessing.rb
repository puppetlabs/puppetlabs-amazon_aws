...
def StartPipelineReprocessing(*args)
  puts "Calling task operation StartPipelineReprocessing" 
  ...
  client = Aws::IoTAnalytics::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.start_pipeline_reprocessing(call_hash)
  end
...
begin
  result = StartPipelineReprocessing(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::IoTAnalytics::Errors::ServiceError => e
