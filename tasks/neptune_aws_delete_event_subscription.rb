...
def DeleteEventSubscription(*args)
  puts "Calling task operation DeleteEventSubscription" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_event_subscription(call_hash)
  end
...
begin
  result = DeleteEventSubscription(params)
