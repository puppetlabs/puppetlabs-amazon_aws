...
def ModifyDBClusterSnapshotAttribute(*args)
  puts "Calling task operation ModifyDBClusterSnapshotAttribute" 
  ...
  if arg_hash.empty?
    ...
    response = client.modify_db_cluster_snapshot_attribute(call_hash)
  end
...
begin
  result = ModifyDBClusterSnapshotAttribute(params)
