...
def CreateLoginProfile(*args)
  puts "Calling task operation CreateLoginProfile" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_login_profile(call_hash)
  end
...
begin
  result = CreateLoginProfile(params)
