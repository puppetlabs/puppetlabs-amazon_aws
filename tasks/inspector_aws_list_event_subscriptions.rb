...
def ListEventSubscriptions(*args)
  puts "Calling task operation ListEventSubscriptions" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_event_subscriptions(call_hash)
  end
...
begin
  result = ListEventSubscriptions(params)
