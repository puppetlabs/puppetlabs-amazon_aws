...
def UpdateBasePathMapping(*args)
  puts "Calling task operation UpdateBasePathMapping" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_base_path_mapping(call_hash)
  end
...
begin
  result = UpdateBasePathMapping(params)
