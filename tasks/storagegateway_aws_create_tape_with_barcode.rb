...
def CreateTapeWithBarcode(*args)
  puts "Calling task operation CreateTapeWithBarcode" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_tape_with_barcode(call_hash)
  end
...
begin
  result = CreateTapeWithBarcode(params)
