...
def UpdateThreatIntelSet(*args)
  puts "Calling task operation UpdateThreatIntelSet" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_threat_intel_set(call_hash)
  end
...
begin
  result = UpdateThreatIntelSet(params)
