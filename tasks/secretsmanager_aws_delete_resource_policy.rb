...
def DeleteResourcePolicy(*args)
  puts "Calling task operation DeleteResourcePolicy" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_resource_policy(call_hash)
  end
...
begin
  result = DeleteResourcePolicy(params)
