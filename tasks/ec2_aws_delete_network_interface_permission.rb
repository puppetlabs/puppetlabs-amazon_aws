...
def DeleteNetworkInterfacePermission(*args)
  puts "Calling task operation DeleteNetworkInterfacePermission" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_network_interface_permission(call_hash)
  end
...
begin
  result = DeleteNetworkInterfacePermission(params)
