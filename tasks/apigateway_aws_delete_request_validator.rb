...
def DeleteRequestValidator(*args)
  puts "Calling task operation DeleteRequestValidator" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_request_validator(call_hash)
  end
...
begin
  result = DeleteRequestValidator(params)
