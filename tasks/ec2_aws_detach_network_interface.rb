...
def DetachNetworkInterface(*args)
  puts "Calling task operation DetachNetworkInterface" 
  ...
  if arg_hash.empty?
    ...
    response = client.detach_network_interface(call_hash)
  end
...
begin
  result = DetachNetworkInterface(params)
