...
def UpdateLifecyclePolicy(*args)
  puts "Calling task operation UpdateLifecyclePolicy" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_lifecycle_policy(call_hash)
  end
...
begin
  result = UpdateLifecyclePolicy(params)
