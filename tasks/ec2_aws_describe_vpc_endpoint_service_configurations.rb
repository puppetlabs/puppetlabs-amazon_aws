...
def DescribeVpcEndpointServiceConfigurations(*args)
  puts "Calling task operation DescribeVpcEndpointServiceConfigurations" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_vpc_endpoint_service_configurations(call_hash)
  end
...
begin
  result = DescribeVpcEndpointServiceConfigurations(params)
