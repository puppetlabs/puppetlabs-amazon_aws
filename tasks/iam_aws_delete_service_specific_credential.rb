...
def DeleteServiceSpecificCredential(*args)
  puts "Calling task operation DeleteServiceSpecificCredential" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_service_specific_credential(call_hash)
  end
...
begin
  result = DeleteServiceSpecificCredential(params)
