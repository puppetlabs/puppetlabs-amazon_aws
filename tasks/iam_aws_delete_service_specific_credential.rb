...
def operation_with_hash(arg_hash)
  ...
  client.delete_service_specific_credential(call_hash)
end

def delete_service_specific_credential(*args)
  argstring = args[0]
  argstring.delete('\\')
  ...
  client = Aws::IAM::Client.new(region: region)
  response = client.delete_service_specific_credential if arg_hash.empty?
...
def task
  ...
  params = STDIN.read
  result = delete_service_specific_credential(params)
