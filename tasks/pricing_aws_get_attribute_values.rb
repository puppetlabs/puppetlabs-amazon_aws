...
def GetAttributeValues(*args)
  puts "Calling task operation GetAttributeValues" 
  ...
  client = Aws::Pricing::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.get_attribute_values(call_hash)
  end
...
begin
  result = GetAttributeValues(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::Pricing::Errors::ServiceError => e
