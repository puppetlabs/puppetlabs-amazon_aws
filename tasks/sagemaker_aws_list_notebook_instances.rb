...
def ListNotebookInstances(*args)
  puts "Calling task operation ListNotebookInstances" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_notebook_instances(call_hash)
  end
...
begin
  result = ListNotebookInstances(params)
