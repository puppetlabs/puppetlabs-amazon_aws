...
def ModifyImageAttribute(*args)
  puts "Calling task operation ModifyImageAttribute" 
  ...
  if arg_hash.empty?
    ...
    response = client.modify_image_attribute(call_hash)
  end
...
begin
  result = ModifyImageAttribute(params)
