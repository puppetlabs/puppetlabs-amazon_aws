...
def CreatePolicyVersion(*args)
  puts "Calling task operation CreatePolicyVersion" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_policy_version(call_hash)
  end
...
begin
  result = CreatePolicyVersion(params)
