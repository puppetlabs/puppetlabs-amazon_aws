...
def DeleteReplicationJob(*args)
  puts "Calling task operation DeleteReplicationJob" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_replication_job(call_hash)
  end
...
begin
  result = DeleteReplicationJob(params)
