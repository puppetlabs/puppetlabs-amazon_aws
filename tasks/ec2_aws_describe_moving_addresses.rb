...
def DescribeMovingAddresses(*args)
  puts "Calling task operation DescribeMovingAddresses" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_moving_addresses(call_hash)
  end
...
begin
  result = DescribeMovingAddresses(params)
