...
def DeleteVirtualMFADevice(*args)
  puts "Calling task operation DeleteVirtualMFADevice" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_virtual_mfa_device(call_hash)
  end
...
begin
  result = DeleteVirtualMFADevice(params)
