...
def ListThreatIntelSets(*args)
  puts "Calling task operation ListThreatIntelSets" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_threat_intel_sets(call_hash)
  end
...
begin
  result = ListThreatIntelSets(params)
