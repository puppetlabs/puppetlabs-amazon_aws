...
def ListScheduledAudits(*args)
  puts "Calling task operation ListScheduledAudits" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_scheduled_audits(call_hash)
  end
...
begin
  result = ListScheduledAudits(params)
