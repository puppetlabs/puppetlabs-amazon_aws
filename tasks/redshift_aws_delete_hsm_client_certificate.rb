...
def DeleteHsmClientCertificate(*args)
  puts "Calling task operation DeleteHsmClientCertificate" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_hsm_client_certificate(call_hash)
  end
...
begin
  result = DeleteHsmClientCertificate(params)
