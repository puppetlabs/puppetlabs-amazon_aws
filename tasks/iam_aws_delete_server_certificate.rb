...
def DeleteServerCertificate(*args)
  puts "Calling task operation DeleteServerCertificate" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_server_certificate(call_hash)
  end
...
begin
  result = DeleteServerCertificate(params)
