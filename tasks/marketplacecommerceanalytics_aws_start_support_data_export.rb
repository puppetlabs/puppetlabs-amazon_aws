...
def StartSupportDataExport(*args)
  puts "Calling task operation StartSupportDataExport" 
  ...
  client = Aws::MarketplaceCommerceAnalytics::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.start_support_data_export(call_hash)
  end
...
begin
  result = StartSupportDataExport(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::MarketplaceCommerceAnalytics::Errors::ServiceError => e
