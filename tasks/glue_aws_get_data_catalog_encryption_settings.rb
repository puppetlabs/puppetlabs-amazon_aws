...
def GetDataCatalogEncryptionSettings(*args)
  puts "Calling task operation GetDataCatalogEncryptionSettings" 
  ...
  client = Aws::Glue::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.get_data_catalog_encryption_settings(call_hash)
  end
...
begin
  result = GetDataCatalogEncryptionSettings(params)
