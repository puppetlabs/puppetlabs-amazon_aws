...
def DeleteInterconnect(*args)
  puts "Calling task operation DeleteInterconnect" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_interconnect(call_hash)
  end
...
begin
  result = DeleteInterconnect(params)
