...
def DescribePrefixLists(*args)
  puts "Calling task operation DescribePrefixLists" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_prefix_lists(call_hash)
  end
...
begin
  result = DescribePrefixLists(params)
