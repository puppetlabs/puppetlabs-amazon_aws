...
def DeleteDirectConnectGatewayAssociation(*args)
  puts "Calling task operation DeleteDirectConnectGatewayAssociation" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_direct_connect_gateway_association(call_hash)
  end
...
begin
  result = DeleteDirectConnectGatewayAssociation(params)
