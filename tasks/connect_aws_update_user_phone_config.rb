...
def UpdateUserPhoneConfig(*args)
  puts "Calling task operation UpdateUserPhoneConfig" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_user_phone_config(call_hash)
  end
...
begin
  result = UpdateUserPhoneConfig(params)
