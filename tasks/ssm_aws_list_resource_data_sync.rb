...
def ListResourceDataSync(*args)
  puts "Calling task operation ListResourceDataSync" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_resource_data_sync(call_hash)
  end
...
begin
  result = ListResourceDataSync(params)
