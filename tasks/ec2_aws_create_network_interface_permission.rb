...
def CreateNetworkInterfacePermission(*args)
  puts "Calling task operation CreateNetworkInterfacePermission" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_network_interface_permission(call_hash)
  end
...
begin
  result = CreateNetworkInterfacePermission(params)
