...
def DescribeSMBFileShares(*args)
  puts "Calling task operation DescribeSMBFileShares" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_smb_file_shares(call_hash)
  end
...
begin
  result = DescribeSMBFileShares(params)
