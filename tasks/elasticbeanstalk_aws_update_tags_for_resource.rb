...
def UpdateTagsForResource(*args)
  puts "Calling task operation UpdateTagsForResource" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_tags_for_resource(call_hash)
  end
...
begin
  result = UpdateTagsForResource(params)
