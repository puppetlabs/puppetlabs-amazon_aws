...
def DescribeInterconnects(*args)
  puts "Calling task operation DescribeInterconnects" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_interconnects(call_hash)
  end
...
begin
  result = DescribeInterconnects(params)
