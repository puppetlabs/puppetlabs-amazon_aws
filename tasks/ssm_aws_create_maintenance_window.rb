...
def CreateMaintenanceWindow(*args)
  puts "Calling task operation CreateMaintenanceWindow" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_maintenance_window(call_hash)
  end
...
begin
  result = CreateMaintenanceWindow(params)
