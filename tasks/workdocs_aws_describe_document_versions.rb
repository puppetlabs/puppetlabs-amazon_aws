...
def DescribeDocumentVersions(*args)
  puts "Calling task operation DescribeDocumentVersions" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_document_versions(call_hash)
  end
...
begin
  result = DescribeDocumentVersions(params)
