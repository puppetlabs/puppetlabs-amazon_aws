...
def DescribeVpcEndpointServices(*args)
  puts "Calling task operation DescribeVpcEndpointServices" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_vpc_endpoint_services(call_hash)
  end
...
begin
  result = DescribeVpcEndpointServices(params)
