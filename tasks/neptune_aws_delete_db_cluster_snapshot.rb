...
def DeleteDBClusterSnapshot(*args)
  puts "Calling task operation DeleteDBClusterSnapshot" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_db_cluster_snapshot(call_hash)
  end
...
begin
  result = DeleteDBClusterSnapshot(params)
