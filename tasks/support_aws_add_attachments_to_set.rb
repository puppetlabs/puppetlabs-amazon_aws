...
def AddAttachmentsToSet(*args)
  puts "Calling task operation AddAttachmentsToSet" 
  ...
  if arg_hash.empty?
    ...
    response = client.add_attachments_to_set(call_hash)
  end
...
begin
  result = AddAttachmentsToSet(params)
