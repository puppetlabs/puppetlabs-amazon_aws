...
def AddThingToThingGroup(*args)
  puts "Calling task operation AddThingToThingGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.add_thing_to_thing_group(call_hash)
  end
...
begin
  result = AddThingToThingGroup(params)
