...
def DescribeCacheParameters(*args)
  puts "Calling task operation DescribeCacheParameters" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_cache_parameters(call_hash)
  end
...
begin
  result = DescribeCacheParameters(params)
