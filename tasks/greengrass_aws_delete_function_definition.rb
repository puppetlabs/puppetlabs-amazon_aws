...
def DeleteFunctionDefinition(*args)
  puts "Calling task operation DeleteFunctionDefinition" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_function_definition(call_hash)
  end
...
begin
  result = DeleteFunctionDefinition(params)
