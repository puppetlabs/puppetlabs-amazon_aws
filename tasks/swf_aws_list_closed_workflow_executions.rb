...
def ListClosedWorkflowExecutions(*args)
  puts "Calling task operation ListClosedWorkflowExecutions" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_closed_workflow_executions(call_hash)
  end
...
begin
  result = ListClosedWorkflowExecutions(params)
