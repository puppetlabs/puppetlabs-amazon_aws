...
def CreateAssessmentTemplate(*args)
  puts "Calling task operation CreateAssessmentTemplate" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_assessment_template(call_hash)
  end
...
begin
  result = CreateAssessmentTemplate(params)
