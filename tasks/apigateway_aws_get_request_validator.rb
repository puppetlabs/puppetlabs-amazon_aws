...
def GetRequestValidator(*args)
  puts "Calling task operation GetRequestValidator" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_request_validator(call_hash)
  end
...
begin
  result = GetRequestValidator(params)
