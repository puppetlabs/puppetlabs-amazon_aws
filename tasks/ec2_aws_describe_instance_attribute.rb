...
def DescribeInstanceAttribute(*args)
  puts "Calling task operation DescribeInstanceAttribute" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_instance_attribute(call_hash)
  end
...
begin
  result = DescribeInstanceAttribute(params)
