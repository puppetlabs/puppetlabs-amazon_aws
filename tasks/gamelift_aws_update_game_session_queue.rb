...
def UpdateGameSessionQueue(*args)
  puts "Calling task operation UpdateGameSessionQueue" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_game_session_queue(call_hash)
  end
...
begin
  result = UpdateGameSessionQueue(params)
