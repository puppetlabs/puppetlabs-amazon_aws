...
def DeleteBaiduChannel(*args)
  puts "Calling task operation DeleteBaiduChannel" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_baidu_channel(call_hash)
  end
...
begin
  result = DeleteBaiduChannel(params)
