...
def DescribeRulesPackages(*args)
  puts "Calling task operation DescribeRulesPackages" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_rules_packages(call_hash)
  end
...
begin
  result = DescribeRulesPackages(params)
