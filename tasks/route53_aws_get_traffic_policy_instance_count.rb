...
def GetTrafficPolicyInstanceCount(*args)
  puts "Calling task operation GetTrafficPolicyInstanceCount" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_traffic_policy_instance_count(call_hash)
  end
...
begin
  result = GetTrafficPolicyInstanceCount(params)
