...
def CreateCacheCluster(*args)
  puts "Calling task operation CreateCacheCluster" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_cache_cluster(call_hash)
  end
...
begin
  result = CreateCacheCluster(params)
