...
def DescribeLoadBalancerPolicyTypes(*args)
  puts "Calling task operation DescribeLoadBalancerPolicyTypes" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_load_balancer_policy_types(call_hash)
  end
...
begin
  result = DescribeLoadBalancerPolicyTypes(params)
