...
def DeleteServiceLinkedRole(*args)
  puts "Calling task operation DeleteServiceLinkedRole" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_service_linked_role(call_hash)
  end
...
begin
  result = DeleteServiceLinkedRole(params)
