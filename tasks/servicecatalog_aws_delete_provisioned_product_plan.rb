...
def DeleteProvisionedProductPlan(*args)
  puts "Calling task operation DeleteProvisionedProductPlan" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_provisioned_product_plan(call_hash)
  end
...
begin
  result = DeleteProvisionedProductPlan(params)
