...
def DescribeConnectionLoa(*args)
  puts "Calling task operation DescribeConnectionLoa" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_connection_loa(call_hash)
  end
...
begin
  result = DescribeConnectionLoa(params)
