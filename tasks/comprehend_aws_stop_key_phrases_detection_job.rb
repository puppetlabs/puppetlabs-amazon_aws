...
def StopKeyPhrasesDetectionJob(*args)
  puts "Calling task operation StopKeyPhrasesDetectionJob" 
  ...
  if arg_hash.empty?
    ...
    response = client.stop_key_phrases_detection_job(call_hash)
  end
...
begin
  result = StopKeyPhrasesDetectionJob(params)
