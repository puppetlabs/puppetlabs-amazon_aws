...
def DescribeRouteTables(*args)
  puts "Calling task operation DescribeRouteTables" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_route_tables(call_hash)
  end
...
begin
  result = DescribeRouteTables(params)
