...
def ListBucketMetricsConfigurations(*args)
  puts "Calling task operation ListBucketMetricsConfigurations" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_bucket_metrics_configurations(call_hash)
  end
...
begin
  result = ListBucketMetricsConfigurations(params)
