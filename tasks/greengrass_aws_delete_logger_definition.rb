...
def DeleteLoggerDefinition(*args)
  puts "Calling task operation DeleteLoggerDefinition" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_logger_definition(call_hash)
  end
...
begin
  result = DeleteLoggerDefinition(params)
