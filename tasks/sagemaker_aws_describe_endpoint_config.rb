...
def DescribeEndpointConfig(*args)
  puts "Calling task operation DescribeEndpointConfig" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_endpoint_config(call_hash)
  end
...
begin
  result = DescribeEndpointConfig(params)
