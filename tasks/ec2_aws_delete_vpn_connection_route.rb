...
def DeleteVpnConnectionRoute(*args)
  puts "Calling task operation DeleteVpnConnectionRoute" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_vpn_connection_route(call_hash)
  end
...
begin
  result = DeleteVpnConnectionRoute(params)
