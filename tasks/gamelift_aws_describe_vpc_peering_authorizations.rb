...
def DescribeVpcPeeringAuthorizations(*args)
  puts "Calling task operation DescribeVpcPeeringAuthorizations" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_vpc_peering_authorizations(call_hash)
  end
...
begin
  result = DescribeVpcPeeringAuthorizations(params)
