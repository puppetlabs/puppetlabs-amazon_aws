...
def operation_with_hash(arg_hash)
  ...
  client.delete_distribution2018_11_05(call_hash)
end

def delete_distribution2018_11_05(*args)
  argstring = args[0]
  argstring.delete('\\')
  ...
  client = Aws::CloudFront::Client.new(region: region)
  response = client.delete_distribution2018_11_05 if arg_hash.empty?
...
def task
  ...
  params = STDIN.read
  result = delete_distribution2018_11_05(params)
