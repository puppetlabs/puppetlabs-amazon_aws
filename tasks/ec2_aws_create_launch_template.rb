...
def CreateLaunchTemplate(*args)
  puts "Calling task operation CreateLaunchTemplate" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_launch_template(call_hash)
  end
...
begin
  result = CreateLaunchTemplate(params)
