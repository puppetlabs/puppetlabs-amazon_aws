...
def ModifyVpcAttribute(*args)
  puts "Calling task operation ModifyVpcAttribute" 
  ...
  if arg_hash.empty?
    ...
    response = client.modify_vpc_attribute(call_hash)
  end
...
begin
  result = ModifyVpcAttribute(params)
