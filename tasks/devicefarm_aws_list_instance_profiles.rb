...
def ListInstanceProfiles(*args)
  puts "Calling task operation ListInstanceProfiles" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_instance_profiles(call_hash)
  end
...
begin
  result = ListInstanceProfiles(params)
