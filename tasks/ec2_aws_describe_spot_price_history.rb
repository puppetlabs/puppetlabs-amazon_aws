...
def DescribeSpotPriceHistory(*args)
  puts "Calling task operation DescribeSpotPriceHistory" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_spot_price_history(call_hash)
  end
...
begin
  result = DescribeSpotPriceHistory(params)
