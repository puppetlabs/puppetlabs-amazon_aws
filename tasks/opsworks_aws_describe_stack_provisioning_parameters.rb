...
def DescribeStackProvisioningParameters(*args)
  puts "Calling task operation DescribeStackProvisioningParameters" 
  ...
  client = Aws::OpsWorks::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.describe_stack_provisioning_parameters(call_hash)
  end
...
begin
  result = DescribeStackProvisioningParameters(params)
