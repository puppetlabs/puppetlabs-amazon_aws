...
def DescribeWorkflowType(*args)
  puts "Calling task operation DescribeWorkflowType" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_workflow_type(call_hash)
  end
...
begin
  result = DescribeWorkflowType(params)
