...
def ListResourceDefinitions(*args)
  puts "Calling task operation ListResourceDefinitions" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_resource_definitions(call_hash)
  end
...
begin
  result = ListResourceDefinitions(params)
