...
def GetLaunchTemplateData(*args)
  puts "Calling task operation GetLaunchTemplateData" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_launch_template_data(call_hash)
  end
...
begin
  result = GetLaunchTemplateData(params)
