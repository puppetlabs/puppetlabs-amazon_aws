...
def ListEndpointsByPlatformApplication(*args)
  puts "Calling task operation ListEndpointsByPlatformApplication" 
  ...
  client = Aws::SNS::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.list_endpoints_by_platform_application(call_hash)
  end
...
begin
  result = ListEndpointsByPlatformApplication(params)
