...
def DescribeConfigurationAggregators(*args)
  puts "Calling task operation DescribeConfigurationAggregators" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_configuration_aggregators(call_hash)
  end
...
begin
  result = DescribeConfigurationAggregators(params)
