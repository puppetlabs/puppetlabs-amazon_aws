...
def GetMaintenanceWindowExecution(*args)
  puts "Calling task operation GetMaintenanceWindowExecution" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_maintenance_window_execution(call_hash)
  end
...
begin
  result = GetMaintenanceWindowExecution(params)
