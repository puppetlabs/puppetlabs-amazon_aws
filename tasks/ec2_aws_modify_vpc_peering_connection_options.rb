...
def ModifyVpcPeeringConnectionOptions(*args)
  puts "Calling task operation ModifyVpcPeeringConnectionOptions" 
  ...
  if arg_hash.empty?
    ...
    response = client.modify_vpc_peering_connection_options(call_hash)
  end
...
begin
  result = ModifyVpcPeeringConnectionOptions(params)
