...
def DescribeConversionTasks(*args)
  puts "Calling task operation DescribeConversionTasks" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_conversion_tasks(call_hash)
  end
...
begin
  result = DescribeConversionTasks(params)
