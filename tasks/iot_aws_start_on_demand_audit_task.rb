...
def StartOnDemandAuditTask(*args)
  puts "Calling task operation StartOnDemandAuditTask" 
  ...
  if arg_hash.empty?
    ...
    response = client.start_on_demand_audit_task(call_hash)
  end
...
begin
  result = StartOnDemandAuditTask(params)
