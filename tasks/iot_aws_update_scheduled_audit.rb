...
def UpdateScheduledAudit(*args)
  puts "Calling task operation UpdateScheduledAudit" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_scheduled_audit(call_hash)
  end
...
begin
  result = UpdateScheduledAudit(params)
