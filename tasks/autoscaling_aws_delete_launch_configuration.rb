...
def DeleteLaunchConfiguration(*args)
  puts "Calling task operation DeleteLaunchConfiguration" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_launch_configuration(call_hash)
  end
...
begin
  result = DeleteLaunchConfiguration(params)
