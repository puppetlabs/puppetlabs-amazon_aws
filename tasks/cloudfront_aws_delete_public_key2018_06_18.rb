...
def DeletePublicKey2018_06_18(*args)
  puts "Calling task operation DeletePublicKey2018_06_18" 
  ...
  if arg_hash.empty?
    response = client.delete_public_key2018_06_18()
  else 
    call_hash={}
    ...
    response = client.delete_public_key2018_06_18(call_hash)
  end
...
begin
  result = DeletePublicKey2018_06_18(params)
