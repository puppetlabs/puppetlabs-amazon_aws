...
def TerminateWorkflowExecution(*args)
  puts "Calling task operation TerminateWorkflowExecution" 
  ...
  if arg_hash.empty?
    ...
    response = client.terminate_workflow_execution(call_hash)
  end
...
begin
  result = TerminateWorkflowExecution(params)
