...
def DeleteRealtimeEndpoint(*args)
  puts "Calling task operation DeleteRealtimeEndpoint" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_realtime_endpoint(call_hash)
  end
...
begin
  result = DeleteRealtimeEndpoint(params)
