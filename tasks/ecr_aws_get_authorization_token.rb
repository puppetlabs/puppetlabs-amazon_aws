...
def GetAuthorizationToken(*args)
  puts "Calling task operation GetAuthorizationToken" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_authorization_token(call_hash)
  end
...
begin
  result = GetAuthorizationToken(params)
