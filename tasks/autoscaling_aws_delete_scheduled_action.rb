...
def DeleteScheduledAction(*args)
  puts "Calling task operation DeleteScheduledAction" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_scheduled_action(call_hash)
  end
...
begin
  result = DeleteScheduledAction(params)
