...
def RemoveSourceIdentifierFromSubscription(*args)
  puts "Calling task operation RemoveSourceIdentifierFromSubscription" 
  ...
  if arg_hash.empty?
    ...
    response = client.remove_source_identifier_from_subscription(call_hash)
  end
...
begin
  result = RemoveSourceIdentifierFromSubscription(params)
