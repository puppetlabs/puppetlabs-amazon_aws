...
def ListHyperParameterTuningJobs(*args)
  puts "Calling task operation ListHyperParameterTuningJobs" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_hyper_parameter_tuning_jobs(call_hash)
  end
...
begin
  result = ListHyperParameterTuningJobs(params)
