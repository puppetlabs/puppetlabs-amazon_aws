...
def DescribeDataSources(*args)
  puts "Calling task operation DescribeDataSources" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_data_sources(call_hash)
  end
...
begin
  result = DescribeDataSources(params)
