...
def CreateGroupCertificateAuthority(*args)
  puts "Calling task operation CreateGroupCertificateAuthority" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_group_certificate_authority(call_hash)
  end
...
begin
  result = CreateGroupCertificateAuthority(params)
