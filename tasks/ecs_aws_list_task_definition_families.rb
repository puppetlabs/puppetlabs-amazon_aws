...
def ListTaskDefinitionFamilies(*args)
  puts "Calling task operation ListTaskDefinitionFamilies" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_task_definition_families(call_hash)
  end
...
begin
  result = ListTaskDefinitionFamilies(params)
