...
def DescribeTimeBasedAutoScaling(*args)
  puts "Calling task operation DescribeTimeBasedAutoScaling" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_time_based_auto_scaling(call_hash)
  end
...
begin
  result = DescribeTimeBasedAutoScaling(params)
