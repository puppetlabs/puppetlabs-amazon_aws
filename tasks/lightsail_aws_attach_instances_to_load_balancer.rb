...
def AttachInstancesToLoadBalancer(*args)
  puts "Calling task operation AttachInstancesToLoadBalancer" 
  ...
  if arg_hash.empty?
    ...
    response = client.attach_instances_to_load_balancer(call_hash)
  end
...
begin
  result = AttachInstancesToLoadBalancer(params)
