...
def DescribeVTLDevices(*args)
  puts "Calling task operation DescribeVTLDevices" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_vtl_devices(call_hash)
  end
...
begin
  result = DescribeVTLDevices(params)
