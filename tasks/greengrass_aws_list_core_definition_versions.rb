...
def ListCoreDefinitionVersions(*args)
  puts "Calling task operation ListCoreDefinitionVersions" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_core_definition_versions(call_hash)
  end
...
begin
  result = ListCoreDefinitionVersions(params)
