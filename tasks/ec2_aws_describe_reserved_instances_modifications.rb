...
def DescribeReservedInstancesModifications(*args)
  puts "Calling task operation DescribeReservedInstancesModifications" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_reserved_instances_modifications(call_hash)
  end
...
begin
  result = DescribeReservedInstancesModifications(params)
