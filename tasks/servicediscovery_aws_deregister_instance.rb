...
def DeregisterInstance(*args)
  puts "Calling task operation DeregisterInstance" 
  ...
  if arg_hash.empty?
    ...
    response = client.deregister_instance(call_hash)
  end
...
begin
  result = DeregisterInstance(params)
