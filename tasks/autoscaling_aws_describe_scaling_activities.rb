...
def DescribeScalingActivities(*args)
  puts "Calling task operation DescribeScalingActivities" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_scaling_activities(call_hash)
  end
...
begin
  result = DescribeScalingActivities(params)
