...
def CreateVpcPeeringAuthorization(*args)
  puts "Calling task operation CreateVpcPeeringAuthorization" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_vpc_peering_authorization(call_hash)
  end
...
begin
  result = CreateVpcPeeringAuthorization(params)
