...
def DescribeConstraint(*args)
  puts "Calling task operation DescribeConstraint" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_constraint(call_hash)
  end
...
begin
  result = DescribeConstraint(params)
