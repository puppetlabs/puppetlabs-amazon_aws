...
def CreateMatchmakingConfiguration(*args)
  puts "Calling task operation CreateMatchmakingConfiguration" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_matchmaking_configuration(call_hash)
  end
...
begin
  result = CreateMatchmakingConfiguration(params)
