...
def RemoveAccountFromOrganization(*args)
  puts "Calling task operation RemoveAccountFromOrganization" 
  ...
  if arg_hash.empty?
    ...
    response = client.remove_account_from_organization(call_hash)
  end
...
begin
  result = RemoveAccountFromOrganization(params)
