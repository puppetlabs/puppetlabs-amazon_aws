...
def ListOnPremisesInstances(*args)
  puts "Calling task operation ListOnPremisesInstances" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_on_premises_instances(call_hash)
  end
...
begin
  result = ListOnPremisesInstances(params)
