...
def DescribeWorkspaceBundles(*args)
  puts "Calling task operation DescribeWorkspaceBundles" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_workspace_bundles(call_hash)
  end
...
begin
  result = DescribeWorkspaceBundles(params)
