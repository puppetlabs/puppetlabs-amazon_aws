...
def ModifyWorkspaceProperties(*args)
  puts "Calling task operation ModifyWorkspaceProperties" 
  ...
  if arg_hash.empty?
    ...
    response = client.modify_workspace_properties(call_hash)
  end
...
begin
  result = ModifyWorkspaceProperties(params)
