...
def DeleteVPCAssociationAuthorization(*args)
  puts "Calling task operation DeleteVPCAssociationAuthorization" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_vpc_association_authorization(call_hash)
  end
...
begin
  result = DeleteVPCAssociationAuthorization(params)
