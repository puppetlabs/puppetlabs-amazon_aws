...
def DeleteRateBasedRule(*args)
  puts "Calling task operation DeleteRateBasedRule" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_rate_based_rule(call_hash)
  end
...
begin
  result = DeleteRateBasedRule(params)
