...
def CreateUsagePlanKey(*args)
  puts "Calling task operation CreateUsagePlanKey" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_usage_plan_key(call_hash)
  end
...
begin
  result = CreateUsagePlanKey(params)
