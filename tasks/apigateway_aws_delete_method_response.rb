...
def DeleteMethodResponse(*args)
  puts "Calling task operation DeleteMethodResponse" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_method_response(call_hash)
  end
...
begin
  result = DeleteMethodResponse(params)
