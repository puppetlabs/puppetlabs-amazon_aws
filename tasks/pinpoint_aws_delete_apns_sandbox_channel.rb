...
def DeleteApnsSandboxChannel(*args)
  puts "Calling task operation DeleteApnsSandboxChannel" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_apns_sandbox_channel(call_hash)
  end
...
begin
  result = DeleteApnsSandboxChannel(params)
