...
def ChangeResourceRecordSets(*args)
  puts "Calling task operation ChangeResourceRecordSets" 
  ...
  if arg_hash.empty?
    ...
    response = client.change_resource_record_sets(call_hash)
  end
...
begin
  result = ChangeResourceRecordSets(params)
