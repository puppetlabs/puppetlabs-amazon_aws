...
def ListJobExecutionsForThing(*args)
  puts "Calling task operation ListJobExecutionsForThing" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_job_executions_for_thing(call_hash)
  end
...
begin
  result = ListJobExecutionsForThing(params)
