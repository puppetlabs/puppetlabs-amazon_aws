...
def DeleteChapCredentials(*args)
  puts "Calling task operation DeleteChapCredentials" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_chap_credentials(call_hash)
  end
...
begin
  result = DeleteChapCredentials(params)
