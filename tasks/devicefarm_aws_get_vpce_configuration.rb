...
def GetVPCEConfiguration(*args)
  puts "Calling task operation GetVPCEConfiguration" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_vpce_configuration(call_hash)
  end
...
begin
  result = GetVPCEConfiguration(params)
