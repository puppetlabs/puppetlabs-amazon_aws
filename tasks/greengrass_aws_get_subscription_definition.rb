...
def GetSubscriptionDefinition(*args)
  puts "Calling task operation GetSubscriptionDefinition" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_subscription_definition(call_hash)
  end
...
begin
  result = GetSubscriptionDefinition(params)
