...
def StartTranscriptionJob(*args)
  puts "Calling task operation StartTranscriptionJob" 
  ...
  if arg_hash.empty?
    ...
    response = client.start_transcription_job(call_hash)
  end
...
begin
  result = StartTranscriptionJob(params)
