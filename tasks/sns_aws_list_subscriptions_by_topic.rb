...
def ListSubscriptionsByTopic(*args)
  puts "Calling task operation ListSubscriptionsByTopic" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_subscriptions_by_topic(call_hash)
  end
...
begin
  result = ListSubscriptionsByTopic(params)
