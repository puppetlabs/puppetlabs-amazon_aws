...
def operation_with_hash(arg_hash)
  ...
  client.list_subscriptions_by_topic(call_hash)
end

def list_subscriptions_by_topic(*args)
  argstring = args[0]
  argstring.delete('\\')
  ...
  client = Aws::SNS::Client.new(region: region)
  response = client.list_subscriptions_by_topic if arg_hash.empty?
...
def task
  ...
  params = STDIN.read
  result = list_subscriptions_by_topic(params)
