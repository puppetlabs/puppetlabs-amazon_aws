...
def UpdateCrawlerSchedule(*args)
  puts "Calling task operation UpdateCrawlerSchedule" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_crawler_schedule(call_hash)
  end
...
begin
  result = UpdateCrawlerSchedule(params)
