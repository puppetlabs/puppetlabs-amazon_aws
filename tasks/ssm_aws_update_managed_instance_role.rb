...
def UpdateManagedInstanceRole(*args)
  puts "Calling task operation UpdateManagedInstanceRole" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_managed_instance_role(call_hash)
  end
...
begin
  result = UpdateManagedInstanceRole(params)
