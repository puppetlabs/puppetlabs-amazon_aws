...
def ListAppliedSchemaArns(*args)
  puts "Calling task operation ListAppliedSchemaArns" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_applied_schema_arns(call_hash)
  end
...
begin
  result = ListAppliedSchemaArns(params)
