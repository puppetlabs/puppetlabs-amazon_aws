...
def DeleteAutoScalingGroup(*args)
  puts "Calling task operation DeleteAutoScalingGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_auto_scaling_group(call_hash)
  end
...
begin
  result = DeleteAutoScalingGroup(params)
