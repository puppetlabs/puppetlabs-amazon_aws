...
def DeleteSqlInjectionMatchSet(*args)
  puts "Calling task operation DeleteSqlInjectionMatchSet" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_sql_injection_match_set(call_hash)
  end
...
begin
  result = DeleteSqlInjectionMatchSet(params)
