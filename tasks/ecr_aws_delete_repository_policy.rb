...
def DeleteRepositoryPolicy(*args)
  puts "Calling task operation DeleteRepositoryPolicy" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_repository_policy(call_hash)
  end
...
begin
  result = DeleteRepositoryPolicy(params)
