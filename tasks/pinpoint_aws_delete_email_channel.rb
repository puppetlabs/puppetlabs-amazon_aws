...
def DeleteEmailChannel(*args)
  puts "Calling task operation DeleteEmailChannel" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_email_channel(call_hash)
  end
...
begin
  result = DeleteEmailChannel(params)
