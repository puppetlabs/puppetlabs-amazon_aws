...
def CreateSamplingRule(*args)
  puts "Calling task operation CreateSamplingRule" 
  ...
  client = Aws::XRay::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.create_sampling_rule(call_hash)
  end
...
begin
  result = CreateSamplingRule(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::XRay::Errors::ServiceError => e
