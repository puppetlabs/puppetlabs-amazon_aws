...
def DeleteBucketInventoryConfiguration(*args)
  puts "Calling task operation DeleteBucketInventoryConfiguration" 
  ...
  client = Aws::S3::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.delete_bucket_inventory_configuration(call_hash)
  end
...
begin
  result = DeleteBucketInventoryConfiguration(params)
