...
def DescribeInstancePatchStates(*args)
  puts "Calling task operation DescribeInstancePatchStates" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_instance_patch_states(call_hash)
  end
...
begin
  result = DescribeInstancePatchStates(params)
