...
def DescribeVpnConnections(*args)
  puts "Calling task operation DescribeVpnConnections" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_vpn_connections(call_hash)
  end
...
begin
  result = DescribeVpnConnections(params)
