...
def UpdateMatchmakingConfiguration(*args)
  puts "Calling task operation UpdateMatchmakingConfiguration" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_matchmaking_configuration(call_hash)
  end
...
begin
  result = UpdateMatchmakingConfiguration(params)
