...
def GetBasePathMapping(*args)
  puts "Calling task operation GetBasePathMapping" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_base_path_mapping(call_hash)
  end
...
begin
  result = GetBasePathMapping(params)
