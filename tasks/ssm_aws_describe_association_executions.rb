...
def DescribeAssociationExecutions(*args)
  puts "Calling task operation DescribeAssociationExecutions" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_association_executions(call_hash)
  end
...
begin
  result = DescribeAssociationExecutions(params)
