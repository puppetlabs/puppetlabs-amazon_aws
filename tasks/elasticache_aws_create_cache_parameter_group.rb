...
def CreateCacheParameterGroup(*args)
  puts "Calling task operation CreateCacheParameterGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_cache_parameter_group(call_hash)
  end
...
begin
  result = CreateCacheParameterGroup(params)
