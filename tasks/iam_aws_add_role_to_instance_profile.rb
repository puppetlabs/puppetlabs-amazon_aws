...
def AddRoleToInstanceProfile(*args)
  puts "Calling task operation AddRoleToInstanceProfile" 
  ...
  if arg_hash.empty?
    ...
    response = client.add_role_to_instance_profile(call_hash)
  end
...
begin
  result = AddRoleToInstanceProfile(params)
