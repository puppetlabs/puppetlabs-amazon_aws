...
def DescribeEcsClusters(*args)
  puts "Calling task operation DescribeEcsClusters" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_ecs_clusters(call_hash)
  end
...
begin
  result = DescribeEcsClusters(params)
