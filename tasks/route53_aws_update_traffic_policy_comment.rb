...
def UpdateTrafficPolicyComment(*args)
  puts "Calling task operation UpdateTrafficPolicyComment" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_traffic_policy_comment(call_hash)
  end
...
begin
  result = UpdateTrafficPolicyComment(params)
