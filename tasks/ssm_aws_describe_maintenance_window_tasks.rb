...
def DescribeMaintenanceWindowTasks(*args)
  puts "Calling task operation DescribeMaintenanceWindowTasks" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_maintenance_window_tasks(call_hash)
  end
...
begin
  result = DescribeMaintenanceWindowTasks(params)
