...
def ListBucketInventoryConfigurations(*args)
  puts "Calling task operation ListBucketInventoryConfigurations" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_bucket_inventory_configurations(call_hash)
  end
...
begin
  result = ListBucketInventoryConfigurations(params)
