...
def GetFieldLevelEncryption2018_06_18(*args)
  puts "Calling task operation GetFieldLevelEncryption2018_06_18" 
  ...
  if arg_hash.empty?
    response = client.get_field_level_encryption2018_06_18()
  else 
    call_hash={}
    ...
    response = client.get_field_level_encryption2018_06_18(call_hash)
  end
...
begin
  result = GetFieldLevelEncryption2018_06_18(params)
