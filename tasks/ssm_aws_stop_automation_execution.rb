...
def StopAutomationExecution(*args)
  puts "Calling task operation StopAutomationExecution" 
  ...
  if arg_hash.empty?
    ...
    response = client.stop_automation_execution(call_hash)
  end
...
begin
  result = StopAutomationExecution(params)
