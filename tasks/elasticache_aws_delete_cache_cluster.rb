...
def DeleteCacheCluster(*args)
  puts "Calling task operation DeleteCacheCluster" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_cache_cluster(call_hash)
  end
...
begin
  result = DeleteCacheCluster(params)
