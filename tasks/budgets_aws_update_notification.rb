...
def UpdateNotification(*args)
  puts "Calling task operation UpdateNotification" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_notification(call_hash)
  end
...
begin
  result = UpdateNotification(params)
