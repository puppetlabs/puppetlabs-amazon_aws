...
def ListAvailableSolutionStacks(*args)
  puts "Calling task operation ListAvailableSolutionStacks" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_available_solution_stacks(call_hash)
  end
...
begin
  result = ListAvailableSolutionStacks(params)
