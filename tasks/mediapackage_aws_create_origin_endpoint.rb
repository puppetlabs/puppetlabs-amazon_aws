...
def CreateOriginEndpoint(*args)
  puts "Calling task operation CreateOriginEndpoint" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_origin_endpoint(call_hash)
  end
...
begin
  result = CreateOriginEndpoint(params)
