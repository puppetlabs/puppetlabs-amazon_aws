...
def DescribeReservedNodeOfferings(*args)
  puts "Calling task operation DescribeReservedNodeOfferings" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_reserved_node_offerings(call_hash)
  end
...
begin
  result = DescribeReservedNodeOfferings(params)
