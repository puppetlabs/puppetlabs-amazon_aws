...
def GetBucketEncryption(*args)
  puts "Calling task operation GetBucketEncryption" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_bucket_encryption(call_hash)
  end
...
begin
  result = GetBucketEncryption(params)
