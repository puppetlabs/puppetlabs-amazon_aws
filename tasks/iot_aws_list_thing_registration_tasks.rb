...
def ListThingRegistrationTasks(*args)
  puts "Calling task operation ListThingRegistrationTasks" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_thing_registration_tasks(call_hash)
  end
...
begin
  result = ListThingRegistrationTasks(params)
