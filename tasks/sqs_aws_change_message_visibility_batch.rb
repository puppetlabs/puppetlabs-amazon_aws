...
def ChangeMessageVisibilityBatch(*args)
  puts "Calling task operation ChangeMessageVisibilityBatch" 
  ...
  client = Aws::SQS::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.change_message_visibility_batch(call_hash)
  end
...
begin
  result = ChangeMessageVisibilityBatch(params)
