...
def DescribeTapeRecoveryPoints(*args)
  puts "Calling task operation DescribeTapeRecoveryPoints" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_tape_recovery_points(call_hash)
  end
...
begin
  result = DescribeTapeRecoveryPoints(params)
