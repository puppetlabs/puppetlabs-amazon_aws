...
def DescribeNotebookInstance(*args)
  puts "Calling task operation DescribeNotebookInstance" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_notebook_instance(call_hash)
  end
...
begin
  result = DescribeNotebookInstance(params)
