...
def AddApplicationOutput(*args)
  puts "Calling task operation AddApplicationOutput" 
  ...
  if arg_hash.empty?
    ...
    response = client.add_application_output(call_hash)
  end
...
begin
  result = AddApplicationOutput(params)
