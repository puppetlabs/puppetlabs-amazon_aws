...
def CreateDBParameterGroup(*args)
  puts "Calling task operation CreateDBParameterGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_db_parameter_group(call_hash)
  end
...
begin
  result = CreateDBParameterGroup(params)
