...
def DeregisterOnPremisesInstance(*args)
  puts "Calling task operation DeregisterOnPremisesInstance" 
  ...
  if arg_hash.empty?
    ...
    response = client.deregister_on_premises_instance(call_hash)
  end
...
begin
  result = DeregisterOnPremisesInstance(params)
