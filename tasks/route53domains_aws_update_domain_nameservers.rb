...
def UpdateDomainNameservers(*args)
  puts "Calling task operation UpdateDomainNameservers" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_domain_nameservers(call_hash)
  end
...
begin
  result = UpdateDomainNameservers(params)
