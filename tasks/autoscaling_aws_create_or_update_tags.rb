...
def CreateOrUpdateTags(*args)
  puts "Calling task operation CreateOrUpdateTags" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_or_update_tags(call_hash)
  end
...
begin
  result = CreateOrUpdateTags(params)
