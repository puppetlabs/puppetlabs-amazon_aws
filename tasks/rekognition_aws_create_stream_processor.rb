...
def CreateStreamProcessor(*args)
  puts "Calling task operation CreateStreamProcessor" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_stream_processor(call_hash)
  end
...
begin
  result = CreateStreamProcessor(params)
