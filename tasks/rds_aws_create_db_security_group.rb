...
def CreateDBSecurityGroup(*args)
  puts "Calling task operation CreateDBSecurityGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_db_security_group(call_hash)
  end
...
begin
  result = CreateDBSecurityGroup(params)
