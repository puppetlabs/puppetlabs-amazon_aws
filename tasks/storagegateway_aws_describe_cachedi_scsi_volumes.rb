...
def DescribeCachediSCSIVolumes(*args)
  puts "Calling task operation DescribeCachediSCSIVolumes" 
  ...
  if arg_hash.empty?
    response = client.describe_cachedi_scsi_volumes()
  else 
    call_hash={}
    ...
    response = client.describe_cachedi_scsi_volumes(call_hash)
  end
...
begin
  result = DescribeCachediSCSIVolumes(params)
