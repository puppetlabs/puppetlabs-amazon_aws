...
def CreateNetworkAclEntry(*args)
  puts "Calling task operation CreateNetworkAclEntry" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_network_acl_entry(call_hash)
  end
...
begin
  result = CreateNetworkAclEntry(params)
