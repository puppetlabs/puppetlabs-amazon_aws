...
def GetApnsVoipSandboxChannel(*args)
  puts "Calling task operation GetApnsVoipSandboxChannel" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_apns_voip_sandbox_channel(call_hash)
  end
...
begin
  result = GetApnsVoipSandboxChannel(params)
