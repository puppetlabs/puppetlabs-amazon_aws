...
def DescribeConfigurationRecorders(*args)
  puts "Calling task operation DescribeConfigurationRecorders" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_configuration_recorders(call_hash)
  end
...
begin
  result = DescribeConfigurationRecorders(params)
