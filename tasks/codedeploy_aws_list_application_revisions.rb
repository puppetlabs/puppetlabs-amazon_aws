...
def ListApplicationRevisions(*args)
  puts "Calling task operation ListApplicationRevisions" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_application_revisions(call_hash)
  end
...
begin
  result = ListApplicationRevisions(params)
