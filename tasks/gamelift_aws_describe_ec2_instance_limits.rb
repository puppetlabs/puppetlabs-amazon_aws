...
def DescribeEC2InstanceLimits(*args)
  puts "Calling task operation DescribeEC2InstanceLimits" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_ec2_instance_limits(call_hash)
  end
...
begin
  result = DescribeEC2InstanceLimits(params)
