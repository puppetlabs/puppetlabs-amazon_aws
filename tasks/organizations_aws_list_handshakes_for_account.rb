...
def ListHandshakesForAccount(*args)
  puts "Calling task operation ListHandshakesForAccount" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_handshakes_for_account(call_hash)
  end
...
begin
  result = ListHandshakesForAccount(params)
