...
def CreateOrganizationalUnit(*args)
  puts "Calling task operation CreateOrganizationalUnit" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_organizational_unit(call_hash)
  end
...
begin
  result = CreateOrganizationalUnit(params)
