...
def DeleteUserEndpoints(*args)
  puts "Calling task operation DeleteUserEndpoints" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_user_endpoints(call_hash)
  end
...
begin
  result = DeleteUserEndpoints(params)
