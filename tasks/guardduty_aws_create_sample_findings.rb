...
def CreateSampleFindings(*args)
  puts "Calling task operation CreateSampleFindings" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_sample_findings(call_hash)
  end
...
begin
  result = CreateSampleFindings(params)
