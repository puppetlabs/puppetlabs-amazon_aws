...
def GetHealthCheckLastFailureReason(*args)
  puts "Calling task operation GetHealthCheckLastFailureReason" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_health_check_last_failure_reason(call_hash)
  end
...
begin
  result = GetHealthCheckLastFailureReason(params)
