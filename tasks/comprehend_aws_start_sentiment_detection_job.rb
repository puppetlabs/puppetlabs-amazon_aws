...
def StartSentimentDetectionJob(*args)
  puts "Calling task operation StartSentimentDetectionJob" 
  ...
  if arg_hash.empty?
    ...
    response = client.start_sentiment_detection_job(call_hash)
  end
...
begin
  result = StartSentimentDetectionJob(params)
