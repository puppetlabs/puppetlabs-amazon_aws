...
def DescribeTrustedAdvisorCheckSummaries(*args)
  puts "Calling task operation DescribeTrustedAdvisorCheckSummaries" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_trusted_advisor_check_summaries(call_hash)
  end
...
begin
  result = DescribeTrustedAdvisorCheckSummaries(params)
