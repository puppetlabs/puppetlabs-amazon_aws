...
def UpdateAssessmentTarget(*args)
  puts "Calling task operation UpdateAssessmentTarget" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_assessment_target(call_hash)
  end
...
begin
  result = UpdateAssessmentTarget(params)
