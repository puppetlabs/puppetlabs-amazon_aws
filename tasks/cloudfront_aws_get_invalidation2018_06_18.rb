...
def GetInvalidation2018_06_18(*args)
  puts "Calling task operation GetInvalidation2018_06_18" 
  ...
  if arg_hash.empty?
    response = client.get_invalidation2018_06_18()
  else 
    call_hash={}
    ...
    response = client.get_invalidation2018_06_18(call_hash)
  end
...
begin
  result = GetInvalidation2018_06_18(params)
