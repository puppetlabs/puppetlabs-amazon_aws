...
def CreateImageBuilderStreamingURL(*args)
  puts "Calling task operation CreateImageBuilderStreamingURL" 
  ...
  client = Aws::AppStream::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.create_image_builder_streaming_url(call_hash)
  end
...
begin
  result = CreateImageBuilderStreamingURL(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::AppStream::Errors::ServiceError => e
