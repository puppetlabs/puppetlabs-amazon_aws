...
def DescribeVolumeStatus(*args)
  puts "Calling task operation DescribeVolumeStatus" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_volume_status(call_hash)
  end
...
begin
  result = DescribeVolumeStatus(params)
