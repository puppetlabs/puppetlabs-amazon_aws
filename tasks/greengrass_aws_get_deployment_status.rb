...
def GetDeploymentStatus(*args)
  puts "Calling task operation GetDeploymentStatus" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_deployment_status(call_hash)
  end
...
begin
  result = GetDeploymentStatus(params)
