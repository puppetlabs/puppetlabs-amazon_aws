...
def DescribeProvisionedProduct(*args)
  puts "Calling task operation DescribeProvisionedProduct" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_provisioned_product(call_hash)
  end
...
begin
  result = DescribeProvisionedProduct(params)
