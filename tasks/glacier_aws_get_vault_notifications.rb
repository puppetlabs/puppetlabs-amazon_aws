...
def GetVaultNotifications(*args)
  puts "Calling task operation GetVaultNotifications" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_vault_notifications(call_hash)
  end
...
begin
  result = GetVaultNotifications(params)
