...
def ListPipelineExecutions(*args)
  puts "Calling task operation ListPipelineExecutions" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_pipeline_executions(call_hash)
  end
...
begin
  result = ListPipelineExecutions(params)
