...
def CreateInternetGateway(*args)
  puts "Calling task operation CreateInternetGateway" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_internet_gateway(call_hash)
  end
...
begin
  result = CreateInternetGateway(params)
