...
def CreateDeploymentConfig(*args)
  puts "Calling task operation CreateDeploymentConfig" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_deployment_config(call_hash)
  end
...
begin
  result = CreateDeploymentConfig(params)
