...
def CreateMatchmakingRuleSet(*args)
  puts "Calling task operation CreateMatchmakingRuleSet" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_matchmaking_rule_set(call_hash)
  end
...
begin
  result = CreateMatchmakingRuleSet(params)
