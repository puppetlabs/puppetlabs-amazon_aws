...
def GetSegmentImportJobs(*args)
  puts "Calling task operation GetSegmentImportJobs" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_segment_import_jobs(call_hash)
  end
...
begin
  result = GetSegmentImportJobs(params)
