...
def DeleteStateMachine(*args)
  puts "Calling task operation DeleteStateMachine" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_state_machine(call_hash)
  end
...
begin
  result = DeleteStateMachine(params)
