...
def UpdateOrganizationalUnit(*args)
  puts "Calling task operation UpdateOrganizationalUnit" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_organizational_unit(call_hash)
  end
...
begin
  result = UpdateOrganizationalUnit(params)
