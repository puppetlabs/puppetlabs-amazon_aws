...
def ModifyReplicationGroup(*args)
  puts "Calling task operation ModifyReplicationGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.modify_replication_group(call_hash)
  end
...
begin
  result = ModifyReplicationGroup(params)
