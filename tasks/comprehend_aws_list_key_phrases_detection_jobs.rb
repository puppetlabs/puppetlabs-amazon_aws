...
def ListKeyPhrasesDetectionJobs(*args)
  puts "Calling task operation ListKeyPhrasesDetectionJobs" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_key_phrases_detection_jobs(call_hash)
  end
...
begin
  result = ListKeyPhrasesDetectionJobs(params)
