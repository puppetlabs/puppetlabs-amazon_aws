...
def DescribeHostedConnections(*args)
  puts "Calling task operation DescribeHostedConnections" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_hosted_connections(call_hash)
  end
...
begin
  result = DescribeHostedConnections(params)
