...
def UpdateFleetCapacity(*args)
  puts "Calling task operation UpdateFleetCapacity" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_fleet_capacity(call_hash)
  end
...
begin
  result = UpdateFleetCapacity(params)
