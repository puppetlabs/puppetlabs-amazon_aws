...
def CreateSnapshotCopyGrant(*args)
  puts "Calling task operation CreateSnapshotCopyGrant" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_snapshot_copy_grant(call_hash)
  end
...
begin
  result = CreateSnapshotCopyGrant(params)
