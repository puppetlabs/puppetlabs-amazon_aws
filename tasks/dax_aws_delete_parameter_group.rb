...
def DeleteParameterGroup(*args)
  puts "Calling task operation DeleteParameterGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_parameter_group(call_hash)
  end
...
begin
  result = DeleteParameterGroup(params)
