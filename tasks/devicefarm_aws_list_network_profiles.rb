...
def ListNetworkProfiles(*args)
  puts "Calling task operation ListNetworkProfiles" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_network_profiles(call_hash)
  end
...
begin
  result = ListNetworkProfiles(params)
