...
def TerminateInstances(*args)
  puts "Calling task operation TerminateInstances" 
  ...
  if arg_hash.empty?
    ...
    response = client.terminate_instances(call_hash)
  end
...
begin
  result = TerminateInstances(params)
