...
def DeleteNotebookInstanceLifecycleConfig(*args)
  puts "Calling task operation DeleteNotebookInstanceLifecycleConfig" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_notebook_instance_lifecycle_config(call_hash)
  end
...
begin
  result = DeleteNotebookInstanceLifecycleConfig(params)
