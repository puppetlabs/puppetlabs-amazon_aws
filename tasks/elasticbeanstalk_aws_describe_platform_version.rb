...
def DescribePlatformVersion(*args)
  puts "Calling task operation DescribePlatformVersion" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_platform_version(call_hash)
  end
...
begin
  result = DescribePlatformVersion(params)
