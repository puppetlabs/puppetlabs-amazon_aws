...
def UpdateTerminationProtection(*args)
  puts "Calling task operation UpdateTerminationProtection" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_termination_protection(call_hash)
  end
...
begin
  result = UpdateTerminationProtection(params)
