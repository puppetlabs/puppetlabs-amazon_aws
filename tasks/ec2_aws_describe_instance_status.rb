...
def DescribeInstanceStatus(*args)
  puts "Calling task operation DescribeInstanceStatus" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_instance_status(call_hash)
  end
...
begin
  result = DescribeInstanceStatus(params)
