...
def DescribeVpcEndpointConnections(*args)
  puts "Calling task operation DescribeVpcEndpointConnections" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_vpc_endpoint_connections(call_hash)
  end
...
begin
  result = DescribeVpcEndpointConnections(params)
