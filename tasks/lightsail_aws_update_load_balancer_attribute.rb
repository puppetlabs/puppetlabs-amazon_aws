...
def UpdateLoadBalancerAttribute(*args)
  puts "Calling task operation UpdateLoadBalancerAttribute" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_load_balancer_attribute(call_hash)
  end
...
begin
  result = UpdateLoadBalancerAttribute(params)
