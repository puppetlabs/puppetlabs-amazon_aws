...
def GetObjectInformation(*args)
  puts "Calling task operation GetObjectInformation" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_object_information(call_hash)
  end
...
begin
  result = GetObjectInformation(params)
