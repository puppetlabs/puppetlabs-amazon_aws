...
def DescribeNodeAssociationStatus(*args)
  puts "Calling task operation DescribeNodeAssociationStatus" 
  ...
  client = Aws::OpsWorksCM::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.describe_node_association_status(call_hash)
  end
...
begin
  result = DescribeNodeAssociationStatus(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::OpsWorksCM::Errors::ServiceError => e
