...
def DescribeAggregationAuthorizations(*args)
  puts "Calling task operation DescribeAggregationAuthorizations" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_aggregation_authorizations(call_hash)
  end
...
begin
  result = DescribeAggregationAuthorizations(params)
