...
def StartLabelDetection(*args)
  puts "Calling task operation StartLabelDetection" 
  ...
  if arg_hash.empty?
    ...
    response = client.start_label_detection(call_hash)
  end
...
begin
  result = StartLabelDetection(params)
