...
def ListAssessmentRunAgents(*args)
  puts "Calling task operation ListAssessmentRunAgents" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_assessment_run_agents(call_hash)
  end
...
begin
  result = ListAssessmentRunAgents(params)
