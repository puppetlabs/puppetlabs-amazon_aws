...
def CreateSecurityProfile(*args)
  puts "Calling task operation CreateSecurityProfile" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_security_profile(call_hash)
  end
...
begin
  result = CreateSecurityProfile(params)
