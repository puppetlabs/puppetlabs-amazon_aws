...
def GetHealthCheckStatus(*args)
  puts "Calling task operation GetHealthCheckStatus" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_health_check_status(call_hash)
  end
...
begin
  result = GetHealthCheckStatus(params)
