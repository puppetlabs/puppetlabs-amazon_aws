...
def DescribeCollection(*args)
  puts "Calling task operation DescribeCollection" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_collection(call_hash)
  end
...
begin
  result = DescribeCollection(params)
