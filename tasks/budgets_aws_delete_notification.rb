...
def DeleteNotification(*args)
  puts "Calling task operation DeleteNotification" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_notification(call_hash)
  end
...
begin
  result = DeleteNotification(params)
