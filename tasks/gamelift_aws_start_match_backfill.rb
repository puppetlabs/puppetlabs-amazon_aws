...
def StartMatchBackfill(*args)
  puts "Calling task operation StartMatchBackfill" 
  ...
  if arg_hash.empty?
    ...
    response = client.start_match_backfill(call_hash)
  end
...
begin
  result = StartMatchBackfill(params)
