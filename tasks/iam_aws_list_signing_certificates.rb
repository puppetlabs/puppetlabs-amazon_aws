...
def ListSigningCertificates(*args)
  puts "Calling task operation ListSigningCertificates" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_signing_certificates(call_hash)
  end
...
begin
  result = ListSigningCertificates(params)
