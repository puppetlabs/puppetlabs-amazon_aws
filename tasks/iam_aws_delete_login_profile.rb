...
def DeleteLoginProfile(*args)
  puts "Calling task operation DeleteLoginProfile" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_login_profile(call_hash)
  end
...
begin
  result = DeleteLoginProfile(params)
