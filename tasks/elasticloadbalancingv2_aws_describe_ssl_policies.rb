...
def DescribeSSLPolicies(*args)
  puts "Calling task operation DescribeSSLPolicies" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_ssl_policies(call_hash)
  end
...
begin
  result = DescribeSSLPolicies(params)
