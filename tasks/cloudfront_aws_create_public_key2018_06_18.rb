...
def CreatePublicKey2018_06_18(*args)
  puts "Calling task operation CreatePublicKey2018_06_18" 
  ...
  if arg_hash.empty?
    response = client.create_public_key2018_06_18()
  else 
    call_hash={}
    ...
    response = client.create_public_key2018_06_18(call_hash)
  end
...
begin
  result = CreatePublicKey2018_06_18(params)
