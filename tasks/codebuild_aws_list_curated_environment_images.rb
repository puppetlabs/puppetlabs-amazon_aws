...
def ListCuratedEnvironmentImages(*args)
  puts "Calling task operation ListCuratedEnvironmentImages" 
  ...
  client = Aws::CodeBuild::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.list_curated_environment_images(call_hash)
  end
...
begin
  result = ListCuratedEnvironmentImages(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::CodeBuild::Errors::ServiceError => e
