...
def DeleteCustomMetadata(*args)
  puts "Calling task operation DeleteCustomMetadata" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_custom_metadata(call_hash)
  end
...
begin
  result = DeleteCustomMetadata(params)
