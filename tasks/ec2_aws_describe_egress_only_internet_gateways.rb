...
def DescribeEgressOnlyInternetGateways(*args)
  puts "Calling task operation DescribeEgressOnlyInternetGateways" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_egress_only_internet_gateways(call_hash)
  end
...
begin
  result = DescribeEgressOnlyInternetGateways(params)
