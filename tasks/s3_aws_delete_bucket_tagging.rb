...
def DeleteBucketTagging(*args)
  puts "Calling task operation DeleteBucketTagging" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_bucket_tagging(call_hash)
  end
...
begin
  result = DeleteBucketTagging(params)
