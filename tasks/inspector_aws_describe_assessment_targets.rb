...
def DescribeAssessmentTargets(*args)
  puts "Calling task operation DescribeAssessmentTargets" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_assessment_targets(call_hash)
  end
...
begin
  result = DescribeAssessmentTargets(params)
