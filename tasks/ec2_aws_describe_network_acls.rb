...
def DescribeNetworkAcls(*args)
  puts "Calling task operation DescribeNetworkAcls" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_network_acls(call_hash)
  end
...
begin
  result = DescribeNetworkAcls(params)
