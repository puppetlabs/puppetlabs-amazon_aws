...
def CreateDBInstanceReadReplica(*args)
  puts "Calling task operation CreateDBInstanceReadReplica" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_db_instance_read_replica(call_hash)
  end
...
begin
  result = CreateDBInstanceReadReplica(params)
