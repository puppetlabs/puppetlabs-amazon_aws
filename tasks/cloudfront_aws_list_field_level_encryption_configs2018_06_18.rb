...
def ListFieldLevelEncryptionConfigs2018_06_18(*args)
  puts "Calling task operation ListFieldLevelEncryptionConfigs2018_06_18" 
  ...
  if arg_hash.empty?
    response = client.list_field_level_encryption_configs2018_06_18()
  else 
    call_hash={}
    ...
    response = client.list_field_level_encryption_configs2018_06_18(call_hash)
  end
...
begin
  result = ListFieldLevelEncryptionConfigs2018_06_18(params)
