...
def DeleteUserPermissionsBoundary(*args)
  puts "Calling task operation DeleteUserPermissionsBoundary" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_user_permissions_boundary(call_hash)
  end
...
begin
  result = DeleteUserPermissionsBoundary(params)
