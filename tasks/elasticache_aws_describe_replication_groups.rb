...
def DescribeReplicationGroups(*args)
  puts "Calling task operation DescribeReplicationGroups" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_replication_groups(call_hash)
  end
...
begin
  result = DescribeReplicationGroups(params)
