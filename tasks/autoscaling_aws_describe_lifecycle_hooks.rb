...
def DescribeLifecycleHooks(*args)
  puts "Calling task operation DescribeLifecycleHooks" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_lifecycle_hooks(call_hash)
  end
...
begin
  result = DescribeLifecycleHooks(params)
