...
def CreateVpcPeeringConnection(*args)
  puts "Calling task operation CreateVpcPeeringConnection" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_vpc_peering_connection(call_hash)
  end
...
begin
  result = CreateVpcPeeringConnection(params)
