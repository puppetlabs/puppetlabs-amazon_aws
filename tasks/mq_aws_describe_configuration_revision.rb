...
def DescribeConfigurationRevision(*args)
  puts "Calling task operation DescribeConfigurationRevision" 
  ...
  client = Aws::MQ::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.describe_configuration_revision(call_hash)
  end
...
begin
  result = DescribeConfigurationRevision(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::MQ::Errors::ServiceError => e
