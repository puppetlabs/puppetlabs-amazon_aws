...
def DescribeGameSessions(*args)
  puts "Calling task operation DescribeGameSessions" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_game_sessions(call_hash)
  end
...
begin
  result = DescribeGameSessions(params)
