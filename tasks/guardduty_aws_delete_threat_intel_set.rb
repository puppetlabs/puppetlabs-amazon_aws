...
def DeleteThreatIntelSet(*args)
  puts "Calling task operation DeleteThreatIntelSet" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_threat_intel_set(call_hash)
  end
...
begin
  result = DeleteThreatIntelSet(params)
