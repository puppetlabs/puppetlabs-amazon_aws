...
def CreateResourceDataSync(*args)
  puts "Calling task operation CreateResourceDataSync" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_resource_data_sync(call_hash)
  end
...
begin
  result = CreateResourceDataSync(params)
