...
def DeleteObjectTagging(*args)
  puts "Calling task operation DeleteObjectTagging" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_object_tagging(call_hash)
  end
...
begin
  result = DeleteObjectTagging(params)
