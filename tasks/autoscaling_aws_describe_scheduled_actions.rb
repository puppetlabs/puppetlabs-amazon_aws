...
def DescribeScheduledActions(*args)
  puts "Calling task operation DescribeScheduledActions" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_scheduled_actions(call_hash)
  end
...
begin
  result = DescribeScheduledActions(params)
