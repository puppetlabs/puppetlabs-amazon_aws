...
def DeleteSpotDatafeedSubscription(*args)
  puts "Calling task operation DeleteSpotDatafeedSubscription" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_spot_datafeed_subscription(call_hash)
  end
...
begin
  result = DeleteSpotDatafeedSubscription(params)
