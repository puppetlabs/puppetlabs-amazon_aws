...
def GetSecurityConfiguration(*args)
  puts "Calling task operation GetSecurityConfiguration" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_security_configuration(call_hash)
  end
...
begin
  result = GetSecurityConfiguration(params)
