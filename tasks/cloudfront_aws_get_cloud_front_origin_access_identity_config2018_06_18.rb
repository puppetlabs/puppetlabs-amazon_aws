...
def GetCloudFrontOriginAccessIdentityConfig2018_06_18(*args)
  puts "Calling task operation GetCloudFrontOriginAccessIdentityConfig2018_06_18" 
  ...
  if arg_hash.empty?
    response = client.get_cloud_front_origin_access_identity_config2018_06_18()
  else 
    call_hash={}
    ...
    response = client.get_cloud_front_origin_access_identity_config2018_06_18(call_hash)
  end
...
begin
  result = GetCloudFrontOriginAccessIdentityConfig2018_06_18(params)
