...
def GetInstancePortStates(*args)
  puts "Calling task operation GetInstancePortStates" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_instance_port_states(call_hash)
  end
...
begin
  result = GetInstancePortStates(params)
