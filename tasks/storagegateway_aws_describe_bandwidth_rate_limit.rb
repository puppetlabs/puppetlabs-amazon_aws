...
def DescribeBandwidthRateLimit(*args)
  puts "Calling task operation DescribeBandwidthRateLimit" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_bandwidth_rate_limit(call_hash)
  end
...
begin
  result = DescribeBandwidthRateLimit(params)
