...
def StartWorkflowExecution(*args)
  puts "Calling task operation StartWorkflowExecution" 
  ...
  if arg_hash.empty?
    ...
    response = client.start_workflow_execution(call_hash)
  end
...
begin
  result = StartWorkflowExecution(params)
