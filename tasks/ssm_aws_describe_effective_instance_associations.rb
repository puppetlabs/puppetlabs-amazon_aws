...
def DescribeEffectiveInstanceAssociations(*args)
  puts "Calling task operation DescribeEffectiveInstanceAssociations" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_effective_instance_associations(call_hash)
  end
...
begin
  result = DescribeEffectiveInstanceAssociations(params)
