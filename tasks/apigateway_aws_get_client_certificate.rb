...
def GetClientCertificate(*args)
  puts "Calling task operation GetClientCertificate" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_client_certificate(call_hash)
  end
...
begin
  result = GetClientCertificate(params)
