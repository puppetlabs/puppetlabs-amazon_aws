...
def StartQueryExecution(*args)
  puts "Calling task operation StartQueryExecution" 
  ...
  if arg_hash.empty?
    ...
    response = client.start_query_execution(call_hash)
  end
...
begin
  result = StartQueryExecution(params)
