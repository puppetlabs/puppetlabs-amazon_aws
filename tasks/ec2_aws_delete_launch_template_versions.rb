...
def DeleteLaunchTemplateVersions(*args)
  puts "Calling task operation DeleteLaunchTemplateVersions" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_launch_template_versions(call_hash)
  end
...
begin
  result = DeleteLaunchTemplateVersions(params)
