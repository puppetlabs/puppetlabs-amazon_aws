...
def GetApplicationSettings(*args)
  puts "Calling task operation GetApplicationSettings" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_application_settings(call_hash)
  end
...
begin
  result = GetApplicationSettings(params)
