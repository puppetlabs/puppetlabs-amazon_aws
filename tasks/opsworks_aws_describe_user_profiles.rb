...
def DescribeUserProfiles(*args)
  puts "Calling task operation DescribeUserProfiles" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_user_profiles(call_hash)
  end
...
begin
  result = DescribeUserProfiles(params)
