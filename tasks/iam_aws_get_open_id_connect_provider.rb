...
def GetOpenIDConnectProvider(*args)
  puts "Calling task operation GetOpenIDConnectProvider" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_open_id_connect_provider(call_hash)
  end
...
begin
  result = GetOpenIDConnectProvider(params)
