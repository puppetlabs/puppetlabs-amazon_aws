...
def GetCommentsForPullRequest(*args)
  puts "Calling task operation GetCommentsForPullRequest" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_comments_for_pull_request(call_hash)
  end
...
begin
  result = GetCommentsForPullRequest(params)
