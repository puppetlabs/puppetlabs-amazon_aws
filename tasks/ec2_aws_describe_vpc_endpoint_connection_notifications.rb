...
def DescribeVpcEndpointConnectionNotifications(*args)
  puts "Calling task operation DescribeVpcEndpointConnectionNotifications" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_vpc_endpoint_connection_notifications(call_hash)
  end
...
begin
  result = DescribeVpcEndpointConnectionNotifications(params)
