...
def GetAggregateComplianceDetailsByConfigRule(*args)
  puts "Calling task operation GetAggregateComplianceDetailsByConfigRule" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_aggregate_compliance_details_by_config_rule(call_hash)
  end
...
begin
  result = GetAggregateComplianceDetailsByConfigRule(params)
