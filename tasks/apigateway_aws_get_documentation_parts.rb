...
def GetDocumentationParts(*args)
  puts "Calling task operation GetDocumentationParts" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_documentation_parts(call_hash)
  end
...
begin
  result = GetDocumentationParts(params)
