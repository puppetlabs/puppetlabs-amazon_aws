...
def DescribeLunaClient(*args)
  puts "Calling task operation DescribeLunaClient" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_luna_client(call_hash)
  end
...
begin
  result = DescribeLunaClient(params)
