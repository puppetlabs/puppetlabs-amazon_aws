...
def DetachElasticLoadBalancer(*args)
  puts "Calling task operation DetachElasticLoadBalancer" 
  ...
  if arg_hash.empty?
    ...
    response = client.detach_elastic_load_balancer(call_hash)
  end
...
begin
  result = DetachElasticLoadBalancer(params)
