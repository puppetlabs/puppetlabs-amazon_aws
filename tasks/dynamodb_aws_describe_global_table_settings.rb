...
def DescribeGlobalTableSettings(*args)
  puts "Calling task operation DescribeGlobalTableSettings" 
  ...
  client = Aws::DynamoDB::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.describe_global_table_settings(call_hash)
  end
...
begin
  result = DescribeGlobalTableSettings(params)
