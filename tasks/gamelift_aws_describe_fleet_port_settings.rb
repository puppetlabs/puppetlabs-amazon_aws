...
def DescribeFleetPortSettings(*args)
  puts "Calling task operation DescribeFleetPortSettings" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_fleet_port_settings(call_hash)
  end
...
begin
  result = DescribeFleetPortSettings(params)
