...
def DeleteVpcEndpoints(*args)
  puts "Calling task operation DeleteVpcEndpoints" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_vpc_endpoints(call_hash)
  end
...
begin
  result = DeleteVpcEndpoints(params)
