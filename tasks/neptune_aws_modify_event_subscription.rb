...
def ModifyEventSubscription(*args)
  puts "Calling task operation ModifyEventSubscription" 
  ...
  if arg_hash.empty?
    ...
    response = client.modify_event_subscription(call_hash)
  end
...
begin
  result = ModifyEventSubscription(params)
