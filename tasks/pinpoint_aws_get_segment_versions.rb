...
def GetSegmentVersions(*args)
  puts "Calling task operation GetSegmentVersions" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_segment_versions(call_hash)
  end
...
begin
  result = GetSegmentVersions(params)
