...
def ListFunctionDefinitions(*args)
  puts "Calling task operation ListFunctionDefinitions" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_function_definitions(call_hash)
  end
...
begin
  result = ListFunctionDefinitions(params)
