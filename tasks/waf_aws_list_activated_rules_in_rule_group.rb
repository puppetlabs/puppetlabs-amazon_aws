...
def ListActivatedRulesInRuleGroup(*args)
  puts "Calling task operation ListActivatedRulesInRuleGroup" 
  ...
  client = Aws::WAF::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.list_activated_rules_in_rule_group(call_hash)
  end
...
begin
  result = ListActivatedRulesInRuleGroup(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::WAF::Errors::ServiceError => e
