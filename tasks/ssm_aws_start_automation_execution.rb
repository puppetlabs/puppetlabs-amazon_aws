...
def StartAutomationExecution(*args)
  puts "Calling task operation StartAutomationExecution" 
  ...
  if arg_hash.empty?
    ...
    response = client.start_automation_execution(call_hash)
  end
...
begin
  result = StartAutomationExecution(params)
