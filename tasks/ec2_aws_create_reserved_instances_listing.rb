...
def CreateReservedInstancesListing(*args)
  puts "Calling task operation CreateReservedInstancesListing" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_reserved_instances_listing(call_hash)
  end
...
begin
  result = CreateReservedInstancesListing(params)
