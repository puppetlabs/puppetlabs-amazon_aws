...
def UpdateGatewaySoftwareNow(*args)
  puts "Calling task operation UpdateGatewaySoftwareNow" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_gateway_software_now(call_hash)
  end
...
begin
  result = UpdateGatewaySoftwareNow(params)
