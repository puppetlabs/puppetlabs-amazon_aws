...
def RemoveResourcePermission(*args)
  puts "Calling task operation RemoveResourcePermission" 
  ...
  if arg_hash.empty?
    ...
    response = client.remove_resource_permission(call_hash)
  end
...
begin
  result = RemoveResourcePermission(params)
