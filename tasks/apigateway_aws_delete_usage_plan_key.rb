...
def DeleteUsagePlanKey(*args)
  puts "Calling task operation DeleteUsagePlanKey" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_usage_plan_key(call_hash)
  end
...
begin
  result = DeleteUsagePlanKey(params)
