...
def ListObjectChildren(*args)
  puts "Calling task operation ListObjectChildren" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_object_children(call_hash)
  end
...
begin
  result = ListObjectChildren(params)
