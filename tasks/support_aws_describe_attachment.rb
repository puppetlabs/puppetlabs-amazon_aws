...
def DescribeAttachment(*args)
  puts "Calling task operation DescribeAttachment" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_attachment(call_hash)
  end
...
begin
  result = DescribeAttachment(params)
