...
def DeleteRegexPatternSet(*args)
  puts "Calling task operation DeleteRegexPatternSet" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_regex_pattern_set(call_hash)
  end
...
begin
  result = DeleteRegexPatternSet(params)
