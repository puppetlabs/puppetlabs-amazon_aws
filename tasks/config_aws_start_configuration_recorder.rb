...
def StartConfigurationRecorder(*args)
  puts "Calling task operation StartConfigurationRecorder" 
  ...
  if arg_hash.empty?
    ...
    response = client.start_configuration_recorder(call_hash)
  end
...
begin
  result = StartConfigurationRecorder(params)
