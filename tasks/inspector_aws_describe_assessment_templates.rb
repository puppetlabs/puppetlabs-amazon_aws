...
def DescribeAssessmentTemplates(*args)
  puts "Calling task operation DescribeAssessmentTemplates" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_assessment_templates(call_hash)
  end
...
begin
  result = DescribeAssessmentTemplates(params)
