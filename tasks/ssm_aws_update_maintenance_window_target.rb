...
def UpdateMaintenanceWindowTarget(*args)
  puts "Calling task operation UpdateMaintenanceWindowTarget" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_maintenance_window_target(call_hash)
  end
...
begin
  result = UpdateMaintenanceWindowTarget(params)
