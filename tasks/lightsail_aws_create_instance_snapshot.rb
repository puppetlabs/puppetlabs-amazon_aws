...
def CreateInstanceSnapshot(*args)
  puts "Calling task operation CreateInstanceSnapshot" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_instance_snapshot(call_hash)
  end
...
begin
  result = CreateInstanceSnapshot(params)
