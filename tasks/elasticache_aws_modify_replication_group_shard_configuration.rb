...
def ModifyReplicationGroupShardConfiguration(*args)
  puts "Calling task operation ModifyReplicationGroupShardConfiguration" 
  ...
  client = Aws::ElastiCache::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.modify_replication_group_shard_configuration(call_hash)
  end
...
begin
  result = ModifyReplicationGroupShardConfiguration(params)
