...
def DescribeCacheParameterGroups(*args)
  puts "Calling task operation DescribeCacheParameterGroups" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_cache_parameter_groups(call_hash)
  end
...
begin
  result = DescribeCacheParameterGroups(params)
