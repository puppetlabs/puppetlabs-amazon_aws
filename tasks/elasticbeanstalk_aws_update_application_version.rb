...
def UpdateApplicationVersion(*args)
  puts "Calling task operation UpdateApplicationVersion" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_application_version(call_hash)
  end
...
begin
  result = UpdateApplicationVersion(params)
