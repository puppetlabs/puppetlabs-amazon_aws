...
def UpdateProvisioningArtifact(*args)
  puts "Calling task operation UpdateProvisioningArtifact" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_provisioning_artifact(call_hash)
  end
...
begin
  result = UpdateProvisioningArtifact(params)
