...
def GetVaultAccessPolicy(*args)
  puts "Calling task operation GetVaultAccessPolicy" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_vault_access_policy(call_hash)
  end
...
begin
  result = GetVaultAccessPolicy(params)
