...
def DescribeExclusions(*args)
  puts "Calling task operation DescribeExclusions" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_exclusions(call_hash)
  end
...
begin
  result = DescribeExclusions(params)
