...
def GetTelemetryMetadata(*args)
  puts "Calling task operation GetTelemetryMetadata" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_telemetry_metadata(call_hash)
  end
...
begin
  result = GetTelemetryMetadata(params)
