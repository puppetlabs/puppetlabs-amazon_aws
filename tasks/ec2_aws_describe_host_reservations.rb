...
def DescribeHostReservations(*args)
  puts "Calling task operation DescribeHostReservations" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_host_reservations(call_hash)
  end
...
begin
  result = DescribeHostReservations(params)
