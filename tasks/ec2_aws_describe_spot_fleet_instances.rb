...
def DescribeSpotFleetInstances(*args)
  puts "Calling task operation DescribeSpotFleetInstances" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_spot_fleet_instances(call_hash)
  end
...
begin
  result = DescribeSpotFleetInstances(params)
