...
def CreateGameSessionQueue(*args)
  puts "Calling task operation CreateGameSessionQueue" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_game_session_queue(call_hash)
  end
...
begin
  result = CreateGameSessionQueue(params)
