...
def ListTaskDefinitions(*args)
  puts "Calling task operation ListTaskDefinitions" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_task_definitions(call_hash)
  end
...
begin
  result = ListTaskDefinitions(params)
