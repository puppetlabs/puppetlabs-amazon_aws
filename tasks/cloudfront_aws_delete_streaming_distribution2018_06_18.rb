...
def DeleteStreamingDistribution2018_06_18(*args)
  puts "Calling task operation DeleteStreamingDistribution2018_06_18" 
  ...
  if arg_hash.empty?
    response = client.delete_streaming_distribution2018_06_18()
  else 
    call_hash={}
    ...
    response = client.delete_streaming_distribution2018_06_18(call_hash)
  end
...
begin
  result = DeleteStreamingDistribution2018_06_18(params)
