...
def GetRemoteAccessSession(*args)
  puts "Calling task operation GetRemoteAccessSession" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_remote_access_session(call_hash)
  end
...
begin
  result = GetRemoteAccessSession(params)
