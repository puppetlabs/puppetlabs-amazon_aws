...
def GetContactReachabilityStatus(*args)
  puts "Calling task operation GetContactReachabilityStatus" 
  ...
  client = Aws::Route53Domains::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.get_contact_reachability_status(call_hash)
  end
...
begin
  result = GetContactReachabilityStatus(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::Route53Domains::Errors::ServiceError => e
