...
def ListSecurityProfilesForTarget(*args)
  puts "Calling task operation ListSecurityProfilesForTarget" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_security_profiles_for_target(call_hash)
  end
...
begin
  result = ListSecurityProfilesForTarget(params)
