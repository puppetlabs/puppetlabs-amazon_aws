...
def DescribeEventDetails(*args)
  puts "Calling task operation DescribeEventDetails" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_event_details(call_hash)
  end
...
begin
  result = DescribeEventDetails(params)
