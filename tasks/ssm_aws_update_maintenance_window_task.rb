...
def UpdateMaintenanceWindowTask(*args)
  puts "Calling task operation UpdateMaintenanceWindowTask" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_maintenance_window_task(call_hash)
  end
...
begin
  result = UpdateMaintenanceWindowTask(params)
