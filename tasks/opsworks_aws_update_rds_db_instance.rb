...
def UpdateRdsDbInstance(*args)
  puts "Calling task operation UpdateRdsDbInstance" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_rds_db_instance(call_hash)
  end
...
begin
  result = UpdateRdsDbInstance(params)
