...
def UpdateTagsForDomain(*args)
  puts "Calling task operation UpdateTagsForDomain" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_tags_for_domain(call_hash)
  end
...
begin
  result = UpdateTagsForDomain(params)
