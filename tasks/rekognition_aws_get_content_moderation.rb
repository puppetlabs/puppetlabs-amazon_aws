...
def GetContentModeration(*args)
  puts "Calling task operation GetContentModeration" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_content_moderation(call_hash)
  end
...
begin
  result = GetContentModeration(params)
