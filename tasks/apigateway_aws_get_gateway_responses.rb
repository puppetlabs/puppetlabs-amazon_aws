...
def GetGatewayResponses(*args)
  puts "Calling task operation GetGatewayResponses" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_gateway_responses(call_hash)
  end
...
begin
  result = GetGatewayResponses(params)
