...
def DetachInstancesFromLoadBalancer(*args)
  puts "Calling task operation DetachInstancesFromLoadBalancer" 
  ...
  if arg_hash.empty?
    ...
    response = client.detach_instances_from_load_balancer(call_hash)
  end
...
begin
  result = DetachInstancesFromLoadBalancer(params)
