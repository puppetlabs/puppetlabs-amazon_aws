...
def DeleteDeploymentConfig(*args)
  puts "Calling task operation DeleteDeploymentConfig" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_deployment_config(call_hash)
  end
...
begin
  result = DeleteDeploymentConfig(params)
