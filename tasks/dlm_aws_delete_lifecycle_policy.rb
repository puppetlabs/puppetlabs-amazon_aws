...
def DeleteLifecyclePolicy(*args)
  puts "Calling task operation DeleteLifecyclePolicy" 
  ...
  client = Aws::DLM::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.delete_lifecycle_policy(call_hash)
  end
...
begin
  result = DeleteLifecyclePolicy(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::DLM::Errors::ServiceError => e
