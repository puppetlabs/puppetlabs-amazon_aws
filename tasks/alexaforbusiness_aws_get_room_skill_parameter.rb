...
def GetRoomSkillParameter(*args)
  puts "Calling task operation GetRoomSkillParameter" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_room_skill_parameter(call_hash)
  end
...
begin
  result = GetRoomSkillParameter(params)
