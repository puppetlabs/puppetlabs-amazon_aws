...
def CreateHsmConfiguration(*args)
  puts "Calling task operation CreateHsmConfiguration" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_hsm_configuration(call_hash)
  end
...
begin
  result = CreateHsmConfiguration(params)
