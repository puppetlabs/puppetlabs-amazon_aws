...
def StopRemoteAccessSession(*args)
  puts "Calling task operation StopRemoteAccessSession" 
  ...
  if arg_hash.empty?
    ...
    response = client.stop_remote_access_session(call_hash)
  end
...
begin
  result = StopRemoteAccessSession(params)
