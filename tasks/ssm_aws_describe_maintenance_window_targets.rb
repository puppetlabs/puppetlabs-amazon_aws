...
def DescribeMaintenanceWindowTargets(*args)
  puts "Calling task operation DescribeMaintenanceWindowTargets" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_maintenance_window_targets(call_hash)
  end
...
begin
  result = DescribeMaintenanceWindowTargets(params)
