...
def ModifyVolumeAttribute(*args)
  puts "Calling task operation ModifyVolumeAttribute" 
  ...
  if arg_hash.empty?
    ...
    response = client.modify_volume_attribute(call_hash)
  end
...
begin
  result = ModifyVolumeAttribute(params)
