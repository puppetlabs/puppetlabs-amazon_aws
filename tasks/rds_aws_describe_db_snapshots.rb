...
def DescribeDBSnapshots(*args)
  puts "Calling task operation DescribeDBSnapshots" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_db_snapshots(call_hash)
  end
...
begin
  result = DescribeDBSnapshots(params)
