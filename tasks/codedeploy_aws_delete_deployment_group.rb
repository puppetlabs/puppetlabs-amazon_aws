...
def DeleteDeploymentGroup(*args)
  puts "Calling task operation DeleteDeploymentGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_deployment_group(call_hash)
  end
...
begin
  result = DeleteDeploymentGroup(params)
