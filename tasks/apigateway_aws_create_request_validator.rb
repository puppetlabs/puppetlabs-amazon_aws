...
def CreateRequestValidator(*args)
  puts "Calling task operation CreateRequestValidator" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_request_validator(call_hash)
  end
...
begin
  result = CreateRequestValidator(params)
