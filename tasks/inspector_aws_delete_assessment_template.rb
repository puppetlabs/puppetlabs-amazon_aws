...
def DeleteAssessmentTemplate(*args)
  puts "Calling task operation DeleteAssessmentTemplate" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_assessment_template(call_hash)
  end
...
begin
  result = DeleteAssessmentTemplate(params)
