...
def DescribeClusterVersions(*args)
  puts "Calling task operation DescribeClusterVersions" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_cluster_versions(call_hash)
  end
...
begin
  result = DescribeClusterVersions(params)
