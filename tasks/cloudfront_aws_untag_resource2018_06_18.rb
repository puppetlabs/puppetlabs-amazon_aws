...
def UntagResource2018_06_18(*args)
  puts "Calling task operation UntagResource2018_06_18" 
  ...
  if arg_hash.empty?
    response = client.untag_resource2018_06_18()
  else 
    call_hash={}
    ...
    response = client.untag_resource2018_06_18(call_hash)
  end
...
begin
  result = UntagResource2018_06_18(params)
