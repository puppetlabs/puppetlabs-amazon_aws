...
def RemoveListenerCertificates(*args)
  puts "Calling task operation RemoveListenerCertificates" 
  ...
  if arg_hash.empty?
    ...
    response = client.remove_listener_certificates(call_hash)
  end
...
begin
  result = RemoveListenerCertificates(params)
