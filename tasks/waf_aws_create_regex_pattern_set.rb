...
def CreateRegexPatternSet(*args)
  puts "Calling task operation CreateRegexPatternSet" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_regex_pattern_set(call_hash)
  end
...
begin
  result = CreateRegexPatternSet(params)
