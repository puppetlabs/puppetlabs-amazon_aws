...
def RemoveTagsFromOnPremisesInstances(*args)
  puts "Calling task operation RemoveTagsFromOnPremisesInstances" 
  ...
  client = Aws::CodeDeploy::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.remove_tags_from_on_premises_instances(call_hash)
  end
...
begin
  result = RemoveTagsFromOnPremisesInstances(params)
