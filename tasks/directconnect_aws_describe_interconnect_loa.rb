...
def DescribeInterconnectLoa(*args)
  puts "Calling task operation DescribeInterconnectLoa" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_interconnect_loa(call_hash)
  end
...
begin
  result = DescribeInterconnectLoa(params)
