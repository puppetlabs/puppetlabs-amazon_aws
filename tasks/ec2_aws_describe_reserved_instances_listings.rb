...
def DescribeReservedInstancesListings(*args)
  puts "Calling task operation DescribeReservedInstancesListings" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_reserved_instances_listings(call_hash)
  end
...
begin
  result = DescribeReservedInstancesListings(params)
