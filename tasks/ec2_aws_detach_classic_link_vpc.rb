...
def DetachClassicLinkVpc(*args)
  puts "Calling task operation DetachClassicLinkVpc" 
  ...
  if arg_hash.empty?
    ...
    response = client.detach_classic_link_vpc(call_hash)
  end
...
begin
  result = DetachClassicLinkVpc(params)
