...
def ModifyClusterDbRevision(*args)
  puts "Calling task operation ModifyClusterDbRevision" 
  ...
  if arg_hash.empty?
    ...
    response = client.modify_cluster_db_revision(call_hash)
  end
...
begin
  result = ModifyClusterDbRevision(params)
