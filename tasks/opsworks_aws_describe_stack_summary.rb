...
def DescribeStackSummary(*args)
  puts "Calling task operation DescribeStackSummary" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_stack_summary(call_hash)
  end
...
begin
  result = DescribeStackSummary(params)
