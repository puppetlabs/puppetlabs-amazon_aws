...
def DescribeLaunchTemplates(*args)
  puts "Calling task operation DescribeLaunchTemplates" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_launch_templates(call_hash)
  end
...
begin
  result = DescribeLaunchTemplates(params)
