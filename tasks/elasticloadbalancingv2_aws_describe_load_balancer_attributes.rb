...
def DescribeLoadBalancerAttributes(*args)
  puts "Calling task operation DescribeLoadBalancerAttributes" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_load_balancer_attributes(call_hash)
  end
...
begin
  result = DescribeLoadBalancerAttributes(params)
