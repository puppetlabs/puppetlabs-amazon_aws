...
def ListSizeConstraintSets(*args)
  puts "Calling task operation ListSizeConstraintSets" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_size_constraint_sets(call_hash)
  end
...
begin
  result = ListSizeConstraintSets(params)
