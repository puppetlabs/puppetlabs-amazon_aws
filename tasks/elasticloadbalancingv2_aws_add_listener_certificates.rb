...
def AddListenerCertificates(*args)
  puts "Calling task operation AddListenerCertificates" 
  ...
  if arg_hash.empty?
    ...
    response = client.add_listener_certificates(call_hash)
  end
...
begin
  result = AddListenerCertificates(params)
