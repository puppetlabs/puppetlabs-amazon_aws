...
def ListAssessmentTemplates(*args)
  puts "Calling task operation ListAssessmentTemplates" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_assessment_templates(call_hash)
  end
...
begin
  result = ListAssessmentTemplates(params)
