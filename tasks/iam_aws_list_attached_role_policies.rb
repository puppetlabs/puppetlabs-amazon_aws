...
def ListAttachedRolePolicies(*args)
  puts "Calling task operation ListAttachedRolePolicies" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_attached_role_policies(call_hash)
  end
...
begin
  result = ListAttachedRolePolicies(params)
