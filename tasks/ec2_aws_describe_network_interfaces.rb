...
def DescribeNetworkInterfaces(*args)
  puts "Calling task operation DescribeNetworkInterfaces" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_network_interfaces(call_hash)
  end
...
begin
  result = DescribeNetworkInterfaces(params)
