...
def CreateCoreDefinitionVersion(*args)
  puts "Calling task operation CreateCoreDefinitionVersion" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_core_definition_version(call_hash)
  end
...
begin
  result = CreateCoreDefinitionVersion(params)
