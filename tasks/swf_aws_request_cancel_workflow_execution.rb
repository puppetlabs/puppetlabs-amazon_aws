...
def RequestCancelWorkflowExecution(*args)
  puts "Calling task operation RequestCancelWorkflowExecution" 
  ...
  client = Aws::SWF::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.request_cancel_workflow_execution(call_hash)
  end
...
begin
  result = RequestCancelWorkflowExecution(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::SWF::Errors::ServiceError => e
