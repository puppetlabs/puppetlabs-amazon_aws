...
def DescribePrincipalIdFormat(*args)
  puts "Calling task operation DescribePrincipalIdFormat" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_principal_id_format(call_hash)
  end
...
begin
  result = DescribePrincipalIdFormat(params)
