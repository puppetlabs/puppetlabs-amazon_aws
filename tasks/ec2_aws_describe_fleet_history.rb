...
def DescribeFleetHistory(*args)
  puts "Calling task operation DescribeFleetHistory" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_fleet_history(call_hash)
  end
...
begin
  result = DescribeFleetHistory(params)
