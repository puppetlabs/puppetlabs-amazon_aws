...
def DescribeParameters(*args)
  puts "Calling task operation DescribeParameters" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_parameters(call_hash)
  end
...
begin
  result = DescribeParameters(params)
