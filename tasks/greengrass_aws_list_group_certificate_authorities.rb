...
def ListGroupCertificateAuthorities(*args)
  puts "Calling task operation ListGroupCertificateAuthorities" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_group_certificate_authorities(call_hash)
  end
...
begin
  result = ListGroupCertificateAuthorities(params)
