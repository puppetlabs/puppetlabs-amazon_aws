...
def GetExclusionsPreview(*args)
  puts "Calling task operation GetExclusionsPreview" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_exclusions_preview(call_hash)
  end
...
begin
  result = GetExclusionsPreview(params)
