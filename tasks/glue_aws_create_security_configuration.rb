...
def CreateSecurityConfiguration(*args)
  puts "Calling task operation CreateSecurityConfiguration" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_security_configuration(call_hash)
  end
...
begin
  result = CreateSecurityConfiguration(params)
