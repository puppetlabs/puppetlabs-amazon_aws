...
def DeleteLoadBalancerTlsCertificate(*args)
  puts "Calling task operation DeleteLoadBalancerTlsCertificate" 
  ...
  client = Aws::Lightsail::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.delete_load_balancer_tls_certificate(call_hash)
  end
...
begin
  result = DeleteLoadBalancerTlsCertificate(params)
