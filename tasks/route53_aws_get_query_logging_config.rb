...
def GetQueryLoggingConfig(*args)
  puts "Calling task operation GetQueryLoggingConfig" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_query_logging_config(call_hash)
  end
...
begin
  result = GetQueryLoggingConfig(params)
