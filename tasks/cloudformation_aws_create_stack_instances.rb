...
def CreateStackInstances(*args)
  puts "Calling task operation CreateStackInstances" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_stack_instances(call_hash)
  end
...
begin
  result = CreateStackInstances(params)
