...
def DescribeSecurityGroups(*args)
  puts "Calling task operation DescribeSecurityGroups" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_security_groups(call_hash)
  end
...
begin
  result = DescribeSecurityGroups(params)
