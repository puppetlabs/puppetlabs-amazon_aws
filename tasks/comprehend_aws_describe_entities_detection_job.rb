...
def DescribeEntitiesDetectionJob(*args)
  puts "Calling task operation DescribeEntitiesDetectionJob" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_entities_detection_job(call_hash)
  end
...
begin
  result = DescribeEntitiesDetectionJob(params)
