...
def DeleteApplicationOutput(*args)
  puts "Calling task operation DeleteApplicationOutput" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_application_output(call_hash)
  end
...
begin
  result = DeleteApplicationOutput(params)
