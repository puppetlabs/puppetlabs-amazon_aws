...
def ListTopicsDetectionJobs(*args)
  puts "Calling task operation ListTopicsDetectionJobs" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_topics_detection_jobs(call_hash)
  end
...
begin
  result = ListTopicsDetectionJobs(params)
