...
def ListRateBasedRules(*args)
  puts "Calling task operation ListRateBasedRules" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_rate_based_rules(call_hash)
  end
...
begin
  result = ListRateBasedRules(params)
