...
def DeleteAnalysisScheme(*args)
  puts "Calling task operation DeleteAnalysisScheme" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_analysis_scheme(call_hash)
  end
...
begin
  result = DeleteAnalysisScheme(params)
