...
def GetHostedZoneCount(*args)
  puts "Calling task operation GetHostedZoneCount" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_hosted_zone_count(call_hash)
  end
...
begin
  result = GetHostedZoneCount(params)
