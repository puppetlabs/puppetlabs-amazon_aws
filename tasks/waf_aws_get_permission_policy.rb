...
def GetPermissionPolicy(*args)
  puts "Calling task operation GetPermissionPolicy" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_permission_policy(call_hash)
  end
...
begin
  result = GetPermissionPolicy(params)
