...
def GetUserDefinedFunction(*args)
  puts "Calling task operation GetUserDefinedFunction" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_user_defined_function(call_hash)
  end
...
begin
  result = GetUserDefinedFunction(params)
