...
def DescribeCrossAccountAccessRole(*args)
  puts "Calling task operation DescribeCrossAccountAccessRole" 
  ...
  client = Aws::Inspector::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.describe_cross_account_access_role(call_hash)
  end
...
begin
  result = DescribeCrossAccountAccessRole(params)
