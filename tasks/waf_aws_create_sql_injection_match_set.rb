...
def CreateSqlInjectionMatchSet(*args)
  puts "Calling task operation CreateSqlInjectionMatchSet" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_sql_injection_match_set(call_hash)
  end
...
begin
  result = CreateSqlInjectionMatchSet(params)
