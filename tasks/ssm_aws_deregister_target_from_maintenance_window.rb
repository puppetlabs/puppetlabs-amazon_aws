...
def DeregisterTargetFromMaintenanceWindow(*args)
  puts "Calling task operation DeregisterTargetFromMaintenanceWindow" 
  ...
  if arg_hash.empty?
    ...
    response = client.deregister_target_from_maintenance_window(call_hash)
  end
...
begin
  result = DeregisterTargetFromMaintenanceWindow(params)
