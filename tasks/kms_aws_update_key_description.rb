...
def UpdateKeyDescription(*args)
  puts "Calling task operation UpdateKeyDescription" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_key_description(call_hash)
  end
...
begin
  result = UpdateKeyDescription(params)
