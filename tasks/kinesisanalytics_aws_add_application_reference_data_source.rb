...
def AddApplicationReferenceDataSource(*args)
  puts "Calling task operation AddApplicationReferenceDataSource" 
  ...
  if arg_hash.empty?
    ...
    response = client.add_application_reference_data_source(call_hash)
  end
...
begin
  result = AddApplicationReferenceDataSource(params)
