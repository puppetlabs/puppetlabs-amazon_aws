...
def ModifyLoadBalancerAttributes(*args)
  puts "Calling task operation ModifyLoadBalancerAttributes" 
  ...
  if arg_hash.empty?
    ...
    response = client.modify_load_balancer_attributes(call_hash)
  end
...
begin
  result = ModifyLoadBalancerAttributes(params)
