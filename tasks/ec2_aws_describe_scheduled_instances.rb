...
def DescribeScheduledInstances(*args)
  puts "Calling task operation DescribeScheduledInstances" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_scheduled_instances(call_hash)
  end
...
begin
  result = DescribeScheduledInstances(params)
