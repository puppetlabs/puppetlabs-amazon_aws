...
def ListRegexPatternSets(*args)
  puts "Calling task operation ListRegexPatternSets" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_regex_pattern_sets(call_hash)
  end
...
begin
  result = ListRegexPatternSets(params)
