...
def ListPlatformVersions(*args)
  puts "Calling task operation ListPlatformVersions" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_platform_versions(call_hash)
  end
...
begin
  result = ListPlatformVersions(params)
