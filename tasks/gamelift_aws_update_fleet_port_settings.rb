...
def UpdateFleetPortSettings(*args)
  puts "Calling task operation UpdateFleetPortSettings" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_fleet_port_settings(call_hash)
  end
...
begin
  result = UpdateFleetPortSettings(params)
