...
def DescribeScalingParameters(*args)
  puts "Calling task operation DescribeScalingParameters" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_scaling_parameters(call_hash)
  end
...
begin
  result = DescribeScalingParameters(params)
