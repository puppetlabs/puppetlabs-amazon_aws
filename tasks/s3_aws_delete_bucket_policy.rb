...
def DeleteBucketPolicy(*args)
  puts "Calling task operation DeleteBucketPolicy" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_bucket_policy(call_hash)
  end
...
begin
  result = DeleteBucketPolicy(params)
