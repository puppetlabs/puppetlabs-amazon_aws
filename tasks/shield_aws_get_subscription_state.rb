...
def GetSubscriptionState(*args)
  puts "Calling task operation GetSubscriptionState" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_subscription_state(call_hash)
  end
...
begin
  result = GetSubscriptionState(params)
