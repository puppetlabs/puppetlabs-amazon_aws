...
def GetClientCertificates(*args)
  puts "Calling task operation GetClientCertificates" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_client_certificates(call_hash)
  end
...
begin
  result = GetClientCertificates(params)
