...
def UpdateNotebookInstanceLifecycleConfig(*args)
  puts "Calling task operation UpdateNotebookInstanceLifecycleConfig" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_notebook_instance_lifecycle_config(call_hash)
  end
...
begin
  result = UpdateNotebookInstanceLifecycleConfig(params)
