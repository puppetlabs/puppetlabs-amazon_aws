...
def UpdateSecurityGroupRuleDescriptionsEgress(*args)
  puts "Calling task operation UpdateSecurityGroupRuleDescriptionsEgress" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_security_group_rule_descriptions_egress(call_hash)
  end
...
begin
  result = UpdateSecurityGroupRuleDescriptionsEgress(params)
