...
def ListAssessmentTargets(*args)
  puts "Calling task operation ListAssessmentTargets" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_assessment_targets(call_hash)
  end
...
begin
  result = ListAssessmentTargets(params)
