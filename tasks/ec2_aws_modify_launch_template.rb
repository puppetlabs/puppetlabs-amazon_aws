...
def ModifyLaunchTemplate(*args)
  puts "Calling task operation ModifyLaunchTemplate" 
  ...
  if arg_hash.empty?
    ...
    response = client.modify_launch_template(call_hash)
  end
...
begin
  result = ModifyLaunchTemplate(params)
