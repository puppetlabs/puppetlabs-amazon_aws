...
def DescribeApplications(*args)
  puts "Calling task operation DescribeApplications" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_applications(call_hash)
  end
...
begin
  result = DescribeApplications(params)
