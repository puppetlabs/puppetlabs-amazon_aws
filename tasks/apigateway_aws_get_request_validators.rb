...
def GetRequestValidators(*args)
  puts "Calling task operation GetRequestValidators" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_request_validators(call_hash)
  end
...
begin
  result = GetRequestValidators(params)
