...
def GetParametersByPath(*args)
  puts "Calling task operation GetParametersByPath" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_parameters_by_path(call_hash)
  end
...
begin
  result = GetParametersByPath(params)
