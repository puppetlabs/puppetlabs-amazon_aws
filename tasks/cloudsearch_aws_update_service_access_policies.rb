...
def UpdateServiceAccessPolicies(*args)
  puts "Calling task operation UpdateServiceAccessPolicies" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_service_access_policies(call_hash)
  end
...
begin
  result = UpdateServiceAccessPolicies(params)
