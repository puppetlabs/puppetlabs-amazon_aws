...
def CreateAssociationBatch(*args)
  puts "Calling task operation CreateAssociationBatch" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_association_batch(call_hash)
  end
...
begin
  result = CreateAssociationBatch(params)
