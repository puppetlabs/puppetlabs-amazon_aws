...
def UpdateOpenIDConnectProviderThumbprint(*args)
  puts "Calling task operation UpdateOpenIDConnectProviderThumbprint" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_open_id_connect_provider_thumbprint(call_hash)
  end
...
begin
  result = UpdateOpenIDConnectProviderThumbprint(params)
