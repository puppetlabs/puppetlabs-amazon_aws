...
def ListObjectPolicies(*args)
  puts "Calling task operation ListObjectPolicies" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_object_policies(call_hash)
  end
...
begin
  result = ListObjectPolicies(params)
