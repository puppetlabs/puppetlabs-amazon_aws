...
def DeleteVaultNotifications(*args)
  puts "Calling task operation DeleteVaultNotifications" 
  ...
  client = Aws::Glacier::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.delete_vault_notifications(call_hash)
  end
...
begin
  result = DeleteVaultNotifications(params)
