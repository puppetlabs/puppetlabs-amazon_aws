...
def CreateStreamingDistributionWithTags2018_06_18(*args)
  puts "Calling task operation CreateStreamingDistributionWithTags2018_06_18" 
  ...
  if arg_hash.empty?
    response = client.create_streaming_distribution_with_tags2018_06_18()
  else 
    call_hash={}
    ...
    response = client.create_streaming_distribution_with_tags2018_06_18(call_hash)
  end
...
begin
  result = CreateStreamingDistributionWithTags2018_06_18(params)
