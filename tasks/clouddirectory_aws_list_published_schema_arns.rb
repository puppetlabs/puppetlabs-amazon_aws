...
def ListPublishedSchemaArns(*args)
  puts "Calling task operation ListPublishedSchemaArns" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_published_schema_arns(call_hash)
  end
...
begin
  result = ListPublishedSchemaArns(params)
