...
def StopStreamProcessor(*args)
  puts "Calling task operation StopStreamProcessor" 
  ...
  if arg_hash.empty?
    ...
    response = client.stop_stream_processor(call_hash)
  end
...
begin
  result = StopStreamProcessor(params)
