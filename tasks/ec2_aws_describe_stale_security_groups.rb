...
def DescribeStaleSecurityGroups(*args)
  puts "Calling task operation DescribeStaleSecurityGroups" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_stale_security_groups(call_hash)
  end
...
begin
  result = DescribeStaleSecurityGroups(params)
