...
def UpdatePullRequestTitle(*args)
  puts "Calling task operation UpdatePullRequestTitle" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_pull_request_title(call_hash)
  end
...
begin
  result = UpdatePullRequestTitle(params)
