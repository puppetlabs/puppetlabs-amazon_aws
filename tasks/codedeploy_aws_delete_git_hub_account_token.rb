...
def DeleteGitHubAccountToken(*args)
  puts "Calling task operation DeleteGitHubAccountToken" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_git_hub_account_token(call_hash)
  end
...
begin
  result = DeleteGitHubAccountToken(params)
