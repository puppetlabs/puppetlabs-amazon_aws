...
def ListOfferingPromotions(*args)
  puts "Calling task operation ListOfferingPromotions" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_offering_promotions(call_hash)
  end
...
begin
  result = ListOfferingPromotions(params)
