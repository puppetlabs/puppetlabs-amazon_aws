...
def DeleteVpcPeeringAuthorization(*args)
  puts "Calling task operation DeleteVpcPeeringAuthorization" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_vpc_peering_authorization(call_hash)
  end
...
begin
  result = DeleteVpcPeeringAuthorization(params)
