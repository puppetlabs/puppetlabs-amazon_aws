...
def DeleteSizeConstraintSet(*args)
  puts "Calling task operation DeleteSizeConstraintSet" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_size_constraint_set(call_hash)
  end
...
begin
  result = DeleteSizeConstraintSet(params)
