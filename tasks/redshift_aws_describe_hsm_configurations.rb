...
def DescribeHsmConfigurations(*args)
  puts "Calling task operation DescribeHsmConfigurations" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_hsm_configurations(call_hash)
  end
...
begin
  result = DescribeHsmConfigurations(params)
