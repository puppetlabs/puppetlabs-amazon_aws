...
def DescribeStorediSCSIVolumes(*args)
  puts "Calling task operation DescribeStorediSCSIVolumes" 
  ...
  if arg_hash.empty?
    response = client.describe_storedi_scsi_volumes()
  else 
    call_hash={}
    ...
    response = client.describe_storedi_scsi_volumes(call_hash)
  end
...
begin
  result = DescribeStorediSCSIVolumes(params)
