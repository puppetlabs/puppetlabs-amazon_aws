...
def DescribeDBClusters(*args)
  puts "Calling task operation DescribeDBClusters" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_db_clusters(call_hash)
  end
...
begin
  result = DescribeDBClusters(params)
