...
def DescribeAutoScalingNotificationTypes(*args)
  puts "Calling task operation DescribeAutoScalingNotificationTypes" 
  ...
  client = Aws::AutoScaling::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.describe_auto_scaling_notification_types(call_hash)
  end
...
begin
  result = DescribeAutoScalingNotificationTypes(params)
