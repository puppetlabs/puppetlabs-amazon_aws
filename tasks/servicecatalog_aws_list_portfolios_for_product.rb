...
def ListPortfoliosForProduct(*args)
  puts "Calling task operation ListPortfoliosForProduct" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_portfolios_for_product(call_hash)
  end
...
begin
  result = ListPortfoliosForProduct(params)
