...
def GenerateDataKeyWithoutPlaintext(*args)
  puts "Calling task operation GenerateDataKeyWithoutPlaintext" 
  ...
  client = Aws::KMS::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.generate_data_key_without_plaintext(call_hash)
  end
...
begin
  result = GenerateDataKeyWithoutPlaintext(params)
