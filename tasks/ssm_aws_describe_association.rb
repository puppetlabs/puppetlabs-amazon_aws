...
def DescribeAssociation(*args)
  puts "Calling task operation DescribeAssociation" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_association(call_hash)
  end
...
begin
  result = DescribeAssociation(params)
