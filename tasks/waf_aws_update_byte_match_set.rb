...
def UpdateByteMatchSet(*args)
  puts "Calling task operation UpdateByteMatchSet" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_byte_match_set(call_hash)
  end
...
begin
  result = UpdateByteMatchSet(params)
