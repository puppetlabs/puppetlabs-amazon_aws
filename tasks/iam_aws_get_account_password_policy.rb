...
def GetAccountPasswordPolicy(*args)
  puts "Calling task operation GetAccountPasswordPolicy" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_account_password_policy(call_hash)
  end
...
begin
  result = GetAccountPasswordPolicy(params)
