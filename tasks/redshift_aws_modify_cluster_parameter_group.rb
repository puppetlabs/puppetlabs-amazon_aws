...
def ModifyClusterParameterGroup(*args)
  puts "Calling task operation ModifyClusterParameterGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.modify_cluster_parameter_group(call_hash)
  end
...
begin
  result = ModifyClusterParameterGroup(params)
