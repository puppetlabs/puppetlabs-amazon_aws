...
def DeleteImagePermissions(*args)
  puts "Calling task operation DeleteImagePermissions" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_image_permissions(call_hash)
  end
...
begin
  result = DeleteImagePermissions(params)
