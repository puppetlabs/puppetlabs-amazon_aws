...
def CreateLoadBalancerListeners(*args)
  puts "Calling task operation CreateLoadBalancerListeners" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_load_balancer_listeners(call_hash)
  end
...
begin
  result = CreateLoadBalancerListeners(params)
