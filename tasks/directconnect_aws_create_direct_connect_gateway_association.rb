...
def CreateDirectConnectGatewayAssociation(*args)
  puts "Calling task operation CreateDirectConnectGatewayAssociation" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_direct_connect_gateway_association(call_hash)
  end
...
begin
  result = CreateDirectConnectGatewayAssociation(params)
