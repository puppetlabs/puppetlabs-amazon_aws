...
def DescribeStateMachineForExecution(*args)
  puts "Calling task operation DescribeStateMachineForExecution" 
  ...
  client = Aws::States::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.describe_state_machine_for_execution(call_hash)
  end
...
begin
  result = DescribeStateMachineForExecution(params)
