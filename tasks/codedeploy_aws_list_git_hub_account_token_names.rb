...
def ListGitHubAccountTokenNames(*args)
  puts "Calling task operation ListGitHubAccountTokenNames" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_git_hub_account_token_names(call_hash)
  end
...
begin
  result = ListGitHubAccountTokenNames(params)
