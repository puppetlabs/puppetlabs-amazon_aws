...
def DeleteGameSessionQueue(*args)
  puts "Calling task operation DeleteGameSessionQueue" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_game_session_queue(call_hash)
  end
...
begin
  result = DeleteGameSessionQueue(params)
