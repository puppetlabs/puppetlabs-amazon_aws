...
def ListVPCAssociationAuthorizations(*args)
  puts "Calling task operation ListVPCAssociationAuthorizations" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_vpc_association_authorizations(call_hash)
  end
...
begin
  result = ListVPCAssociationAuthorizations(params)
