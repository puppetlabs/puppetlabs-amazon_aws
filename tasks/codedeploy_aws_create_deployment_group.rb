...
def CreateDeploymentGroup(*args)
  puts "Calling task operation CreateDeploymentGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_deployment_group(call_hash)
  end
...
begin
  result = CreateDeploymentGroup(params)
