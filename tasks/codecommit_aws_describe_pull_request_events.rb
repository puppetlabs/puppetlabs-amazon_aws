...
def DescribePullRequestEvents(*args)
  puts "Calling task operation DescribePullRequestEvents" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_pull_request_events(call_hash)
  end
...
begin
  result = DescribePullRequestEvents(params)
