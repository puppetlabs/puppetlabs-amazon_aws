...
def GetDistribution2018_06_18(*args)
  puts "Calling task operation GetDistribution2018_06_18" 
  ...
  if arg_hash.empty?
    response = client.get_distribution2018_06_18()
  else 
    call_hash={}
    ...
    response = client.get_distribution2018_06_18(call_hash)
  end
...
begin
  result = GetDistribution2018_06_18(params)
