...
def CreateQueryLoggingConfig(*args)
  puts "Calling task operation CreateQueryLoggingConfig" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_query_logging_config(call_hash)
  end
...
begin
  result = CreateQueryLoggingConfig(params)
