...
def ListLoggerDefinitionVersions(*args)
  puts "Calling task operation ListLoggerDefinitionVersions" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_logger_definition_versions(call_hash)
  end
...
begin
  result = ListLoggerDefinitionVersions(params)
