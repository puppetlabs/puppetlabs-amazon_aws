...
def DescribeInstanceInformation(*args)
  puts "Calling task operation DescribeInstanceInformation" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_instance_information(call_hash)
  end
...
begin
  result = DescribeInstanceInformation(params)
