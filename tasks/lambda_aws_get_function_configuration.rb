...
def GetFunctionConfiguration(*args)
  puts "Calling task operation GetFunctionConfiguration" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_function_configuration(call_hash)
  end
...
begin
  result = GetFunctionConfiguration(params)
