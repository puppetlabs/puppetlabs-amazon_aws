...
def DescribeSnapshotCopyGrants(*args)
  puts "Calling task operation DescribeSnapshotCopyGrants" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_snapshot_copy_grants(call_hash)
  end
...
begin
  result = DescribeSnapshotCopyGrants(params)
