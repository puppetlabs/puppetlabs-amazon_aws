...
def UpdateAvailabilityOptions(*args)
  puts "Calling task operation UpdateAvailabilityOptions" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_availability_options(call_hash)
  end
...
begin
  result = UpdateAvailabilityOptions(params)
