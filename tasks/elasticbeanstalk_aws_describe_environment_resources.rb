...
def DescribeEnvironmentResources(*args)
  puts "Calling task operation DescribeEnvironmentResources" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_environment_resources(call_hash)
  end
...
begin
  result = DescribeEnvironmentResources(params)
