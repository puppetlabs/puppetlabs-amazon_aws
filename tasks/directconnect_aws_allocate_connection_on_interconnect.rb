...
def AllocateConnectionOnInterconnect(*args)
  puts "Calling task operation AllocateConnectionOnInterconnect" 
  ...
  if arg_hash.empty?
    ...
    response = client.allocate_connection_on_interconnect(call_hash)
  end
...
begin
  result = AllocateConnectionOnInterconnect(params)
