...
def GetInstanceProfile(*args)
  puts "Calling task operation GetInstanceProfile" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_instance_profile(call_hash)
  end
...
begin
  result = GetInstanceProfile(params)
