...
def ListObjectParentPaths(*args)
  puts "Calling task operation ListObjectParentPaths" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_object_parent_paths(call_hash)
  end
...
begin
  result = ListObjectParentPaths(params)
