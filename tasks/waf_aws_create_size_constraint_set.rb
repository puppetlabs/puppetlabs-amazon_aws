...
def CreateSizeConstraintSet(*args)
  puts "Calling task operation CreateSizeConstraintSet" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_size_constraint_set(call_hash)
  end
...
begin
  result = CreateSizeConstraintSet(params)
