...
def DescribeOptionGroups(*args)
  puts "Calling task operation DescribeOptionGroups" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_option_groups(call_hash)
  end
...
begin
  result = DescribeOptionGroups(params)
