...
def UpdateChapCredentials(*args)
  puts "Calling task operation UpdateChapCredentials" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_chap_credentials(call_hash)
  end
...
begin
  result = UpdateChapCredentials(params)
