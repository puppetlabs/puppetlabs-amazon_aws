...
def DeleteEndpointConfig(*args)
  puts "Calling task operation DeleteEndpointConfig" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_endpoint_config(call_hash)
  end
...
begin
  result = DeleteEndpointConfig(params)
