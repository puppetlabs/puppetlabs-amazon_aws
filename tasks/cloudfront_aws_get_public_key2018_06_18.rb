...
def GetPublicKey2018_06_18(*args)
  puts "Calling task operation GetPublicKey2018_06_18" 
  ...
  if arg_hash.empty?
    response = client.get_public_key2018_06_18()
  else 
    call_hash={}
    ...
    response = client.get_public_key2018_06_18(call_hash)
  end
...
begin
  result = GetPublicKey2018_06_18(params)
