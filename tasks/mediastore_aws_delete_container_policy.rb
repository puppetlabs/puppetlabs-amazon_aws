...
def DeleteContainerPolicy(*args)
  puts "Calling task operation DeleteContainerPolicy" 
  ...
  client = Aws::MediaStore::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.delete_container_policy(call_hash)
  end
...
begin
  result = DeleteContainerPolicy(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::MediaStore::Errors::ServiceError => e
