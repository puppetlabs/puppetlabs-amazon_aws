...
def DescribeDhcpOptions(*args)
  puts "Calling task operation DescribeDhcpOptions" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_dhcp_options(call_hash)
  end
...
begin
  result = DescribeDhcpOptions(params)
