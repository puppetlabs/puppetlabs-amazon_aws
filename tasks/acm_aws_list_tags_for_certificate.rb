...
def ListTagsForCertificate(*args)
  puts "Calling task operation ListTagsForCertificate" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_tags_for_certificate(call_hash)
  end
...
begin
  result = ListTagsForCertificate(params)
