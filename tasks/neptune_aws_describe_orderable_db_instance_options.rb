...
def DescribeOrderableDBInstanceOptions(*args)
  puts "Calling task operation DescribeOrderableDBInstanceOptions" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_orderable_db_instance_options(call_hash)
  end
...
begin
  result = DescribeOrderableDBInstanceOptions(params)
