...
def ListServerCertificates(*args)
  puts "Calling task operation ListServerCertificates" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_server_certificates(call_hash)
  end
...
begin
  result = ListServerCertificates(params)
