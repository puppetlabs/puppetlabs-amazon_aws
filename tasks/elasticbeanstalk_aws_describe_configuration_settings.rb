...
def DescribeConfigurationSettings(*args)
  puts "Calling task operation DescribeConfigurationSettings" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_configuration_settings(call_hash)
  end
...
begin
  result = DescribeConfigurationSettings(params)
