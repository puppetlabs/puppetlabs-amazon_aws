...
def ListJobsByPipeline(*args)
  puts "Calling task operation ListJobsByPipeline" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_jobs_by_pipeline(call_hash)
  end
...
begin
  result = ListJobsByPipeline(params)
