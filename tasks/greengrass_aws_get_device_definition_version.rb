...
def GetDeviceDefinitionVersion(*args)
  puts "Calling task operation GetDeviceDefinitionVersion" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_device_definition_version(call_hash)
  end
...
begin
  result = GetDeviceDefinitionVersion(params)
