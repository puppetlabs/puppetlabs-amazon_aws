...
def StartContentModeration(*args)
  puts "Calling task operation StartContentModeration" 
  ...
  if arg_hash.empty?
    ...
    response = client.start_content_moderation(call_hash)
  end
...
begin
  result = StartContentModeration(params)
