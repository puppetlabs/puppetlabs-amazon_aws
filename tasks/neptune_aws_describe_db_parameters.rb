...
def DescribeDBParameters(*args)
  puts "Calling task operation DescribeDBParameters" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_db_parameters(call_hash)
  end
...
begin
  result = DescribeDBParameters(params)
