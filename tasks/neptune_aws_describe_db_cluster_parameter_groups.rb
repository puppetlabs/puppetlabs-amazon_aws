...
def DescribeDBClusterParameterGroups(*args)
  puts "Calling task operation DescribeDBClusterParameterGroups" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_db_cluster_parameter_groups(call_hash)
  end
...
begin
  result = DescribeDBClusterParameterGroups(params)
