...
def DescribeEnvironmentStatus(*args)
  puts "Calling task operation DescribeEnvironmentStatus" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_environment_status(call_hash)
  end
...
begin
  result = DescribeEnvironmentStatus(params)
