...
def DescribeMatchmakingConfigurations(*args)
  puts "Calling task operation DescribeMatchmakingConfigurations" 
  ...
  client = Aws::GameLift::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.describe_matchmaking_configurations(call_hash)
  end
...
begin
  result = DescribeMatchmakingConfigurations(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::GameLift::Errors::ServiceError => e
