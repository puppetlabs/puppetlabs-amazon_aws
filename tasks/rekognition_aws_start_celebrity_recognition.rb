...
def StartCelebrityRecognition(*args)
  puts "Calling task operation StartCelebrityRecognition" 
  ...
  client = Aws::Rekognition::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.start_celebrity_recognition(call_hash)
  end
...
begin
  result = StartCelebrityRecognition(params)
