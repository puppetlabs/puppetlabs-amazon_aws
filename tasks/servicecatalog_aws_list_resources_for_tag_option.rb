...
def ListResourcesForTagOption(*args)
  puts "Calling task operation ListResourcesForTagOption" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_resources_for_tag_option(call_hash)
  end
...
begin
  result = ListResourcesForTagOption(params)
