...
def TerminateProvisionedProduct(*args)
  puts "Calling task operation TerminateProvisionedProduct" 
  ...
  if arg_hash.empty?
    ...
    response = client.terminate_provisioned_product(call_hash)
  end
...
begin
  result = TerminateProvisionedProduct(params)
