...
def DeleteSnapshotCopyGrant(*args)
  puts "Calling task operation DeleteSnapshotCopyGrant" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_snapshot_copy_grant(call_hash)
  end
...
begin
  result = DeleteSnapshotCopyGrant(params)
