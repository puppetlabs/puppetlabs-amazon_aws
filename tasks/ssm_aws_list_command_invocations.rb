...
def ListCommandInvocations(*args)
  puts "Calling task operation ListCommandInvocations" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_command_invocations(call_hash)
  end
...
begin
  result = ListCommandInvocations(params)
