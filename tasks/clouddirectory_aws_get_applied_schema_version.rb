...
def GetAppliedSchemaVersion(*args)
  puts "Calling task operation GetAppliedSchemaVersion" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_applied_schema_version(call_hash)
  end
...
begin
  result = GetAppliedSchemaVersion(params)
