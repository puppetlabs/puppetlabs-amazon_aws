...
def ListDeviceDefinitionVersions(*args)
  puts "Calling task operation ListDeviceDefinitionVersions" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_device_definition_versions(call_hash)
  end
...
begin
  result = ListDeviceDefinitionVersions(params)
