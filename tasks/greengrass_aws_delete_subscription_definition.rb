...
def DeleteSubscriptionDefinition(*args)
  puts "Calling task operation DeleteSubscriptionDefinition" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_subscription_definition(call_hash)
  end
...
begin
  result = DeleteSubscriptionDefinition(params)
