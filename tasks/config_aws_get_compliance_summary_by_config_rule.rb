...
def GetComplianceSummaryByConfigRule(*args)
  puts "Calling task operation GetComplianceSummaryByConfigRule" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_compliance_summary_by_config_rule(call_hash)
  end
...
begin
  result = GetComplianceSummaryByConfigRule(params)
