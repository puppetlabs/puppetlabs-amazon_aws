...
def DescribeBundleTasks(*args)
  puts "Calling task operation DescribeBundleTasks" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_bundle_tasks(call_hash)
  end
...
begin
  result = DescribeBundleTasks(params)
