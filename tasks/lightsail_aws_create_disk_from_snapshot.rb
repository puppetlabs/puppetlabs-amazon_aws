...
def CreateDiskFromSnapshot(*args)
  puts "Calling task operation CreateDiskFromSnapshot" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_disk_from_snapshot(call_hash)
  end
...
begin
  result = CreateDiskFromSnapshot(params)
