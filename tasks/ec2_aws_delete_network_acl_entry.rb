...
def DeleteNetworkAclEntry(*args)
  puts "Calling task operation DeleteNetworkAclEntry" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_network_acl_entry(call_hash)
  end
...
begin
  result = DeleteNetworkAclEntry(params)
