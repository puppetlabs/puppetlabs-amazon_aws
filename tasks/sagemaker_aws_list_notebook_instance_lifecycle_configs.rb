...
def ListNotebookInstanceLifecycleConfigs(*args)
  puts "Calling task operation ListNotebookInstanceLifecycleConfigs" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_notebook_instance_lifecycle_configs(call_hash)
  end
...
begin
  result = ListNotebookInstanceLifecycleConfigs(params)
