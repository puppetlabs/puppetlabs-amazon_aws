...
def DescribeAccountAttributes(*args)
  puts "Calling task operation DescribeAccountAttributes" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_account_attributes(call_hash)
  end
...
begin
  result = DescribeAccountAttributes(params)
