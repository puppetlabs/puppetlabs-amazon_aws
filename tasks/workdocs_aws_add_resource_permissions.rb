...
def AddResourcePermissions(*args)
  puts "Calling task operation AddResourcePermissions" 
  ...
  if arg_hash.empty?
    ...
    response = client.add_resource_permissions(call_hash)
  end
...
begin
  result = AddResourcePermissions(params)
