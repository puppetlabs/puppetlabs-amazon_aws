...
def ListDominantLanguageDetectionJobs(*args)
  puts "Calling task operation ListDominantLanguageDetectionJobs" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_dominant_language_detection_jobs(call_hash)
  end
...
begin
  result = ListDominantLanguageDetectionJobs(params)
