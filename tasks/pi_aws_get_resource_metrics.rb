...
def GetResourceMetrics(*args)
  puts "Calling task operation GetResourceMetrics" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_resource_metrics(call_hash)
  end
...
begin
  result = GetResourceMetrics(params)
