...
def DescribeFleetInstances(*args)
  puts "Calling task operation DescribeFleetInstances" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_fleet_instances(call_hash)
  end
...
begin
  result = DescribeFleetInstances(params)
