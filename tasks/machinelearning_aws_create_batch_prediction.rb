...
def CreateBatchPrediction(*args)
  puts "Calling task operation CreateBatchPrediction" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_batch_prediction(call_hash)
  end
...
begin
  result = CreateBatchPrediction(params)
