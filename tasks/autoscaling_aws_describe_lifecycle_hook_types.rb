...
def DescribeLifecycleHookTypes(*args)
  puts "Calling task operation DescribeLifecycleHookTypes" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_lifecycle_hook_types(call_hash)
  end
...
begin
  result = DescribeLifecycleHookTypes(params)
