...
def GetBucketMetricsConfiguration(*args)
  puts "Calling task operation GetBucketMetricsConfiguration" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_bucket_metrics_configuration(call_hash)
  end
...
begin
  result = GetBucketMetricsConfiguration(params)
