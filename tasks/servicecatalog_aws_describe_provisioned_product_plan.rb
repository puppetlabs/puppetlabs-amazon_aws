...
def DescribeProvisionedProductPlan(*args)
  puts "Calling task operation DescribeProvisionedProductPlan" 
  ...
  client = Aws::ServiceCatalog::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.describe_provisioned_product_plan(call_hash)
  end
...
begin
  result = DescribeProvisionedProductPlan(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::ServiceCatalog::Errors::ServiceError => e
