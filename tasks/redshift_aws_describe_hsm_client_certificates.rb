...
def DescribeHsmClientCertificates(*args)
  puts "Calling task operation DescribeHsmClientCertificates" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_hsm_client_certificates(call_hash)
  end
...
begin
  result = DescribeHsmClientCertificates(params)
