...
def AddApplicationInput(*args)
  puts "Calling task operation AddApplicationInput" 
  ...
  if arg_hash.empty?
    ...
    response = client.add_application_input(call_hash)
  end
...
begin
  result = AddApplicationInput(params)
