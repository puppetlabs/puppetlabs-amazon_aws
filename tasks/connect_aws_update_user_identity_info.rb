...
def UpdateUserIdentityInfo(*args)
  puts "Calling task operation UpdateUserIdentityInfo" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_user_identity_info(call_hash)
  end
...
begin
  result = UpdateUserIdentityInfo(params)
