...
def DescribeDocumentPermission(*args)
  puts "Calling task operation DescribeDocumentPermission" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_document_permission(call_hash)
  end
...
begin
  result = DescribeDocumentPermission(params)
