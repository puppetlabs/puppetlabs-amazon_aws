...
def CreateLoggerDefinition(*args)
  puts "Calling task operation CreateLoggerDefinition" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_logger_definition(call_hash)
  end
...
begin
  result = CreateLoggerDefinition(params)
