...
def DeleteSnapshotSchedule(*args)
  puts "Calling task operation DeleteSnapshotSchedule" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_snapshot_schedule(call_hash)
  end
...
begin
  result = DeleteSnapshotSchedule(params)
