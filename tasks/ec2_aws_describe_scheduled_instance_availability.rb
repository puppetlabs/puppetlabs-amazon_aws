...
def DescribeScheduledInstanceAvailability(*args)
  puts "Calling task operation DescribeScheduledInstanceAvailability" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_scheduled_instance_availability(call_hash)
  end
...
begin
  result = DescribeScheduledInstanceAvailability(params)
