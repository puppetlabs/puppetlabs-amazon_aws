...
def DeleteDatasetContent(*args)
  puts "Calling task operation DeleteDatasetContent" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_dataset_content(call_hash)
  end
...
begin
  result = DeleteDatasetContent(params)
