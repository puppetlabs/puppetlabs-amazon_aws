...
def DeleteOrganization(*args)
  puts "Calling task operation DeleteOrganization" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_organization(call_hash)
  end
...
begin
  result = DeleteOrganization(params)
