...
def ModifyReservedInstances(*args)
  puts "Calling task operation ModifyReservedInstances" 
  ...
  if arg_hash.empty?
    ...
    response = client.modify_reserved_instances(call_hash)
  end
...
begin
  result = ModifyReservedInstances(params)
