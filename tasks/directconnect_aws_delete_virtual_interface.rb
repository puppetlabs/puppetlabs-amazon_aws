...
def DeleteVirtualInterface(*args)
  puts "Calling task operation DeleteVirtualInterface" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_virtual_interface(call_hash)
  end
...
begin
  result = DeleteVirtualInterface(params)
