...
def StopStreamEncryption(*args)
  puts "Calling task operation StopStreamEncryption" 
  ...
  if arg_hash.empty?
    ...
    response = client.stop_stream_encryption(call_hash)
  end
...
begin
  result = StopStreamEncryption(params)
