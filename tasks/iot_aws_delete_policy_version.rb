...
def DeletePolicyVersion(*args)
  puts "Calling task operation DeletePolicyVersion" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_policy_version(call_hash)
  end
...
begin
  result = DeletePolicyVersion(params)
