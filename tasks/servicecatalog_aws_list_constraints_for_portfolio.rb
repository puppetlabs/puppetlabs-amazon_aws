...
def ListConstraintsForPortfolio(*args)
  puts "Calling task operation ListConstraintsForPortfolio" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_constraints_for_portfolio(call_hash)
  end
...
begin
  result = ListConstraintsForPortfolio(params)
