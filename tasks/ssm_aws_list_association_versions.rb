...
def ListAssociationVersions(*args)
  puts "Calling task operation ListAssociationVersions" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_association_versions(call_hash)
  end
...
begin
  result = ListAssociationVersions(params)
