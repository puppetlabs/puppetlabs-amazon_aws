...
def DeletePendingAggregationRequest(*args)
  puts "Calling task operation DeletePendingAggregationRequest" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_pending_aggregation_request(call_hash)
  end
...
begin
  result = DeletePendingAggregationRequest(params)
