...
def DeleteConfigurationTemplate(*args)
  puts "Calling task operation DeleteConfigurationTemplate" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_configuration_template(call_hash)
  end
...
begin
  result = DeleteConfigurationTemplate(params)
