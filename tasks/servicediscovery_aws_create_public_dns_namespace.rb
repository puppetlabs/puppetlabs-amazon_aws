...
def CreatePublicDnsNamespace(*args)
  puts "Calling task operation CreatePublicDnsNamespace" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_public_dns_namespace(call_hash)
  end
...
begin
  result = CreatePublicDnsNamespace(params)
