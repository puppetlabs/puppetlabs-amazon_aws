...
def DescribeTimeToLive(*args)
  puts "Calling task operation DescribeTimeToLive" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_time_to_live(call_hash)
  end
...
begin
  result = DescribeTimeToLive(params)
