...
def ListComplianceStatus(*args)
  puts "Calling task operation ListComplianceStatus" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_compliance_status(call_hash)
  end
...
begin
  result = ListComplianceStatus(params)
