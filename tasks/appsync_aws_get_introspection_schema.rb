...
def GetIntrospectionSchema(*args)
  puts "Calling task operation GetIntrospectionSchema" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_introspection_schema(call_hash)
  end
...
begin
  result = GetIntrospectionSchema(params)
