...
def CreateNFSFileShare(*args)
  puts "Calling task operation CreateNFSFileShare" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_nfs_file_share(call_hash)
  end
...
begin
  result = CreateNFSFileShare(params)
