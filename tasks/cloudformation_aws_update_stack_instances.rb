...
def UpdateStackInstances(*args)
  puts "Calling task operation UpdateStackInstances" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_stack_instances(call_hash)
  end
...
begin
  result = UpdateStackInstances(params)
