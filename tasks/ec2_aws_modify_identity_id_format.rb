...
def ModifyIdentityIdFormat(*args)
  puts "Calling task operation ModifyIdentityIdFormat" 
  ...
  if arg_hash.empty?
    ...
    response = client.modify_identity_id_format(call_hash)
  end
...
begin
  result = ModifyIdentityIdFormat(params)
