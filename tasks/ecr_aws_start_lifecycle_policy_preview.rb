...
def StartLifecyclePolicyPreview(*args)
  puts "Calling task operation StartLifecyclePolicyPreview" 
  ...
  client = Aws::ECR::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.start_lifecycle_policy_preview(call_hash)
  end
...
begin
  result = StartLifecyclePolicyPreview(params)
