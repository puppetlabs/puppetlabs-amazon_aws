...
def AttachClassicLinkVpc(*args)
  puts "Calling task operation AttachClassicLinkVpc" 
  ...
  if arg_hash.empty?
    ...
    response = client.attach_classic_link_vpc(call_hash)
  end
...
begin
  result = AttachClassicLinkVpc(params)
