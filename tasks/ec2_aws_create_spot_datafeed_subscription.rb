...
def CreateSpotDatafeedSubscription(*args)
  puts "Calling task operation CreateSpotDatafeedSubscription" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_spot_datafeed_subscription(call_hash)
  end
...
begin
  result = CreateSpotDatafeedSubscription(params)
