...
def ModifyCacheCluster(*args)
  puts "Calling task operation ModifyCacheCluster" 
  ...
  if arg_hash.empty?
    ...
    response = client.modify_cache_cluster(call_hash)
  end
...
begin
  result = ModifyCacheCluster(params)
