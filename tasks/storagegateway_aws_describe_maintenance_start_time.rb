...
def DescribeMaintenanceStartTime(*args)
  puts "Calling task operation DescribeMaintenanceStartTime" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_maintenance_start_time(call_hash)
  end
...
begin
  result = DescribeMaintenanceStartTime(params)
