...
def UpdatePatchBaseline(*args)
  puts "Calling task operation UpdatePatchBaseline" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_patch_baseline(call_hash)
  end
...
begin
  result = UpdatePatchBaseline(params)
