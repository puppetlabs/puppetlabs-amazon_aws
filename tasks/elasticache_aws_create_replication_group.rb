...
def CreateReplicationGroup(*args)
  puts "Calling task operation CreateReplicationGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_replication_group(call_hash)
  end
...
begin
  result = CreateReplicationGroup(params)
