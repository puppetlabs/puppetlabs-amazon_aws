...
def ListAcceptedPortfolioShares(*args)
  puts "Calling task operation ListAcceptedPortfolioShares" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_accepted_portfolio_shares(call_hash)
  end
...
begin
  result = ListAcceptedPortfolioShares(params)
