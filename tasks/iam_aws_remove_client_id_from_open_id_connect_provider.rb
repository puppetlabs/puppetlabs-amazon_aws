...
def RemoveClientIDFromOpenIDConnectProvider(*args)
  puts "Calling task operation RemoveClientIDFromOpenIDConnectProvider" 
  ...
  client = Aws::IAM::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.remove_client_id_from_open_id_connect_provider(call_hash)
  end
...
begin
  result = RemoveClientIDFromOpenIDConnectProvider(params)
