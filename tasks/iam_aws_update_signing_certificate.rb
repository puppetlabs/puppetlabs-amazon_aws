...
def UpdateSigningCertificate(*args)
  puts "Calling task operation UpdateSigningCertificate" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_signing_certificate(call_hash)
  end
...
begin
  result = UpdateSigningCertificate(params)
