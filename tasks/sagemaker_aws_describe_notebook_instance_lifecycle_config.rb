...
def DescribeNotebookInstanceLifecycleConfig(*args)
  puts "Calling task operation DescribeNotebookInstanceLifecycleConfig" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_notebook_instance_lifecycle_config(call_hash)
  end
...
begin
  result = DescribeNotebookInstanceLifecycleConfig(params)
