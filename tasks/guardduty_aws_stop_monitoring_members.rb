...
def StopMonitoringMembers(*args)
  puts "Calling task operation StopMonitoringMembers" 
  ...
  if arg_hash.empty?
    ...
    response = client.stop_monitoring_members(call_hash)
  end
...
begin
  result = StopMonitoringMembers(params)
