...
def TerminateEnvironment(*args)
  puts "Calling task operation TerminateEnvironment" 
  ...
  if arg_hash.empty?
    ...
    response = client.terminate_environment(call_hash)
  end
...
begin
  result = TerminateEnvironment(params)
