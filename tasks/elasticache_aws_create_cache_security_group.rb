...
def CreateCacheSecurityGroup(*args)
  puts "Calling task operation CreateCacheSecurityGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_cache_security_group(call_hash)
  end
...
begin
  result = CreateCacheSecurityGroup(params)
