...
def DescribeConfiguration(*args)
  puts "Calling task operation DescribeConfiguration" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_configuration(call_hash)
  end
...
begin
  result = DescribeConfiguration(params)
