...
def DescribeFolderContents(*args)
  puts "Calling task operation DescribeFolderContents" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_folder_contents(call_hash)
  end
...
begin
  result = DescribeFolderContents(params)
