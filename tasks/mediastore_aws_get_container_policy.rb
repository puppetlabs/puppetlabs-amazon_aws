...
def GetContainerPolicy(*args)
  puts "Calling task operation GetContainerPolicy" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_container_policy(call_hash)
  end
...
begin
  result = GetContainerPolicy(params)
