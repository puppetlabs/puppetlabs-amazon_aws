...
def ListEndpointConfigs(*args)
  puts "Calling task operation ListEndpointConfigs" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_endpoint_configs(call_hash)
  end
...
begin
  result = ListEndpointConfigs(params)
