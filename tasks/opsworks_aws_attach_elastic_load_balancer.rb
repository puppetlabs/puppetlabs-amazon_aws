...
def AttachElasticLoadBalancer(*args)
  puts "Calling task operation AttachElasticLoadBalancer" 
  ...
  if arg_hash.empty?
    ...
    response = client.attach_elastic_load_balancer(call_hash)
  end
...
begin
  result = AttachElasticLoadBalancer(params)
