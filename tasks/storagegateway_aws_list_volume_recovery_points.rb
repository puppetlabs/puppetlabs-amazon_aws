...
def ListVolumeRecoveryPoints(*args)
  puts "Calling task operation ListVolumeRecoveryPoints" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_volume_recovery_points(call_hash)
  end
...
begin
  result = ListVolumeRecoveryPoints(params)
