...
def AttachLoadBalancerTlsCertificate(*args)
  puts "Calling task operation AttachLoadBalancerTlsCertificate" 
  ...
  if arg_hash.empty?
    ...
    response = client.attach_load_balancer_tls_certificate(call_hash)
  end
...
begin
  result = AttachLoadBalancerTlsCertificate(params)
