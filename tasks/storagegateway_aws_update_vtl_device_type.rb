...
def UpdateVTLDeviceType(*args)
  puts "Calling task operation UpdateVTLDeviceType" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_vtl_device_type(call_hash)
  end
...
begin
  result = UpdateVTLDeviceType(params)
