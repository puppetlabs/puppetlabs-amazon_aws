...
def DescribeUploadBuffer(*args)
  puts "Calling task operation DescribeUploadBuffer" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_upload_buffer(call_hash)
  end
...
begin
  result = DescribeUploadBuffer(params)
