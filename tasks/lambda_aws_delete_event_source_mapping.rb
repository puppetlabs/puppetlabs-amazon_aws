...
def DeleteEventSourceMapping(*args)
  puts "Calling task operation DeleteEventSourceMapping" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_event_source_mapping(call_hash)
  end
...
begin
  result = DeleteEventSourceMapping(params)
