...
def CreateEnvironmentMembership(*args)
  puts "Calling task operation CreateEnvironmentMembership" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_environment_membership(call_hash)
  end
...
begin
  result = CreateEnvironmentMembership(params)
