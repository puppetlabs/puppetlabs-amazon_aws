...
def ModifyVpcEndpointServicePermissions(*args)
  puts "Calling task operation ModifyVpcEndpointServicePermissions" 
  ...
  if arg_hash.empty?
    ...
    response = client.modify_vpc_endpoint_service_permissions(call_hash)
  end
...
begin
  result = ModifyVpcEndpointServicePermissions(params)
