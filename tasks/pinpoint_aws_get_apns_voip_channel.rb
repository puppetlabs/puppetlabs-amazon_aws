...
def GetApnsVoipChannel(*args)
  puts "Calling task operation GetApnsVoipChannel" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_apns_voip_channel(call_hash)
  end
...
begin
  result = GetApnsVoipChannel(params)
