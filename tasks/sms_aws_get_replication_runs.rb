...
def GetReplicationRuns(*args)
  puts "Calling task operation GetReplicationRuns" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_replication_runs(call_hash)
  end
...
begin
  result = GetReplicationRuns(params)
