...
def DescribeStreamSummary(*args)
  puts "Calling task operation DescribeStreamSummary" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_stream_summary(call_hash)
  end
...
begin
  result = DescribeStreamSummary(params)
