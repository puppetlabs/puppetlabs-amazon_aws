...
def DeleteFolderContents(*args)
  puts "Calling task operation DeleteFolderContents" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_folder_contents(call_hash)
  end
...
begin
  result = DeleteFolderContents(params)
