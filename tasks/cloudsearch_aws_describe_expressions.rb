...
def DescribeExpressions(*args)
  puts "Calling task operation DescribeExpressions" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_expressions(call_hash)
  end
...
begin
  result = DescribeExpressions(params)
