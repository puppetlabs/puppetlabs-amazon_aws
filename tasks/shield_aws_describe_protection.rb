...
def DescribeProtection(*args)
  puts "Calling task operation DescribeProtection" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_protection(call_hash)
  end
...
begin
  result = DescribeProtection(params)
