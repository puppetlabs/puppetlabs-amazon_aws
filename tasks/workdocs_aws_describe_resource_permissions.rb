...
def DescribeResourcePermissions(*args)
  puts "Calling task operation DescribeResourcePermissions" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_resource_permissions(call_hash)
  end
...
begin
  result = DescribeResourcePermissions(params)
