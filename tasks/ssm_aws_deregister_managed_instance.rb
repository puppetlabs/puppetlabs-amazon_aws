...
def DeregisterManagedInstance(*args)
  puts "Calling task operation DeregisterManagedInstance" 
  ...
  if arg_hash.empty?
    ...
    response = client.deregister_managed_instance(call_hash)
  end
...
begin
  result = DeregisterManagedInstance(params)
