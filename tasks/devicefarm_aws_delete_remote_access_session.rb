...
def DeleteRemoteAccessSession(*args)
  puts "Calling task operation DeleteRemoteAccessSession" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_remote_access_session(call_hash)
  end
...
begin
  result = DeleteRemoteAccessSession(params)
