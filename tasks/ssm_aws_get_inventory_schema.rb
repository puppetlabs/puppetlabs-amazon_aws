...
def GetInventorySchema(*args)
  puts "Calling task operation GetInventorySchema" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_inventory_schema(call_hash)
  end
...
begin
  result = GetInventorySchema(params)
