...
def DescribeDBSnapshotAttributes(*args)
  puts "Calling task operation DescribeDBSnapshotAttributes" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_db_snapshot_attributes(call_hash)
  end
...
begin
  result = DescribeDBSnapshotAttributes(params)
