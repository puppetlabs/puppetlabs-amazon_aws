...
def GetBatchPrediction(*args)
  puts "Calling task operation GetBatchPrediction" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_batch_prediction(call_hash)
  end
...
begin
  result = GetBatchPrediction(params)
