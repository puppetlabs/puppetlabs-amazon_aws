...
def GetTrafficPolicyInstance(*args)
  puts "Calling task operation GetTrafficPolicyInstance" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_traffic_policy_instance(call_hash)
  end
...
begin
  result = GetTrafficPolicyInstance(params)
