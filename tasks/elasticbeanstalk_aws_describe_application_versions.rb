...
def DescribeApplicationVersions(*args)
  puts "Calling task operation DescribeApplicationVersions" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_application_versions(call_hash)
  end
...
begin
  result = DescribeApplicationVersions(params)
