...
def DescribeReservedCacheNodes(*args)
  puts "Calling task operation DescribeReservedCacheNodes" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_reserved_cache_nodes(call_hash)
  end
...
begin
  result = DescribeReservedCacheNodes(params)
