...
def DescribeWorkflowExecution(*args)
  puts "Calling task operation DescribeWorkflowExecution" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_workflow_execution(call_hash)
  end
...
begin
  result = DescribeWorkflowExecution(params)
