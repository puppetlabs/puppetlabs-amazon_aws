...
def GetResourceDefinitionVersion(*args)
  puts "Calling task operation GetResourceDefinitionVersion" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_resource_definition_version(call_hash)
  end
...
begin
  result = GetResourceDefinitionVersion(params)
