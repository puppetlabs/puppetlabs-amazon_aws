...
def DescribeVolumesModifications(*args)
  puts "Calling task operation DescribeVolumesModifications" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_volumes_modifications(call_hash)
  end
...
begin
  result = DescribeVolumesModifications(params)
