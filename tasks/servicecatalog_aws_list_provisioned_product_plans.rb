...
def ListProvisionedProductPlans(*args)
  puts "Calling task operation ListProvisionedProductPlans" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_provisioned_product_plans(call_hash)
  end
...
begin
  result = ListProvisionedProductPlans(params)
