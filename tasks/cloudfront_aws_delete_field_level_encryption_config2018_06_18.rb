...
def DeleteFieldLevelEncryptionConfig2018_06_18(*args)
  puts "Calling task operation DeleteFieldLevelEncryptionConfig2018_06_18" 
  ...
  if arg_hash.empty?
    response = client.delete_field_level_encryption_config2018_06_18()
  else 
    call_hash={}
    ...
    response = client.delete_field_level_encryption_config2018_06_18(call_hash)
  end
...
begin
  result = DeleteFieldLevelEncryptionConfig2018_06_18(params)
