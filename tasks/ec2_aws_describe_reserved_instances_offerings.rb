...
def DescribeReservedInstancesOfferings(*args)
  puts "Calling task operation DescribeReservedInstancesOfferings" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_reserved_instances_offerings(call_hash)
  end
...
begin
  result = DescribeReservedInstancesOfferings(params)
