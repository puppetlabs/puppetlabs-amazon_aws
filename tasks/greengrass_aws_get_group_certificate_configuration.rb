...
def GetGroupCertificateConfiguration(*args)
  puts "Calling task operation GetGroupCertificateConfiguration" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_group_certificate_configuration(call_hash)
  end
...
begin
  result = GetGroupCertificateConfiguration(params)
