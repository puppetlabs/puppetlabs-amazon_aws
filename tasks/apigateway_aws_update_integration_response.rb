...
def UpdateIntegrationResponse(*args)
  puts "Calling task operation UpdateIntegrationResponse" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_integration_response(call_hash)
  end
...
begin
  result = UpdateIntegrationResponse(params)
