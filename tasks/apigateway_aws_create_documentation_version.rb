...
def CreateDocumentationVersion(*args)
  puts "Calling task operation CreateDocumentationVersion" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_documentation_version(call_hash)
  end
...
begin
  result = CreateDocumentationVersion(params)
