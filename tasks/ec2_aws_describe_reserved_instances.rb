...
def DescribeReservedInstances(*args)
  puts "Calling task operation DescribeReservedInstances" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_reserved_instances(call_hash)
  end
...
begin
  result = DescribeReservedInstances(params)
