...
def DescribeTerminationPolicyTypes(*args)
  puts "Calling task operation DescribeTerminationPolicyTypes" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_termination_policy_types(call_hash)
  end
...
begin
  result = DescribeTerminationPolicyTypes(params)
