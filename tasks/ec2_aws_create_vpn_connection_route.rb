...
def CreateVpnConnectionRoute(*args)
  puts "Calling task operation CreateVpnConnectionRoute" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_vpn_connection_route(call_hash)
  end
...
begin
  result = CreateVpnConnectionRoute(params)
