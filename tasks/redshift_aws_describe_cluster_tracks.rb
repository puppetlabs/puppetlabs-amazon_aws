...
def DescribeClusterTracks(*args)
  puts "Calling task operation DescribeClusterTracks" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_cluster_tracks(call_hash)
  end
...
begin
  result = DescribeClusterTracks(params)
