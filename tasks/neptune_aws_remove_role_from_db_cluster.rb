...
def RemoveRoleFromDBCluster(*args)
  puts "Calling task operation RemoveRoleFromDBCluster" 
  ...
  if arg_hash.empty?
    ...
    response = client.remove_role_from_db_cluster(call_hash)
  end
...
begin
  result = RemoveRoleFromDBCluster(params)
