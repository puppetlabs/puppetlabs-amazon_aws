...
def DeleteApplicationReferenceDataSource(*args)
  puts "Calling task operation DeleteApplicationReferenceDataSource" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_application_reference_data_source(call_hash)
  end
...
begin
  result = DeleteApplicationReferenceDataSource(params)
