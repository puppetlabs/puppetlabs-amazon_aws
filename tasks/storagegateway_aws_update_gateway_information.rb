...
def UpdateGatewayInformation(*args)
  puts "Calling task operation UpdateGatewayInformation" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_gateway_information(call_hash)
  end
...
begin
  result = UpdateGatewayInformation(params)
