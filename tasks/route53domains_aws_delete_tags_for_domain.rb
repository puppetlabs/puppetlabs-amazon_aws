...
def DeleteTagsForDomain(*args)
  puts "Calling task operation DeleteTagsForDomain" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_tags_for_domain(call_hash)
  end
...
begin
  result = DeleteTagsForDomain(params)
