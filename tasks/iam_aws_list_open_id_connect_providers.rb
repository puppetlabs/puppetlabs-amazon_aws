...
def ListOpenIDConnectProviders(*args)
  puts "Calling task operation ListOpenIDConnectProviders" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_open_id_connect_providers(call_hash)
  end
...
begin
  result = ListOpenIDConnectProviders(params)
