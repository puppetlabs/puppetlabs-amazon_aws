...
def CreateGroupVersion(*args)
  puts "Calling task operation CreateGroupVersion" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_group_version(call_hash)
  end
...
begin
  result = CreateGroupVersion(params)
