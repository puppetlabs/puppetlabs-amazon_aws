...
def GetDownloadUrlForLayer(*args)
  puts "Calling task operation GetDownloadUrlForLayer" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_download_url_for_layer(call_hash)
  end
...
begin
  result = GetDownloadUrlForLayer(params)
