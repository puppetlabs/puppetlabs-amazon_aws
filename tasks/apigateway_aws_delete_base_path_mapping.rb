...
def DeleteBasePathMapping(*args)
  puts "Calling task operation DeleteBasePathMapping" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_base_path_mapping(call_hash)
  end
...
begin
  result = DeleteBasePathMapping(params)
