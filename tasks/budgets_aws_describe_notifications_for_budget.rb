...
def DescribeNotificationsForBudget(*args)
  puts "Calling task operation DescribeNotificationsForBudget" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_notifications_for_budget(call_hash)
  end
...
begin
  result = DescribeNotificationsForBudget(params)
