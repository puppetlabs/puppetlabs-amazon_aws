...
def DeleteQueryLoggingConfig(*args)
  puts "Calling task operation DeleteQueryLoggingConfig" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_query_logging_config(call_hash)
  end
...
begin
  result = DeleteQueryLoggingConfig(params)
