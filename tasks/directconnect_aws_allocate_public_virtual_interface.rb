...
def AllocatePublicVirtualInterface(*args)
  puts "Calling task operation AllocatePublicVirtualInterface" 
  ...
  if arg_hash.empty?
    ...
    response = client.allocate_public_virtual_interface(call_hash)
  end
...
begin
  result = AllocatePublicVirtualInterface(params)
