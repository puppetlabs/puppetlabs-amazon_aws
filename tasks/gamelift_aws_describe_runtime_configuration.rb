...
def DescribeRuntimeConfiguration(*args)
  puts "Calling task operation DescribeRuntimeConfiguration" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_runtime_configuration(call_hash)
  end
...
begin
  result = DescribeRuntimeConfiguration(params)
