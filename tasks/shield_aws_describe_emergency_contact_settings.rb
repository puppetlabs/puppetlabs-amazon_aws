...
def DescribeEmergencyContactSettings(*args)
  puts "Calling task operation DescribeEmergencyContactSettings" 
  ...
  client = Aws::Shield::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.describe_emergency_contact_settings(call_hash)
  end
...
begin
  result = DescribeEmergencyContactSettings(params)
