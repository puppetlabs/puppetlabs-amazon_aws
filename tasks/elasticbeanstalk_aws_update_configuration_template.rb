...
def UpdateConfigurationTemplate(*args)
  puts "Calling task operation UpdateConfigurationTemplate" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_configuration_template(call_hash)
  end
...
begin
  result = UpdateConfigurationTemplate(params)
