...
def UpdateServiceSpecificCredential(*args)
  puts "Calling task operation UpdateServiceSpecificCredential" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_service_specific_credential(call_hash)
  end
...
begin
  result = UpdateServiceSpecificCredential(params)
