...
def DescribeWorkspaceDirectories(*args)
  puts "Calling task operation DescribeWorkspaceDirectories" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_workspace_directories(call_hash)
  end
...
begin
  result = DescribeWorkspaceDirectories(params)
