...
def ListComplianceItems(*args)
  puts "Calling task operation ListComplianceItems" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_compliance_items(call_hash)
  end
...
begin
  result = ListComplianceItems(params)
