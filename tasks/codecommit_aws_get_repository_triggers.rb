...
def GetRepositoryTriggers(*args)
  puts "Calling task operation GetRepositoryTriggers" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_repository_triggers(call_hash)
  end
...
begin
  result = GetRepositoryTriggers(params)
