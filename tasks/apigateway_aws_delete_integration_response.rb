...
def DeleteIntegrationResponse(*args)
  puts "Calling task operation DeleteIntegrationResponse" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_integration_response(call_hash)
  end
...
begin
  result = DeleteIntegrationResponse(params)
