...
def ListRegexMatchSets(*args)
  puts "Calling task operation ListRegexMatchSets" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_regex_match_sets(call_hash)
  end
...
begin
  result = ListRegexMatchSets(params)
