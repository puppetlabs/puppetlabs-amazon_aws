...
def DeleteBucketMetricsConfiguration(*args)
  puts "Calling task operation DeleteBucketMetricsConfiguration" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_bucket_metrics_configuration(call_hash)
  end
...
begin
  result = DeleteBucketMetricsConfiguration(params)
