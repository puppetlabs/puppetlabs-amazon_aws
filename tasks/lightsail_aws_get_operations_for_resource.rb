...
def GetOperationsForResource(*args)
  puts "Calling task operation GetOperationsForResource" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_operations_for_resource(call_hash)
  end
...
begin
  result = GetOperationsForResource(params)
