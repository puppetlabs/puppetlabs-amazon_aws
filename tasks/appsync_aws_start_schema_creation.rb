...
def StartSchemaCreation(*args)
  puts "Calling task operation StartSchemaCreation" 
  ...
  if arg_hash.empty?
    ...
    response = client.start_schema_creation(call_hash)
  end
...
begin
  result = StartSchemaCreation(params)
