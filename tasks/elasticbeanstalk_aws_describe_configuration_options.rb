...
def DescribeConfigurationOptions(*args)
  puts "Calling task operation DescribeConfigurationOptions" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_configuration_options(call_hash)
  end
...
begin
  result = DescribeConfigurationOptions(params)
