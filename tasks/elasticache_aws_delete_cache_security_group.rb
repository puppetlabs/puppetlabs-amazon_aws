...
def DeleteCacheSecurityGroup(*args)
  puts "Calling task operation DeleteCacheSecurityGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_cache_security_group(call_hash)
  end
...
begin
  result = DeleteCacheSecurityGroup(params)
