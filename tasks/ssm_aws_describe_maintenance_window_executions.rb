...
def DescribeMaintenanceWindowExecutions(*args)
  puts "Calling task operation DescribeMaintenanceWindowExecutions" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_maintenance_window_executions(call_hash)
  end
...
begin
  result = DescribeMaintenanceWindowExecutions(params)
