...
def DescribeSecurityProfile(*args)
  puts "Calling task operation DescribeSecurityProfile" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_security_profile(call_hash)
  end
...
begin
  result = DescribeSecurityProfile(params)
