...
def RequestCertificate(*args)
  puts "Calling task operation RequestCertificate" 
  ...
  if arg_hash.empty?
    ...
    response = client.request_certificate(call_hash)
  end
...
begin
  result = RequestCertificate(params)
