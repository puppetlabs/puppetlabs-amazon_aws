...
def GetDocumentationPart(*args)
  puts "Calling task operation GetDocumentationPart" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_documentation_part(call_hash)
  end
...
begin
  result = GetDocumentationPart(params)
