...
def StopConfigurationRecorder(*args)
  puts "Calling task operation StopConfigurationRecorder" 
  ...
  if arg_hash.empty?
    ...
    response = client.stop_configuration_recorder(call_hash)
  end
...
begin
  result = StopConfigurationRecorder(params)
