...
def DescribeOrganizationalUnit(*args)
  puts "Calling task operation DescribeOrganizationalUnit" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_organizational_unit(call_hash)
  end
...
begin
  result = DescribeOrganizationalUnit(params)
