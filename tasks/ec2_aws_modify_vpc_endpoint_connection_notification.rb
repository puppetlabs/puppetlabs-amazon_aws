...
def ModifyVpcEndpointConnectionNotification(*args)
  puts "Calling task operation ModifyVpcEndpointConnectionNotification" 
  ...
  if arg_hash.empty?
    ...
    response = client.modify_vpc_endpoint_connection_notification(call_hash)
  end
...
begin
  result = ModifyVpcEndpointConnectionNotification(params)
