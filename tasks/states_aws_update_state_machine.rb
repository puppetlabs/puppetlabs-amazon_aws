...
def UpdateStateMachine(*args)
  puts "Calling task operation UpdateStateMachine" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_state_machine(call_hash)
  end
...
begin
  result = UpdateStateMachine(params)
