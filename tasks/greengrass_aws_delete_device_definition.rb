...
def DeleteDeviceDefinition(*args)
  puts "Calling task operation DeleteDeviceDefinition" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_device_definition(call_hash)
  end
...
begin
  result = DeleteDeviceDefinition(params)
