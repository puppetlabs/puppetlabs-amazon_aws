...
def DescribeScalingPolicies(*args)
  puts "Calling task operation DescribeScalingPolicies" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_scaling_policies(call_hash)
  end
...
begin
  result = DescribeScalingPolicies(params)
