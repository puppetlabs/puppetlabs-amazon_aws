...
def CreateFunctionDefinitionVersion(*args)
  puts "Calling task operation CreateFunctionDefinitionVersion" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_function_definition_version(call_hash)
  end
...
begin
  result = CreateFunctionDefinitionVersion(params)
