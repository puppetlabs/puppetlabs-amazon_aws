...
def DeleteOpenIDConnectProvider(*args)
  puts "Calling task operation DeleteOpenIDConnectProvider" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_open_id_connect_provider(call_hash)
  end
...
begin
  result = DeleteOpenIDConnectProvider(params)
