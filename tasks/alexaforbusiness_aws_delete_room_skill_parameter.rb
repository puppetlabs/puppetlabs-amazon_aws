...
def DeleteRoomSkillParameter(*args)
  puts "Calling task operation DeleteRoomSkillParameter" 
  ...
  client = Aws::AlexaForBusiness::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.delete_room_skill_parameter(call_hash)
  end
...
begin
  result = DeleteRoomSkillParameter(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::AlexaForBusiness::Errors::ServiceError => e
