...
def CreateScheduledAudit(*args)
  puts "Calling task operation CreateScheduledAudit" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_scheduled_audit(call_hash)
  end
...
begin
  result = CreateScheduledAudit(params)
