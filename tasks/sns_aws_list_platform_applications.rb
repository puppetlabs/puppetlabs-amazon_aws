...
def ListPlatformApplications(*args)
  puts "Calling task operation ListPlatformApplications" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_platform_applications(call_hash)
  end
...
begin
  result = ListPlatformApplications(params)
