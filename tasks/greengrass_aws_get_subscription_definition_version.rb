...
def GetSubscriptionDefinitionVersion(*args)
  puts "Calling task operation GetSubscriptionDefinitionVersion" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_subscription_definition_version(call_hash)
  end
...
begin
  result = GetSubscriptionDefinitionVersion(params)
