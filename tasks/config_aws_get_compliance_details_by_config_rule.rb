...
def GetComplianceDetailsByConfigRule(*args)
  puts "Calling task operation GetComplianceDetailsByConfigRule" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_compliance_details_by_config_rule(call_hash)
  end
...
begin
  result = GetComplianceDetailsByConfigRule(params)
