...
def CreateVPCAssociationAuthorization(*args)
  puts "Calling task operation CreateVPCAssociationAuthorization" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_vpc_association_authorization(call_hash)
  end
...
begin
  result = CreateVPCAssociationAuthorization(params)
