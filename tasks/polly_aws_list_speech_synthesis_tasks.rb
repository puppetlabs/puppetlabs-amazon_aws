...
def ListSpeechSynthesisTasks(*args)
  puts "Calling task operation ListSpeechSynthesisTasks" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_speech_synthesis_tasks(call_hash)
  end
...
begin
  result = ListSpeechSynthesisTasks(params)
