...
def ListAttachedUserPolicies(*args)
  puts "Calling task operation ListAttachedUserPolicies" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_attached_user_policies(call_hash)
  end
...
begin
  result = ListAttachedUserPolicies(params)
