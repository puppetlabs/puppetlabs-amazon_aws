...
def DeleteAssessmentTarget(*args)
  puts "Calling task operation DeleteAssessmentTarget" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_assessment_target(call_hash)
  end
...
begin
  result = DeleteAssessmentTarget(params)
