...
def CreateConfigurationTemplate(*args)
  puts "Calling task operation CreateConfigurationTemplate" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_configuration_template(call_hash)
  end
...
begin
  result = CreateConfigurationTemplate(params)
