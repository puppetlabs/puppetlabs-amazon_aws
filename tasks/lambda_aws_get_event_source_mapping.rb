...
def GetEventSourceMapping(*args)
  puts "Calling task operation GetEventSourceMapping" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_event_source_mapping(call_hash)
  end
...
begin
  result = GetEventSourceMapping(params)
