...
def UpdateDirectoryConfig(*args)
  puts "Calling task operation UpdateDirectoryConfig" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_directory_config(call_hash)
  end
...
begin
  result = UpdateDirectoryConfig(params)
