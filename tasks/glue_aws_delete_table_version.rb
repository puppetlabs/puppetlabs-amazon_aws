...
def DeleteTableVersion(*args)
  puts "Calling task operation DeleteTableVersion" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_table_version(call_hash)
  end
...
begin
  result = DeleteTableVersion(params)
