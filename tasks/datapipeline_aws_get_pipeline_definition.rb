...
def GetPipelineDefinition(*args)
  puts "Calling task operation GetPipelineDefinition" 
  ...
  client = Aws::DataPipeline::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.get_pipeline_definition(call_hash)
  end
...
begin
  result = GetPipelineDefinition(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::DataPipeline::Errors::ServiceError => e
