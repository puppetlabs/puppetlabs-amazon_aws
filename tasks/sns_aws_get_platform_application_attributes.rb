...
def GetPlatformApplicationAttributes(*args)
  puts "Calling task operation GetPlatformApplicationAttributes" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_platform_application_attributes(call_hash)
  end
...
begin
  result = GetPlatformApplicationAttributes(params)
