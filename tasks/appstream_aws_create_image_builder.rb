...
def CreateImageBuilder(*args)
  puts "Calling task operation CreateImageBuilder" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_image_builder(call_hash)
  end
...
begin
  result = CreateImageBuilder(params)
