...
def CreateInstanceExportTask(*args)
  puts "Calling task operation CreateInstanceExportTask" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_instance_export_task(call_hash)
  end
...
begin
  result = CreateInstanceExportTask(params)
