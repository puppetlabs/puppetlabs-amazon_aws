...
def DescribePendingAggregationRequests(*args)
  puts "Calling task operation DescribePendingAggregationRequests" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_pending_aggregation_requests(call_hash)
  end
...
begin
  result = DescribePendingAggregationRequests(params)
