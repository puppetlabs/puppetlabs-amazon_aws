...
def ModifySubnetAttribute(*args)
  puts "Calling task operation ModifySubnetAttribute" 
  ...
  if arg_hash.empty?
    ...
    response = client.modify_subnet_attribute(call_hash)
  end
...
begin
  result = ModifySubnetAttribute(params)
