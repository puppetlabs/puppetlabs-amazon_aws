...
def DescribeKeyPhrasesDetectionJob(*args)
  puts "Calling task operation DescribeKeyPhrasesDetectionJob" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_key_phrases_detection_job(call_hash)
  end
...
begin
  result = DescribeKeyPhrasesDetectionJob(params)
