...
def DescribeVpcEndpointServicePermissions(*args)
  puts "Calling task operation DescribeVpcEndpointServicePermissions" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_vpc_endpoint_service_permissions(call_hash)
  end
...
begin
  result = DescribeVpcEndpointServicePermissions(params)
