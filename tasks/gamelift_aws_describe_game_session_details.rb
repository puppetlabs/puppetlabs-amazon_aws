...
def DescribeGameSessionDetails(*args)
  puts "Calling task operation DescribeGameSessionDetails" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_game_session_details(call_hash)
  end
...
begin
  result = DescribeGameSessionDetails(params)
