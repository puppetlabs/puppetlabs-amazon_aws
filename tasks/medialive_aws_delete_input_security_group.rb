...
def DeleteInputSecurityGroup(*args)
  puts "Calling task operation DeleteInputSecurityGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_input_security_group(call_hash)
  end
...
begin
  result = DeleteInputSecurityGroup(params)
