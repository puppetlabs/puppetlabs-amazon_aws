...
def CreateClusterSecurityGroup(*args)
  puts "Calling task operation CreateClusterSecurityGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_cluster_security_group(call_hash)
  end
...
begin
  result = CreateClusterSecurityGroup(params)
