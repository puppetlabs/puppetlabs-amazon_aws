...
def StopEntitiesDetectionJob(*args)
  puts "Calling task operation StopEntitiesDetectionJob" 
  ...
  if arg_hash.empty?
    ...
    response = client.stop_entities_detection_job(call_hash)
  end
...
begin
  result = StopEntitiesDetectionJob(params)
