...
def DeletePermissionPolicy(*args)
  puts "Calling task operation DeletePermissionPolicy" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_permission_policy(call_hash)
  end
...
begin
  result = DeletePermissionPolicy(params)
