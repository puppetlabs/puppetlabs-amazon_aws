...
def DescribeSigningJob(*args)
  puts "Calling task operation DescribeSigningJob" 
  ...
  client = Aws::Signer::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.describe_signing_job(call_hash)
  end
...
begin
  result = DescribeSigningJob(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::Signer::Errors::ServiceError => e
