...
def DescribeCustomerGateways(*args)
  puts "Calling task operation DescribeCustomerGateways" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_customer_gateways(call_hash)
  end
...
begin
  result = DescribeCustomerGateways(params)
