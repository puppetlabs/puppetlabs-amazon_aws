...
def StartAssociationsOnce(*args)
  puts "Calling task operation StartAssociationsOnce" 
  ...
  if arg_hash.empty?
    ...
    response = client.start_associations_once(call_hash)
  end
...
begin
  result = StartAssociationsOnce(params)
