...
def ListObjectAttributes(*args)
  puts "Calling task operation ListObjectAttributes" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_object_attributes(call_hash)
  end
...
begin
  result = ListObjectAttributes(params)
