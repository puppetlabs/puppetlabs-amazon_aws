...
def DescribeActivityType(*args)
  puts "Calling task operation DescribeActivityType" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_activity_type(call_hash)
  end
...
begin
  result = DescribeActivityType(params)
