...
def DeleteReplicationGroup(*args)
  puts "Calling task operation DeleteReplicationGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_replication_group(call_hash)
  end
...
begin
  result = DeleteReplicationGroup(params)
