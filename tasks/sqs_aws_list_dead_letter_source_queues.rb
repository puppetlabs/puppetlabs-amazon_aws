...
def ListDeadLetterSourceQueues(*args)
  puts "Calling task operation ListDeadLetterSourceQueues" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_dead_letter_source_queues(call_hash)
  end
...
begin
  result = ListDeadLetterSourceQueues(params)
