...
def ModifyClusterSubnetGroup(*args)
  puts "Calling task operation ModifyClusterSubnetGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.modify_cluster_subnet_group(call_hash)
  end
...
begin
  result = ModifyClusterSubnetGroup(params)
