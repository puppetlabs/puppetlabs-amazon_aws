...
def GetSizeConstraintSet(*args)
  puts "Calling task operation GetSizeConstraintSet" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_size_constraint_set(call_hash)
  end
...
begin
  result = GetSizeConstraintSet(params)
