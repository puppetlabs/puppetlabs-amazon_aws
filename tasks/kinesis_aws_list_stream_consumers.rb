...
def ListStreamConsumers(*args)
  puts "Calling task operation ListStreamConsumers" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_stream_consumers(call_hash)
  end
...
begin
  result = ListStreamConsumers(params)
