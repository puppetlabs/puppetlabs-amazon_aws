...
def AddTagsToCertificate(*args)
  puts "Calling task operation AddTagsToCertificate" 
  ...
  if arg_hash.empty?
    ...
    response = client.add_tags_to_certificate(call_hash)
  end
...
begin
  result = AddTagsToCertificate(params)
