...
def UpdateRulesOfIpGroup(*args)
  puts "Calling task operation UpdateRulesOfIpGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_rules_of_ip_group(call_hash)
  end
...
begin
  result = UpdateRulesOfIpGroup(params)
