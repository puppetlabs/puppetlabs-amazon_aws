...
def DescribeDBClusterSnapshots(*args)
  puts "Calling task operation DescribeDBClusterSnapshots" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_db_cluster_snapshots(call_hash)
  end
...
begin
  result = DescribeDBClusterSnapshots(params)
