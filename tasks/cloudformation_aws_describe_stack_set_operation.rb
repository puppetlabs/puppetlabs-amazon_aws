...
def DescribeStackSetOperation(*args)
  puts "Calling task operation DescribeStackSetOperation" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_stack_set_operation(call_hash)
  end
...
begin
  result = DescribeStackSetOperation(params)
