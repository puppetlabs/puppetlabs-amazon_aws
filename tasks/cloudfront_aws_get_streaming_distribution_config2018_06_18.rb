...
def GetStreamingDistributionConfig2018_06_18(*args)
  puts "Calling task operation GetStreamingDistributionConfig2018_06_18" 
  ...
  if arg_hash.empty?
    response = client.get_streaming_distribution_config2018_06_18()
  else 
    call_hash={}
    ...
    response = client.get_streaming_distribution_config2018_06_18(call_hash)
  end
...
begin
  result = GetStreamingDistributionConfig2018_06_18(params)
