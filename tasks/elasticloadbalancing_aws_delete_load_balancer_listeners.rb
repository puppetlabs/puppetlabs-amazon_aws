...
def DeleteLoadBalancerListeners(*args)
  puts "Calling task operation DeleteLoadBalancerListeners" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_load_balancer_listeners(call_hash)
  end
...
begin
  result = DeleteLoadBalancerListeners(params)
