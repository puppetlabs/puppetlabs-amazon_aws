...
def DescribePermissions(*args)
  puts "Calling task operation DescribePermissions" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_permissions(call_hash)
  end
...
begin
  result = DescribePermissions(params)
