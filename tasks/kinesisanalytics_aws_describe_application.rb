...
def DescribeApplication(*args)
  puts "Calling task operation DescribeApplication" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_application(call_hash)
  end
...
begin
  result = DescribeApplication(params)
