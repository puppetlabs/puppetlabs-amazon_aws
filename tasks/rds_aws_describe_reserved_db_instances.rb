...
def DescribeReservedDBInstances(*args)
  puts "Calling task operation DescribeReservedDBInstances" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_reserved_db_instances(call_hash)
  end
...
begin
  result = DescribeReservedDBInstances(params)
