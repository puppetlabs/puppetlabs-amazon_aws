...
def DescribeImportSnapshotTasks(*args)
  puts "Calling task operation DescribeImportSnapshotTasks" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_import_snapshot_tasks(call_hash)
  end
...
begin
  result = DescribeImportSnapshotTasks(params)
