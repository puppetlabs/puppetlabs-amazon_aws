...
def DeleteTrafficPolicy(*args)
  puts "Calling task operation DeleteTrafficPolicy" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_traffic_policy(call_hash)
  end
...
begin
  result = DeleteTrafficPolicy(params)
