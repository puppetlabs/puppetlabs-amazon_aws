...
def UpdateSubscription(*args)
  puts "Calling task operation UpdateSubscription" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_subscription(call_hash)
  end
...
begin
  result = UpdateSubscription(params)
