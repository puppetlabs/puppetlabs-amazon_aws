...
def UpdateFleetAttributes(*args)
  puts "Calling task operation UpdateFleetAttributes" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_fleet_attributes(call_hash)
  end
...
begin
  result = UpdateFleetAttributes(params)
