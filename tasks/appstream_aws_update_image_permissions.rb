...
def UpdateImagePermissions(*args)
  puts "Calling task operation UpdateImagePermissions" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_image_permissions(call_hash)
  end
...
begin
  result = UpdateImagePermissions(params)
