...
def DescribeCommunications(*args)
  puts "Calling task operation DescribeCommunications" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_communications(call_hash)
  end
...
begin
  result = DescribeCommunications(params)
