...
def DescribeWorkspacesConnectionStatus(*args)
  puts "Calling task operation DescribeWorkspacesConnectionStatus" 
  ...
  client = Aws::WorkSpaces::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.describe_workspaces_connection_status(call_hash)
  end
...
begin
  result = DescribeWorkspacesConnectionStatus(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::WorkSpaces::Errors::ServiceError => e
