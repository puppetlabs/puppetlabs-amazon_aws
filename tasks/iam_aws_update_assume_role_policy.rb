...
def UpdateAssumeRolePolicy(*args)
  puts "Calling task operation UpdateAssumeRolePolicy" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_assume_role_policy(call_hash)
  end
...
begin
  result = UpdateAssumeRolePolicy(params)
