...
def GetTranscriptionJob(*args)
  puts "Calling task operation GetTranscriptionJob" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_transcription_job(call_hash)
  end
...
begin
  result = GetTranscriptionJob(params)
