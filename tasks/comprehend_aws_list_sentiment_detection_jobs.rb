...
def ListSentimentDetectionJobs(*args)
  puts "Calling task operation ListSentimentDetectionJobs" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_sentiment_detection_jobs(call_hash)
  end
...
begin
  result = ListSentimentDetectionJobs(params)
