...
def operation_with_hash(arg_hash)
  ...
  client.create_streaming_distribution2018_11_05(call_hash)
end

def create_streaming_distribution2018_11_05(*args)
  argstring = args[0]
  argstring.delete('\\')
  ...
  client = Aws::CloudFront::Client.new(region: region)
  response = client.create_streaming_distribution2018_11_05 if arg_hash.empty?
...
def task
  ...
  params = STDIN.read
  result = create_streaming_distribution2018_11_05(params)
