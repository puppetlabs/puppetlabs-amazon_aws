...
def DescribeClusterParameters(*args)
  puts "Calling task operation DescribeClusterParameters" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_cluster_parameters(call_hash)
  end
...
begin
  result = DescribeClusterParameters(params)
