...
def DescribeLoadBalancerPolicies(*args)
  puts "Calling task operation DescribeLoadBalancerPolicies" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_load_balancer_policies(call_hash)
  end
...
begin
  result = DescribeLoadBalancerPolicies(params)
