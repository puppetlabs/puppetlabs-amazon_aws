...
def CreateEgressOnlyInternetGateway(*args)
  puts "Calling task operation CreateEgressOnlyInternetGateway" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_egress_only_internet_gateway(call_hash)
  end
...
begin
  result = CreateEgressOnlyInternetGateway(params)
