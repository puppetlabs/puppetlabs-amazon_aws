...
def GetRepositoryPolicy(*args)
  puts "Calling task operation GetRepositoryPolicy" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_repository_policy(call_hash)
  end
...
begin
  result = GetRepositoryPolicy(params)
