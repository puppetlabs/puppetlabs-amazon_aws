...
def GetPipelineExecution(*args)
  puts "Calling task operation GetPipelineExecution" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_pipeline_execution(call_hash)
  end
...
begin
  result = GetPipelineExecution(params)
