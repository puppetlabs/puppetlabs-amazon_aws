...
def DeleteCustomActionType(*args)
  puts "Calling task operation DeleteCustomActionType" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_custom_action_type(call_hash)
  end
...
begin
  result = DeleteCustomActionType(params)
