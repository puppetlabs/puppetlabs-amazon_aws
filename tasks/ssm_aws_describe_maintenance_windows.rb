...
def DescribeMaintenanceWindows(*args)
  puts "Calling task operation DescribeMaintenanceWindows" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_maintenance_windows(call_hash)
  end
...
begin
  result = DescribeMaintenanceWindows(params)
