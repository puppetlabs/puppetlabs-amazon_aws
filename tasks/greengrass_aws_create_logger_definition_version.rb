...
def CreateLoggerDefinitionVersion(*args)
  puts "Calling task operation CreateLoggerDefinitionVersion" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_logger_definition_version(call_hash)
  end
...
begin
  result = CreateLoggerDefinitionVersion(params)
