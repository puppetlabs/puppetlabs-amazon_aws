...
def TerminateWorkspaces(*args)
  puts "Calling task operation TerminateWorkspaces" 
  ...
  if arg_hash.empty?
    ...
    response = client.terminate_workspaces(call_hash)
  end
...
begin
  result = TerminateWorkspaces(params)
