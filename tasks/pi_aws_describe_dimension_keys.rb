...
def DescribeDimensionKeys(*args)
  puts "Calling task operation DescribeDimensionKeys" 
  ...
  client = Aws::PI::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.describe_dimension_keys(call_hash)
  end
...
begin
  result = DescribeDimensionKeys(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::PI::Errors::ServiceError => e
