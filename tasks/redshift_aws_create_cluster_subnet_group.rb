...
def CreateClusterSubnetGroup(*args)
  puts "Calling task operation CreateClusterSubnetGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_cluster_subnet_group(call_hash)
  end
...
begin
  result = CreateClusterSubnetGroup(params)
