...
def UpdateSAMLProvider(*args)
  puts "Calling task operation UpdateSAMLProvider" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_saml_provider(call_hash)
  end
...
begin
  result = UpdateSAMLProvider(params)
