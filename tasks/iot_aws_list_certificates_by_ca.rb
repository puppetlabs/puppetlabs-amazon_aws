...
def ListCertificatesByCA(*args)
  puts "Calling task operation ListCertificatesByCA" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_certificates_by_ca(call_hash)
  end
...
begin
  result = ListCertificatesByCA(params)
