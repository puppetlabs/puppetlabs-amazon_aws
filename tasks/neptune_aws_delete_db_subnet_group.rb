...
def DeleteDBSubnetGroup(*args)
  puts "Calling task operation DeleteDBSubnetGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_db_subnet_group(call_hash)
  end
...
begin
  result = DeleteDBSubnetGroup(params)
