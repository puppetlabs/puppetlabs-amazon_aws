...
def GetComplianceDetailsByResource(*args)
  puts "Calling task operation GetComplianceDetailsByResource" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_compliance_details_by_resource(call_hash)
  end
...
begin
  result = GetComplianceDetailsByResource(params)
