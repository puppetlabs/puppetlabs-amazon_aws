...
def DescribeProvisioningArtifact(*args)
  puts "Calling task operation DescribeProvisioningArtifact" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_provisioning_artifact(call_hash)
  end
...
begin
  result = DescribeProvisioningArtifact(params)
