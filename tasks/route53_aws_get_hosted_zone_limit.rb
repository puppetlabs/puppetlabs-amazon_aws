...
def GetHostedZoneLimit(*args)
  puts "Calling task operation GetHostedZoneLimit" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_hosted_zone_limit(call_hash)
  end
...
begin
  result = GetHostedZoneLimit(params)
