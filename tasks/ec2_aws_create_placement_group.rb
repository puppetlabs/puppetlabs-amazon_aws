...
def CreatePlacementGroup(*args)
  puts "Calling task operation CreatePlacementGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_placement_group(call_hash)
  end
...
begin
  result = CreatePlacementGroup(params)
