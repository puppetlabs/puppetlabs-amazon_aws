...
def UpdateMethodResponse(*args)
  puts "Calling task operation UpdateMethodResponse" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_method_response(call_hash)
  end
...
begin
  result = UpdateMethodResponse(params)
