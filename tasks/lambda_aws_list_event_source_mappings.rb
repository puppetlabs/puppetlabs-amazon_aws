...
def ListEventSourceMappings(*args)
  puts "Calling task operation ListEventSourceMappings" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_event_source_mappings(call_hash)
  end
...
begin
  result = ListEventSourceMappings(params)
