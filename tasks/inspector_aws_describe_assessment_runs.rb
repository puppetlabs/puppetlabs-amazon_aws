...
def DescribeAssessmentRuns(*args)
  puts "Calling task operation DescribeAssessmentRuns" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_assessment_runs(call_hash)
  end
...
begin
  result = DescribeAssessmentRuns(params)
