...
def ListSqlInjectionMatchSets(*args)
  puts "Calling task operation ListSqlInjectionMatchSets" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_sql_injection_match_sets(call_hash)
  end
...
begin
  result = ListSqlInjectionMatchSets(params)
