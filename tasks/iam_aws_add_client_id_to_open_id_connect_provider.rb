...
def AddClientIDToOpenIDConnectProvider(*args)
  puts "Calling task operation AddClientIDToOpenIDConnectProvider" 
  ...
  if arg_hash.empty?
    ...
    response = client.add_client_id_to_open_id_connect_provider(call_hash)
  end
...
begin
  result = AddClientIDToOpenIDConnectProvider(params)
