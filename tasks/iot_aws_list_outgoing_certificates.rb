...
def ListOutgoingCertificates(*args)
  puts "Calling task operation ListOutgoingCertificates" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_outgoing_certificates(call_hash)
  end
...
begin
  result = ListOutgoingCertificates(params)
