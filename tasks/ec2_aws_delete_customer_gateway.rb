...
def DeleteCustomerGateway(*args)
  puts "Calling task operation DeleteCustomerGateway" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_customer_gateway(call_hash)
  end
...
begin
  result = DeleteCustomerGateway(params)
