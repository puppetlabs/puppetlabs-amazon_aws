...
def CreateComputeEnvironment(*args)
  puts "Calling task operation CreateComputeEnvironment" 
  ...
  client = Aws::Batch::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.create_compute_environment(call_hash)
  end
...
begin
  result = CreateComputeEnvironment(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::Batch::Errors::ServiceError => e
