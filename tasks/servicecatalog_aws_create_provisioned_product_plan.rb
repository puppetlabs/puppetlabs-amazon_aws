...
def CreateProvisionedProductPlan(*args)
  puts "Calling task operation CreateProvisionedProductPlan" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_provisioned_product_plan(call_hash)
  end
...
begin
  result = CreateProvisionedProductPlan(params)
