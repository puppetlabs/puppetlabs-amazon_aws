...
def CreateDBSubnetGroup(*args)
  puts "Calling task operation CreateDBSubnetGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_db_subnet_group(call_hash)
  end
...
begin
  result = CreateDBSubnetGroup(params)
