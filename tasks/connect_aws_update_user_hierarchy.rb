...
def UpdateUserHierarchy(*args)
  puts "Calling task operation UpdateUserHierarchy" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_user_hierarchy(call_hash)
  end
...
begin
  result = UpdateUserHierarchy(params)
