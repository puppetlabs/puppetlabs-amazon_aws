...
def CreateFieldLevelEncryptionConfig2018_06_18(*args)
  puts "Calling task operation CreateFieldLevelEncryptionConfig2018_06_18" 
  ...
  if arg_hash.empty?
    response = client.create_field_level_encryption_config2018_06_18()
  else 
    call_hash={}
    ...
    response = client.create_field_level_encryption_config2018_06_18(call_hash)
  end
...
begin
  result = CreateFieldLevelEncryptionConfig2018_06_18(params)
