...
def DescribeWorkingStorage(*args)
  puts "Calling task operation DescribeWorkingStorage" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_working_storage(call_hash)
  end
...
begin
  result = DescribeWorkingStorage(params)
