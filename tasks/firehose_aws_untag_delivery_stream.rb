...
def UntagDeliveryStream(*args)
  puts "Calling task operation UntagDeliveryStream" 
  ...
  if arg_hash.empty?
    ...
    response = client.untag_delivery_stream(call_hash)
  end
...
begin
  result = UntagDeliveryStream(params)
