...
def ListTagsForResource2018_06_18(*args)
  puts "Calling task operation ListTagsForResource2018_06_18" 
  ...
  if arg_hash.empty?
    response = client.list_tags_for_resource2018_06_18()
  else 
    call_hash={}
    ...
    response = client.list_tags_for_resource2018_06_18(call_hash)
  end
...
begin
  result = ListTagsForResource2018_06_18(params)
