...
def DeleteGatewayResponse(*args)
  puts "Calling task operation DeleteGatewayResponse" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_gateway_response(call_hash)
  end
...
begin
  result = DeleteGatewayResponse(params)
