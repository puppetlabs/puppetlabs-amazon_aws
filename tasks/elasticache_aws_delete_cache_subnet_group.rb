...
def DeleteCacheSubnetGroup(*args)
  puts "Calling task operation DeleteCacheSubnetGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_cache_subnet_group(call_hash)
  end
...
begin
  result = DeleteCacheSubnetGroup(params)
