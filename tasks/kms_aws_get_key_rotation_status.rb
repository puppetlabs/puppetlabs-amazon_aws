...
def GetKeyRotationStatus(*args)
  puts "Calling task operation GetKeyRotationStatus" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_key_rotation_status(call_hash)
  end
...
begin
  result = GetKeyRotationStatus(params)
