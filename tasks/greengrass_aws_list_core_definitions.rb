...
def ListCoreDefinitions(*args)
  puts "Calling task operation ListCoreDefinitions" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_core_definitions(call_hash)
  end
...
begin
  result = ListCoreDefinitions(params)
