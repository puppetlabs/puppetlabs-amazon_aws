...
def DescribeNotificationSubscriptions(*args)
  puts "Calling task operation DescribeNotificationSubscriptions" 
  ...
  client = Aws::WorkDocs::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.describe_notification_subscriptions(call_hash)
  end
...
begin
  result = DescribeNotificationSubscriptions(params)
