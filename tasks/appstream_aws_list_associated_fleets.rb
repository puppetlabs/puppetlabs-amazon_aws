...
def ListAssociatedFleets(*args)
  puts "Calling task operation ListAssociatedFleets" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_associated_fleets(call_hash)
  end
...
begin
  result = ListAssociatedFleets(params)
