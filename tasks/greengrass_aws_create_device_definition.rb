...
def CreateDeviceDefinition(*args)
  puts "Calling task operation CreateDeviceDefinition" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_device_definition(call_hash)
  end
...
begin
  result = CreateDeviceDefinition(params)
