...
def UpdateMaintenanceStartTime(*args)
  puts "Calling task operation UpdateMaintenanceStartTime" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_maintenance_start_time(call_hash)
  end
...
begin
  result = UpdateMaintenanceStartTime(params)
