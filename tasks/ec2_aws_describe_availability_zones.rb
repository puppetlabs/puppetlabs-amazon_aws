...
def DescribeAvailabilityZones(*args)
  puts "Calling task operation DescribeAvailabilityZones" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_availability_zones(call_hash)
  end
...
begin
  result = DescribeAvailabilityZones(params)
