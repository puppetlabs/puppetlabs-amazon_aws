...
def DeleteCoreDefinition(*args)
  puts "Calling task operation DeleteCoreDefinition" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_core_definition(call_hash)
  end
...
begin
  result = DeleteCoreDefinition(params)
