...
def DescribePatchGroups(*args)
  puts "Calling task operation DescribePatchGroups" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_patch_groups(call_hash)
  end
...
begin
  result = DescribePatchGroups(params)
