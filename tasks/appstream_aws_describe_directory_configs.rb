...
def DescribeDirectoryConfigs(*args)
  puts "Calling task operation DescribeDirectoryConfigs" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_directory_configs(call_hash)
  end
...
begin
  result = DescribeDirectoryConfigs(params)
