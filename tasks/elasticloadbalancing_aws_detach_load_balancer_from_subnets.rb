...
def DetachLoadBalancerFromSubnets(*args)
  puts "Calling task operation DetachLoadBalancerFromSubnets" 
  ...
  if arg_hash.empty?
    ...
    response = client.detach_load_balancer_from_subnets(call_hash)
  end
...
begin
  result = DetachLoadBalancerFromSubnets(params)
