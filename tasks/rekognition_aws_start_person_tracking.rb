...
def StartPersonTracking(*args)
  puts "Calling task operation StartPersonTracking" 
  ...
  if arg_hash.empty?
    ...
    response = client.start_person_tracking(call_hash)
  end
...
begin
  result = StartPersonTracking(params)
