...
def DescribeDBClusterBacktracks(*args)
  puts "Calling task operation DescribeDBClusterBacktracks" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_db_cluster_backtracks(call_hash)
  end
...
begin
  result = DescribeDBClusterBacktracks(params)
