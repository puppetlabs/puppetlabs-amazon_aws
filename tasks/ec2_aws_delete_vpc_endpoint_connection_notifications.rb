...
def DeleteVpcEndpointConnectionNotifications(*args)
  puts "Calling task operation DeleteVpcEndpointConnectionNotifications" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_vpc_endpoint_connection_notifications(call_hash)
  end
...
begin
  result = DeleteVpcEndpointConnectionNotifications(params)
