...
def DescribeFleetUtilization(*args)
  puts "Calling task operation DescribeFleetUtilization" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_fleet_utilization(call_hash)
  end
...
begin
  result = DescribeFleetUtilization(params)
