...
def CreateSnapshotFromVolumeRecoveryPoint(*args)
  puts "Calling task operation CreateSnapshotFromVolumeRecoveryPoint" 
  ...
  client = Aws::StorageGateway::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.create_snapshot_from_volume_recovery_point(call_hash)
  end
...
begin
  result = CreateSnapshotFromVolumeRecoveryPoint(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::StorageGateway::Errors::ServiceError => e
