...
def GetComplianceDetail(*args)
  puts "Calling task operation GetComplianceDetail" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_compliance_detail(call_hash)
  end
...
begin
  result = GetComplianceDetail(params)
