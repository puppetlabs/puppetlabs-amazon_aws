...
def ModifyFpgaImageAttribute(*args)
  puts "Calling task operation ModifyFpgaImageAttribute" 
  ...
  if arg_hash.empty?
    ...
    response = client.modify_fpga_image_attribute(call_hash)
  end
...
begin
  result = ModifyFpgaImageAttribute(params)
