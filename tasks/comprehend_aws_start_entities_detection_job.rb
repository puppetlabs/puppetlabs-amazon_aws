...
def StartEntitiesDetectionJob(*args)
  puts "Calling task operation StartEntitiesDetectionJob" 
  ...
  if arg_hash.empty?
    ...
    response = client.start_entities_detection_job(call_hash)
  end
...
begin
  result = StartEntitiesDetectionJob(params)
