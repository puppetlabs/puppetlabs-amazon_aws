...
def ListTrafficPolicyInstances(*args)
  puts "Calling task operation ListTrafficPolicyInstances" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_traffic_policy_instances(call_hash)
  end
...
begin
  result = ListTrafficPolicyInstances(params)
