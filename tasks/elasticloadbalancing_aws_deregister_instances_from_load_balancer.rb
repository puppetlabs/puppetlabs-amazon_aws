...
def DeregisterInstancesFromLoadBalancer(*args)
  puts "Calling task operation DeregisterInstancesFromLoadBalancer" 
  ...
  client = Aws::ElasticLoadBalancingV2::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.deregister_instances_from_load_balancer(call_hash)
  end
...
begin
  result = DeregisterInstancesFromLoadBalancer(params)
