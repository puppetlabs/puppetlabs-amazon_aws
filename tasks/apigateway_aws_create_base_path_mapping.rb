...
def CreateBasePathMapping(*args)
  puts "Calling task operation CreateBasePathMapping" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_base_path_mapping(call_hash)
  end
...
begin
  result = CreateBasePathMapping(params)
