...
def DescribeOptionGroupOptions(*args)
  puts "Calling task operation DescribeOptionGroupOptions" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_option_group_options(call_hash)
  end
...
begin
  result = DescribeOptionGroupOptions(params)
