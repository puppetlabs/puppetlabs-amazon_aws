...
def GetBucketRequestPayment(*args)
  puts "Calling task operation GetBucketRequestPayment" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_bucket_request_payment(call_hash)
  end
...
begin
  result = GetBucketRequestPayment(params)
