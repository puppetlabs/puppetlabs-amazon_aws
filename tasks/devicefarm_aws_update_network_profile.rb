...
def UpdateNetworkProfile(*args)
  puts "Calling task operation UpdateNetworkProfile" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_network_profile(call_hash)
  end
...
begin
  result = UpdateNetworkProfile(params)
