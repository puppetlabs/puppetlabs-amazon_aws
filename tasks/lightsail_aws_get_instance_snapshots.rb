...
def GetInstanceSnapshots(*args)
  puts "Calling task operation GetInstanceSnapshots" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_instance_snapshots(call_hash)
  end
...
begin
  result = GetInstanceSnapshots(params)
