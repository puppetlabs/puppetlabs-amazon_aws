...
def CreateDefaultSubnet(*args)
  puts "Calling task operation CreateDefaultSubnet" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_default_subnet(call_hash)
  end
...
begin
  result = CreateDefaultSubnet(params)
