...
def ListStackInstances(*args)
  puts "Calling task operation ListStackInstances" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_stack_instances(call_hash)
  end
...
begin
  result = ListStackInstances(params)
