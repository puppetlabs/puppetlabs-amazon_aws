...
def CreateLoadBalancerPolicy(*args)
  puts "Calling task operation CreateLoadBalancerPolicy" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_load_balancer_policy(call_hash)
  end
...
begin
  result = CreateLoadBalancerPolicy(params)
