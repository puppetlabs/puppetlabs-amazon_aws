...
def ModifySnapshotCopyRetentionPeriod(*args)
  puts "Calling task operation ModifySnapshotCopyRetentionPeriod" 
  ...
  client = Aws::Redshift::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.modify_snapshot_copy_retention_period(call_hash)
  end
...
begin
  result = ModifySnapshotCopyRetentionPeriod(params)
