...
def DescribeExportTasks(*args)
  puts "Calling task operation DescribeExportTasks" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_export_tasks(call_hash)
  end
...
begin
  result = DescribeExportTasks(params)
