...
def DeregisterTaskDefinition(*args)
  puts "Calling task operation DeregisterTaskDefinition" 
  ...
  if arg_hash.empty?
    ...
    response = client.deregister_task_definition(call_hash)
  end
...
begin
  result = DeregisterTaskDefinition(params)
