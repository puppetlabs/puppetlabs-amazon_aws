...
def DescribeDefaultClusterParameters(*args)
  puts "Calling task operation DescribeDefaultClusterParameters" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_default_cluster_parameters(call_hash)
  end
...
begin
  result = DescribeDefaultClusterParameters(params)
