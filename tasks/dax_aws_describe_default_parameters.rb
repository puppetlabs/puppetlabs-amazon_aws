...
def DescribeDefaultParameters(*args)
  puts "Calling task operation DescribeDefaultParameters" 
  ...
  client = Aws::DAX::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.describe_default_parameters(call_hash)
  end
...
begin
  result = DescribeDefaultParameters(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::DAX::Errors::ServiceError => e
