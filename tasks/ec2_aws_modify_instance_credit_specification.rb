...
def ModifyInstanceCreditSpecification(*args)
  puts "Calling task operation ModifyInstanceCreditSpecification" 
  ...
  if arg_hash.empty?
    ...
    response = client.modify_instance_credit_specification(call_hash)
  end
...
begin
  result = ModifyInstanceCreditSpecification(params)
