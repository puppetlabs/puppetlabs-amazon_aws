...
def CreateClusterParameterGroup(*args)
  puts "Calling task operation CreateClusterParameterGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_cluster_parameter_group(call_hash)
  end
...
begin
  result = CreateClusterParameterGroup(params)
