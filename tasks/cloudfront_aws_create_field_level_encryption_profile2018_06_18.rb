...
def CreateFieldLevelEncryptionProfile2018_06_18(*args)
  puts "Calling task operation CreateFieldLevelEncryptionProfile2018_06_18" 
  ...
  if arg_hash.empty?
    response = client.create_field_level_encryption_profile2018_06_18()
  else 
    call_hash={}
    ...
    response = client.create_field_level_encryption_profile2018_06_18(call_hash)
  end
...
begin
  result = CreateFieldLevelEncryptionProfile2018_06_18(params)
