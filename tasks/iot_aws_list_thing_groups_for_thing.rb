...
def ListThingGroupsForThing(*args)
  puts "Calling task operation ListThingGroupsForThing" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_thing_groups_for_thing(call_hash)
  end
...
begin
  result = ListThingGroupsForThing(params)
