...
def DescribeClusterSnapshots(*args)
  puts "Calling task operation DescribeClusterSnapshots" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_cluster_snapshots(call_hash)
  end
...
begin
  result = DescribeClusterSnapshots(params)
