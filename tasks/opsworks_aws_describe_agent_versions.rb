...
def DescribeAgentVersions(*args)
  puts "Calling task operation DescribeAgentVersions" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_agent_versions(call_hash)
  end
...
begin
  result = DescribeAgentVersions(params)
