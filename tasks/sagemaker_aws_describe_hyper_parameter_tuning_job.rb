...
def DescribeHyperParameterTuningJob(*args)
  puts "Calling task operation DescribeHyperParameterTuningJob" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_hyper_parameter_tuning_job(call_hash)
  end
...
begin
  result = DescribeHyperParameterTuningJob(params)
