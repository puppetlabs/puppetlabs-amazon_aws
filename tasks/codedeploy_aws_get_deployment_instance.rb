...
def GetDeploymentInstance(*args)
  puts "Calling task operation GetDeploymentInstance" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_deployment_instance(call_hash)
  end
...
begin
  result = GetDeploymentInstance(params)
