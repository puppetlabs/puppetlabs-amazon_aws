...
def CreateThreatIntelSet(*args)
  puts "Calling task operation CreateThreatIntelSet" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_threat_intel_set(call_hash)
  end
...
begin
  result = CreateThreatIntelSet(params)
