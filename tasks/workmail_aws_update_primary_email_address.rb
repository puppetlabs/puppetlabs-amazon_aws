...
def UpdatePrimaryEmailAddress(*args)
  puts "Calling task operation UpdatePrimaryEmailAddress" 
  ...
  client = Aws::WorkMail::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.update_primary_email_address(call_hash)
  end
...
begin
  result = UpdatePrimaryEmailAddress(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::WorkMail::Errors::ServiceError => e
