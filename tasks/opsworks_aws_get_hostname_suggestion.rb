...
def GetHostnameSuggestion(*args)
  puts "Calling task operation GetHostnameSuggestion" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_hostname_suggestion(call_hash)
  end
...
begin
  result = GetHostnameSuggestion(params)
