...
def CreateHyperParameterTuningJob(*args)
  puts "Calling task operation CreateHyperParameterTuningJob" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_hyper_parameter_tuning_job(call_hash)
  end
...
begin
  result = CreateHyperParameterTuningJob(params)
