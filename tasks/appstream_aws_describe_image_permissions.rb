...
def DescribeImagePermissions(*args)
  puts "Calling task operation DescribeImagePermissions" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_image_permissions(call_hash)
  end
...
begin
  result = DescribeImagePermissions(params)
