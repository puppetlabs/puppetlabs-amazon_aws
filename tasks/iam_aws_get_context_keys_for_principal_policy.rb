...
def GetContextKeysForPrincipalPolicy(*args)
  puts "Calling task operation GetContextKeysForPrincipalPolicy" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_context_keys_for_principal_policy(call_hash)
  end
...
begin
  result = GetContextKeysForPrincipalPolicy(params)
