...
def ListAttachedIndices(*args)
  puts "Calling task operation ListAttachedIndices" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_attached_indices(call_hash)
  end
...
begin
  result = ListAttachedIndices(params)
