...
def DeleteMatchmakingConfiguration(*args)
  puts "Calling task operation DeleteMatchmakingConfiguration" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_matchmaking_configuration(call_hash)
  end
...
begin
  result = DeleteMatchmakingConfiguration(params)
