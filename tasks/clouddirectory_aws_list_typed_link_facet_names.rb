...
def ListTypedLinkFacetNames(*args)
  puts "Calling task operation ListTypedLinkFacetNames" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_typed_link_facet_names(call_hash)
  end
...
begin
  result = ListTypedLinkFacetNames(params)
