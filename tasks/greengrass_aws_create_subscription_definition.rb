...
def CreateSubscriptionDefinition(*args)
  puts "Calling task operation CreateSubscriptionDefinition" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_subscription_definition(call_hash)
  end
...
begin
  result = CreateSubscriptionDefinition(params)
