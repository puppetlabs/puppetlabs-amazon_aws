...
def CreateParameterGroup(*args)
  puts "Calling task operation CreateParameterGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_parameter_group(call_hash)
  end
...
begin
  result = CreateParameterGroup(params)
