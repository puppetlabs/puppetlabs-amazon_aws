...
def CreatePatchBaseline(*args)
  puts "Calling task operation CreatePatchBaseline" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_patch_baseline(call_hash)
  end
...
begin
  result = CreatePatchBaseline(params)
