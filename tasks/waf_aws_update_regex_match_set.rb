...
def UpdateRegexMatchSet(*args)
  puts "Calling task operation UpdateRegexMatchSet" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_regex_match_set(call_hash)
  end
...
begin
  result = UpdateRegexMatchSet(params)
