...
def DescribeAutoScalingGroups(*args)
  puts "Calling task operation DescribeAutoScalingGroups" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_auto_scaling_groups(call_hash)
  end
...
begin
  result = DescribeAutoScalingGroups(params)
