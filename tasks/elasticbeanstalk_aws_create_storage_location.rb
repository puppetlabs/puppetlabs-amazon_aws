...
def CreateStorageLocation(*args)
  puts "Calling task operation CreateStorageLocation" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_storage_location(call_hash)
  end
...
begin
  result = CreateStorageLocation(params)
