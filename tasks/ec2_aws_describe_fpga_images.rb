...
def DescribeFpgaImages(*args)
  puts "Calling task operation DescribeFpgaImages" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_fpga_images(call_hash)
  end
...
begin
  result = DescribeFpgaImages(params)
