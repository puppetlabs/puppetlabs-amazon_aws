...
def ListHandshakesForOrganization(*args)
  puts "Calling task operation ListHandshakesForOrganization" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_handshakes_for_organization(call_hash)
  end
...
begin
  result = ListHandshakesForOrganization(params)
