...
def CreateTrafficPolicyVersion(*args)
  puts "Calling task operation CreateTrafficPolicyVersion" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_traffic_policy_version(call_hash)
  end
...
begin
  result = CreateTrafficPolicyVersion(params)
