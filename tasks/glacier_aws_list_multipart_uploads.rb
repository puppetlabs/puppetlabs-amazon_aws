...
def ListMultipartUploads(*args)
  puts "Calling task operation ListMultipartUploads" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_multipart_uploads(call_hash)
  end
...
begin
  result = ListMultipartUploads(params)
