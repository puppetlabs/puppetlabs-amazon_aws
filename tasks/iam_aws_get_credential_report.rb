...
def GetCredentialReport(*args)
  puts "Calling task operation GetCredentialReport" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_credential_report(call_hash)
  end
...
begin
  result = GetCredentialReport(params)
