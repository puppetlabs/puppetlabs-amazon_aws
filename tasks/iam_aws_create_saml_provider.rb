...
def CreateSAMLProvider(*args)
  puts "Calling task operation CreateSAMLProvider" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_saml_provider(call_hash)
  end
...
begin
  result = CreateSAMLProvider(params)
