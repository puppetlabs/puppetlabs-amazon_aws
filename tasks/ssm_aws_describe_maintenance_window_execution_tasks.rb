...
def DescribeMaintenanceWindowExecutionTasks(*args)
  puts "Calling task operation DescribeMaintenanceWindowExecutionTasks" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_maintenance_window_execution_tasks(call_hash)
  end
...
begin
  result = DescribeMaintenanceWindowExecutionTasks(params)
