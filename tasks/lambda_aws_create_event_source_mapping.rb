...
def CreateEventSourceMapping(*args)
  puts "Calling task operation CreateEventSourceMapping" 
  ...
  client = Aws::Lambda::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.create_event_source_mapping(call_hash)
  end
...
begin
  result = CreateEventSourceMapping(params)
