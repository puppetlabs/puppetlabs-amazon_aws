...
def UpdateInstanceCustomHealthStatus(*args)
  puts "Calling task operation UpdateInstanceCustomHealthStatus" 
  ...
  client = Aws::ServiceDiscovery::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.update_instance_custom_health_status(call_hash)
  end
...
begin
  result = UpdateInstanceCustomHealthStatus(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::ServiceDiscovery::Errors::ServiceError => e
