...
def CreateResourceDefinition(*args)
  puts "Calling task operation CreateResourceDefinition" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_resource_definition(call_hash)
  end
...
begin
  result = CreateResourceDefinition(params)
