...
def GetReplicationJobs(*args)
  puts "Calling task operation GetReplicationJobs" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_replication_jobs(call_hash)
  end
...
begin
  result = GetReplicationJobs(params)
