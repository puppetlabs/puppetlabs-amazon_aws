...
def UpdateEmergencyContactSettings(*args)
  puts "Calling task operation UpdateEmergencyContactSettings" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_emergency_contact_settings(call_hash)
  end
...
begin
  result = UpdateEmergencyContactSettings(params)
