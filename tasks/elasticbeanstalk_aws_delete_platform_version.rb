...
def DeletePlatformVersion(*args)
  puts "Calling task operation DeletePlatformVersion" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_platform_version(call_hash)
  end
...
begin
  result = DeletePlatformVersion(params)
