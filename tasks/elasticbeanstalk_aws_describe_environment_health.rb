...
def DescribeEnvironmentHealth(*args)
  puts "Calling task operation DescribeEnvironmentHealth" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_environment_health(call_hash)
  end
...
begin
  result = DescribeEnvironmentHealth(params)
