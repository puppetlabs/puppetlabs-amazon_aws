...
def UpdatePullRequestDescription(*args)
  puts "Calling task operation UpdatePullRequestDescription" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_pull_request_description(call_hash)
  end
...
begin
  result = UpdatePullRequestDescription(params)
