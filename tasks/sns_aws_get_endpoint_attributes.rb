...
def GetEndpointAttributes(*args)
  puts "Calling task operation GetEndpointAttributes" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_endpoint_attributes(call_hash)
  end
...
begin
  result = GetEndpointAttributes(params)
