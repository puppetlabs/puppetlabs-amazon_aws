...
def CreateDataSourceFromS3(*args)
  puts "Calling task operation CreateDataSourceFromS3" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_data_source_from_s3(call_hash)
  end
...
begin
  result = CreateDataSourceFromS3(params)
