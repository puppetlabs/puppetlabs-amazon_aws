...
def operation_with_hash(arg_hash)
  ...
  client.create_data_source_from_s3(call_hash)
end

def create_data_source_from_s3(*args)
  argstring = args[0]
  argstring.delete('\\')
  ...
  client = Aws::MachineLearning::Client.new(region: region)
  response = client.create_data_source_from_s3 if arg_hash.empty?
...
def task
  ...
  params = STDIN.read
  result = create_data_source_from_s3(params)
