...
def GetInstancesHealthStatus(*args)
  puts "Calling task operation GetInstancesHealthStatus" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_instances_health_status(call_hash)
  end
...
begin
  result = GetInstancesHealthStatus(params)
