...
def DescribeOperatingSystems(*args)
  puts "Calling task operation DescribeOperatingSystems" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_operating_systems(call_hash)
  end
...
begin
  result = DescribeOperatingSystems(params)
