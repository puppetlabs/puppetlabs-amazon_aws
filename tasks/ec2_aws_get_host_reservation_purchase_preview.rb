...
def GetHostReservationPurchasePreview(*args)
  puts "Calling task operation GetHostReservationPurchasePreview" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_host_reservation_purchase_preview(call_hash)
  end
...
begin
  result = GetHostReservationPurchasePreview(params)
