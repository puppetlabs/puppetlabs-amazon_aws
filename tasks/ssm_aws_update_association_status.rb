...
def UpdateAssociationStatus(*args)
  puts "Calling task operation UpdateAssociationStatus" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_association_status(call_hash)
  end
...
begin
  result = UpdateAssociationStatus(params)
