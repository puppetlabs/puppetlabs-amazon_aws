...
def GetCoreDefinitionVersion(*args)
  puts "Calling task operation GetCoreDefinitionVersion" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_core_definition_version(call_hash)
  end
...
begin
  result = GetCoreDefinitionVersion(params)
