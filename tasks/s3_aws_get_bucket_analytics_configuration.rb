...
def GetBucketAnalyticsConfiguration(*args)
  puts "Calling task operation GetBucketAnalyticsConfiguration" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_bucket_analytics_configuration(call_hash)
  end
...
begin
  result = GetBucketAnalyticsConfiguration(params)
