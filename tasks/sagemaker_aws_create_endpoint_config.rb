...
def CreateEndpointConfig(*args)
  puts "Calling task operation CreateEndpointConfig" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_endpoint_config(call_hash)
  end
...
begin
  result = CreateEndpointConfig(params)
