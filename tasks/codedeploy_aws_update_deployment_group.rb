...
def UpdateDeploymentGroup(*args)
  puts "Calling task operation UpdateDeploymentGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_deployment_group(call_hash)
  end
...
begin
  result = UpdateDeploymentGroup(params)
