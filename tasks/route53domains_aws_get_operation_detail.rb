...
def GetOperationDetail(*args)
  puts "Calling task operation GetOperationDetail" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_operation_detail(call_hash)
  end
...
begin
  result = GetOperationDetail(params)
