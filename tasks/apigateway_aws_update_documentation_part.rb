...
def UpdateDocumentationPart(*args)
  puts "Calling task operation UpdateDocumentationPart" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_documentation_part(call_hash)
  end
...
begin
  result = UpdateDocumentationPart(params)
