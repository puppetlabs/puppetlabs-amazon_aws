...
def DescribeConnectionsOnInterconnect(*args)
  puts "Calling task operation DescribeConnectionsOnInterconnect" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_connections_on_interconnect(call_hash)
  end
...
begin
  result = DescribeConnectionsOnInterconnect(params)
