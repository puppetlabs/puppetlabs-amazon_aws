...
def DescribeTaskDefinition(*args)
  puts "Calling task operation DescribeTaskDefinition" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_task_definition(call_hash)
  end
...
begin
  result = DescribeTaskDefinition(params)
