...
def CreateNotebookInstance(*args)
  puts "Calling task operation CreateNotebookInstance" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_notebook_instance(call_hash)
  end
...
begin
  result = CreateNotebookInstance(params)
