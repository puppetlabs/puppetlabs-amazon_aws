...
def DescribeLoadBasedAutoScaling(*args)
  puts "Calling task operation DescribeLoadBasedAutoScaling" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_load_based_auto_scaling(call_hash)
  end
...
begin
  result = DescribeLoadBasedAutoScaling(params)
