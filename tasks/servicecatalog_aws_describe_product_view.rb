...
def DescribeProductView(*args)
  puts "Calling task operation DescribeProductView" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_product_view(call_hash)
  end
...
begin
  result = DescribeProductView(params)
