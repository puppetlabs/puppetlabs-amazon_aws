...
def DescribeReservedDBInstancesOfferings(*args)
  puts "Calling task operation DescribeReservedDBInstancesOfferings" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_reserved_db_instances_offerings(call_hash)
  end
...
begin
  result = DescribeReservedDBInstancesOfferings(params)
