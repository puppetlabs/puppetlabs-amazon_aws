...
def DescribeDirectConnectGatewayAttachments(*args)
  puts "Calling task operation DescribeDirectConnectGatewayAttachments" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_direct_connect_gateway_attachments(call_hash)
  end
...
begin
  result = DescribeDirectConnectGatewayAttachments(params)
