...
def DescribeCertificate(*args)
  puts "Calling task operation DescribeCertificate" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_certificate(call_hash)
  end
...
begin
  result = DescribeCertificate(params)
