...
def UpdateNFSFileShare(*args)
  puts "Calling task operation UpdateNFSFileShare" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_nfs_file_share(call_hash)
  end
...
begin
  result = UpdateNFSFileShare(params)
