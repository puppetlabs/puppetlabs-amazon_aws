...
def DeleteAccountAlias(*args)
  puts "Calling task operation DeleteAccountAlias" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_account_alias(call_hash)
  end
...
begin
  result = DeleteAccountAlias(params)
