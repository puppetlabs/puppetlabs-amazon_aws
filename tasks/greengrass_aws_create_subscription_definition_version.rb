...
def CreateSubscriptionDefinitionVersion(*args)
  puts "Calling task operation CreateSubscriptionDefinitionVersion" 
  ...
  client = Aws::Greengrass::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.create_subscription_definition_version(call_hash)
  end
...
begin
  result = CreateSubscriptionDefinitionVersion(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::Greengrass::Errors::ServiceError => e
