...
def GetMaintenanceWindowTask(*args)
  puts "Calling task operation GetMaintenanceWindowTask" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_maintenance_window_task(call_hash)
  end
...
begin
  result = GetMaintenanceWindowTask(params)
