...
def DescribeSnapshotSchedule(*args)
  puts "Calling task operation DescribeSnapshotSchedule" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_snapshot_schedule(call_hash)
  end
...
begin
  result = DescribeSnapshotSchedule(params)
