...
def GetGroupCertificateAuthority(*args)
  puts "Calling task operation GetGroupCertificateAuthority" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_group_certificate_authority(call_hash)
  end
...
begin
  result = GetGroupCertificateAuthority(params)
