...
def ListAWSServiceAccessForOrganization(*args)
  puts "Calling task operation ListAWSServiceAccessForOrganization" 
  ...
  client = Aws::Organizations::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.list_aws_service_access_for_organization(call_hash)
  end
...
begin
  result = ListAWSServiceAccessForOrganization(params)
