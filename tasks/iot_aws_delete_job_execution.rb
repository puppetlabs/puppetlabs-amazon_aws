...
def DeleteJobExecution(*args)
  puts "Calling task operation DeleteJobExecution" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_job_execution(call_hash)
  end
...
begin
  result = DeleteJobExecution(params)
