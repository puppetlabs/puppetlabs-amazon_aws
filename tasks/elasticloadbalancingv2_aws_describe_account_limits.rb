...
def DescribeAccountLimits(*args)
  puts "Calling task operation DescribeAccountLimits" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_account_limits(call_hash)
  end
...
begin
  result = DescribeAccountLimits(params)
