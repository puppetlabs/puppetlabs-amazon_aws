...
def GetTopicAttributes(*args)
  puts "Calling task operation GetTopicAttributes" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_topic_attributes(call_hash)
  end
...
begin
  result = GetTopicAttributes(params)
