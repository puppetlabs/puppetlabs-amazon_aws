...
def GetReservedNodeExchangeOfferings(*args)
  puts "Calling task operation GetReservedNodeExchangeOfferings" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_reserved_node_exchange_offerings(call_hash)
  end
...
begin
  result = GetReservedNodeExchangeOfferings(params)
