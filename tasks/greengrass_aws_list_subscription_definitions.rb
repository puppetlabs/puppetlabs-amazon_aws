...
def ListSubscriptionDefinitions(*args)
  puts "Calling task operation ListSubscriptionDefinitions" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_subscription_definitions(call_hash)
  end
...
begin
  result = ListSubscriptionDefinitions(params)
