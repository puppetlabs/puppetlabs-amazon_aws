...
def DescribeOrderableClusterOptions(*args)
  puts "Calling task operation DescribeOrderableClusterOptions" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_orderable_cluster_options(call_hash)
  end
...
begin
  result = DescribeOrderableClusterOptions(params)
