...
def DescribeVirtualGateways(*args)
  puts "Calling task operation DescribeVirtualGateways" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_virtual_gateways(call_hash)
  end
...
begin
  result = DescribeVirtualGateways(params)
