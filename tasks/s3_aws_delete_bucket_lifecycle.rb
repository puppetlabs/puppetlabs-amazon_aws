...
def DeleteBucketLifecycle(*args)
  puts "Calling task operation DeleteBucketLifecycle" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_bucket_lifecycle(call_hash)
  end
...
begin
  result = DeleteBucketLifecycle(params)
