...
def DescribeGatewayInformation(*args)
  puts "Calling task operation DescribeGatewayInformation" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_gateway_information(call_hash)
  end
...
begin
  result = DescribeGatewayInformation(params)
