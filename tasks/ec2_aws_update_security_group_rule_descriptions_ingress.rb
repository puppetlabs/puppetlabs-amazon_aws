...
def UpdateSecurityGroupRuleDescriptionsIngress(*args)
  puts "Calling task operation UpdateSecurityGroupRuleDescriptionsIngress" 
  ...
  client = Aws::EC2::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.update_security_group_rule_descriptions_ingress(call_hash)
  end
...
begin
  result = UpdateSecurityGroupRuleDescriptionsIngress(params)
