...
def GetBucketLifecycleConfiguration(*args)
  puts "Calling task operation GetBucketLifecycleConfiguration" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_bucket_lifecycle_configuration(call_hash)
  end
...
begin
  result = GetBucketLifecycleConfiguration(params)
