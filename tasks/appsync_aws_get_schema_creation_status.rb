...
def GetSchemaCreationStatus(*args)
  puts "Calling task operation GetSchemaCreationStatus" 
  ...
  client = Aws::AppSync::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.get_schema_creation_status(call_hash)
  end
...
begin
  result = GetSchemaCreationStatus(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::AppSync::Errors::ServiceError => e
