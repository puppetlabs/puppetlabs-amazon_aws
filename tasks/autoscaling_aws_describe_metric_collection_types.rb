...
def DescribeMetricCollectionTypes(*args)
  puts "Calling task operation DescribeMetricCollectionTypes" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_metric_collection_types(call_hash)
  end
...
begin
  result = DescribeMetricCollectionTypes(params)
