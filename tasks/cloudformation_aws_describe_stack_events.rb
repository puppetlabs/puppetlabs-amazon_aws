...
def DescribeStackEvents(*args)
  puts "Calling task operation DescribeStackEvents" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_stack_events(call_hash)
  end
...
begin
  result = DescribeStackEvents(params)
