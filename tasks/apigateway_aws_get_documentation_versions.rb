...
def GetDocumentationVersions(*args)
  puts "Calling task operation GetDocumentationVersions" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_documentation_versions(call_hash)
  end
...
begin
  result = GetDocumentationVersions(params)
