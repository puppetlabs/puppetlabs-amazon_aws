...
def ListPublicKeys2018_06_18(*args)
  puts "Calling task operation ListPublicKeys2018_06_18" 
  ...
  if arg_hash.empty?
    response = client.list_public_keys2018_06_18()
  else 
    call_hash={}
    ...
    response = client.list_public_keys2018_06_18(call_hash)
  end
...
begin
  result = ListPublicKeys2018_06_18(params)
