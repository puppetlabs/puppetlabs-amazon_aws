...
def ModifyCacheSubnetGroup(*args)
  puts "Calling task operation ModifyCacheSubnetGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.modify_cache_subnet_group(call_hash)
  end
...
begin
  result = ModifyCacheSubnetGroup(params)
