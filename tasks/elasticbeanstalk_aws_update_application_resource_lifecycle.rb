...
def UpdateApplicationResourceLifecycle(*args)
  puts "Calling task operation UpdateApplicationResourceLifecycle" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_application_resource_lifecycle(call_hash)
  end
...
begin
  result = UpdateApplicationResourceLifecycle(params)
