...
def ChangeMessageVisibility(*args)
  puts "Calling task operation ChangeMessageVisibility" 
  ...
  if arg_hash.empty?
    ...
    response = client.change_message_visibility(call_hash)
  end
...
begin
  result = ChangeMessageVisibility(params)
