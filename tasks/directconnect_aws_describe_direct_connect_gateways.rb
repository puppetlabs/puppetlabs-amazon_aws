...
def DescribeDirectConnectGateways(*args)
  puts "Calling task operation DescribeDirectConnectGateways" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_direct_connect_gateways(call_hash)
  end
...
begin
  result = DescribeDirectConnectGateways(params)
