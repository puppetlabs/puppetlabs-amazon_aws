...
def DeleteNetworkInterface(*args)
  puts "Calling task operation DeleteNetworkInterface" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_network_interface(call_hash)
  end
...
begin
  result = DeleteNetworkInterface(params)
