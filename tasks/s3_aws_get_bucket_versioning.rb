...
def GetBucketVersioning(*args)
  puts "Calling task operation GetBucketVersioning" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_bucket_versioning(call_hash)
  end
...
begin
  result = GetBucketVersioning(params)
