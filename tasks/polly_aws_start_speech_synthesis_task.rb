...
def StartSpeechSynthesisTask(*args)
  puts "Calling task operation StartSpeechSynthesisTask" 
  ...
  client = Aws::Polly::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.start_speech_synthesis_task(call_hash)
  end
...
begin
  result = StartSpeechSynthesisTask(params)
