...
def DescribeSubscription(*args)
  puts "Calling task operation DescribeSubscription" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_subscription(call_hash)
  end
...
begin
  result = DescribeSubscription(params)
