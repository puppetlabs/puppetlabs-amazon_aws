...
def DescribeHostReservationOfferings(*args)
  puts "Calling task operation DescribeHostReservationOfferings" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_host_reservation_offerings(call_hash)
  end
...
begin
  result = DescribeHostReservationOfferings(params)
