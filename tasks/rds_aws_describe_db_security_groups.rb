...
def DescribeDBSecurityGroups(*args)
  puts "Calling task operation DescribeDBSecurityGroups" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_db_security_groups(call_hash)
  end
...
begin
  result = DescribeDBSecurityGroups(params)
