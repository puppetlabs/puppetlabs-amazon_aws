...
def ListInputSecurityGroups(*args)
  puts "Calling task operation ListInputSecurityGroups" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_input_security_groups(call_hash)
  end
...
begin
  result = ListInputSecurityGroups(params)
