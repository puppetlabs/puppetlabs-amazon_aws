...
def DescribeReservedNodes(*args)
  puts "Calling task operation DescribeReservedNodes" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_reserved_nodes(call_hash)
  end
...
begin
  result = DescribeReservedNodes(params)
