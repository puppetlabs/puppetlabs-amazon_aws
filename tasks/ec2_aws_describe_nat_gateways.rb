...
def DescribeNatGateways(*args)
  puts "Calling task operation DescribeNatGateways" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_nat_gateways(call_hash)
  end
...
begin
  result = DescribeNatGateways(params)
