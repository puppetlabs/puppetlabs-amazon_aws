...
def DeleteLoadBalancerPolicy(*args)
  puts "Calling task operation DeleteLoadBalancerPolicy" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_load_balancer_policy(call_hash)
  end
...
begin
  result = DeleteLoadBalancerPolicy(params)
