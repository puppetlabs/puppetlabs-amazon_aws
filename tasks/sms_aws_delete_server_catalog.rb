...
def DeleteServerCatalog(*args)
  puts "Calling task operation DeleteServerCatalog" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_server_catalog(call_hash)
  end
...
begin
  result = DeleteServerCatalog(params)
