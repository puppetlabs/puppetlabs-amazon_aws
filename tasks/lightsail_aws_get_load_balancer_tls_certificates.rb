...
def GetLoadBalancerTlsCertificates(*args)
  puts "Calling task operation GetLoadBalancerTlsCertificates" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_load_balancer_tls_certificates(call_hash)
  end
...
begin
  result = GetLoadBalancerTlsCertificates(params)
