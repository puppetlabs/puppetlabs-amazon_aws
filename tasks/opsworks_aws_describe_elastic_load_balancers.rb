...
def DescribeElasticLoadBalancers(*args)
  puts "Calling task operation DescribeElasticLoadBalancers" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_elastic_load_balancers(call_hash)
  end
...
begin
  result = DescribeElasticLoadBalancers(params)
