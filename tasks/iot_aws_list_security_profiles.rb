...
def ListSecurityProfiles(*args)
  puts "Calling task operation ListSecurityProfiles" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_security_profiles(call_hash)
  end
...
begin
  result = ListSecurityProfiles(params)
