...
def DescribeLoggingStatus(*args)
  puts "Calling task operation DescribeLoggingStatus" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_logging_status(call_hash)
  end
...
begin
  result = DescribeLoggingStatus(params)
