...
def CreateAccountAlias(*args)
  puts "Calling task operation CreateAccountAlias" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_account_alias(call_hash)
  end
...
begin
  result = CreateAccountAlias(params)
