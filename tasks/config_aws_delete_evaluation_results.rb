...
def DeleteEvaluationResults(*args)
  puts "Calling task operation DeleteEvaluationResults" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_evaluation_results(call_hash)
  end
...
begin
  result = DeleteEvaluationResults(params)
