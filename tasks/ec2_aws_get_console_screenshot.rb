...
def GetConsoleScreenshot(*args)
  puts "Calling task operation GetConsoleScreenshot" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_console_screenshot(call_hash)
  end
...
begin
  result = GetConsoleScreenshot(params)
