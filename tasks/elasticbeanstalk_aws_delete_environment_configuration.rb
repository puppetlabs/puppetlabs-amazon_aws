...
def DeleteEnvironmentConfiguration(*args)
  puts "Calling task operation DeleteEnvironmentConfiguration" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_environment_configuration(call_hash)
  end
...
begin
  result = DeleteEnvironmentConfiguration(params)
