...
def StopHyperParameterTuningJob(*args)
  puts "Calling task operation StopHyperParameterTuningJob" 
  ...
  if arg_hash.empty?
    ...
    response = client.stop_hyper_parameter_tuning_job(call_hash)
  end
...
begin
  result = StopHyperParameterTuningJob(params)
