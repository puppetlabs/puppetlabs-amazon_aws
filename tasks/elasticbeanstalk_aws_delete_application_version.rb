...
def DeleteApplicationVersion(*args)
  puts "Calling task operation DeleteApplicationVersion" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_application_version(call_hash)
  end
...
begin
  result = DeleteApplicationVersion(params)
