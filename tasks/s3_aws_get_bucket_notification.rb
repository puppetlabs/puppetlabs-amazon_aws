...
def GetBucketNotification(*args)
  puts "Calling task operation GetBucketNotification" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_bucket_notification(call_hash)
  end
...
begin
  result = GetBucketNotification(params)
