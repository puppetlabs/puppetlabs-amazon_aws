...
def DescribeStreamProcessor(*args)
  puts "Calling task operation DescribeStreamProcessor" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_stream_processor(call_hash)
  end
...
begin
  result = DescribeStreamProcessor(params)
