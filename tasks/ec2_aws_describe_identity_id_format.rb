...
def DescribeIdentityIdFormat(*args)
  puts "Calling task operation DescribeIdentityIdFormat" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_identity_id_format(call_hash)
  end
...
begin
  result = DescribeIdentityIdFormat(params)
