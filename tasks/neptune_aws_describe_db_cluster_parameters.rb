...
def DescribeDBClusterParameters(*args)
  puts "Calling task operation DescribeDBClusterParameters" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_db_cluster_parameters(call_hash)
  end
...
begin
  result = DescribeDBClusterParameters(params)
