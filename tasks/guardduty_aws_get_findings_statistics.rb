...
def GetFindingsStatistics(*args)
  puts "Calling task operation GetFindingsStatistics" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_findings_statistics(call_hash)
  end
...
begin
  result = GetFindingsStatistics(params)
