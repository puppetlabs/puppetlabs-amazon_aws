...
def DescribeInstanceHealth(*args)
  puts "Calling task operation DescribeInstanceHealth" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_instance_health(call_hash)
  end
...
begin
  result = DescribeInstanceHealth(params)
