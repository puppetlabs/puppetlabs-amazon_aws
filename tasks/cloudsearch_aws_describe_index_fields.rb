...
def DescribeIndexFields(*args)
  puts "Calling task operation DescribeIndexFields" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_index_fields(call_hash)
  end
...
begin
  result = DescribeIndexFields(params)
