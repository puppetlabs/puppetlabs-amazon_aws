...
def ListTagsForResource(*args)
  puts "Calling task operation ListTagsForResource" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_tags_for_resource(call_hash)
  end
...
begin
  result = ListTagsForResource(params)
