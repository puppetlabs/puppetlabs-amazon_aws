...
def DescribeConfigurationAggregatorSourcesStatus(*args)
  puts "Calling task operation DescribeConfigurationAggregatorSourcesStatus" 
  ...
  client = Aws::ConfigService::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.describe_configuration_aggregator_sources_status(call_hash)
  end
...
begin
  result = DescribeConfigurationAggregatorSourcesStatus(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::ConfigService::Errors::ServiceError => e
