...
def DescribeElasticIps(*args)
  puts "Calling task operation DescribeElasticIps" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_elastic_ips(call_hash)
  end
...
begin
  result = DescribeElasticIps(params)
