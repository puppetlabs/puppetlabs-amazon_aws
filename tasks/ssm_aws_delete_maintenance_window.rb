...
def DeleteMaintenanceWindow(*args)
  puts "Calling task operation DeleteMaintenanceWindow" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_maintenance_window(call_hash)
  end
...
begin
  result = DeleteMaintenanceWindow(params)
