...
def DeleteNotificationConfiguration(*args)
  puts "Calling task operation DeleteNotificationConfiguration" 
  ...
  if arg_hash.empty?
    ...
    response = client.delete_notification_configuration(call_hash)
  end
...
begin
  result = DeleteNotificationConfiguration(params)
