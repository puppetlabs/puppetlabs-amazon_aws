...
def ListContainerInstances(*args)
  puts "Calling task operation ListContainerInstances" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_container_instances(call_hash)
  end
...
begin
  result = ListContainerInstances(params)
