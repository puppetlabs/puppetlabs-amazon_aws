...
def ListDeviceInstances(*args)
  puts "Calling task operation ListDeviceInstances" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_device_instances(call_hash)
  end
...
begin
  result = ListDeviceInstances(params)
