...
def ListDatasetContents(*args)
  puts "Calling task operation ListDatasetContents" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_dataset_contents(call_hash)
  end
...
begin
  result = ListDatasetContents(params)
