...
def DetachLoadBalancerTargetGroups(*args)
  puts "Calling task operation DetachLoadBalancerTargetGroups" 
  ...
  if arg_hash.empty?
    ...
    response = client.detach_load_balancer_target_groups(call_hash)
  end
...
begin
  result = DetachLoadBalancerTargetGroups(params)
