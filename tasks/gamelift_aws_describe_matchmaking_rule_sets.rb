...
def DescribeMatchmakingRuleSets(*args)
  puts "Calling task operation DescribeMatchmakingRuleSets" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_matchmaking_rule_sets(call_hash)
  end
...
begin
  result = DescribeMatchmakingRuleSets(params)
