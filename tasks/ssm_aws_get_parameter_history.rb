...
def GetParameterHistory(*args)
  puts "Calling task operation GetParameterHistory" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_parameter_history(call_hash)
  end
...
begin
  result = GetParameterHistory(params)
