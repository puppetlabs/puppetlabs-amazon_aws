...
def ModifyInstanceAttribute(*args)
  puts "Calling task operation ModifyInstanceAttribute" 
  ...
  if arg_hash.empty?
    ...
    response = client.modify_instance_attribute(call_hash)
  end
...
begin
  result = ModifyInstanceAttribute(params)
