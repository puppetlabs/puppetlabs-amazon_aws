...
def GetEventSelectors(*args)
  puts "Calling task operation GetEventSelectors" 
  ...
  client = Aws::CloudTrail::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.get_event_selectors(call_hash)
  end
...
begin
  result = GetEventSelectors(params)
