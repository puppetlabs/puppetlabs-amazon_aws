...
def CreateNetworkProfile(*args)
  puts "Calling task operation CreateNetworkProfile" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_network_profile(call_hash)
  end
...
begin
  result = CreateNetworkProfile(params)
