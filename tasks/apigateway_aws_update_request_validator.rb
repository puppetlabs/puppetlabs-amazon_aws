...
def UpdateRequestValidator(*args)
  puts "Calling task operation UpdateRequestValidator" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_request_validator(call_hash)
  end
...
begin
  result = UpdateRequestValidator(params)
