...
def ModifyDBParameterGroup(*args)
  puts "Calling task operation ModifyDBParameterGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.modify_db_parameter_group(call_hash)
  end
...
begin
  result = ModifyDBParameterGroup(params)
