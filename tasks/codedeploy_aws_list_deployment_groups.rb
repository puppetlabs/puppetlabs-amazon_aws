...
def ListDeploymentGroups(*args)
  puts "Calling task operation ListDeploymentGroups" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_deployment_groups(call_hash)
  end
...
begin
  result = ListDeploymentGroups(params)
