...
def CreateEventSubscription(*args)
  puts "Calling task operation CreateEventSubscription" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_event_subscription(call_hash)
  end
...
begin
  result = CreateEventSubscription(params)
