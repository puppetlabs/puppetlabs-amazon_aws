...
def DeleteDocumentationVersion(*args)
  puts "Calling task operation DeleteDocumentationVersion" 
  ...
  client = Aws::APIGateway::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.delete_documentation_version(call_hash)
  end
...
begin
  result = DeleteDocumentationVersion(params)
