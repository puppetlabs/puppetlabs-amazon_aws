...
def ListResourceDefinitionVersions(*args)
  puts "Calling task operation ListResourceDefinitionVersions" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_resource_definition_versions(call_hash)
  end
...
begin
  result = ListResourceDefinitionVersions(params)
