...
def ListFunctionDefinitionVersions(*args)
  puts "Calling task operation ListFunctionDefinitionVersions" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_function_definition_versions(call_hash)
  end
...
begin
  result = ListFunctionDefinitionVersions(params)
