...
def DescribeInputSecurityGroup(*args)
  puts "Calling task operation DescribeInputSecurityGroup" 
  ...
  client = Aws::MediaLive::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.describe_input_security_group(call_hash)
  end
...
begin
  result = DescribeInputSecurityGroup(params)
