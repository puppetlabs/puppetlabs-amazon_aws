...
def DescribeClusters(*args)
  puts "Calling task operation DescribeClusters" 
  ...
  client = Aws::CloudHSMV2::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.describe_clusters(call_hash)
  end
...
begin
  result = DescribeClusters(params)
  puts JSON.pretty_generate(result)
  exit 0
rescue Aws::CloudHSMV2::Errors::ServiceError => e
