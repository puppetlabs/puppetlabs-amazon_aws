...
def ListCreateAccountStatus(*args)
  puts "Calling task operation ListCreateAccountStatus" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_create_account_status(call_hash)
  end
...
begin
  result = ListCreateAccountStatus(params)
