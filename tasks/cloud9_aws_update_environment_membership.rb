...
def UpdateEnvironmentMembership(*args)
  puts "Calling task operation UpdateEnvironmentMembership" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_environment_membership(call_hash)
  end
...
begin
  result = UpdateEnvironmentMembership(params)
