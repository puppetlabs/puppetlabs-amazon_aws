...
def CreateClusterSnapshot(*args)
  puts "Calling task operation CreateClusterSnapshot" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_cluster_snapshot(call_hash)
  end
...
begin
  result = CreateClusterSnapshot(params)
