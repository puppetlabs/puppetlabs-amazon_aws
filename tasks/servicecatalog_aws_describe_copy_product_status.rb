...
def DescribeCopyProductStatus(*args)
  puts "Calling task operation DescribeCopyProductStatus" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_copy_product_status(call_hash)
  end
...
begin
  result = DescribeCopyProductStatus(params)
