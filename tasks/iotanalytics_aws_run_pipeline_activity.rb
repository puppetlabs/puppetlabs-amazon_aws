...
def RunPipelineActivity(*args)
  puts "Calling task operation RunPipelineActivity" 
  ...
  if arg_hash.empty?
    ...
    response = client.run_pipeline_activity(call_hash)
  end
...
begin
  result = RunPipelineActivity(params)
