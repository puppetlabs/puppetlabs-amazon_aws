...
def DescribeStateMachine(*args)
  puts "Calling task operation DescribeStateMachine" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_state_machine(call_hash)
  end
...
begin
  result = DescribeStateMachine(params)
