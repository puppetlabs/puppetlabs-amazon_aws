...
def GetDomainSuggestions(*args)
  puts "Calling task operation GetDomainSuggestions" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_domain_suggestions(call_hash)
  end
...
begin
  result = GetDomainSuggestions(params)
