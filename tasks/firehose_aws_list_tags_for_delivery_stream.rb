...
def ListTagsForDeliveryStream(*args)
  puts "Calling task operation ListTagsForDeliveryStream" 
  ...
  client = Aws::Firehose::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.list_tags_for_delivery_stream(call_hash)
  end
...
begin
  result = ListTagsForDeliveryStream(params)
