...
def RemoveTagsFromResource(*args)
  puts "Calling task operation RemoveTagsFromResource" 
  ...
  if arg_hash.empty?
    ...
    response = client.remove_tags_from_resource(call_hash)
  end
...
begin
  result = RemoveTagsFromResource(params)
