...
def CreateCachediSCSIVolume(*args)
  puts "Calling task operation CreateCachediSCSIVolume" 
  ...
  if arg_hash.empty?
    response = client.create_cachedi_scsi_volume()
  else 
    call_hash={}
    ...
    response = client.create_cachedi_scsi_volume(call_hash)
  end
...
begin
  result = CreateCachediSCSIVolume(params)
