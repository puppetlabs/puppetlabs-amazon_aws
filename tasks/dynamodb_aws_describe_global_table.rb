...
def DescribeGlobalTable(*args)
  puts "Calling task operation DescribeGlobalTable" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_global_table(call_hash)
  end
...
begin
  result = DescribeGlobalTable(params)
