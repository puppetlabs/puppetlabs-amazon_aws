...
def DescribeRaidArrays(*args)
  puts "Calling task operation DescribeRaidArrays" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_raid_arrays(call_hash)
  end
...
begin
  result = DescribeRaidArrays(params)
