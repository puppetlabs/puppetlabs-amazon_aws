...
def ListDeploymentConfigs(*args)
  puts "Calling task operation ListDeploymentConfigs" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_deployment_configs(call_hash)
  end
...
begin
  result = ListDeploymentConfigs(params)
