...
def GetAggregateConfigRuleComplianceSummary(*args)
  puts "Calling task operation GetAggregateConfigRuleComplianceSummary" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_aggregate_config_rule_compliance_summary(call_hash)
  end
...
begin
  result = GetAggregateConfigRuleComplianceSummary(params)
