...
def DescribeStreamConsumer(*args)
  puts "Calling task operation DescribeStreamConsumer" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_stream_consumer(call_hash)
  end
...
begin
  result = DescribeStreamConsumer(params)
