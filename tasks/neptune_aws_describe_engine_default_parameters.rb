...
def DescribeEngineDefaultParameters(*args)
  puts "Calling task operation DescribeEngineDefaultParameters" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_engine_default_parameters(call_hash)
  end
...
begin
  result = DescribeEngineDefaultParameters(params)
