...
def DescribeContainerInstances(*args)
  puts "Calling task operation DescribeContainerInstances" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_container_instances(call_hash)
  end
...
begin
  result = DescribeContainerInstances(params)
