...
def GetGatewayResponse(*args)
  puts "Calling task operation GetGatewayResponse" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_gateway_response(call_hash)
  end
...
begin
  result = GetGatewayResponse(params)
