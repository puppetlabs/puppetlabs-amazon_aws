...
def DeregisterRdsDbInstance(*args)
  puts "Calling task operation DeregisterRdsDbInstance" 
  ...
  if arg_hash.empty?
    ...
    response = client.deregister_rds_db_instance(call_hash)
  end
...
begin
  result = DeregisterRdsDbInstance(params)
