...
def DescribeMaintenanceWindowExecutionTaskInvocations(*args)
  puts "Calling task operation DescribeMaintenanceWindowExecutionTaskInvocations" 
  ...
  client = Aws::SSM::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.describe_maintenance_window_execution_task_invocations(call_hash)
  end
...
begin
  result = DescribeMaintenanceWindowExecutionTaskInvocations(params)
