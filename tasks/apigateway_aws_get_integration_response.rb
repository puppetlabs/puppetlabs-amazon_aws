...
def GetIntegrationResponse(*args)
  puts "Calling task operation GetIntegrationResponse" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_integration_response(call_hash)
  end
...
begin
  result = GetIntegrationResponse(params)
