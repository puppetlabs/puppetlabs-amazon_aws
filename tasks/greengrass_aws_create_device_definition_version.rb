...
def CreateDeviceDefinitionVersion(*args)
  puts "Calling task operation CreateDeviceDefinitionVersion" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_device_definition_version(call_hash)
  end
...
begin
  result = CreateDeviceDefinitionVersion(params)
