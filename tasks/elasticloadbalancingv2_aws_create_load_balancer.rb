...
def CreateLoadBalancer(*args)
  puts "Calling task operation CreateLoadBalancer" 
  ...
  if arg_hash.empty?
    ...
    response = client.create_load_balancer(call_hash)
  end
...
begin
  result = CreateLoadBalancer(params)
