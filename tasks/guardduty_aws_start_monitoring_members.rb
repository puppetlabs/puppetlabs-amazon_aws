...
def StartMonitoringMembers(*args)
  puts "Calling task operation StartMonitoringMembers" 
  ...
  if arg_hash.empty?
    ...
    response = client.start_monitoring_members(call_hash)
  end
...
begin
  result = StartMonitoringMembers(params)
