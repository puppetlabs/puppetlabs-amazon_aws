...
def GetCloudFrontOriginAccessIdentity2018_06_18(*args)
  puts "Calling task operation GetCloudFrontOriginAccessIdentity2018_06_18" 
  ...
  if arg_hash.empty?
    response = client.get_cloud_front_origin_access_identity2018_06_18()
  else 
    call_hash={}
    ...
    response = client.get_cloud_front_origin_access_identity2018_06_18(call_hash)
  end
...
begin
  result = GetCloudFrontOriginAccessIdentity2018_06_18(params)
