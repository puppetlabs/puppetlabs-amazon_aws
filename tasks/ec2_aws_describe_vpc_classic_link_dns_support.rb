...
def DescribeVpcClassicLinkDnsSupport(*args)
  puts "Calling task operation DescribeVpcClassicLinkDnsSupport" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_vpc_classic_link_dns_support(call_hash)
  end
...
begin
  result = DescribeVpcClassicLinkDnsSupport(params)
