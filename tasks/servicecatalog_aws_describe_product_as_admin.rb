...
def DescribeProductAsAdmin(*args)
  puts "Calling task operation DescribeProductAsAdmin" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_product_as_admin(call_hash)
  end
...
begin
  result = DescribeProductAsAdmin(params)
