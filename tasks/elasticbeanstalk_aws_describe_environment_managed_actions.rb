...
def DescribeEnvironmentManagedActions(*args)
  puts "Calling task operation DescribeEnvironmentManagedActions" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_environment_managed_actions(call_hash)
  end
...
begin
  result = DescribeEnvironmentManagedActions(params)
