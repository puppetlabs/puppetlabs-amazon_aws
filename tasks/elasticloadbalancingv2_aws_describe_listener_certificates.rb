...
def operation_with_hash(arg_hash)
  ...
  client.describe_listener_certificates(call_hash)
end
...
def describe_listener_certificates(*args)
  ...
  client = Aws::ElasticLoadBalancingV2::Client.new(region: region)
  response = client.describe_listener_certificates if arg_hash.empty?
...
def task
  ...
  params = STDIN.read
  result = describe_listener_certificates(params)
