...
def DescribeListenerCertificates(*args)
  puts "Calling task operation DescribeListenerCertificates" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_listener_certificates(call_hash)
  end
...
begin
  result = DescribeListenerCertificates(params)
