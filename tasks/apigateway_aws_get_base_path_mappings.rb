...
def GetBasePathMappings(*args)
  puts "Calling task operation GetBasePathMappings" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_base_path_mappings(call_hash)
  end
...
begin
  result = GetBasePathMappings(params)
