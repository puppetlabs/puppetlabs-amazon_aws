...
def DescribeDBInstances(*args)
  puts "Calling task operation DescribeDBInstances" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_db_instances(call_hash)
  end
...
begin
  result = DescribeDBInstances(params)
