...
def UpdateDocumentVersion(*args)
  puts "Calling task operation UpdateDocumentVersion" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_document_version(call_hash)
  end
...
begin
  result = UpdateDocumentVersion(params)
