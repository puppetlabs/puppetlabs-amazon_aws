...
def DescribeAggregateComplianceByConfigRules(*args)
  puts "Calling task operation DescribeAggregateComplianceByConfigRules" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_aggregate_compliance_by_config_rules(call_hash)
  end
...
begin
  result = DescribeAggregateComplianceByConfigRules(params)
