...
def RemoveUserFromGroup(*args)
  puts "Calling task operation RemoveUserFromGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.remove_user_from_group(call_hash)
  end
...
begin
  result = RemoveUserFromGroup(params)
