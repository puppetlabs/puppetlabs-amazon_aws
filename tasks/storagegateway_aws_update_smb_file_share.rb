...
def UpdateSMBFileShare(*args)
  puts "Calling task operation UpdateSMBFileShare" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_smb_file_share(call_hash)
  end
...
begin
  result = UpdateSMBFileShare(params)
