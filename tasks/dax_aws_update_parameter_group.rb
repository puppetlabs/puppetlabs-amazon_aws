...
def UpdateParameterGroup(*args)
  puts "Calling task operation UpdateParameterGroup" 
  ...
  if arg_hash.empty?
    ...
    response = client.update_parameter_group(call_hash)
  end
...
begin
  result = UpdateParameterGroup(params)
