...
def GetFederationToken(*args)
  puts "Calling task operation GetFederationToken" 
  ...
  client = Aws::STS::Client.new(region: get_region)
  ...
  if arg_hash.empty?
    ...
    response = client.get_federation_token(call_hash)
  end
...
begin
  result = GetFederationToken(params)
