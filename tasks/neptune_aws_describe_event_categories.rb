...
def DescribeEventCategories(*args)
  puts "Calling task operation DescribeEventCategories" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_event_categories(call_hash)
  end
...
begin
  result = DescribeEventCategories(params)
