...
def DescribeProvisioningParameters(*args)
  puts "Calling task operation DescribeProvisioningParameters" 
  ...
  if arg_hash.empty?
    ...
    response = client.describe_provisioning_parameters(call_hash)
  end
...
begin
  result = DescribeProvisioningParameters(params)
