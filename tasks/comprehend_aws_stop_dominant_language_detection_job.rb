...
def StopDominantLanguageDetectionJob(*args)
  puts "Calling task operation StopDominantLanguageDetectionJob" 
  ...
  if arg_hash.empty?
    ...
    response = client.stop_dominant_language_detection_job(call_hash)
  end
...
begin
  result = StopDominantLanguageDetectionJob(params)
