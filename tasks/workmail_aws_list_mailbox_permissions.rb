...
def ListMailboxPermissions(*args)
  puts "Calling task operation ListMailboxPermissions" 
  ...
  if arg_hash.empty?
    ...
    response = client.list_mailbox_permissions(call_hash)
  end
...
begin
  result = ListMailboxPermissions(params)
