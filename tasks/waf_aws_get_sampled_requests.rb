...
def GetSampledRequests(*args)
  puts "Calling task operation GetSampledRequests" 
  ...
  if arg_hash.empty?
    ...
    response = client.get_sampled_requests(call_hash)
  end
...
begin
  result = GetSampledRequests(params)
